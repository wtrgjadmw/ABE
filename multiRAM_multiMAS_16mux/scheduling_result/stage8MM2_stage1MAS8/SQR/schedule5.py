...
def solve():
	...
	S += c_t4_t3_t2_mem0 >= 16
	c_t4_t3_t2_mem0 += MAS_MEM[14]

	c_t4_t3_t2_mem1 = S.Task('c_t4_t3_t2_mem1', length=1, delay_cost=1)
	S += c_t4_t3_t2_mem1 >= 16
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS8/SQR/schedule5.png"
	if(S.solution() != []):
