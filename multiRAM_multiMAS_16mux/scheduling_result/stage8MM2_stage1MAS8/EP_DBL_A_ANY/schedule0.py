...
def solve():
	...
	t3 = S.Task('t3', length=8, delay_cost=1)
	t3 += alt(MM)
	...
	t8 = S.Task('t8', length=8, delay_cost=1)
	t8 += alt(MM)
	...
	t7 = S.Task('t7', length=8, delay_cost=1)
	t7 += alt(MM)
	...
	t14 = S.Task('t14', length=8, delay_cost=1)
	t14 += alt(MM)
	...
	t17 = S.Task('t17', length=8, delay_cost=1)
	t17 += alt(MM)
	...
	t22 = S.Task('t22', length=8, delay_cost=1)
	t22 += alt(MM)
	...
	t12 = S.Task('t12', length=8, delay_cost=1)
	t12 += alt(MM)
	...
	t13 = S.Task('t13', length=8, delay_cost=1)
	t13 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS8/EP_DBL_A_ANY/schedule0.png"
	if(S.solution() != []):
