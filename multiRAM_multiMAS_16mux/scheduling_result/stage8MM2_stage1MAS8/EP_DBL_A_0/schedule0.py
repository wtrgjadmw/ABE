...
def solve():
	...
	new_PZ = S.Task('new_PZ', length=8, delay_cost=1)
	new_PZ += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS8/EP_DBL_A_0/schedule0.png"
	if(S.solution() != []):
