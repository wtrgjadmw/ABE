...
def solve():
	...
	S += d_t3_t2_t5_mem0 >= 38
	d_t3_t2_t5_mem0 += MM_MEM[0]

	d_t3_t2_t5_mem1 = S.Task('d_t3_t2_t5_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t5_mem1 >= 38
	...
	S += d_t5_t2_t1_mem0 >= 55
	d_t5_t2_t1_mem0 += MAS_MEM[6]

	d_t5_t2_t1_mem1 = S.Task('d_t5_t2_t1_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t1_mem1 >= 55
	...
	S += d_t5_t2_t0_mem0 >= 57
	d_t5_t2_t0_mem0 += MAS_MEM[12]

	d_t5_t2_t0_mem1 = S.Task('d_t5_t2_t0_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t0_mem1 >= 57
	...
	S += d_t5_t2_t4_mem0 >= 59
	d_t5_t2_t4_mem0 += MAS_MEM[8]

	d_t5_t2_t4_mem1 = S.Task('d_t5_t2_t4_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t4_mem1 >= 59
	...
	S += d_t5_t2_t5_mem0 >= 65
	d_t5_t2_t5_mem0 += MM_MEM[2]

	d_t5_t2_t5_mem1 = S.Task('d_t5_t2_t5_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t5_mem1 >= 65
	...
	S += c_t4_t0_t5_mem0 >= 78
	c_t4_t0_t5_mem0 += MM_MEM[2]

	c_t4_t0_t5_mem1 = S.Task('c_t4_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t5_mem1 >= 78
	...
	S += c_t5_t4_t1_mem0 >= 95
	c_t5_t4_t1_mem0 += MAS_MEM[0]

	c_t5_t4_t1_mem1 = S.Task('c_t5_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t1_mem1 >= 95
	...
	S += c_t8010_mem0 >= 98
	c_t8010_mem0 += MAS_MEM[14]

	c_t8010_mem1 = S.Task('c_t8010_mem1', length=1, delay_cost=1)
	S += c_t8010_mem1 >= 98
	c_t8010_mem1 += MAS_MEM[13]
	...
	S += c_t7000_mem1 >= 102
	c_t7000_mem1 += MAS_MEM[11]

	c_t8000_mem0 = S.Task('c_t8000_mem0', length=1, delay_cost=1)
	S += c_t8000_mem0 >= 102
	c_t8000_mem0 += MAS_MEM[10]
	...
	S += c_t9_y1_1_mem0 >= 106
	c_t9_y1_1_mem0 += MAS_MEM[0]

	c_t9_y1_1_mem1 = S.Task('c_t9_y1_1_mem1', length=1, delay_cost=1)
	S += c_t9_y1_1_mem1 >= 106
	c_t9_y1_1_mem1 += MAS_MEM[15]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS8/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
