...
def solve():
	...
	T4 = S.Task('T4', length=8, delay_cost=1)
	T4 += alt(MM)
	...
	T6 = S.Task('T6', length=8, delay_cost=1)
	T6 += alt(MM)
	...
	T9 = S.Task('T9', length=8, delay_cost=1)
	T9 += alt(MM)
	...
	T11 = S.Task('T11', length=8, delay_cost=1)
	T11 += alt(MM)
	...
	T16 = S.Task('T16', length=8, delay_cost=1)
	T16 += alt(MM)
	...
	Z2_new = S.Task('Z2_new', length=8, delay_cost=1)
	Z2_new += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS8/EP_LADDERMUL/schedule0.png"
	if(S.solution() != []):
