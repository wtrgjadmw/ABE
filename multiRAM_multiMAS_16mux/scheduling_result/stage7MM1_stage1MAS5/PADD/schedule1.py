...
def solve():
	...
	S += (t10*MAS[1])-1 < t4_t0_mem0*MAS_MEM[2]
	S += (t10*MAS[2])-1 < t4_t0_mem0*MAS_MEM[4]
	S += (t10*MAS[3])-1 < t4_t0_mem0*MAS_MEM[6]
	S += (t10*MAS[4])-1 < t4_t0_mem0*MAS_MEM[8]
	S += t4_t0_mem0 <= t4_t0

	t4_t0_mem1 = S.Task('t4_t0_mem1', length=1, delay_cost=1)
	t4_t0_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t4_t0_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t4_t0_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t4_t0_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t4_t0_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t4_t0_mem1*MAS_MEM[9]
	S += t4_t0_mem1 <= t4_t0
	...
	S += (t10*MAS[1])-1 < t4_t1_mem0*MAS_MEM[2]
	S += (t10*MAS[2])-1 < t4_t1_mem0*MAS_MEM[4]
	S += (t10*MAS[3])-1 < t4_t1_mem0*MAS_MEM[6]
	S += (t10*MAS[4])-1 < t4_t1_mem0*MAS_MEM[8]
	S += t4_t1_mem0 <= t4_t1

	t4_t1_mem1 = S.Task('t4_t1_mem1', length=1, delay_cost=1)
	t4_t1_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t4_t1_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t4_t1_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t4_t1_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t4_t1_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t4_t1_mem1*MAS_MEM[9]
	S += t4_t1_mem1 <= t4_t1
	...
	S += (t10*MAS[1])-1 < t4_t3_mem0*MAS_MEM[2]
	S += (t10*MAS[2])-1 < t4_t3_mem0*MAS_MEM[4]
	S += (t10*MAS[3])-1 < t4_t3_mem0*MAS_MEM[6]
	S += (t10*MAS[4])-1 < t4_t3_mem0*MAS_MEM[8]
	S += t4_t3_mem0 <= t4_t3

	t4_t3_mem1 = S.Task('t4_t3_mem1', length=1, delay_cost=1)
	t4_t3_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t4_t3_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t4_t3_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t4_t3_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t4_t3_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t4_t3_mem1*MAS_MEM[9]
	S += t4_t3_mem1 <= t4_t3
	...
	S += (t30*MAS[1])-1 < t5_t0_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < t5_t0_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < t5_t0_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < t5_t0_mem0*MAS_MEM[8]
	S += t5_t0_mem0 <= t5_t0

	t5_t0_mem1 = S.Task('t5_t0_mem1', length=1, delay_cost=1)
	t5_t0_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < t5_t0_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t5_t0_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t5_t0_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t5_t0_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t5_t0_mem1*MAS_MEM[9]
	S += t5_t0_mem1 <= t5_t0
	...
	S += (t30*MAS[1])-1 < t5_t1_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < t5_t1_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < t5_t1_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < t5_t1_mem0*MAS_MEM[8]
	S += t5_t1_mem0 <= t5_t1

	t5_t1_mem1 = S.Task('t5_t1_mem1', length=1, delay_cost=1)
	t5_t1_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < t5_t1_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t5_t1_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t5_t1_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t5_t1_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t5_t1_mem1*MAS_MEM[9]
	S += t5_t1_mem1 <= t5_t1
	...
	S += (t30*MAS[1])-1 < t5_t3_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < t5_t3_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < t5_t3_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < t5_t3_mem0*MAS_MEM[8]
	S += t5_t3_mem0 <= t5_t3

	t5_t3_mem1 = S.Task('t5_t3_mem1', length=1, delay_cost=1)
	t5_t3_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < t5_t3_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t5_t3_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t5_t3_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t5_t3_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t5_t3_mem1*MAS_MEM[9]
	S += t5_t3_mem1 <= t5_t3
	...
	S += (t30*MAS[1])-1 < t6_t2_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < t6_t2_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < t6_t2_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < t6_t2_mem0*MAS_MEM[8]
	S += t6_t2_mem0 <= t6_t2

	t6_t2_mem1 = S.Task('t6_t2_mem1', length=1, delay_cost=1)
	t6_t2_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < t6_t2_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t6_t2_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t6_t2_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t6_t2_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t6_t2_mem1*MAS_MEM[9]
	S += t6_t2_mem1 <= t6_t2
	...
	S += (t30*MAS[1])-1 < new_TX_t2_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < new_TX_t2_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < new_TX_t2_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < new_TX_t2_mem0*MAS_MEM[8]
	S += new_TX_t2_mem0 <= new_TX_t2

	new_TX_t2_mem1 = S.Task('new_TX_t2_mem1', length=1, delay_cost=1)
	new_TX_t2_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < new_TX_t2_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < new_TX_t2_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < new_TX_t2_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < new_TX_t2_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < new_TX_t2_mem1*MAS_MEM[9]
	...
	S += (t10*MAS[1])-1 < t13_t2_mem0*MAS_MEM[2]
	S += (t10*MAS[2])-1 < t13_t2_mem0*MAS_MEM[4]
	S += (t10*MAS[3])-1 < t13_t2_mem0*MAS_MEM[6]
	S += (t10*MAS[4])-1 < t13_t2_mem0*MAS_MEM[8]
	S += t13_t2_mem0 <= t13_t2

	t13_t2_mem1 = S.Task('t13_t2_mem1', length=1, delay_cost=1)
	t13_t2_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t13_t2_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t13_t2_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t13_t2_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t13_t2_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t13_t2_mem1*MAS_MEM[9]
	...
	S += (t31*MAS[1])-1 < c011_mem0*MAS_MEM[2]
	S += (t31*MAS[2])-1 < c011_mem0*MAS_MEM[4]
	S += (t31*MAS[3])-1 < c011_mem0*MAS_MEM[6]
	S += (t31*MAS[4])-1 < c011_mem0*MAS_MEM[8]
	S += c011_mem0 <= c011
	...
	S += (t11*MAS[1])-1 < c201_mem0*MAS_MEM[2]
	S += (t11*MAS[2])-1 < c201_mem0*MAS_MEM[4]
	S += (t11*MAS[3])-1 < c201_mem0*MAS_MEM[6]
	S += (t11*MAS[4])-1 < c201_mem0*MAS_MEM[8]
	S += c201_mem0 <= c201
	...
	S += (t31*MAS[0])-1 < t16_t1_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t16_t1_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t16_t1_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t16_t1_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t16_t1_mem1*MAS_MEM[9]
	...
	S += (t30*MAS[1])-1 < t16_t3_mem0*MAS_MEM[2]
	S += (t30*MAS[2])-1 < t16_t3_mem0*MAS_MEM[4]
	S += (t30*MAS[3])-1 < t16_t3_mem0*MAS_MEM[6]
	S += (t30*MAS[4])-1 < t16_t3_mem0*MAS_MEM[8]
	S += t16_t3_mem0 <= t16_t3

	t16_t3_mem1 = S.Task('t16_t3_mem1', length=1, delay_cost=1)
	t16_t3_mem1 += alt(MAS_MEM)
	S += (t31*MAS[0])-1 < t16_t3_mem1*MAS_MEM[1]
	S += (t31*MAS[1])-1 < t16_t3_mem1*MAS_MEM[3]
	S += (t31*MAS[2])-1 < t16_t3_mem1*MAS_MEM[5]
	S += (t31*MAS[3])-1 < t16_t3_mem1*MAS_MEM[7]
	S += (t31*MAS[4])-1 < t16_t3_mem1*MAS_MEM[9]
	...
	S += (t11*MAS[0])-1 < t17_t1_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t17_t1_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t17_t1_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t17_t1_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t17_t1_mem1*MAS_MEM[9]
	...
	S += (t10*MAS[1])-1 < t17_t3_mem0*MAS_MEM[2]
	S += (t10*MAS[2])-1 < t17_t3_mem0*MAS_MEM[4]
	S += (t10*MAS[3])-1 < t17_t3_mem0*MAS_MEM[6]
	S += (t10*MAS[4])-1 < t17_t3_mem0*MAS_MEM[8]
	S += t17_t3_mem0 <= t17_t3

	t17_t3_mem1 = S.Task('t17_t3_mem1', length=1, delay_cost=1)
	t17_t3_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t17_t3_mem1*MAS_MEM[1]
	S += (t11*MAS[1])-1 < t17_t3_mem1*MAS_MEM[3]
	S += (t11*MAS[2])-1 < t17_t3_mem1*MAS_MEM[5]
	S += (t11*MAS[3])-1 < t17_t3_mem1*MAS_MEM[7]
	S += (t11*MAS[4])-1 < t17_t3_mem1*MAS_MEM[9]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage7MM1_stage1MAS5/PADD/schedule1.png"
	if(S.solution() != []):
