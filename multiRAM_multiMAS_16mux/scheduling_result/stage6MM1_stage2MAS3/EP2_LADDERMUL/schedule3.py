...
def solve():
	...
	T22_t0_mem1 += alt(MAS_MEM)
	S += (T211*MAS[0])-1 < T22_t0_mem1*MAS_MEM[1]
	S += (T211*MAS[1])-1 < T22_t0_mem1*MAS_MEM[3]
	S += (T211*MAS[2])-1 < T22_t0_mem1*MAS_MEM[5]
	...
	T22_t1_mem1 += alt(MAS_MEM)
	S += (T211*MAS[0])-1 < T22_t1_mem1*MAS_MEM[1]
	S += (T211*MAS[1])-1 < T22_t1_mem1*MAS_MEM[3]
	S += (T211*MAS[2])-1 < T22_t1_mem1*MAS_MEM[5]
	...
	T22_t3_mem1 += alt(MAS_MEM)
	S += (T211*MAS[0])-1 < T22_t3_mem1*MAS_MEM[1]
	S += (T211*MAS[1])-1 < T22_t3_mem1*MAS_MEM[3]
	S += (T211*MAS[2])-1 < T22_t3_mem1*MAS_MEM[5]
