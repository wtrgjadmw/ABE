...
def solve():
	...
	S += 26 < c_t3_t3_t4_mem0
	S += c_t3_t3_t4_mem0 <= c_t3_t3_t4

	c_t3_t3_t4_mem1 = S.Task('c_t3_t3_t4_mem1', length=1, delay_cost=1)
	c_t3_t3_t4_mem1 += alt(MAS_MEM)
	S += (c_t3_t3_t3*MAS[0])-1 < c_t3_t3_t4_mem1*MAS_MEM[1]
	S += (c_t3_t3_t3*MAS[1])-1 < c_t3_t3_t4_mem1*MAS_MEM[3]
	S += (c_t3_t3_t3*MAS[2])-1 < c_t3_t3_t4_mem1*MAS_MEM[5]
	...
	c_t4_t00_mem1 += alt(MAS_MEM)
	S += (c_t4_a1_0*MAS[0])-1 < c_t4_t00_mem1*MAS_MEM[1]
	S += (c_t4_a1_0*MAS[1])-1 < c_t4_t00_mem1*MAS_MEM[3]
	S += (c_t4_a1_0*MAS[2])-1 < c_t4_t00_mem1*MAS_MEM[5]
	...
	c_t4_t2_t3_mem0 += alt(MAS_MEM)
	S += (c_t4_t10*MAS[0])-1 < c_t4_t2_t3_mem0*MAS_MEM[0]
	S += (c_t4_t10*MAS[1])-1 < c_t4_t2_t3_mem0*MAS_MEM[2]
	S += (c_t4_t10*MAS[2])-1 < c_t4_t2_t3_mem0*MAS_MEM[4]
	...
	c_t4_t3_t4_mem1 += alt(MAS_MEM)
	S += (c_t4_t3_t3*MAS[0])-1 < c_t4_t3_t4_mem1*MAS_MEM[1]
	S += (c_t4_t3_t3*MAS[1])-1 < c_t4_t3_t4_mem1*MAS_MEM[3]
	S += (c_t4_t3_t3*MAS[2])-1 < c_t4_t3_t4_mem1*MAS_MEM[5]
	...
	c_t4_t30_mem0 += alt(MM_MEM)
	S += (c_t4_t3_t0*MM[0])-1 < c_t4_t30_mem0*MM_MEM[0]
	...
	c_t4_t3_t5_mem0 += alt(MM_MEM)
	S += (c_t4_t3_t0*MM[0])-1 < c_t4_t3_t5_mem0*MM_MEM[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage2MAS3/SQR/schedule2.png"
	if(S.solution() != []):
