...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS6/FP12_INV_BEFORE_FPINV/schedule8.png"
	if(S.solution() != []):
