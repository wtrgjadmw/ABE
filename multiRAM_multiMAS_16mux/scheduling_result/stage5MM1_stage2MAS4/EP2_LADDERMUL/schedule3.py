...
def solve():
	...
	T20_t1_mem1 += alt(MAS_MEM)
	S += (T181*MAS[0])-1 < T20_t1_mem1*MAS_MEM[1]
	S += (T181*MAS[1])-1 < T20_t1_mem1*MAS_MEM[3]
	S += (T181*MAS[2])-1 < T20_t1_mem1*MAS_MEM[5]
	S += (T181*MAS[3])-1 < T20_t1_mem1*MAS_MEM[7]
	...
	T20_t3_mem1 += alt(MAS_MEM)
	S += (T181*MAS[0])-1 < T20_t3_mem1*MAS_MEM[1]
	S += (T181*MAS[1])-1 < T20_t3_mem1*MAS_MEM[3]
	S += (T181*MAS[2])-1 < T20_t3_mem1*MAS_MEM[5]
	S += (T181*MAS[3])-1 < T20_t3_mem1*MAS_MEM[7]
	...
	S += (T191*MAS[2])-1 < T23_t0_mem1*MAS_MEM[5]
	S += (T191*MAS[3])-1 < T23_t0_mem1*MAS_MEM[7]
	...
	S += (T191*MAS[2])-1 < T23_t1_mem1*MAS_MEM[5]
	S += (T191*MAS[3])-1 < T23_t1_mem1*MAS_MEM[7]
	...
	S += (T191*MAS[2])-1 < T23_t3_mem1*MAS_MEM[5]
	S += (T191*MAS[3])-1 < T23_t3_mem1*MAS_MEM[7]
	...
	T24_t4_mem0 += alt(MAS_MEM)
	S += (T24_t2*MAS[0])-1 < T24_t4_mem0*MAS_MEM[0]
	S += (T24_t2*MAS[1])-1 < T24_t4_mem0*MAS_MEM[2]
	S += (T24_t2*MAS[2])-1 < T24_t4_mem0*MAS_MEM[4]
	S += (T24_t2*MAS[3])-1 < T24_t4_mem0*MAS_MEM[6]
	...
	T240_mem0 += alt(MM_MEM)
	S += (T24_t0*MM[0])-1 < T240_mem0*MM_MEM[0]
	S += T240_mem0 <= T240

	T240_mem1 = S.Task('T240_mem1', length=1, delay_cost=1)
	T240_mem1 += alt(MM_MEM)
	S += (T24_t1*MM[0])-1 < T240_mem1*MM_MEM[1]
	S += T240_mem1 <= T240
	...
	T24_t5_mem0 += alt(MM_MEM)
	S += (T24_t0*MM[0])-1 < T24_t5_mem0*MM_MEM[0]
	S += T24_t5_mem0 <= T24_t5

	T24_t5_mem1 = S.Task('T24_t5_mem1', length=1, delay_cost=1)
	T24_t5_mem1 += alt(MM_MEM)
	S += (T24_t1*MM[0])-1 < T24_t5_mem1*MM_MEM[1]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/EP2_LADDERMUL/schedule3.png"
	if(S.solution() != []):
