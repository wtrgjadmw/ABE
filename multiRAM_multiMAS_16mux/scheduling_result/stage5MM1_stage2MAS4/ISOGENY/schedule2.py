...
def solve():
	...
	S += (NX4_*MAS[1])-1 < NX4_mem0*MAS_MEM[2]
	S += (NX4_*MAS[2])-1 < NX4_mem0*MAS_MEM[4]
	S += (NX4_*MAS[3])-1 < NX4_mem0*MAS_MEM[6]
	S += NX4_mem0 <= NX4
	...
	DY5__mem1 += alt(MM_MEM)
	S += (k3_10_Z6*MM[0])-1 < DY5__mem1*MM_MEM[1]
	S += DY5__mem1 <= DY5_
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/ISOGENY/schedule2.png"
	if(S.solution() != []):
