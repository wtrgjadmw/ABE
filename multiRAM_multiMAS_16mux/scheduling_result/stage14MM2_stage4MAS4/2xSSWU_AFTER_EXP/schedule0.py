...
def solve():
	...
	# new tasks
	alpha0 = S.Task('alpha0', length=14, delay_cost=1)
	alpha0 += alt(MM)
	...
	alpha1 = S.Task('alpha1', length=14, delay_cost=1)
	alpha1 += alt(MM)
	...
	xit2N0 = S.Task('xit2N0', length=14, delay_cost=1)
	xit2N0 += alt(MM)
	...
	xit2N1 = S.Task('xit2N1', length=14, delay_cost=1)
	xit2N1 += alt(MM)
	...
	alphaD0 = S.Task('alphaD0', length=14, delay_cost=1)
	alphaD0 += alt(MM)
	...
	alphaD1 = S.Task('alphaD1', length=14, delay_cost=1)
	alphaD1 += alt(MM)
	...
	alpha20 = S.Task('alpha20', length=14, delay_cost=1)
	alpha20 += alt(MM)
	...
	alpha21 = S.Task('alpha21', length=14, delay_cost=1)
	alpha21 += alt(MM)
	...
	alpha2V0 = S.Task('alpha2V0', length=14, delay_cost=1)
	alpha2V0 += alt(MM)
	...
	alpha2V1 = S.Task('alpha2V1', length=14, delay_cost=1)
	alpha2V1 += alt(MM)
	...
	t3alphaD0 = S.Task('t3alphaD0', length=14, delay_cost=1)
	t3alphaD0 += alt(MM)
	...
	t3alphaD1 = S.Task('t3alphaD1', length=14, delay_cost=1)
	t3alphaD1 += alt(MM)
	...
	y20 = S.Task('y20', length=14, delay_cost=1)
	y20 += alt(MM)
	...
	y21 = S.Task('y21', length=14, delay_cost=1)
	y21 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage14MM2_stage4MAS4/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
