...
def solve():
	...
	new_PZ = S.Task('new_PZ', length=14, delay_cost=1)
	new_PZ += alt(MM)
	...
	t13 = S.Task('t13', length=14, delay_cost=1)
	t13 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage14MM2_stage4MAS4/EP_DBL_A_0/schedule0.png"
	if(S.solution() != []):
