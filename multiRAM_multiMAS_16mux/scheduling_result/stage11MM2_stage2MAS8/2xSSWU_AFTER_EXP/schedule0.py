...
def solve():
	...
	S += (alpha0*MM[1])-1 < alphaD0_mem0*MM_MEM[2]
	...
	S += (alpha1*MM[1])-1 < alphaD1_mem0*MM_MEM[2]
	...
	S += (alphaD1*MM[1])-1 < t3alphaD1_mem1*MM_MEM[3]
	S += t3alphaD1_mem1 <= t3alphaD1

	y20 = S.Task('y20', length=11, delay_cost=1)
	y20 += alt(MM)
	y20_in = S.Task('y20_in', length=1, delay_cost=1)
	y20_in += alt(MM_in)
	S += y20_in*MM_in[0]<=y20*MM[0]
	S += y20_in*MM_in[1]<=y20*MM[1]
	S += 0<y20
	...
	S += (t3alphaD0*MM[1])-1 < y20_mem1*MM_MEM[3]
	S += y20_mem1 <= y20

	y21 = S.Task('y21', length=11, delay_cost=1)
	y21 += alt(MM)
	y21_in = S.Task('y21_in', length=1, delay_cost=1)
	y21_in += alt(MM_in)
	S += y21_in*MM_in[0]<=y21*MM[0]
	S += y21_in*MM_in[1]<=y21*MM[1]
	S += 0<y21
	...
	S += (t3alphaD1*MM[1])-1 < y21_mem1*MM_MEM[3]
	S += y21_mem1 <= y21
	...
	S += alpha2V_U0_in*MAS_in[4]<=alpha2V_U0*MAS[4]

	S += alpha2V_U0_in*MAS_in[5]<=alpha2V_U0*MAS[5]

	S += alpha2V_U0_in*MAS_in[6]<=alpha2V_U0*MAS[6]

	S += alpha2V_U0_in*MAS_in[7]<=alpha2V_U0*MAS[7]
	...
	S += (alpha2V0*MM[1])-1 < alpha2V_U0_mem0*MM_MEM[2]
	...
	S += alpha2V_U1_in*MAS_in[4]<=alpha2V_U1*MAS[4]

	S += alpha2V_U1_in*MAS_in[5]<=alpha2V_U1*MAS[5]

	S += alpha2V_U1_in*MAS_in[6]<=alpha2V_U1*MAS[6]

	S += alpha2V_U1_in*MAS_in[7]<=alpha2V_U1*MAS[7]
	...
	S += (alpha2V1*MM[1])-1 < alpha2V_U1_mem0*MM_MEM[2]
	...
	S += y_alt0_in*MAS_in[5]<=y_alt0*MAS[5]

	S += y_alt0_in*MAS_in[6]<=y_alt0*MAS[6]

	S += y_alt0_in*MAS_in[7]<=y_alt0*MAS[7]
	...
	S += y_alt1_in*MAS_in[4]<=y_alt1*MAS[4]

	S += y_alt1_in*MAS_in[5]<=y_alt1*MAS[5]

	S += y_alt1_in*MAS_in[6]<=y_alt1*MAS[6]

	S += y_alt1_in*MAS_in[7]<=y_alt1*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
