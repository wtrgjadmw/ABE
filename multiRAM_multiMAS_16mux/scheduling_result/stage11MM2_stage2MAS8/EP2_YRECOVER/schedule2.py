...
def solve():
	...
	# new tasks
	r9_t1 = S.Task('r9_t1', length=11, delay_cost=1)
	r9_t1 += alt(MM)
	...
	S += r9_t3_in*MAS_in[6]<=r9_t3*MAS[6]

	S += r9_t3_in*MAS_in[7]<=r9_t3*MAS[7]
	...
	S += r11_t0_in*MAS_in[6]<=r11_t0*MAS[6]

	S += r11_t0_in*MAS_in[7]<=r11_t0*MAS[7]
	...
	S += r11_t1_in*MAS_in[6]<=r11_t1*MAS[6]

	S += r11_t1_in*MAS_in[7]<=r11_t1*MAS[7]
	...
	r11_t1_mem1 += MAS_MEM[15]
	S += 43 < r11_t1_mem1
	S += r11_t1_mem1 <= r11_t1

	r11_t3 = S.Task('r11_t3', length=11, delay_cost=1)
	r11_t3 += alt(MM)
	...
	r11_t3_mem1 += MAS_MEM[15]
	S += 43 < r11_t3_mem1
	S += r11_t3_mem1 <= r11_t3

	X_new_t1 = S.Task('X_new_t1', length=11, delay_cost=1)
	X_new_t1 += alt(MM)
	...
	S += X_new_t2_in*MAS_in[6]<=X_new_t2*MAS[6]

	S += X_new_t2_in*MAS_in[7]<=X_new_t2*MAS[7]

	X_new_t2_mem0 = S.Task('X_new_t2_mem0', length=1, delay_cost=1)
	X_new_t2_mem0 += MAS_MEM[10]
	S += 22 < X_new_t2_mem0
	...
	r14_t1 = S.Task('r14_t1', length=11, delay_cost=1)
	r14_t1 += alt(MM)
	...
	S += r14_t2_in*MAS_in[6]<=r14_t2*MAS[6]

	S += r14_t2_in*MAS_in[7]<=r14_t2*MAS[7]

	r14_t2_mem0 = S.Task('r14_t2_mem0', length=1, delay_cost=1)
	r14_t2_mem0 += MAS_MEM[10]
	S += 22 < r14_t2_mem0
	...
	S += r15_t2_in*MAS_in[6]<=r15_t2*MAS[6]

	S += r15_t2_in*MAS_in[7]<=r15_t2*MAS[7]

	r15_t2_mem0 = S.Task('r15_t2_mem0', length=1, delay_cost=1)
	r15_t2_mem0 += MAS_MEM[10]
	S += 33 < r15_t2_mem0
	...
	Z_new_t1 = S.Task('Z_new_t1', length=11, delay_cost=1)
	Z_new_t1 += alt(MM)
	...
	S += Z_new_t2_in*MAS_in[6]<=Z_new_t2*MAS[6]

	S += Z_new_t2_in*MAS_in[7]<=Z_new_t2*MAS[7]

	Z_new_t2_mem0 = S.Task('Z_new_t2_mem0', length=1, delay_cost=1)
	Z_new_t2_mem0 += MAS_MEM[10]
	S += 22 < Z_new_t2_mem0
	...
	r9_t4 = S.Task('r9_t4', length=11, delay_cost=1)
	r9_t4 += alt(MM)
	...
	S += (r9_t3*MAS[6])-1 < r9_t4_mem1*MAS_MEM[13]
	S += (r9_t3*MAS[7])-1 < r9_t4_mem1*MAS_MEM[15]
	S += r9_t4_mem1 <= r9_t4
	...
	S += r90_in*MAS_in[6]<=r90*MAS[6]

	S += r90_in*MAS_in[7]<=r90*MAS[7]
	...
	S += r9_t5_in*MAS_in[6]<=r9_t5*MAS[6]

	S += r9_t5_in*MAS_in[7]<=r9_t5*MAS[7]
	...
	r11_t2 = S.Task('r11_t2', length=11, delay_cost=1)
	r11_t2 += alt(MM)
	...
	S += (r11_t0*MAS[6])-1 < r11_t2_mem0*MAS_MEM[12]
	S += (r11_t0*MAS[7])-1 < r11_t2_mem0*MAS_MEM[14]
	...
	S += (r11_t1*MAS[6])-1 < r11_t2_mem1*MAS_MEM[13]
	S += (r11_t1*MAS[7])-1 < r11_t2_mem1*MAS_MEM[15]
	...
	S += r111_in*MAS_in[6]<=r111*MAS[6]

	S += r111_in*MAS_in[7]<=r111*MAS[7]
	...
	X_new_t4 = S.Task('X_new_t4', length=11, delay_cost=1)
	X_new_t4 += alt(MM)
	...
	S += (X_new_t2*MAS[6])-1 < X_new_t4_mem0*MAS_MEM[12]
	S += (X_new_t2*MAS[7])-1 < X_new_t4_mem0*MAS_MEM[14]
	S += X_new_t4_mem0 <= X_new_t4

	X_new_t4_mem1 = S.Task('X_new_t4_mem1', length=1, delay_cost=1)
	X_new_t4_mem1 += MAS_MEM[15]
	S += 35 < X_new_t4_mem1
	...
	S += X_new0_in*MAS_in[6]<=X_new0*MAS[6]

	S += X_new0_in*MAS_in[7]<=X_new0*MAS[7]
	...
	S += X_new_t5_in*MAS_in[6]<=X_new_t5*MAS[6]

	S += X_new_t5_in*MAS_in[7]<=X_new_t5*MAS[7]
	...
	r14_t4 = S.Task('r14_t4', length=11, delay_cost=1)
	r14_t4 += alt(MM)
	...
	S += (r14_t2*MAS[6])-1 < r14_t4_mem0*MAS_MEM[12]
	S += (r14_t2*MAS[7])-1 < r14_t4_mem0*MAS_MEM[14]
	S += r14_t4_mem0 <= r14_t4

	r14_t4_mem1 = S.Task('r14_t4_mem1', length=1, delay_cost=1)
	r14_t4_mem1 += MAS_MEM[11]
	S += 38 < r14_t4_mem1
	...
	S += r140_in*MAS_in[6]<=r140*MAS[6]

	S += r140_in*MAS_in[7]<=r140*MAS[7]
	...
	S += r14_t5_in*MAS_in[6]<=r14_t5*MAS[6]

	S += r14_t5_in*MAS_in[7]<=r14_t5*MAS[7]
	...
	Z_new_t4 = S.Task('Z_new_t4', length=11, delay_cost=1)
	Z_new_t4 += alt(MM)
	...
	S += (Z_new_t2*MAS[6])-1 < Z_new_t4_mem0*MAS_MEM[12]
	S += (Z_new_t2*MAS[7])-1 < Z_new_t4_mem0*MAS_MEM[14]
	...
	S += Z_new_t5_in*MAS_in[6]<=Z_new_t5*MAS[6]

	S += Z_new_t5_in*MAS_in[7]<=Z_new_t5*MAS[7]
	...
	S += r91_in*MAS_in[6]<=r91*MAS[6]

	S += r91_in*MAS_in[7]<=r91*MAS[7]
	...
	S += (r9_t5*MAS[6])-1 < r91_mem1*MAS_MEM[13]
	S += (r9_t5*MAS[7])-1 < r91_mem1*MAS_MEM[15]
	S += r91_mem1 <= r91
	...
	S += X_new1_in*MAS_in[6]<=X_new1*MAS[6]

	S += X_new1_in*MAS_in[7]<=X_new1*MAS[7]
	...
	S += (X_new_t5*MAS[6])-1 < X_new1_mem1*MAS_MEM[13]
	S += (X_new_t5*MAS[7])-1 < X_new1_mem1*MAS_MEM[15]
	...
	S += r141_in*MAS_in[6]<=r141*MAS[6]

	S += r141_in*MAS_in[7]<=r141*MAS[7]
	...
	S += (r14_t5*MAS[6])-1 < r141_mem1*MAS_MEM[13]
	S += (r14_t5*MAS[7])-1 < r141_mem1*MAS_MEM[15]
	S += r141_mem1 <= r141

	r15_t0 = S.Task('r15_t0', length=11, delay_cost=1)
	r15_t0 += alt(MM)
	...
	S += (r90*MAS[6])-1 < r15_t0_mem1*MAS_MEM[13]
	S += (r90*MAS[7])-1 < r15_t0_mem1*MAS_MEM[15]
	S += r15_t0_mem1 <= r15_t0

	r16_t1 = S.Task('r16_t1', length=11, delay_cost=1)
	r16_t1 += alt(MM)
	...
	S += (r111*MAS[6])-1 < r16_t1_mem0*MAS_MEM[12]
	S += (r111*MAS[7])-1 < r16_t1_mem0*MAS_MEM[14]
	...
	S += Z_new1_in*MAS_in[6]<=Z_new1*MAS[6]

	S += Z_new1_in*MAS_in[7]<=Z_new1*MAS[7]
	...
	S += (Z_new_t5*MAS[6])-1 < Z_new1_mem1*MAS_MEM[13]
	S += (Z_new_t5*MAS[7])-1 < Z_new1_mem1*MAS_MEM[15]
	S += Z_new1_mem1 <= Z_new1

	r15_t1 = S.Task('r15_t1', length=11, delay_cost=1)
	r15_t1 += alt(MM)
	...
	S += (r91*MAS[6])-1 < r15_t1_mem1*MAS_MEM[13]
	S += (r91*MAS[7])-1 < r15_t1_mem1*MAS_MEM[15]
	...
	S += r15_t3_in*MAS_in[6]<=r15_t3*MAS[6]

	S += r15_t3_in*MAS_in[7]<=r15_t3*MAS[7]
	...
	S += (r90*MAS[6])-1 < r15_t3_mem0*MAS_MEM[12]
	S += (r90*MAS[7])-1 < r15_t3_mem0*MAS_MEM[14]
	...
	S += (r91*MAS[6])-1 < r15_t3_mem1*MAS_MEM[13]
	S += (r91*MAS[7])-1 < r15_t3_mem1*MAS_MEM[15]
	S += r15_t3_mem1 <= r15_t3

	r16_t0 = S.Task('r16_t0', length=11, delay_cost=1)
	r16_t0 += alt(MM)
	...
	S += (r110*MAS[6])-1 < r16_t0_mem0*MAS_MEM[12]
	S += (r110*MAS[7])-1 < r16_t0_mem0*MAS_MEM[14]
	...
	S += r16_t2_in*MAS_in[6]<=r16_t2*MAS[6]

	S += r16_t2_in*MAS_in[7]<=r16_t2*MAS[7]
	...
	S += (r110*MAS[6])-1 < r16_t2_mem0*MAS_MEM[12]
	S += (r110*MAS[7])-1 < r16_t2_mem0*MAS_MEM[14]
	...
	S += (r111*MAS[6])-1 < r16_t2_mem1*MAS_MEM[13]
	S += (r111*MAS[7])-1 < r16_t2_mem1*MAS_MEM[15]
	S += r16_t2_mem1 <= r16_t2

	r15_t4 = S.Task('r15_t4', length=11, delay_cost=1)
	r15_t4 += alt(MM)
	...
	S += (r15_t2*MAS[6])-1 < r15_t4_mem0*MAS_MEM[12]
	S += (r15_t2*MAS[7])-1 < r15_t4_mem0*MAS_MEM[14]
	...
	S += (r15_t3*MAS[6])-1 < r15_t4_mem1*MAS_MEM[13]
	S += (r15_t3*MAS[7])-1 < r15_t4_mem1*MAS_MEM[15]
	...
	S += r150_in*MAS_in[6]<=r150*MAS[6]

	S += r150_in*MAS_in[7]<=r150*MAS[7]
	...
	S += r15_t5_in*MAS_in[6]<=r15_t5*MAS[6]

	S += r15_t5_in*MAS_in[7]<=r15_t5*MAS[7]
	...
	r16_t4 = S.Task('r16_t4', length=11, delay_cost=1)
	r16_t4 += alt(MM)
	...
	S += (r16_t2*MAS[6])-1 < r16_t4_mem0*MAS_MEM[12]
	S += (r16_t2*MAS[7])-1 < r16_t4_mem0*MAS_MEM[14]
	...
	S += r160_in*MAS_in[6]<=r160*MAS[6]

	S += r160_in*MAS_in[7]<=r160*MAS[7]
	...
	S += r16_t5_in*MAS_in[6]<=r16_t5*MAS[6]

	S += r16_t5_in*MAS_in[7]<=r16_t5*MAS[7]
	...
	S += r151_in*MAS_in[6]<=r151*MAS[6]

	S += r151_in*MAS_in[7]<=r151*MAS[7]
	...
	S += (r15_t5*MAS[6])-1 < r151_mem1*MAS_MEM[13]
	S += (r15_t5*MAS[7])-1 < r151_mem1*MAS_MEM[15]
	S += r151_mem1 <= r151
	...
	S += r161_in*MAS_in[6]<=r161*MAS[6]

	S += r161_in*MAS_in[7]<=r161*MAS[7]
	...
	S += (r16_t5*MAS[6])-1 < r161_mem1*MAS_MEM[13]
	S += (r16_t5*MAS[7])-1 < r161_mem1*MAS_MEM[15]
	S += r161_mem1 <= r161
	...
	S += r170_in*MAS_in[6]<=r170*MAS[6]

	S += r170_in*MAS_in[7]<=r170*MAS[7]
	...
	S += (r140*MAS[6])-1 < r170_mem0*MAS_MEM[12]
	S += (r140*MAS[7])-1 < r170_mem0*MAS_MEM[14]
	S += r170_mem0 <= r170
	...
	S += (r150*MAS[6])-1 < r170_mem1*MAS_MEM[13]
	S += (r150*MAS[7])-1 < r170_mem1*MAS_MEM[15]
	S += r170_mem1 <= r170
	...
	S += r171_in*MAS_in[6]<=r171*MAS[6]

	S += r171_in*MAS_in[7]<=r171*MAS[7]
	...
	S += (r141*MAS[6])-1 < r171_mem0*MAS_MEM[12]
	S += (r141*MAS[7])-1 < r171_mem0*MAS_MEM[14]
	S += r171_mem0 <= r171
	...
	S += (r151*MAS[6])-1 < r171_mem1*MAS_MEM[13]
	S += (r151*MAS[7])-1 < r171_mem1*MAS_MEM[15]
	S += r171_mem1 <= r171
	...
	S += Y_new0_in*MAS_in[6]<=Y_new0*MAS[6]

	S += Y_new0_in*MAS_in[7]<=Y_new0*MAS[7]
	...
	S += (r170*MAS[6])-1 < Y_new0_mem0*MAS_MEM[12]
	S += (r170*MAS[7])-1 < Y_new0_mem0*MAS_MEM[14]
	...
	S += (r160*MAS[6])-1 < Y_new0_mem1*MAS_MEM[13]
	S += (r160*MAS[7])-1 < Y_new0_mem1*MAS_MEM[15]
	...
	S += Y_new1_in*MAS_in[6]<=Y_new1*MAS[6]

	S += Y_new1_in*MAS_in[7]<=Y_new1*MAS[7]
	...
	S += (r171*MAS[6])-1 < Y_new1_mem0*MAS_MEM[12]
	S += (r171*MAS[7])-1 < Y_new1_mem0*MAS_MEM[14]
	...
	S += (r161*MAS[6])-1 < Y_new1_mem1*MAS_MEM[13]
	S += (r161*MAS[7])-1 < Y_new1_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/EP2_YRECOVER/schedule2.png"
	if(S.solution() != []):
