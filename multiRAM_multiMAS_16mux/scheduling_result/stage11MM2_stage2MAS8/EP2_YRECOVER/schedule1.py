...
def solve():
	...
	r3_t1 = S.Task('r3_t1', length=11, delay_cost=1)
	S += r3_t1 >= 1
	r3_t1 += MM[0]
	...
	r1_t1 = S.Task('r1_t1', length=11, delay_cost=1)
	S += r1_t1 >= 3
	r1_t1 += MM[0]
	...
	r4_t0 = S.Task('r4_t0', length=11, delay_cost=1)
	S += r4_t0 >= 6
	r4_t0 += MM[0]
	...
	r6_t0 = S.Task('r6_t0', length=11, delay_cost=1)
	S += r6_t0 >= 7
	r6_t0 += MM[0]

	r1_t0 = S.Task('r1_t0', length=11, delay_cost=1)
	S += r1_t0 >= 8
	r1_t0 += MM[1]
	...
	r4_t1 = S.Task('r4_t1', length=11, delay_cost=1)
	S += r4_t1 >= 9
	r4_t1 += MM[0]
	...
	r5_t0 = S.Task('r5_t0', length=11, delay_cost=1)
	S += r5_t0 >= 10
	r5_t0 += MM[0]
	...
	r6_t1 = S.Task('r6_t1', length=11, delay_cost=1)
	S += r6_t1 >= 11
	r6_t1 += MM[0]
	...
	r5_t1 = S.Task('r5_t1', length=11, delay_cost=1)
	S += r5_t1 >= 14
	r5_t1 += MM[0]

	r12_t0 = S.Task('r12_t0', length=11, delay_cost=1)
	S += r12_t0 >= 15
	r12_t0 += MM[0]
	...
	r12_t1 = S.Task('r12_t1', length=11, delay_cost=1)
	S += r12_t1 >= 18
	r12_t1 += MM[0]
	...
	r13_t0 = S.Task('r13_t0', length=11, delay_cost=1)
	S += r13_t0 >= 20
	r13_t0 += MM[0]
	...
	r3_t0 = S.Task('r3_t0', length=11, delay_cost=1)
	S += r3_t0 >= 22
	r3_t0 += MM[0]

	r13_t1 = S.Task('r13_t1', length=11, delay_cost=1)
	S += r13_t1 >= 23
	r13_t1 += MM[0]
	...
	S += r10_in*MAS_in[4]<=r10*MAS[4]

	S += r10_in*MAS_in[5]<=r10*MAS[5]

	S += r10_in*MAS_in[6]<=r10*MAS[6]

	S += r10_in*MAS_in[7]<=r10*MAS[7]
	...
	S += r1_t5_in*MAS_in[3]<=r1_t5*MAS[3]

	S += r1_t5_in*MAS_in[4]<=r1_t5*MAS[4]

	S += r1_t5_in*MAS_in[5]<=r1_t5*MAS[5]

	S += r1_t5_in*MAS_in[6]<=r1_t5*MAS[6]

	S += r1_t5_in*MAS_in[7]<=r1_t5*MAS[7]
	...
	S += r30_in*MAS_in[3]<=r30*MAS[3]

	S += r30_in*MAS_in[4]<=r30*MAS[4]

	S += r30_in*MAS_in[5]<=r30*MAS[5]

	S += r30_in*MAS_in[6]<=r30*MAS[6]

	S += r30_in*MAS_in[7]<=r30*MAS[7]
	...
	S += r3_t5_in*MAS_in[3]<=r3_t5*MAS[3]

	S += r3_t5_in*MAS_in[4]<=r3_t5*MAS[4]

	S += r3_t5_in*MAS_in[5]<=r3_t5*MAS[5]

	S += r3_t5_in*MAS_in[6]<=r3_t5*MAS[6]

	S += r3_t5_in*MAS_in[7]<=r3_t5*MAS[7]
	...
	S += r40_in*MAS_in[3]<=r40*MAS[3]

	S += r40_in*MAS_in[4]<=r40*MAS[4]

	S += r40_in*MAS_in[5]<=r40*MAS[5]

	S += r40_in*MAS_in[6]<=r40*MAS[6]

	S += r40_in*MAS_in[7]<=r40*MAS[7]
	...
	S += r4_t5_in*MAS_in[3]<=r4_t5*MAS[3]

	S += r4_t5_in*MAS_in[4]<=r4_t5*MAS[4]

	S += r4_t5_in*MAS_in[5]<=r4_t5*MAS[5]

	S += r4_t5_in*MAS_in[6]<=r4_t5*MAS[6]

	S += r4_t5_in*MAS_in[7]<=r4_t5*MAS[7]
	...
	S += r50_in*MAS_in[3]<=r50*MAS[3]

	S += r50_in*MAS_in[4]<=r50*MAS[4]

	S += r50_in*MAS_in[5]<=r50*MAS[5]

	S += r50_in*MAS_in[6]<=r50*MAS[6]

	S += r50_in*MAS_in[7]<=r50*MAS[7]
	...
	S += r5_t5_in*MAS_in[3]<=r5_t5*MAS[3]

	S += r5_t5_in*MAS_in[4]<=r5_t5*MAS[4]

	S += r5_t5_in*MAS_in[5]<=r5_t5*MAS[5]

	S += r5_t5_in*MAS_in[6]<=r5_t5*MAS[6]

	S += r5_t5_in*MAS_in[7]<=r5_t5*MAS[7]
	...
	S += r60_in*MAS_in[3]<=r60*MAS[3]

	S += r60_in*MAS_in[4]<=r60*MAS[4]

	S += r60_in*MAS_in[5]<=r60*MAS[5]

	S += r60_in*MAS_in[6]<=r60*MAS[6]

	S += r60_in*MAS_in[7]<=r60*MAS[7]
	...
	S += r6_t5_in*MAS_in[3]<=r6_t5*MAS[3]

	S += r6_t5_in*MAS_in[4]<=r6_t5*MAS[4]

	S += r6_t5_in*MAS_in[5]<=r6_t5*MAS[5]

	S += r6_t5_in*MAS_in[6]<=r6_t5*MAS[6]

	S += r6_t5_in*MAS_in[7]<=r6_t5*MAS[7]
	...
	S += r120_in*MAS_in[3]<=r120*MAS[3]

	S += r120_in*MAS_in[4]<=r120*MAS[4]

	S += r120_in*MAS_in[5]<=r120*MAS[5]

	S += r120_in*MAS_in[6]<=r120*MAS[6]

	S += r120_in*MAS_in[7]<=r120*MAS[7]
	...
	S += r12_t5_in*MAS_in[3]<=r12_t5*MAS[3]

	S += r12_t5_in*MAS_in[4]<=r12_t5*MAS[4]

	S += r12_t5_in*MAS_in[5]<=r12_t5*MAS[5]

	S += r12_t5_in*MAS_in[6]<=r12_t5*MAS[6]

	S += r12_t5_in*MAS_in[7]<=r12_t5*MAS[7]
	...
	S += r130_in*MAS_in[3]<=r130*MAS[3]

	S += r130_in*MAS_in[4]<=r130*MAS[4]

	S += r130_in*MAS_in[5]<=r130*MAS[5]

	S += r130_in*MAS_in[6]<=r130*MAS[6]

	S += r130_in*MAS_in[7]<=r130*MAS[7]
	...
	S += r13_t5_in*MAS_in[3]<=r13_t5*MAS[3]

	S += r13_t5_in*MAS_in[4]<=r13_t5*MAS[4]

	S += r13_t5_in*MAS_in[5]<=r13_t5*MAS[5]

	S += r13_t5_in*MAS_in[6]<=r13_t5*MAS[6]

	S += r13_t5_in*MAS_in[7]<=r13_t5*MAS[7]
	...
	S += r11_in*MAS_in[3]<=r11*MAS[3]

	S += r11_in*MAS_in[4]<=r11*MAS[4]

	S += r11_in*MAS_in[5]<=r11*MAS[5]

	S += r11_in*MAS_in[6]<=r11*MAS[6]

	S += r11_in*MAS_in[7]<=r11*MAS[7]

	r11_mem0 = S.Task('r11_mem0', length=1, delay_cost=1)
	r11_mem0 += alt(MM_MEM)
	S += (r1_t4*MM[0])-1 < r11_mem0*MM_MEM[0]
	S += (r1_t4*MM[1])-1 < r11_mem0*MM_MEM[2]
	S += r11_mem0 <= r11
	...
	S += (r1_t5*MAS[4])-1 < r11_mem1*MAS_MEM[9]
	S += (r1_t5*MAS[5])-1 < r11_mem1*MAS_MEM[11]
	S += (r1_t5*MAS[6])-1 < r11_mem1*MAS_MEM[13]
	S += (r1_t5*MAS[7])-1 < r11_mem1*MAS_MEM[15]
	S += r11_mem1 <= r11
	...
	S += r20_in*MAS_in[3]<=r20*MAS[3]

	S += r20_in*MAS_in[4]<=r20*MAS[4]

	S += r20_in*MAS_in[5]<=r20*MAS[5]

	S += r20_in*MAS_in[6]<=r20*MAS[6]

	S += r20_in*MAS_in[7]<=r20*MAS[7]
	...
	S += (r10*MAS[4])-1 < r20_mem0*MAS_MEM[8]
	S += (r10*MAS[5])-1 < r20_mem0*MAS_MEM[10]
	S += (r10*MAS[6])-1 < r20_mem0*MAS_MEM[12]
	S += (r10*MAS[7])-1 < r20_mem0*MAS_MEM[14]
	S += r20_mem0 <= r20
	...
	S += (r10*MAS[4])-1 < r20_mem1*MAS_MEM[9]
	S += (r10*MAS[5])-1 < r20_mem1*MAS_MEM[11]
	S += (r10*MAS[6])-1 < r20_mem1*MAS_MEM[13]
	S += (r10*MAS[7])-1 < r20_mem1*MAS_MEM[15]
	S += r20_mem1 <= r20
	...
	S += r31_in*MAS_in[3]<=r31*MAS[3]

	S += r31_in*MAS_in[4]<=r31*MAS[4]

	S += r31_in*MAS_in[5]<=r31*MAS[5]

	S += r31_in*MAS_in[6]<=r31*MAS[6]

	S += r31_in*MAS_in[7]<=r31*MAS[7]

	r31_mem0 = S.Task('r31_mem0', length=1, delay_cost=1)
	r31_mem0 += alt(MM_MEM)
	S += (r3_t4*MM[0])-1 < r31_mem0*MM_MEM[0]
	S += (r3_t4*MM[1])-1 < r31_mem0*MM_MEM[2]
	S += r31_mem0 <= r31
	...
	S += (r3_t5*MAS[4])-1 < r31_mem1*MAS_MEM[9]
	S += (r3_t5*MAS[5])-1 < r31_mem1*MAS_MEM[11]
	S += (r3_t5*MAS[6])-1 < r31_mem1*MAS_MEM[13]
	S += (r3_t5*MAS[7])-1 < r31_mem1*MAS_MEM[15]
	S += r31_mem1 <= r31
	...
	S += r41_in*MAS_in[3]<=r41*MAS[3]

	S += r41_in*MAS_in[4]<=r41*MAS[4]

	S += r41_in*MAS_in[5]<=r41*MAS[5]

	S += r41_in*MAS_in[6]<=r41*MAS[6]

	S += r41_in*MAS_in[7]<=r41*MAS[7]

	r41_mem0 = S.Task('r41_mem0', length=1, delay_cost=1)
	r41_mem0 += alt(MM_MEM)
	S += (r4_t4*MM[0])-1 < r41_mem0*MM_MEM[0]
	S += (r4_t4*MM[1])-1 < r41_mem0*MM_MEM[2]
	S += r41_mem0 <= r41
	...
	S += (r4_t5*MAS[4])-1 < r41_mem1*MAS_MEM[9]
	S += (r4_t5*MAS[5])-1 < r41_mem1*MAS_MEM[11]
	S += (r4_t5*MAS[6])-1 < r41_mem1*MAS_MEM[13]
	S += (r4_t5*MAS[7])-1 < r41_mem1*MAS_MEM[15]
	S += r41_mem1 <= r41
	...
	S += r51_in*MAS_in[3]<=r51*MAS[3]

	S += r51_in*MAS_in[4]<=r51*MAS[4]

	S += r51_in*MAS_in[5]<=r51*MAS[5]

	S += r51_in*MAS_in[6]<=r51*MAS[6]

	S += r51_in*MAS_in[7]<=r51*MAS[7]

	r51_mem0 = S.Task('r51_mem0', length=1, delay_cost=1)
	r51_mem0 += alt(MM_MEM)
	S += (r5_t4*MM[0])-1 < r51_mem0*MM_MEM[0]
	S += (r5_t4*MM[1])-1 < r51_mem0*MM_MEM[2]
	S += r51_mem0 <= r51
	...
	S += (r5_t5*MAS[4])-1 < r51_mem1*MAS_MEM[9]
	S += (r5_t5*MAS[5])-1 < r51_mem1*MAS_MEM[11]
	S += (r5_t5*MAS[6])-1 < r51_mem1*MAS_MEM[13]
	S += (r5_t5*MAS[7])-1 < r51_mem1*MAS_MEM[15]
	S += r51_mem1 <= r51
	...
	S += r61_in*MAS_in[3]<=r61*MAS[3]

	S += r61_in*MAS_in[4]<=r61*MAS[4]

	S += r61_in*MAS_in[5]<=r61*MAS[5]

	S += r61_in*MAS_in[6]<=r61*MAS[6]

	S += r61_in*MAS_in[7]<=r61*MAS[7]

	r61_mem0 = S.Task('r61_mem0', length=1, delay_cost=1)
	r61_mem0 += alt(MM_MEM)
	S += (r6_t4*MM[0])-1 < r61_mem0*MM_MEM[0]
	S += (r6_t4*MM[1])-1 < r61_mem0*MM_MEM[2]
	S += r61_mem0 <= r61
	...
	S += (r6_t5*MAS[4])-1 < r61_mem1*MAS_MEM[9]
	S += (r6_t5*MAS[5])-1 < r61_mem1*MAS_MEM[11]
	S += (r6_t5*MAS[6])-1 < r61_mem1*MAS_MEM[13]
	S += (r6_t5*MAS[7])-1 < r61_mem1*MAS_MEM[15]
	S += r61_mem1 <= r61
	...
	S += r70_in*MAS_in[3]<=r70*MAS[3]

	S += r70_in*MAS_in[4]<=r70*MAS[4]

	S += r70_in*MAS_in[5]<=r70*MAS[5]

	S += r70_in*MAS_in[6]<=r70*MAS[6]

	S += r70_in*MAS_in[7]<=r70*MAS[7]
	...
	S += (r50*MAS[4])-1 < r70_mem0*MAS_MEM[8]
	S += (r50*MAS[5])-1 < r70_mem0*MAS_MEM[10]
	S += (r50*MAS[6])-1 < r70_mem0*MAS_MEM[12]
	S += (r50*MAS[7])-1 < r70_mem0*MAS_MEM[14]
	S += r70_mem0 <= r70
	...
	S += (r60*MAS[4])-1 < r70_mem1*MAS_MEM[9]
	S += (r60*MAS[5])-1 < r70_mem1*MAS_MEM[11]
	S += (r60*MAS[6])-1 < r70_mem1*MAS_MEM[13]
	S += (r60*MAS[7])-1 < r70_mem1*MAS_MEM[15]
	S += r70_mem1 <= r70
	...
	S += r80_in*MAS_in[3]<=r80*MAS[3]

	S += r80_in*MAS_in[4]<=r80*MAS[4]

	S += r80_in*MAS_in[5]<=r80*MAS[5]

	S += r80_in*MAS_in[6]<=r80*MAS[6]

	S += r80_in*MAS_in[7]<=r80*MAS[7]
	...
	S += (r40*MAS[4])-1 < r80_mem1*MAS_MEM[9]
	S += (r40*MAS[5])-1 < r80_mem1*MAS_MEM[11]
	S += (r40*MAS[6])-1 < r80_mem1*MAS_MEM[13]
	S += (r40*MAS[7])-1 < r80_mem1*MAS_MEM[15]
	S += r80_mem1 <= r80
	...
	S += r100_in*MAS_in[3]<=r100*MAS[3]

	S += r100_in*MAS_in[4]<=r100*MAS[4]

	S += r100_in*MAS_in[5]<=r100*MAS[5]

	S += r100_in*MAS_in[6]<=r100*MAS[6]

	S += r100_in*MAS_in[7]<=r100*MAS[7]
	...
	S += (r40*MAS[4])-1 < r100_mem1*MAS_MEM[9]
	S += (r40*MAS[5])-1 < r100_mem1*MAS_MEM[11]
	S += (r40*MAS[6])-1 < r100_mem1*MAS_MEM[13]
	S += (r40*MAS[7])-1 < r100_mem1*MAS_MEM[15]
	S += r100_mem1 <= r100
	...
	S += r121_in*MAS_in[3]<=r121*MAS[3]

	S += r121_in*MAS_in[4]<=r121*MAS[4]

	S += r121_in*MAS_in[5]<=r121*MAS[5]

	S += r121_in*MAS_in[6]<=r121*MAS[6]

	S += r121_in*MAS_in[7]<=r121*MAS[7]

	r121_mem0 = S.Task('r121_mem0', length=1, delay_cost=1)
	r121_mem0 += alt(MM_MEM)
	S += (r12_t4*MM[0])-1 < r121_mem0*MM_MEM[0]
	S += (r12_t4*MM[1])-1 < r121_mem0*MM_MEM[2]
	S += r121_mem0 <= r121
	...
	S += (r12_t5*MAS[4])-1 < r121_mem1*MAS_MEM[9]
	S += (r12_t5*MAS[5])-1 < r121_mem1*MAS_MEM[11]
	S += (r12_t5*MAS[6])-1 < r121_mem1*MAS_MEM[13]
	S += (r12_t5*MAS[7])-1 < r121_mem1*MAS_MEM[15]
	S += r121_mem1 <= r121
	...
	S += r131_in*MAS_in[3]<=r131*MAS[3]

	S += r131_in*MAS_in[4]<=r131*MAS[4]

	S += r131_in*MAS_in[5]<=r131*MAS[5]

	S += r131_in*MAS_in[6]<=r131*MAS[6]

	S += r131_in*MAS_in[7]<=r131*MAS[7]

	r131_mem0 = S.Task('r131_mem0', length=1, delay_cost=1)
	r131_mem0 += alt(MM_MEM)
	S += (r13_t4*MM[0])-1 < r131_mem0*MM_MEM[0]
	S += (r13_t4*MM[1])-1 < r131_mem0*MM_MEM[2]
	S += r131_mem0 <= r131
	...
	S += (r13_t5*MAS[4])-1 < r131_mem1*MAS_MEM[9]
	S += (r13_t5*MAS[5])-1 < r131_mem1*MAS_MEM[11]
	S += (r13_t5*MAS[6])-1 < r131_mem1*MAS_MEM[13]
	S += (r13_t5*MAS[7])-1 < r131_mem1*MAS_MEM[15]
	S += r131_mem1 <= r131
	...
	S += r21_in*MAS_in[3]<=r21*MAS[3]

	S += r21_in*MAS_in[4]<=r21*MAS[4]

	S += r21_in*MAS_in[5]<=r21*MAS[5]

	S += r21_in*MAS_in[6]<=r21*MAS[6]

	S += r21_in*MAS_in[7]<=r21*MAS[7]
	...
	S += (r11*MAS[4])-1 < r21_mem0*MAS_MEM[8]
	S += (r11*MAS[5])-1 < r21_mem0*MAS_MEM[10]
	S += (r11*MAS[6])-1 < r21_mem0*MAS_MEM[12]
	S += (r11*MAS[7])-1 < r21_mem0*MAS_MEM[14]
	S += r21_mem0 <= r21
	...
	S += (r11*MAS[4])-1 < r21_mem1*MAS_MEM[9]
	S += (r11*MAS[5])-1 < r21_mem1*MAS_MEM[11]
	S += (r11*MAS[6])-1 < r21_mem1*MAS_MEM[13]
	S += (r11*MAS[7])-1 < r21_mem1*MAS_MEM[15]
	S += r21_mem1 <= r21
	...
	S += r71_in*MAS_in[3]<=r71*MAS[3]

	S += r71_in*MAS_in[4]<=r71*MAS[4]

	S += r71_in*MAS_in[5]<=r71*MAS[5]

	S += r71_in*MAS_in[6]<=r71*MAS[6]

	S += r71_in*MAS_in[7]<=r71*MAS[7]
	...
	S += (r51*MAS[4])-1 < r71_mem0*MAS_MEM[8]
	S += (r51*MAS[5])-1 < r71_mem0*MAS_MEM[10]
	S += (r51*MAS[6])-1 < r71_mem0*MAS_MEM[12]
	S += (r51*MAS[7])-1 < r71_mem0*MAS_MEM[14]
	S += r71_mem0 <= r71
	...
	S += (r61*MAS[4])-1 < r71_mem1*MAS_MEM[9]
	S += (r61*MAS[5])-1 < r71_mem1*MAS_MEM[11]
	S += (r61*MAS[6])-1 < r71_mem1*MAS_MEM[13]
	S += (r61*MAS[7])-1 < r71_mem1*MAS_MEM[15]
	S += r71_mem1 <= r71
	...
	S += r81_in*MAS_in[3]<=r81*MAS[3]

	S += r81_in*MAS_in[4]<=r81*MAS[4]

	S += r81_in*MAS_in[5]<=r81*MAS[5]

	S += r81_in*MAS_in[6]<=r81*MAS[6]

	S += r81_in*MAS_in[7]<=r81*MAS[7]
	...
	S += (r41*MAS[4])-1 < r81_mem1*MAS_MEM[9]
	S += (r41*MAS[5])-1 < r81_mem1*MAS_MEM[11]
	S += (r41*MAS[6])-1 < r81_mem1*MAS_MEM[13]
	S += (r41*MAS[7])-1 < r81_mem1*MAS_MEM[15]
	S += r81_mem1 <= r81

	r9_t0 = S.Task('r9_t0', length=11, delay_cost=1)
	r9_t0 += alt(MM)
	r9_t0_in = S.Task('r9_t0_in', length=1, delay_cost=1)
	r9_t0_in += alt(MM_in)
	S += r9_t0_in*MM_in[0]<=r9_t0*MM[0]
	S += r9_t0_in*MM_in[1]<=r9_t0*MM[1]
	...
	S += (r70*MAS[4])-1 < r9_t0_mem1*MAS_MEM[9]
	S += (r70*MAS[5])-1 < r9_t0_mem1*MAS_MEM[11]
	S += (r70*MAS[6])-1 < r9_t0_mem1*MAS_MEM[13]
	S += (r70*MAS[7])-1 < r9_t0_mem1*MAS_MEM[15]
	S += r9_t0_mem1 <= r9_t0
	...
	S += r101_in*MAS_in[3]<=r101*MAS[3]

	S += r101_in*MAS_in[4]<=r101*MAS[4]

	S += r101_in*MAS_in[5]<=r101*MAS[5]

	S += r101_in*MAS_in[6]<=r101*MAS[6]

	S += r101_in*MAS_in[7]<=r101*MAS[7]
	...
	S += (r41*MAS[4])-1 < r101_mem1*MAS_MEM[9]
	S += (r41*MAS[5])-1 < r101_mem1*MAS_MEM[11]
	S += (r41*MAS[6])-1 < r101_mem1*MAS_MEM[13]
	S += (r41*MAS[7])-1 < r101_mem1*MAS_MEM[15]
	S += r101_mem1 <= r101

	X_new_t0 = S.Task('X_new_t0', length=11, delay_cost=1)
	X_new_t0 += alt(MM)
	X_new_t0_in = S.Task('X_new_t0_in', length=1, delay_cost=1)
	X_new_t0_in += alt(MM_in)
	S += X_new_t0_in*MM_in[0]<=X_new_t0*MM[0]
	S += X_new_t0_in*MM_in[1]<=X_new_t0*MM[1]
	...
	S += (r20*MAS[4])-1 < X_new_t0_mem0*MAS_MEM[8]
	S += (r20*MAS[5])-1 < X_new_t0_mem0*MAS_MEM[10]
	S += (r20*MAS[6])-1 < X_new_t0_mem0*MAS_MEM[12]
	S += (r20*MAS[7])-1 < X_new_t0_mem0*MAS_MEM[14]
	...
	S += (r120*MAS[4])-1 < X_new_t0_mem1*MAS_MEM[9]
	S += (r120*MAS[5])-1 < X_new_t0_mem1*MAS_MEM[11]
	S += (r120*MAS[6])-1 < X_new_t0_mem1*MAS_MEM[13]
	S += (r120*MAS[7])-1 < X_new_t0_mem1*MAS_MEM[15]
	...
	S += X_new_t3_in*MAS_in[3]<=X_new_t3*MAS[3]

	S += X_new_t3_in*MAS_in[4]<=X_new_t3*MAS[4]

	S += X_new_t3_in*MAS_in[5]<=X_new_t3*MAS[5]

	S += X_new_t3_in*MAS_in[6]<=X_new_t3*MAS[6]

	S += X_new_t3_in*MAS_in[7]<=X_new_t3*MAS[7]
	...
	S += (r120*MAS[4])-1 < X_new_t3_mem0*MAS_MEM[8]
	S += (r120*MAS[5])-1 < X_new_t3_mem0*MAS_MEM[10]
	S += (r120*MAS[6])-1 < X_new_t3_mem0*MAS_MEM[12]
	S += (r120*MAS[7])-1 < X_new_t3_mem0*MAS_MEM[14]
	...
	S += (r121*MAS[4])-1 < X_new_t3_mem1*MAS_MEM[9]
	S += (r121*MAS[5])-1 < X_new_t3_mem1*MAS_MEM[11]
	S += (r121*MAS[6])-1 < X_new_t3_mem1*MAS_MEM[13]
	S += (r121*MAS[7])-1 < X_new_t3_mem1*MAS_MEM[15]
	S += X_new_t3_mem1 <= X_new_t3

	r14_t0 = S.Task('r14_t0', length=11, delay_cost=1)
	r14_t0 += alt(MM)
	r14_t0_in = S.Task('r14_t0_in', length=1, delay_cost=1)
	r14_t0_in += alt(MM_in)
	S += r14_t0_in*MM_in[0]<=r14_t0*MM[0]
	S += r14_t0_in*MM_in[1]<=r14_t0*MM[1]
	...
	S += (r20*MAS[4])-1 < r14_t0_mem0*MAS_MEM[8]
	S += (r20*MAS[5])-1 < r14_t0_mem0*MAS_MEM[10]
	S += (r20*MAS[6])-1 < r14_t0_mem0*MAS_MEM[12]
	S += (r20*MAS[7])-1 < r14_t0_mem0*MAS_MEM[14]
	...
	S += (r30*MAS[4])-1 < r14_t0_mem1*MAS_MEM[9]
	S += (r30*MAS[5])-1 < r14_t0_mem1*MAS_MEM[11]
	S += (r30*MAS[6])-1 < r14_t0_mem1*MAS_MEM[13]
	S += (r30*MAS[7])-1 < r14_t0_mem1*MAS_MEM[15]
	...
	S += r14_t3_in*MAS_in[3]<=r14_t3*MAS[3]

	S += r14_t3_in*MAS_in[4]<=r14_t3*MAS[4]

	S += r14_t3_in*MAS_in[5]<=r14_t3*MAS[5]

	S += r14_t3_in*MAS_in[6]<=r14_t3*MAS[6]

	S += r14_t3_in*MAS_in[7]<=r14_t3*MAS[7]
	...
	S += (r30*MAS[4])-1 < r14_t3_mem0*MAS_MEM[8]
	S += (r30*MAS[5])-1 < r14_t3_mem0*MAS_MEM[10]
	S += (r30*MAS[6])-1 < r14_t3_mem0*MAS_MEM[12]
	S += (r30*MAS[7])-1 < r14_t3_mem0*MAS_MEM[14]
	...
	S += (r31*MAS[4])-1 < r14_t3_mem1*MAS_MEM[9]
	S += (r31*MAS[5])-1 < r14_t3_mem1*MAS_MEM[11]
	S += (r31*MAS[6])-1 < r14_t3_mem1*MAS_MEM[13]
	S += (r31*MAS[7])-1 < r14_t3_mem1*MAS_MEM[15]
	S += r14_t3_mem1 <= r14_t3

	Z_new_t0 = S.Task('Z_new_t0', length=11, delay_cost=1)
	Z_new_t0 += alt(MM)
	Z_new_t0_in = S.Task('Z_new_t0_in', length=1, delay_cost=1)
	Z_new_t0_in += alt(MM_in)
	S += Z_new_t0_in*MM_in[0]<=Z_new_t0*MM[0]
	S += Z_new_t0_in*MM_in[1]<=Z_new_t0*MM[1]
	...
	S += (r20*MAS[4])-1 < Z_new_t0_mem0*MAS_MEM[8]
	S += (r20*MAS[5])-1 < Z_new_t0_mem0*MAS_MEM[10]
	S += (r20*MAS[6])-1 < Z_new_t0_mem0*MAS_MEM[12]
	S += (r20*MAS[7])-1 < Z_new_t0_mem0*MAS_MEM[14]
	...
	S += (r130*MAS[4])-1 < Z_new_t0_mem1*MAS_MEM[9]
	S += (r130*MAS[5])-1 < Z_new_t0_mem1*MAS_MEM[11]
	S += (r130*MAS[6])-1 < Z_new_t0_mem1*MAS_MEM[13]
	S += (r130*MAS[7])-1 < Z_new_t0_mem1*MAS_MEM[15]
	...
	S += Z_new_t3_in*MAS_in[3]<=Z_new_t3*MAS[3]

	S += Z_new_t3_in*MAS_in[4]<=Z_new_t3*MAS[4]

	S += Z_new_t3_in*MAS_in[5]<=Z_new_t3*MAS[5]

	S += Z_new_t3_in*MAS_in[6]<=Z_new_t3*MAS[6]

	S += Z_new_t3_in*MAS_in[7]<=Z_new_t3*MAS[7]
	...
	S += (r130*MAS[4])-1 < Z_new_t3_mem0*MAS_MEM[8]
	S += (r130*MAS[5])-1 < Z_new_t3_mem0*MAS_MEM[10]
	S += (r130*MAS[6])-1 < Z_new_t3_mem0*MAS_MEM[12]
	S += (r130*MAS[7])-1 < Z_new_t3_mem0*MAS_MEM[14]
	...
	S += (r131*MAS[4])-1 < Z_new_t3_mem1*MAS_MEM[9]
	S += (r131*MAS[5])-1 < Z_new_t3_mem1*MAS_MEM[11]
	S += (r131*MAS[6])-1 < Z_new_t3_mem1*MAS_MEM[13]
	S += (r131*MAS[7])-1 < Z_new_t3_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/EP2_YRECOVER/schedule1.png"
	if(S.solution() != []):
