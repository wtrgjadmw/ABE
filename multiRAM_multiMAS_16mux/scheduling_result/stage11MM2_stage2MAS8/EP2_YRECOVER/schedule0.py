...
def solve():
	...
	r1_t2_in += alt(MAS_in)
	S += r1_t2_in*MAS_in[0]<=r1_t2*MAS[0]

	S += r1_t2_in*MAS_in[1]<=r1_t2*MAS[1]

	S += r1_t2_in*MAS_in[2]<=r1_t2*MAS[2]

	S += r1_t2_in*MAS_in[3]<=r1_t2*MAS[3]

	S += r1_t2_in*MAS_in[4]<=r1_t2*MAS[4]

	S += r1_t2_in*MAS_in[5]<=r1_t2*MAS[5]

	S += r1_t2_in*MAS_in[6]<=r1_t2*MAS[6]

	S += r1_t2_in*MAS_in[7]<=r1_t2*MAS[7]
	...
	r1_t3_in += alt(MAS_in)
	S += r1_t3_in*MAS_in[0]<=r1_t3*MAS[0]

	S += r1_t3_in*MAS_in[1]<=r1_t3*MAS[1]

	S += r1_t3_in*MAS_in[2]<=r1_t3*MAS[2]

	S += r1_t3_in*MAS_in[3]<=r1_t3*MAS[3]

	S += r1_t3_in*MAS_in[4]<=r1_t3*MAS[4]

	S += r1_t3_in*MAS_in[5]<=r1_t3*MAS[5]

	S += r1_t3_in*MAS_in[6]<=r1_t3*MAS[6]

	S += r1_t3_in*MAS_in[7]<=r1_t3*MAS[7]
	...
	r3_t2_in += alt(MAS_in)
	S += r3_t2_in*MAS_in[0]<=r3_t2*MAS[0]

	S += r3_t2_in*MAS_in[1]<=r3_t2*MAS[1]

	S += r3_t2_in*MAS_in[2]<=r3_t2*MAS[2]

	S += r3_t2_in*MAS_in[3]<=r3_t2*MAS[3]

	S += r3_t2_in*MAS_in[4]<=r3_t2*MAS[4]

	S += r3_t2_in*MAS_in[5]<=r3_t2*MAS[5]

	S += r3_t2_in*MAS_in[6]<=r3_t2*MAS[6]

	S += r3_t2_in*MAS_in[7]<=r3_t2*MAS[7]
	...
	r3_t3_in += alt(MAS_in)
	S += r3_t3_in*MAS_in[0]<=r3_t3*MAS[0]

	S += r3_t3_in*MAS_in[1]<=r3_t3*MAS[1]

	S += r3_t3_in*MAS_in[2]<=r3_t3*MAS[2]

	S += r3_t3_in*MAS_in[3]<=r3_t3*MAS[3]

	S += r3_t3_in*MAS_in[4]<=r3_t3*MAS[4]

	S += r3_t3_in*MAS_in[5]<=r3_t3*MAS[5]

	S += r3_t3_in*MAS_in[6]<=r3_t3*MAS[6]

	S += r3_t3_in*MAS_in[7]<=r3_t3*MAS[7]
	...
	r4_t2_in += alt(MAS_in)
	S += r4_t2_in*MAS_in[0]<=r4_t2*MAS[0]

	S += r4_t2_in*MAS_in[1]<=r4_t2*MAS[1]

	S += r4_t2_in*MAS_in[2]<=r4_t2*MAS[2]

	S += r4_t2_in*MAS_in[3]<=r4_t2*MAS[3]

	S += r4_t2_in*MAS_in[4]<=r4_t2*MAS[4]

	S += r4_t2_in*MAS_in[5]<=r4_t2*MAS[5]

	S += r4_t2_in*MAS_in[6]<=r4_t2*MAS[6]

	S += r4_t2_in*MAS_in[7]<=r4_t2*MAS[7]
	...
	r4_t3_in += alt(MAS_in)
	S += r4_t3_in*MAS_in[0]<=r4_t3*MAS[0]

	S += r4_t3_in*MAS_in[1]<=r4_t3*MAS[1]

	S += r4_t3_in*MAS_in[2]<=r4_t3*MAS[2]

	S += r4_t3_in*MAS_in[3]<=r4_t3*MAS[3]

	S += r4_t3_in*MAS_in[4]<=r4_t3*MAS[4]

	S += r4_t3_in*MAS_in[5]<=r4_t3*MAS[5]

	S += r4_t3_in*MAS_in[6]<=r4_t3*MAS[6]

	S += r4_t3_in*MAS_in[7]<=r4_t3*MAS[7]
	...
	r5_t2_in += alt(MAS_in)
	S += r5_t2_in*MAS_in[0]<=r5_t2*MAS[0]

	S += r5_t2_in*MAS_in[1]<=r5_t2*MAS[1]

	S += r5_t2_in*MAS_in[2]<=r5_t2*MAS[2]

	S += r5_t2_in*MAS_in[3]<=r5_t2*MAS[3]

	S += r5_t2_in*MAS_in[4]<=r5_t2*MAS[4]

	S += r5_t2_in*MAS_in[5]<=r5_t2*MAS[5]

	S += r5_t2_in*MAS_in[6]<=r5_t2*MAS[6]

	S += r5_t2_in*MAS_in[7]<=r5_t2*MAS[7]
	...
	r5_t3_in += alt(MAS_in)
	S += r5_t3_in*MAS_in[0]<=r5_t3*MAS[0]

	S += r5_t3_in*MAS_in[1]<=r5_t3*MAS[1]

	S += r5_t3_in*MAS_in[2]<=r5_t3*MAS[2]

	S += r5_t3_in*MAS_in[3]<=r5_t3*MAS[3]

	S += r5_t3_in*MAS_in[4]<=r5_t3*MAS[4]

	S += r5_t3_in*MAS_in[5]<=r5_t3*MAS[5]

	S += r5_t3_in*MAS_in[6]<=r5_t3*MAS[6]

	S += r5_t3_in*MAS_in[7]<=r5_t3*MAS[7]
	...
	r6_t2_in += alt(MAS_in)
	S += r6_t2_in*MAS_in[0]<=r6_t2*MAS[0]

	S += r6_t2_in*MAS_in[1]<=r6_t2*MAS[1]

	S += r6_t2_in*MAS_in[2]<=r6_t2*MAS[2]

	S += r6_t2_in*MAS_in[3]<=r6_t2*MAS[3]

	S += r6_t2_in*MAS_in[4]<=r6_t2*MAS[4]

	S += r6_t2_in*MAS_in[5]<=r6_t2*MAS[5]

	S += r6_t2_in*MAS_in[6]<=r6_t2*MAS[6]

	S += r6_t2_in*MAS_in[7]<=r6_t2*MAS[7]
	...
	r6_t3_in += alt(MAS_in)
	S += r6_t3_in*MAS_in[0]<=r6_t3*MAS[0]

	S += r6_t3_in*MAS_in[1]<=r6_t3*MAS[1]

	S += r6_t3_in*MAS_in[2]<=r6_t3*MAS[2]

	S += r6_t3_in*MAS_in[3]<=r6_t3*MAS[3]

	S += r6_t3_in*MAS_in[4]<=r6_t3*MAS[4]

	S += r6_t3_in*MAS_in[5]<=r6_t3*MAS[5]

	S += r6_t3_in*MAS_in[6]<=r6_t3*MAS[6]

	S += r6_t3_in*MAS_in[7]<=r6_t3*MAS[7]
	...
	r9_t2_in += alt(MAS_in)
	S += r9_t2_in*MAS_in[0]<=r9_t2*MAS[0]

	S += r9_t2_in*MAS_in[1]<=r9_t2*MAS[1]

	S += r9_t2_in*MAS_in[2]<=r9_t2*MAS[2]

	S += r9_t2_in*MAS_in[3]<=r9_t2*MAS[3]

	S += r9_t2_in*MAS_in[4]<=r9_t2*MAS[4]

	S += r9_t2_in*MAS_in[5]<=r9_t2*MAS[5]

	S += r9_t2_in*MAS_in[6]<=r9_t2*MAS[6]

	S += r9_t2_in*MAS_in[7]<=r9_t2*MAS[7]
	...
	S += r12_t0_in*MM_in[1]<=r12_t0*MM[1]
	...
	S += r12_t1_in*MM_in[1]<=r12_t1*MM[1]
	...
	r12_t2_in += alt(MAS_in)
	S += r12_t2_in*MAS_in[0]<=r12_t2*MAS[0]

	S += r12_t2_in*MAS_in[1]<=r12_t2*MAS[1]

	S += r12_t2_in*MAS_in[2]<=r12_t2*MAS[2]

	S += r12_t2_in*MAS_in[3]<=r12_t2*MAS[3]

	S += r12_t2_in*MAS_in[4]<=r12_t2*MAS[4]

	S += r12_t2_in*MAS_in[5]<=r12_t2*MAS[5]

	S += r12_t2_in*MAS_in[6]<=r12_t2*MAS[6]

	S += r12_t2_in*MAS_in[7]<=r12_t2*MAS[7]
	...
	r12_t3_in += alt(MAS_in)
	S += r12_t3_in*MAS_in[0]<=r12_t3*MAS[0]

	S += r12_t3_in*MAS_in[1]<=r12_t3*MAS[1]

	S += r12_t3_in*MAS_in[2]<=r12_t3*MAS[2]

	S += r12_t3_in*MAS_in[3]<=r12_t3*MAS[3]

	S += r12_t3_in*MAS_in[4]<=r12_t3*MAS[4]

	S += r12_t3_in*MAS_in[5]<=r12_t3*MAS[5]

	S += r12_t3_in*MAS_in[6]<=r12_t3*MAS[6]

	S += r12_t3_in*MAS_in[7]<=r12_t3*MAS[7]
	...
	S += r13_t0_in*MM_in[1]<=r13_t0*MM[1]
	...
	S += r13_t1_in*MM_in[1]<=r13_t1*MM[1]
	...
	r13_t2_in += alt(MAS_in)
	S += r13_t2_in*MAS_in[0]<=r13_t2*MAS[0]

	S += r13_t2_in*MAS_in[1]<=r13_t2*MAS[1]

	S += r13_t2_in*MAS_in[2]<=r13_t2*MAS[2]

	S += r13_t2_in*MAS_in[3]<=r13_t2*MAS[3]

	S += r13_t2_in*MAS_in[4]<=r13_t2*MAS[4]

	S += r13_t2_in*MAS_in[5]<=r13_t2*MAS[5]

	S += r13_t2_in*MAS_in[6]<=r13_t2*MAS[6]

	S += r13_t2_in*MAS_in[7]<=r13_t2*MAS[7]
	...
	r13_t3_in += alt(MAS_in)
	S += r13_t3_in*MAS_in[0]<=r13_t3*MAS[0]

	S += r13_t3_in*MAS_in[1]<=r13_t3*MAS[1]

	S += r13_t3_in*MAS_in[2]<=r13_t3*MAS[2]

	S += r13_t3_in*MAS_in[3]<=r13_t3*MAS[3]

	S += r13_t3_in*MAS_in[4]<=r13_t3*MAS[4]

	S += r13_t3_in*MAS_in[5]<=r13_t3*MAS[5]

	S += r13_t3_in*MAS_in[6]<=r13_t3*MAS[6]

	S += r13_t3_in*MAS_in[7]<=r13_t3*MAS[7]
	...
	r16_t3_in += alt(MAS_in)
	S += r16_t3_in*MAS_in[0]<=r16_t3*MAS[0]

	S += r16_t3_in*MAS_in[1]<=r16_t3*MAS[1]

	S += r16_t3_in*MAS_in[2]<=r16_t3*MAS[2]

	S += r16_t3_in*MAS_in[3]<=r16_t3*MAS[3]

	S += r16_t3_in*MAS_in[4]<=r16_t3*MAS[4]

	S += r16_t3_in*MAS_in[5]<=r16_t3*MAS[5]

	S += r16_t3_in*MAS_in[6]<=r16_t3*MAS[6]

	S += r16_t3_in*MAS_in[7]<=r16_t3*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/EP2_YRECOVER/schedule0.png"
	if(S.solution() != []):
