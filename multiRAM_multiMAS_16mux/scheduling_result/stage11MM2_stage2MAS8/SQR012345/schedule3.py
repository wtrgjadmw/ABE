...
def solve():
	...
	S += t201_mem0 >= 37
	t201_mem0 += MAS_MEM[14]

	t201_mem1 = S.Task('t201_mem1', length=1, delay_cost=1)
	S += t201_mem1 >= 37
	t201_mem1 += MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/SQR012345/schedule3.png"
	if(S.solution() != []):
