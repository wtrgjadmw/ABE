...
def solve():
	...
	S += t2_t3_mem0 >= 26
	t2_t3_mem0 += MAS_MEM[8]

	t2_t3_mem1 = S.Task('t2_t3_mem1', length=1, delay_cost=1)
	S += t2_t3_mem1 >= 26
	t2_t3_mem1 += MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
