...
def solve():
	...
	c_qinv0_t4_mem0 += MAS_MEM[12]
	S += 10 < c_qinv0_t4_mem0
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/FP12_INV_AFTER_FPINV/schedule1.png"
	if(S.solution() != []):
