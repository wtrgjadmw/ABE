...
def solve():
	...
	S += c_pbc_t0_t3_in*MAS_in[6]<=c_pbc_t0_t3*MAS[6]

	S += c_pbc_t0_t3_in*MAS_in[7]<=c_pbc_t0_t3*MAS[7]
	...
	S += c_pbc_t1_t3_in*MAS_in[6]<=c_pbc_t1_t3*MAS[6]

	S += c_pbc_t1_t3_in*MAS_in[7]<=c_pbc_t1_t3*MAS[7]
	...
	S += c_pbc_t30_in*MAS_in[6]<=c_pbc_t30*MAS[6]

	S += c_pbc_t30_in*MAS_in[7]<=c_pbc_t30*MAS[7]
	...
	S += c_pbc_t31_in*MAS_in[6]<=c_pbc_t31*MAS[6]

	S += c_pbc_t31_in*MAS_in[7]<=c_pbc_t31*MAS[7]
	...
	S += c_pcb_t0_t3_in*MAS_in[6]<=c_pcb_t0_t3*MAS[6]

	S += c_pcb_t0_t3_in*MAS_in[7]<=c_pcb_t0_t3*MAS[7]
	...
	S += c_pcb_t1_t3_in*MAS_in[6]<=c_pcb_t1_t3*MAS[6]

	S += c_pcb_t1_t3_in*MAS_in[7]<=c_pcb_t1_t3*MAS[7]
	...
	S += c_pcb_t30_in*MAS_in[6]<=c_pcb_t30*MAS[6]

	S += c_pcb_t30_in*MAS_in[7]<=c_pcb_t30*MAS[7]
	...
	S += c_pcb_t31_in*MAS_in[6]<=c_pcb_t31*MAS[6]

	S += c_pcb_t31_in*MAS_in[7]<=c_pcb_t31*MAS[7]
	...
	S += c_paa_t0_t3_in*MAS_in[6]<=c_paa_t0_t3*MAS[6]

	S += c_paa_t0_t3_in*MAS_in[7]<=c_paa_t0_t3*MAS[7]
	...
	S += c_paa_t1_t3_in*MAS_in[6]<=c_paa_t1_t3*MAS[6]

	S += c_paa_t1_t3_in*MAS_in[7]<=c_paa_t1_t3*MAS[7]
	...
	S += c_paa_t30_in*MAS_in[6]<=c_paa_t30*MAS[6]

	S += c_paa_t30_in*MAS_in[7]<=c_paa_t30*MAS[7]
	...
	S += c_paa_t31_in*MAS_in[6]<=c_paa_t31*MAS[6]

	S += c_paa_t31_in*MAS_in[7]<=c_paa_t31*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/FP12_INV_BEFORE_FPINV/schedule2.png"
	if(S.solution() != []):
