...
def solve():
	...
	S += c_t2_t1_t2_in*MAS_in[6]<=c_t2_t1_t2*MAS[6]

	S += c_t2_t1_t2_in*MAS_in[7]<=c_t2_t1_t2*MAS[7]
	...
	S += c_t2_t1_t3_in*MAS_in[6]<=c_t2_t1_t3*MAS[6]

	S += c_t2_t1_t3_in*MAS_in[7]<=c_t2_t1_t3*MAS[7]
	...
	S += c_t3100_in*MAS_in[6]<=c_t3100*MAS[6]

	S += c_t3100_in*MAS_in[7]<=c_t3100*MAS[7]
	...
	S += c_t3101_in*MAS_in[6]<=c_t3101*MAS[6]

	S += c_t3101_in*MAS_in[7]<=c_t3101*MAS[7]
	...
	S += c_t3110_in*MAS_in[6]<=c_t3110*MAS[6]

	S += c_t3110_in*MAS_in[7]<=c_t3110*MAS[7]
	...
	S += c_t3111_in*MAS_in[6]<=c_t3111*MAS[6]

	S += c_t3111_in*MAS_in[7]<=c_t3111*MAS[7]
	...
	S += c_t4100_in*MAS_in[6]<=c_t4100*MAS[6]

	S += c_t4100_in*MAS_in[7]<=c_t4100*MAS[7]
	...
	S += c_t4101_in*MAS_in[6]<=c_t4101*MAS[6]

	S += c_t4101_in*MAS_in[7]<=c_t4101*MAS[7]
	...
	S += c_t4110_in*MAS_in[6]<=c_t4110*MAS[6]

	S += c_t4110_in*MAS_in[7]<=c_t4110*MAS[7]
	...
	S += c_t4111_in*MAS_in[6]<=c_t4111*MAS[6]

	S += c_t4111_in*MAS_in[7]<=c_t4111*MAS[7]
	...
	S += c_t5100_in*MAS_in[6]<=c_t5100*MAS[6]

	S += c_t5100_in*MAS_in[7]<=c_t5100*MAS[7]
	...
	S += c_t5101_in*MAS_in[6]<=c_t5101*MAS[6]

	S += c_t5101_in*MAS_in[7]<=c_t5101*MAS[7]
	...
	S += c_t5110_in*MAS_in[6]<=c_t5110*MAS[6]

	S += c_t5110_in*MAS_in[7]<=c_t5110*MAS[7]
	...
	S += c_t5111_in*MAS_in[6]<=c_t5111*MAS[6]

	S += c_t5111_in*MAS_in[7]<=c_t5111*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/MUL/schedule1.png"
	if(S.solution() != []):
