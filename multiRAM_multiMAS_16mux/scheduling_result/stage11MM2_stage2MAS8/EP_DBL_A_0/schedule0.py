...
def solve():
	...
	new_PZ = S.Task('new_PZ', length=11, delay_cost=1)
	new_PZ += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage2MAS8/EP_DBL_A_0/schedule0.png"
	if(S.solution() != []):
