...
def solve():
	...
	t3alpha0 = S.Task('t3alpha0', length=6, delay_cost=1)
	t3alpha0 += alt(MM)
	...
	t3alpha1 = S.Task('t3alpha1', length=6, delay_cost=1)
	t3alpha1 += alt(MM)
	...
	Y_Hash0 = S.Task('Y_Hash0', length=6, delay_cost=1)
	Y_Hash0 += alt(MM)
	...
	Y_Hash1 = S.Task('Y_Hash1', length=6, delay_cost=1)
	Y_Hash1 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage2MAS5/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
