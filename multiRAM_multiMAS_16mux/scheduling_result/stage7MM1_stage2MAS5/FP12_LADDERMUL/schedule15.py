...
def solve():
	...
	S += d_t3_t2_t5_mem0 >= 28
	d_t3_t2_t5_mem0 += MM_MEM[0]

	d_t3_t2_t5_mem1 = S.Task('d_t3_t2_t5_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t5_mem1 >= 28
	...
	S += d_t5_t2_t0_mem0 >= 42
	d_t5_t2_t0_mem0 += MAS_MEM[6]

	d_t5_t2_t0_mem1 = S.Task('d_t5_t2_t0_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t0_mem1 >= 42
	...
	S += c_t9_y1_1_mem0 >= 115
	c_t9_y1_1_mem0 += MAS_MEM[8]

	c_t9_y1_1_mem1 = S.Task('c_t9_y1_1_mem1', length=1, delay_cost=1)
	S += c_t9_y1_1_mem1 >= 115
	...
	S += c_t9_y1_0_mem0 >= 116
	c_t9_y1_0_mem0 += MAS_MEM[2]

	c_t9_y1_0_mem1 = S.Task('c_t9_y1_0_mem1', length=1, delay_cost=1)
	S += c_t9_y1_0_mem1 >= 116
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM1_stage2MAS5/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
