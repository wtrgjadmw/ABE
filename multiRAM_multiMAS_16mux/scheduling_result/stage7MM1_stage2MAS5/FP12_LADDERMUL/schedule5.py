...
def solve():
	...
	S += d_t5_t3_t1_mem0 >= 40
	d_t5_t3_t1_mem0 += MAS_MEM[8]

	d_t5_t3_t1_mem1 = S.Task('d_t5_t3_t1_mem1', length=1, delay_cost=1)
	S += d_t5_t3_t1_mem1 >= 40
	...
	S += d_t4_t3_t3_mem0 >= 50
	d_t4_t3_t3_mem0 += MAS_MEM[0]

	d_t4_t3_t3_mem1 = S.Task('d_t4_t3_t3_mem1', length=1, delay_cost=1)
	S += d_t4_t3_t3_mem1 >= 50
	...
	S += c_t0_t4_t1_mem0 >= 57
	c_t0_t4_t1_mem0 += MAS_MEM[8]

	c_t0_t4_t1_mem1 = S.Task('c_t0_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t0_t4_t1_mem1 >= 57
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM1_stage2MAS5/FP12_LADDERMUL/schedule5.png"
	if(S.solution() != []):
