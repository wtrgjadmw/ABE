...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage3MAS4/FP12_LADDERMUL/schedule9.png"
	if(S.solution() != []):
