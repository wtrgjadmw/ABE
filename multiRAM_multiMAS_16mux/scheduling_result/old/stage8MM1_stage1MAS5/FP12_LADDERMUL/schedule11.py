...
def solve():
	...
	S += d_t5_t2_t2_mem0 >= 42
	d_t5_t2_t2_mem0 += MAS_MEM[6]

	d_t5_t2_t2_mem1 = S.Task('d_t5_t2_t2_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t2_mem1 >= 42
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage1MAS5/FP12_LADDERMUL/schedule11.png"
	if(S.solution() != []):
