...
def solve():
	...
	t5_t100_mem1 += alt(MAS_MEM)
	S += (t5_t21*MAS[0])-1 < t5_t100_mem1*MAS_MEM[1]
	S += (t5_t21*MAS[1])-1 < t5_t100_mem1*MAS_MEM[3]
	S += (t5_t21*MAS[2])-1 < t5_t100_mem1*MAS_MEM[5]
	S += (t5_t21*MAS[3])-1 < t5_t100_mem1*MAS_MEM[7]
	S += (t5_t21*MAS[4])-1 < t5_t100_mem1*MAS_MEM[9]
	...
	t5_t101_mem0 += alt(MAS_MEM)
	S += (t5_t21*MAS[0])-1 < t5_t101_mem0*MAS_MEM[0]
	S += (t5_t21*MAS[1])-1 < t5_t101_mem0*MAS_MEM[2]
	S += (t5_t21*MAS[2])-1 < t5_t101_mem0*MAS_MEM[4]
	S += (t5_t21*MAS[3])-1 < t5_t101_mem0*MAS_MEM[6]
	S += (t5_t21*MAS[4])-1 < t5_t101_mem0*MAS_MEM[8]
	...
	S += (t21*MAS[0])-1 < t161_mem0*MAS_MEM[0]
	S += (t21*MAS[1])-1 < t161_mem0*MAS_MEM[2]
	S += (t21*MAS[2])-1 < t161_mem0*MAS_MEM[4]
	S += (t21*MAS[3])-1 < t161_mem0*MAS_MEM[6]
	S += (t21*MAS[4])-1 < t161_mem0*MAS_MEM[8]
	S += t161_mem0 <= t161
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage1MAS5/SPARSE/schedule4.png"
	if(S.solution() != []):
