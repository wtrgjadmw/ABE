...
def solve():
	...
	d_t0_t2_t0 += alt(MM)
	S += d_t0_t2_t0>=d_t0_t2_t0_in

	d_t0_t2_t0_mem0 = S.Task('d_t0_t2_t0_mem0', length=1, delay_cost=1)
	d_t0_t2_t0_mem0 += MAS_MEM[2]
	S += 21 < d_t0_t2_t0_mem0
	...
	d_t0_t2_t1 += alt(MM)
	S += d_t0_t2_t1>=d_t0_t2_t1_in

	d_t0_t2_t1_mem0 = S.Task('d_t0_t2_t1_mem0', length=1, delay_cost=1)
	d_t0_t2_t1_mem0 += MAS_MEM[8]
	S += 23 < d_t0_t2_t1_mem0
	...
	d_t1_t2_t0 += alt(MM)
	S += d_t1_t2_t0>=d_t1_t2_t0_in

	d_t1_t2_t0_mem0 = S.Task('d_t1_t2_t0_mem0', length=1, delay_cost=1)
	d_t1_t2_t0_mem0 += MAS_MEM[6]
	S += 22 < d_t1_t2_t0_mem0
	...
	d_t1_t2_t1 += alt(MM)
	S += d_t1_t2_t1>=d_t1_t2_t1_in

	d_t1_t2_t1_mem0 = S.Task('d_t1_t2_t1_mem0', length=1, delay_cost=1)
	d_t1_t2_t1_mem0 += MAS_MEM[4]
	S += 22 < d_t1_t2_t1_mem0
	...
	d_t2_t2_t0 += alt(MM)
	S += d_t2_t2_t0>=d_t2_t2_t0_in

	d_t2_t2_t0_mem0 = S.Task('d_t2_t2_t0_mem0', length=1, delay_cost=1)
	d_t2_t2_t0_mem0 += MAS_MEM[6]
	S += 21 < d_t2_t2_t0_mem0
	...
	d_t2_t2_t1 += alt(MM)
	S += d_t2_t2_t1>=d_t2_t2_t1_in

	d_t2_t2_t1_mem0 = S.Task('d_t2_t2_t1_mem0', length=1, delay_cost=1)
	d_t2_t2_t1_mem0 += MAS_MEM[6]
	S += 23 < d_t2_t2_t1_mem0
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage1MAS5/FP12_LADDERMUL/schedule7.png"
	if(S.solution() != []):
