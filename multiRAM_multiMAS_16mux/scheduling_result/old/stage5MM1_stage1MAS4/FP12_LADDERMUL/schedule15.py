...
def solve():
	...
	d011_mem1 += alt(MAS_MEM)
	S += (d_s1101*MAS[0])-1 < d011_mem1*MAS_MEM[1]
	S += (d_s1101*MAS[1])-1 < d011_mem1*MAS_MEM[3]
	S += (d_s1101*MAS[2])-1 < d011_mem1*MAS_MEM[5]
	S += (d_s1101*MAS[3])-1 < d011_mem1*MAS_MEM[7]
	S += d011_mem1 <= d011
