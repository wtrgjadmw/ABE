...
def solve():
	...
	S += d_t5_t2_t2_mem0 >= 51
	d_t5_t2_t2_mem0 += MAS_MEM[4]

	d_t5_t2_t2_mem1 = S.Task('d_t5_t2_t2_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t2_mem1 >= 51
	...
	S += d_t3_t2_t2_mem0 >= 59
	d_t3_t2_t2_mem0 += MAS_MEM[6]

	d_t3_t2_t2_mem1 = S.Task('d_t3_t2_t2_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t2_mem1 >= 59
	...
	d101_mem0 += alt(MAS_MEM)
	S += (d_s001*MAS[0])-1 < d101_mem0*MAS_MEM[0]
	S += (d_s001*MAS[1])-1 < d101_mem0*MAS_MEM[2]
	S += (d_s001*MAS[2])-1 < d101_mem0*MAS_MEM[4]
	S += (d_s001*MAS[3])-1 < d101_mem0*MAS_MEM[6]
	S += d101_mem0 <= d101
	...
	d200_mem1 += alt(MAS_MEM)
	S += (d_s200*MAS[0])-1 < d200_mem1*MAS_MEM[1]
	S += (d_s200*MAS[1])-1 < d200_mem1*MAS_MEM[3]
	S += (d_s200*MAS[2])-1 < d200_mem1*MAS_MEM[5]
	S += (d_s200*MAS[3])-1 < d200_mem1*MAS_MEM[7]
	S += d200_mem1 <= d200
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage3MAS4/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
