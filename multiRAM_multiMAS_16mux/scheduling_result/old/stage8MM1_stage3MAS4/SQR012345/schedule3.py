...
def solve():
	...
	S += (t201*MAS[3])-1 < t211_mem0*MAS_MEM[6]
	S += t211_mem0 <= t211
	...
	S += (t240*MAS[0])-1 < t250_mem1*MAS_MEM[1]
	S += (t240*MAS[1])-1 < t250_mem1*MAS_MEM[3]
	S += (t240*MAS[2])-1 < t250_mem1*MAS_MEM[5]
	S += (t240*MAS[3])-1 < t250_mem1*MAS_MEM[7]
	S += t250_mem1 <= t250
	...
	S += (t101*MAS[0])-1 < c201_mem1*MAS_MEM[1]
	S += (t101*MAS[1])-1 < c201_mem1*MAS_MEM[3]
	S += (t101*MAS[2])-1 < c201_mem1*MAS_MEM[5]
	S += (t101*MAS[3])-1 < c201_mem1*MAS_MEM[7]
	S += c201_mem1 <= c201
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage3MAS4/SQR012345/schedule3.png"
	if(S.solution() != []):
