...
def solve():
	...
	t12_t4_mem0 += alt(MAS_MEM)
	S += (t12_t2*MAS[0])-1 < t12_t4_mem0*MAS_MEM[0]
	S += (t12_t2*MAS[1])-1 < t12_t4_mem0*MAS_MEM[2]
	S += (t12_t2*MAS[2])-1 < t12_t4_mem0*MAS_MEM[4]
	S += (t12_t2*MAS[3])-1 < t12_t4_mem0*MAS_MEM[6]
	S += t12_t4_mem0 <= t12_t4

	t12_t4_mem1 = S.Task('t12_t4_mem1', length=1, delay_cost=1)
	t12_t4_mem1 += alt(MAS_MEM)
	S += (t12_t3*MAS[0])-1 < t12_t4_mem1*MAS_MEM[1]
	S += (t12_t3*MAS[1])-1 < t12_t4_mem1*MAS_MEM[3]
	S += (t12_t3*MAS[2])-1 < t12_t4_mem1*MAS_MEM[5]
	S += (t12_t3*MAS[3])-1 < t12_t4_mem1*MAS_MEM[7]
	...
	t120_mem1 += alt(MM_MEM)
	S += (t12_t1*MM[0])-1 < t120_mem1*MM_MEM[1]
	S += t120_mem1 <= t120
	...
	t12_t5_mem1 += alt(MM_MEM)
	S += (t12_t1*MM[0])-1 < t12_t5_mem1*MM_MEM[1]
	...
	S += (t01*MAS[0])-1 < c001_mem0*MAS_MEM[0]
	S += (t01*MAS[1])-1 < c001_mem0*MAS_MEM[2]
	S += (t01*MAS[2])-1 < c001_mem0*MAS_MEM[4]
	S += (t01*MAS[3])-1 < c001_mem0*MAS_MEM[6]
	S += c001_mem0 <= c001
	...
	t161_mem0 += alt(MAS_MEM)
	S += (t01*MAS[0])-1 < t161_mem0*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t161_mem0*MAS_MEM[2]
	S += (t01*MAS[2])-1 < t161_mem0*MAS_MEM[4]
	S += (t01*MAS[3])-1 < t161_mem0*MAS_MEM[6]
	S += t161_mem0 <= t161
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
