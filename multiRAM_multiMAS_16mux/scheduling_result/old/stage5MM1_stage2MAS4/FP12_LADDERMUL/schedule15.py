...
def solve():
	...
	S += d_t3_t2_t2_mem0 >= 66
	d_t3_t2_t2_mem0 += MAS_MEM[6]

	d_t3_t2_t2_mem1 = S.Task('d_t3_t2_t2_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t2_mem1 >= 66
	...
	S += d_t2_t2_t4_mem0 >= 76
	d_t2_t2_t4_mem0 += MAS_MEM[4]

	d_t2_t2_t4_mem1 = S.Task('d_t2_t2_t4_mem1', length=1, delay_cost=1)
	S += d_t2_t2_t4_mem1 >= 76
	...
	S += d_t2_t2_t5_mem0 >= 79
	d_t2_t2_t5_mem0 += MM_MEM[0]

	d_t2_t2_t5_mem1 = S.Task('d_t2_t2_t5_mem1', length=1, delay_cost=1)
	S += d_t2_t2_t5_mem1 >= 79
	...
	S += d_t3_t2_t1_mem0 >= 83
	d_t3_t2_t1_mem0 += MAS_MEM[4]

	d_t3_t2_t1_mem1 = S.Task('d_t3_t2_t1_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t1_mem1 >= 83
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
