...
def solve():
	...
	S += (t170*MAS[3])-1 < c110_mem1*MAS_MEM[7]
	S += c110_mem1 <= c110
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/SQR012345/schedule3.png"
	if(S.solution() != []):
