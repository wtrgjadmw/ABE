...
def solve():
	...
	T22_t0_mem0 += alt(MAS_MEM)
	S += (T210*MAS[0])-1 < T22_t0_mem0*MAS_MEM[0]
	S += (T210*MAS[1])-1 < T22_t0_mem0*MAS_MEM[2]
	S += (T210*MAS[2])-1 < T22_t0_mem0*MAS_MEM[4]
	S += (T210*MAS[3])-1 < T22_t0_mem0*MAS_MEM[6]
	...
	T22_t1_mem0 += alt(MAS_MEM)
	S += (T210*MAS[0])-1 < T22_t1_mem0*MAS_MEM[0]
	S += (T210*MAS[1])-1 < T22_t1_mem0*MAS_MEM[2]
	S += (T210*MAS[2])-1 < T22_t1_mem0*MAS_MEM[4]
	S += (T210*MAS[3])-1 < T22_t1_mem0*MAS_MEM[6]
	...
	T22_t3_mem0 += alt(MAS_MEM)
	S += (T210*MAS[0])-1 < T22_t3_mem0*MAS_MEM[0]
	S += (T210*MAS[1])-1 < T22_t3_mem0*MAS_MEM[2]
	S += (T210*MAS[2])-1 < T22_t3_mem0*MAS_MEM[4]
	S += (T210*MAS[3])-1 < T22_t3_mem0*MAS_MEM[6]
