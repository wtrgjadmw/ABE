...
def solve():
	...
	r1_t4_in += alt(MM_in)
	r1_t4 = S.Task('r1_t4', length=4, delay_cost=1)
	r1_t4 += alt(MM)
	S += r1_t4>=r1_t4_in
	...
	r3_t4_in += alt(MM_in)
	r3_t4 = S.Task('r3_t4', length=4, delay_cost=1)
	r3_t4 += alt(MM)
	S += r3_t4>=r3_t4_in

	r3_t4_mem0 = S.Task('r3_t4_mem0', length=1, delay_cost=1)
	r3_t4_mem0 += MAS_MEM[8]
	S += 3 < r3_t4_mem0
	S += r3_t4_mem0 <= r3_t4
	...
	r4_t4_in += alt(MM_in)
	r4_t4 = S.Task('r4_t4', length=4, delay_cost=1)
	r4_t4 += alt(MM)
	S += r4_t4>=r4_t4_in
	...
	r5_t4_in += alt(MM_in)
	r5_t4 = S.Task('r5_t4', length=4, delay_cost=1)
	r5_t4 += alt(MM)
	S += r5_t4>=r5_t4_in
	...
	r6_t4_in += alt(MM_in)
	r6_t4 = S.Task('r6_t4', length=4, delay_cost=1)
	r6_t4 += alt(MM)
	S += r6_t4>=r6_t4_in
	...
	r12_t4_in += alt(MM_in)
	r12_t4 = S.Task('r12_t4', length=4, delay_cost=1)
	r12_t4 += alt(MM)
	S += r12_t4>=r12_t4_in
	...
	r13_t4_in += alt(MM_in)
	r13_t4 = S.Task('r13_t4', length=4, delay_cost=1)
	r13_t4 += alt(MM)
	S += r13_t4>=r13_t4_in
	...
	r9_t0_in += alt(MM_in)
	r9_t0 = S.Task('r9_t0', length=4, delay_cost=1)
	r9_t0 += alt(MM)
	S += r9_t0>=r9_t0_in
	...
	X_new_t0 = S.Task('X_new_t0', length=4, delay_cost=1)
	X_new_t0 += alt(MM)
	S += X_new_t0>=X_new_t0_in
	...
	r14_t0_in += alt(MM_in)
	r14_t0 = S.Task('r14_t0', length=4, delay_cost=1)
	r14_t0 += alt(MM)
	S += r14_t0>=r14_t0_in
	...
	Z_new_t0 = S.Task('Z_new_t0', length=4, delay_cost=1)
	Z_new_t0 += alt(MM)
	S += Z_new_t0>=Z_new_t0_in
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage1MAS5/EP2_YRECOVER/schedule1.png"
	if(S.solution() != []):
