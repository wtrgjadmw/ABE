...
def solve():
	...
	r9_t1_in += alt(MM_in)
	r9_t1 = S.Task('r9_t1', length=4, delay_cost=1)
	r9_t1 += alt(MM)
	S += r9_t1>=r9_t1_in
	...
	r11_t3_in += alt(MM_in)
	r11_t3 = S.Task('r11_t3', length=4, delay_cost=1)
	r11_t3 += alt(MM)
	S += r11_t3>=r11_t3_in
	...
	X_new_t1 = S.Task('X_new_t1', length=4, delay_cost=1)
	X_new_t1 += alt(MM)
	...
	r14_t1_in += alt(MM_in)
	r14_t1 = S.Task('r14_t1', length=4, delay_cost=1)
	r14_t1 += alt(MM)
	S += r14_t1>=r14_t1_in
	...
	Z_new_t1 = S.Task('Z_new_t1', length=4, delay_cost=1)
	Z_new_t1 += alt(MM)
	...
	r9_t4_in += alt(MM_in)
	r9_t4 = S.Task('r9_t4', length=4, delay_cost=1)
	r9_t4 += alt(MM)
	S += r9_t4>=r9_t4_in
	...
	r11_t2_in += alt(MM_in)
	r11_t2 = S.Task('r11_t2', length=4, delay_cost=1)
	r11_t2 += alt(MM)
	S += r11_t2>=r11_t2_in
	...
	X_new_t4 = S.Task('X_new_t4', length=4, delay_cost=1)
	X_new_t4 += alt(MM)
	...
	r14_t4_in += alt(MM_in)
	r14_t4 = S.Task('r14_t4', length=4, delay_cost=1)
	r14_t4 += alt(MM)
	S += r14_t4>=r14_t4_in
	...
	Z_new_t4 = S.Task('Z_new_t4', length=4, delay_cost=1)
	Z_new_t4 += alt(MM)
	...
	r15_t0_in += alt(MM_in)
	r15_t0 = S.Task('r15_t0', length=4, delay_cost=1)
	r15_t0 += alt(MM)
	S += r15_t0>=r15_t0_in
	...
	r16_t1_in += alt(MM_in)
	r16_t1 = S.Task('r16_t1', length=4, delay_cost=1)
	r16_t1 += alt(MM)
	S += r16_t1>=r16_t1_in
	...
	r15_t1_in += alt(MM_in)
	r15_t1 = S.Task('r15_t1', length=4, delay_cost=1)
	r15_t1 += alt(MM)
	S += r15_t1>=r15_t1_in
	...
	r16_t0_in += alt(MM_in)
	r16_t0 = S.Task('r16_t0', length=4, delay_cost=1)
	r16_t0 += alt(MM)
	S += r16_t0>=r16_t0_in
	...
	r15_t4_in += alt(MM_in)
	r15_t4 = S.Task('r15_t4', length=4, delay_cost=1)
	r15_t4 += alt(MM)
	S += r15_t4>=r15_t4_in
	...
	r16_t4_in += alt(MM_in)
	r16_t4 = S.Task('r16_t4', length=4, delay_cost=1)
	r16_t4 += alt(MM)
	S += r16_t4>=r16_t4_in
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage1MAS5/EP2_YRECOVER/schedule2.png"
	if(S.solution() != []):
