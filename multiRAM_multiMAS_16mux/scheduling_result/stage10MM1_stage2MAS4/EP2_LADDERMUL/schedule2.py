...
def solve():
	...
	T8_t4_mem1 += alt(MAS_MEM)
	S += (T8_t3*MAS[0])-1 < T8_t4_mem1*MAS_MEM[1]
	S += (T8_t3*MAS[1])-1 < T8_t4_mem1*MAS_MEM[3]
	S += (T8_t3*MAS[2])-1 < T8_t4_mem1*MAS_MEM[5]
	S += (T8_t3*MAS[3])-1 < T8_t4_mem1*MAS_MEM[7]
	S += T8_t4_mem1 <= T8_t4
	...
	S += (T10_t3*MAS[3])-1 < T10_t4_mem1*MAS_MEM[7]
	...
	S += (T10*MAS[3])-1 < T16_t0_mem0*MAS_MEM[6]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM1_stage2MAS4/EP2_LADDERMUL/schedule2.png"
	if(S.solution() != []):
