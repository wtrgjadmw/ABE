...
def solve():
	...
	S += c_t4_t0_t5_mem0 >= 57
	c_t4_t0_t5_mem0 += MM_MEM[0]

	c_t4_t0_t5_mem1 = S.Task('c_t4_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t5_mem1 >= 57
	...
	S += c_t3_t1_t5_mem0 >= 73
	c_t3_t1_t5_mem0 += MM_MEM[0]

	c_t3_t1_t5_mem1 = S.Task('c_t3_t1_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t1_t5_mem1 >= 73
	...
	c_t611_mem0 += alt(MAS_MEM)
	S += (c_t311*MAS[0])-1 < c_t611_mem0*MAS_MEM[0]
	S += (c_t311*MAS[1])-1 < c_t611_mem0*MAS_MEM[2]
	S += (c_t311*MAS[2])-1 < c_t611_mem0*MAS_MEM[4]
	S += (c_t311*MAS[3])-1 < c_t611_mem0*MAS_MEM[6]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS4/MUL/schedule7.png"
	if(S.solution() != []):
