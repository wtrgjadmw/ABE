...
def solve():
	...
	S += (t171*MAS[0])-1 < c001_mem0*MAS_MEM[0]
	S += (t171*MAS[1])-1 < c001_mem0*MAS_MEM[2]
	S += (t171*MAS[2])-1 < c001_mem0*MAS_MEM[4]
	S += (t171*MAS[3])-1 < c001_mem0*MAS_MEM[6]
	S += c001_mem0 <= c001
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage3MAS4/SPARSE/schedule4.png"
	if(S.solution() != []):
