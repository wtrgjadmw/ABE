...
def solve():
	...
	c2_t0_t4_mem1 += alt(MAS_MEM)
	S += (c2_t0_t3*MAS[0])-1 < c2_t0_t4_mem1*MAS_MEM[1]
	S += (c2_t0_t3*MAS[1])-1 < c2_t0_t4_mem1*MAS_MEM[3]
	S += (c2_t0_t3*MAS[2])-1 < c2_t0_t4_mem1*MAS_MEM[5]
	S += (c2_t0_t3*MAS[3])-1 < c2_t0_t4_mem1*MAS_MEM[7]
