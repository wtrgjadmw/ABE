...
def solve():
	...
	t7_t2 = S.Task('t7_t2', length=10, delay_cost=1)
	S += t7_t2 >= 8
	t7_t2 += MM[0]
	...
	t7_t3 = S.Task('t7_t3', length=10, delay_cost=1)
	S += t7_t3 >= 14
	t7_t3 += MM[0]
	...
	S += t2_t3_mem0 >= 35
	t2_t3_mem0 += MAS_MEM[10]

	t2_t3_mem1 = S.Task('t2_t3_mem1', length=1, delay_cost=1)
	S += t2_t3_mem1 >= 35
	t2_t3_mem1 += MAS_MEM[13]
	...
	S += t12_t0_mem0 >= 36
	t12_t0_mem0 += MAS_MEM[4]

	t12_t0_mem1 = S.Task('t12_t0_mem1', length=1, delay_cost=1)
	S += t12_t0_mem1 >= 36
	t12_t0_mem1 += MAS_MEM[9]

	t18_t0 = S.Task('t18_t0', length=4, delay_cost=1)
	S += t18_t0 >= 36
	t18_t0 += MAS[0]
	...
	t12_t0 = S.Task('t12_t0', length=10, delay_cost=1)
	S += t12_t0 >= 37
	t12_t0 += MM[1]
	...
	S += t12_t1_mem1 >= 38
	t12_t1_mem1 += MAS_MEM[13]

	t12_t2 = S.Task('t12_t2', length=4, delay_cost=1)
	S += t12_t2 >= 38
	t12_t2 += MAS[7]
	...
	t12_t1 = S.Task('t12_t1', length=10, delay_cost=1)
	S += t12_t1 >= 39
	t12_t1 += MM[1]
	...
	t12_t3 = S.Task('t12_t3', length=4, delay_cost=1)
	S += t12_t3 >= 40
	t12_t3 += MAS[0]

	t18_t2 = S.Task('t18_t2', length=10, delay_cost=1)
	S += t18_t2 >= 40
	t18_t2 += MM[0]
	...
	t18_t5 = S.Task('t18_t5', length=4, delay_cost=1)
	S += t18_t5 >= 44
	t18_t5 += MAS[3]
	...
	t12_t5 = S.Task('t12_t5', length=4, delay_cost=1)
	t12_t5 += alt(MAS)
	...
	S += t12_t5_in*MAS_in[5]<=t12_t5*MAS[5]

	S += t12_t5_in*MAS_in[6]<=t12_t5*MAS[6]

	S += t12_t5_in*MAS_in[7]<=t12_t5*MAS[7]
	...
	S += (t21*MAS[5])-1 < t31_mem0*MAS_MEM[10]
	S += (t21*MAS[6])-1 < t31_mem0*MAS_MEM[12]
	S += (t21*MAS[7])-1 < t31_mem0*MAS_MEM[14]
	S += t31_mem0 <= t31
	...
	S += (t30*MAS[5])-1 < t40_mem0*MAS_MEM[10]
	S += (t30*MAS[6])-1 < t40_mem0*MAS_MEM[12]
	S += (t30*MAS[7])-1 < t40_mem0*MAS_MEM[14]
	S += t40_mem0 <= t40
	...
	S += (t12_t4*MM[1])-1 < t121_mem0*MM_MEM[2]
	S += t121_mem0 <= t121
	...
	S += (t12_t5*MAS[5])-1 < t121_mem1*MAS_MEM[11]
	S += (t12_t5*MAS[6])-1 < t121_mem1*MAS_MEM[13]
	S += (t12_t5*MAS[7])-1 < t121_mem1*MAS_MEM[15]
	S += t121_mem1 <= t121
	...
	S += (t120*MAS[5])-1 < t130_mem0*MAS_MEM[10]
	S += (t120*MAS[6])-1 < t130_mem0*MAS_MEM[12]
	S += (t120*MAS[7])-1 < t130_mem0*MAS_MEM[14]
	S += t130_mem0 <= t130
	...
	S += (t120*MAS[5])-1 < t130_mem1*MAS_MEM[11]
	S += (t120*MAS[6])-1 < t130_mem1*MAS_MEM[13]
	S += (t120*MAS[7])-1 < t130_mem1*MAS_MEM[15]
	S += t130_mem1 <= t130
	...
	S += (t31*MAS[5])-1 < t41_mem0*MAS_MEM[10]
	S += (t31*MAS[6])-1 < t41_mem0*MAS_MEM[12]
	S += (t31*MAS[7])-1 < t41_mem0*MAS_MEM[14]
	S += t41_mem0 <= t41
	...
	S += (t21*MAS[5])-1 < t41_mem1*MAS_MEM[11]
	S += (t21*MAS[6])-1 < t41_mem1*MAS_MEM[13]
	S += (t21*MAS[7])-1 < t41_mem1*MAS_MEM[15]
	S += t41_mem1 <= t41
	...
	S += (t121*MAS[5])-1 < t131_mem0*MAS_MEM[10]
	S += (t121*MAS[6])-1 < t131_mem0*MAS_MEM[12]
	S += (t121*MAS[7])-1 < t131_mem0*MAS_MEM[14]
	S += t131_mem0 <= t131
	...
	S += (t121*MAS[5])-1 < t131_mem1*MAS_MEM[11]
	S += (t121*MAS[6])-1 < t131_mem1*MAS_MEM[13]
	S += (t121*MAS[7])-1 < t131_mem1*MAS_MEM[15]
	S += t131_mem1 <= t131
	...
	S += new_TZ0_in*MAS_in[5]<=new_TZ0*MAS[5]

	S += new_TZ0_in*MAS_in[6]<=new_TZ0*MAS[6]

	S += new_TZ0_in*MAS_in[7]<=new_TZ0*MAS[7]
	...
	S += (t130*MAS[5])-1 < new_TZ0_mem0*MAS_MEM[10]
	S += (t130*MAS[6])-1 < new_TZ0_mem0*MAS_MEM[12]
	S += (t130*MAS[7])-1 < new_TZ0_mem0*MAS_MEM[14]
	...
	S += (t130*MAS[5])-1 < new_TZ0_mem1*MAS_MEM[11]
	S += (t130*MAS[6])-1 < new_TZ0_mem1*MAS_MEM[13]
	S += (t130*MAS[7])-1 < new_TZ0_mem1*MAS_MEM[15]
	...
	S += (t40*MAS[5])-1 < c000_mem1*MAS_MEM[11]
	S += (t40*MAS[6])-1 < c000_mem1*MAS_MEM[13]
	S += (t40*MAS[7])-1 < c000_mem1*MAS_MEM[15]
	S += c000_mem1 <= c000
	...
	S += (t40*MAS[5])-1 < t140_mem0*MAS_MEM[10]
	S += (t40*MAS[6])-1 < t140_mem0*MAS_MEM[12]
	S += (t40*MAS[7])-1 < t140_mem0*MAS_MEM[14]
	S += t140_mem0 <= t140
	...
	S += (t40*MAS[5])-1 < t140_mem1*MAS_MEM[11]
	S += (t40*MAS[6])-1 < t140_mem1*MAS_MEM[13]
	S += (t40*MAS[7])-1 < t140_mem1*MAS_MEM[15]
	S += t140_mem1 <= t140
	...
	S += new_TZ1_in*MAS_in[5]<=new_TZ1*MAS[5]

	S += new_TZ1_in*MAS_in[6]<=new_TZ1*MAS[6]

	S += new_TZ1_in*MAS_in[7]<=new_TZ1*MAS[7]
	...
	S += (t131*MAS[5])-1 < new_TZ1_mem0*MAS_MEM[10]
	S += (t131*MAS[6])-1 < new_TZ1_mem0*MAS_MEM[12]
	S += (t131*MAS[7])-1 < new_TZ1_mem0*MAS_MEM[14]
	...
	S += (t131*MAS[5])-1 < new_TZ1_mem1*MAS_MEM[11]
	S += (t131*MAS[6])-1 < new_TZ1_mem1*MAS_MEM[13]
	S += (t131*MAS[7])-1 < new_TZ1_mem1*MAS_MEM[15]
	...
	S += (t41*MAS[5])-1 < c001_mem1*MAS_MEM[11]
	S += (t41*MAS[6])-1 < c001_mem1*MAS_MEM[13]
	S += (t41*MAS[7])-1 < c001_mem1*MAS_MEM[15]
	S += c001_mem1 <= c001
	...
	S += (t41*MAS[5])-1 < t141_mem0*MAS_MEM[10]
	S += (t41*MAS[6])-1 < t141_mem0*MAS_MEM[12]
	S += (t41*MAS[7])-1 < t141_mem0*MAS_MEM[14]
	S += t141_mem0 <= t141
	...
	S += (t41*MAS[5])-1 < t141_mem1*MAS_MEM[11]
	S += (t41*MAS[6])-1 < t141_mem1*MAS_MEM[13]
	S += (t41*MAS[7])-1 < t141_mem1*MAS_MEM[15]
	S += t141_mem1 <= t141
	...
	S += (c000*MAS[5])-1 < t150_mem0*MAS_MEM[10]
	S += (c000*MAS[6])-1 < t150_mem0*MAS_MEM[12]
	S += (c000*MAS[7])-1 < t150_mem0*MAS_MEM[14]
	S += t150_mem0 <= t150
	...
	S += (t140*MAS[5])-1 < t150_mem1*MAS_MEM[11]
	S += (t140*MAS[6])-1 < t150_mem1*MAS_MEM[13]
	S += (t140*MAS[7])-1 < t150_mem1*MAS_MEM[15]
	S += t150_mem1 <= t150
	...
	S += t160_in*MAS_in[6]<=t160*MAS[6]

	S += t160_in*MAS_in[7]<=t160*MAS[7]
	...
	S += (c000*MAS[5])-1 < t160_mem1*MAS_MEM[11]
	S += (c000*MAS[6])-1 < t160_mem1*MAS_MEM[13]
	S += (c000*MAS[7])-1 < t160_mem1*MAS_MEM[15]
	S += t160_mem1 <= t160

	b30 = S.Task('b30', length=4, delay_cost=1)
	b30 += alt(MAS)
	...
	S += b30_in*MAS_in[5]<=b30*MAS[5]

	S += b30_in*MAS_in[6]<=b30*MAS[6]

	S += b30_in*MAS_in[7]<=b30*MAS[7]
	...
	S += (t140*MAS[5])-1 < b30_mem0*MAS_MEM[10]
	S += (t140*MAS[6])-1 < b30_mem0*MAS_MEM[12]
	S += (t140*MAS[7])-1 < b30_mem0*MAS_MEM[14]
	S += b30_mem0 <= b30
	...
	S += (t40*MAS[5])-1 < b30_mem1*MAS_MEM[11]
	S += (t40*MAS[6])-1 < b30_mem1*MAS_MEM[13]
	S += (t40*MAS[7])-1 < b30_mem1*MAS_MEM[15]
	S += b30_mem1 <= b30
	...
	S += (c001*MAS[5])-1 < t151_mem0*MAS_MEM[10]
	S += (c001*MAS[6])-1 < t151_mem0*MAS_MEM[12]
	S += (c001*MAS[7])-1 < t151_mem0*MAS_MEM[14]
	S += t151_mem0 <= t151
	...
	S += (t141*MAS[6])-1 < t151_mem1*MAS_MEM[13]
	S += (t141*MAS[7])-1 < t151_mem1*MAS_MEM[15]
	S += t151_mem1 <= t151
	...
	S += (t150*MAS[5])-1 < new_TX_t0_mem0*MAS_MEM[10]
	S += (t150*MAS[6])-1 < new_TX_t0_mem0*MAS_MEM[12]
	S += (t150*MAS[7])-1 < new_TX_t0_mem0*MAS_MEM[14]
	...
	S += (c001*MAS[5])-1 < t161_mem1*MAS_MEM[11]
	S += (c001*MAS[6])-1 < t161_mem1*MAS_MEM[13]
	S += (c001*MAS[7])-1 < t161_mem1*MAS_MEM[15]
	S += t161_mem1 <= t161

	b31 = S.Task('b31', length=4, delay_cost=1)
	b31 += alt(MAS)
	...
	S += b31_in*MAS_in[5]<=b31*MAS[5]

	S += b31_in*MAS_in[6]<=b31*MAS[6]

	S += b31_in*MAS_in[7]<=b31*MAS[7]
	...
	S += (t141*MAS[5])-1 < b31_mem0*MAS_MEM[10]
	S += (t141*MAS[6])-1 < b31_mem0*MAS_MEM[12]
	S += (t141*MAS[7])-1 < b31_mem0*MAS_MEM[14]
	S += b31_mem0 <= b31
	...
	S += (t41*MAS[5])-1 < b31_mem1*MAS_MEM[11]
	S += (t41*MAS[6])-1 < b31_mem1*MAS_MEM[13]
	S += (t41*MAS[7])-1 < b31_mem1*MAS_MEM[15]
	S += b31_mem1 <= b31
	...
	S += (b30*MAS[5])-1 < t17_t0_mem0*MAS_MEM[10]
	S += (b30*MAS[6])-1 < t17_t0_mem0*MAS_MEM[12]
	S += (b30*MAS[7])-1 < t17_t0_mem0*MAS_MEM[14]
	...
	S += (t160*MAS[5])-1 < t17_t0_mem1*MAS_MEM[11]
	S += (t160*MAS[6])-1 < t17_t0_mem1*MAS_MEM[13]
	S += (t160*MAS[7])-1 < t17_t0_mem1*MAS_MEM[15]
	...
	S += (t151*MAS[5])-1 < new_TX_t1_mem0*MAS_MEM[10]
	S += (t151*MAS[6])-1 < new_TX_t1_mem0*MAS_MEM[12]
	S += (t151*MAS[7])-1 < new_TX_t1_mem0*MAS_MEM[14]
	...
	S += new_TX_t2_in*MAS_in[5]<=new_TX_t2*MAS[5]

	S += new_TX_t2_in*MAS_in[6]<=new_TX_t2*MAS[6]

	S += new_TX_t2_in*MAS_in[7]<=new_TX_t2*MAS[7]
	...
	S += (t150*MAS[5])-1 < new_TX_t2_mem0*MAS_MEM[10]
	S += (t150*MAS[6])-1 < new_TX_t2_mem0*MAS_MEM[12]
	S += (t150*MAS[7])-1 < new_TX_t2_mem0*MAS_MEM[14]
	...
	S += (t151*MAS[5])-1 < new_TX_t2_mem1*MAS_MEM[11]
	S += (t151*MAS[6])-1 < new_TX_t2_mem1*MAS_MEM[13]
	S += (t151*MAS[7])-1 < new_TX_t2_mem1*MAS_MEM[15]
	...
	S += (b31*MAS[5])-1 < t17_t1_mem0*MAS_MEM[10]
	S += (b31*MAS[6])-1 < t17_t1_mem0*MAS_MEM[12]
	S += (b31*MAS[7])-1 < t17_t1_mem0*MAS_MEM[14]
	...
	S += (t161*MAS[5])-1 < t17_t1_mem1*MAS_MEM[11]
	S += (t161*MAS[6])-1 < t17_t1_mem1*MAS_MEM[13]
	S += (t161*MAS[7])-1 < t17_t1_mem1*MAS_MEM[15]
	...
	S += (b30*MAS[5])-1 < t17_t2_mem0*MAS_MEM[10]
	S += (b30*MAS[6])-1 < t17_t2_mem0*MAS_MEM[12]
	S += (b30*MAS[7])-1 < t17_t2_mem0*MAS_MEM[14]
	...
	S += (b31*MAS[5])-1 < t17_t2_mem1*MAS_MEM[11]
	S += (b31*MAS[6])-1 < t17_t2_mem1*MAS_MEM[13]
	S += (b31*MAS[7])-1 < t17_t2_mem1*MAS_MEM[15]
	...
	S += (t160*MAS[5])-1 < t17_t3_mem0*MAS_MEM[10]
	S += (t160*MAS[6])-1 < t17_t3_mem0*MAS_MEM[12]
	S += (t160*MAS[7])-1 < t17_t3_mem0*MAS_MEM[14]
	...
	S += (t161*MAS[5])-1 < t17_t3_mem1*MAS_MEM[11]
	S += (t161*MAS[6])-1 < t17_t3_mem1*MAS_MEM[13]
	S += (t161*MAS[7])-1 < t17_t3_mem1*MAS_MEM[15]
	...
	S += (new_TX_t2*MAS[5])-1 < new_TX_t4_mem0*MAS_MEM[10]
	S += (new_TX_t2*MAS[6])-1 < new_TX_t4_mem0*MAS_MEM[12]
	S += (new_TX_t2*MAS[7])-1 < new_TX_t4_mem0*MAS_MEM[14]
	...
	S += new_TX0_in*MAS_in[5]<=new_TX0*MAS[5]

	S += new_TX0_in*MAS_in[6]<=new_TX0*MAS[6]

	S += new_TX0_in*MAS_in[7]<=new_TX0*MAS[7]
	...
	S += new_TX_t5_in*MAS_in[5]<=new_TX_t5*MAS[5]

	S += new_TX_t5_in*MAS_in[6]<=new_TX_t5*MAS[6]

	S += new_TX_t5_in*MAS_in[7]<=new_TX_t5*MAS[7]
	...
	S += (t17_t2*MAS[5])-1 < t17_t4_mem0*MAS_MEM[10]
	S += (t17_t2*MAS[6])-1 < t17_t4_mem0*MAS_MEM[12]
	S += (t17_t2*MAS[7])-1 < t17_t4_mem0*MAS_MEM[14]
	...
	S += (t17_t3*MAS[5])-1 < t17_t4_mem1*MAS_MEM[11]
	S += (t17_t3*MAS[6])-1 < t17_t4_mem1*MAS_MEM[13]
	S += (t17_t3*MAS[7])-1 < t17_t4_mem1*MAS_MEM[15]
	...
	S += t170_in*MAS_in[6]<=t170*MAS[6]

	S += t170_in*MAS_in[7]<=t170*MAS[7]

	t170_mem0 = S.Task('t170_mem0', length=1, delay_cost=1)
	t170_mem0 += alt(MM_MEM)
	S += (t17_t0*MM[0])-1 < t170_mem0*MM_MEM[0]
	S += (t17_t0*MM[1])-1 < t170_mem0*MM_MEM[2]
	S += t170_mem0 <= t170
	...
	S += t17_t5_in*MAS_in[6]<=t17_t5*MAS[6]

	S += t17_t5_in*MAS_in[7]<=t17_t5*MAS[7]

	t17_t5_mem0 = S.Task('t17_t5_mem0', length=1, delay_cost=1)
	t17_t5_mem0 += alt(MM_MEM)
	S += (t17_t0*MM[0])-1 < t17_t5_mem0*MM_MEM[0]
	S += (t17_t0*MM[1])-1 < t17_t5_mem0*MM_MEM[2]
	...
	S += new_TX1_in*MAS_in[5]<=new_TX1*MAS[5]

	S += new_TX1_in*MAS_in[6]<=new_TX1*MAS[6]

	S += new_TX1_in*MAS_in[7]<=new_TX1*MAS[7]
	...
	S += (new_TX_t5*MAS[5])-1 < new_TX1_mem1*MAS_MEM[11]
	S += (new_TX_t5*MAS[6])-1 < new_TX1_mem1*MAS_MEM[13]
	S += (new_TX_t5*MAS[7])-1 < new_TX1_mem1*MAS_MEM[15]
	...
	S += t171_in*MAS_in[6]<=t171*MAS[6]

	S += t171_in*MAS_in[7]<=t171*MAS[7]
	...
	S += (t170*MAS[5])-1 < new_TY0_mem0*MAS_MEM[10]
	S += (t170*MAS[6])-1 < new_TY0_mem0*MAS_MEM[12]
	S += (t170*MAS[7])-1 < new_TY0_mem0*MAS_MEM[14]
	...
	S += (t180*MAS[5])-1 < new_TY0_mem1*MAS_MEM[11]
	S += (t180*MAS[6])-1 < new_TY0_mem1*MAS_MEM[13]
	S += (t180*MAS[7])-1 < new_TY0_mem1*MAS_MEM[15]
	...
	S += (t171*MAS[5])-1 < new_TY1_mem0*MAS_MEM[10]
	S += (t171*MAS[6])-1 < new_TY1_mem0*MAS_MEM[12]
	S += (t171*MAS[7])-1 < new_TY1_mem0*MAS_MEM[14]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
