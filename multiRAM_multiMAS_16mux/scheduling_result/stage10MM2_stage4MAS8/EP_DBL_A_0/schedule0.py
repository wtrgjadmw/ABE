...
def solve():
	...
	S += (t5*MAS[5])-1 < t6_mem0*MAS_MEM[10]
	S += (t5*MAS[6])-1 < t6_mem0*MAS_MEM[12]
	S += (t5*MAS[7])-1 < t6_mem0*MAS_MEM[14]
	S += t6_mem0 <= t6

	t6_mem1 = S.Task('t6_mem1', length=1, delay_cost=1)
	t6_mem1 += alt(MAS_MEM)
	S += (t5*MAS[0])-1 < t6_mem1*MAS_MEM[1]
	S += (t5*MAS[1])-1 < t6_mem1*MAS_MEM[3]
	S += (t5*MAS[2])-1 < t6_mem1*MAS_MEM[5]
	S += (t5*MAS[3])-1 < t6_mem1*MAS_MEM[7]
	S += (t5*MAS[4])-1 < t6_mem1*MAS_MEM[9]
	S += (t5*MAS[5])-1 < t6_mem1*MAS_MEM[11]
	S += (t5*MAS[6])-1 < t6_mem1*MAS_MEM[13]
	S += (t5*MAS[7])-1 < t6_mem1*MAS_MEM[15]
	S += t6_mem1 <= t6
	...
	S += (t6*MAS[5])-1 < t7_mem0*MAS_MEM[10]
	S += (t6*MAS[6])-1 < t7_mem0*MAS_MEM[12]
	S += (t6*MAS[7])-1 < t7_mem0*MAS_MEM[14]
	S += t7_mem0 <= t7
	...
	S += (t7*MAS[5])-1 < t8_mem1*MAS_MEM[11]
	S += (t7*MAS[6])-1 < t8_mem1*MAS_MEM[13]
	S += (t7*MAS[7])-1 < t8_mem1*MAS_MEM[15]
	S += t8_mem1 <= t8
	...
	S += new_PZ_in*MM_in[1]<=new_PZ*MM[1]
	S += 0<new_PZ
	...
	S += (t1*MM[1])-1 < new_PZ_mem0*MM_MEM[2]
	...
	S += (t7*MAS[5])-1 < new_PZ_mem1*MAS_MEM[11]
	S += (t7*MAS[6])-1 < new_PZ_mem1*MAS_MEM[13]
	S += (t7*MAS[7])-1 < new_PZ_mem1*MAS_MEM[15]
	...
	S += (t9*MAS[5])-1 < t13_mem1*MAS_MEM[11]
	S += (t9*MAS[6])-1 < t13_mem1*MAS_MEM[13]
	S += (t9*MAS[7])-1 < t13_mem1*MAS_MEM[15]
	S += t13_mem1 <= t13
	...
	S += (t14*MM[1])-1 < new_PX_mem0*MM_MEM[2]
	...
	S += (t14*MM[1])-1 < new_PX_mem1*MM_MEM[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/EP_DBL_A_0/schedule0.png"
	if(S.solution() != []):
