...
def solve():
	...
	S += d_t4_t2_t4_mem0 >= 65
	d_t4_t2_t4_mem0 += MAS_MEM[10]

	d_t4_t2_t4_mem1 = S.Task('d_t4_t2_t4_mem1', length=1, delay_cost=1)
	S += d_t4_t2_t4_mem1 >= 65
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_LADDERMUL/schedule12.png"
	if(S.solution() != []):
