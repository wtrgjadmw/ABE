...
def solve():
	...
	S += c_pbccb01_mem0 >= 135
	c_pbccb01_mem0 += MAS_MEM[12]

	c_pbccb01_mem1 = S.Task('c_pbccb01_mem1', length=1, delay_cost=1)
	S += c_pbccb01_mem1 >= 135
	c_pbccb01_mem1 += MAS_MEM[11]
	...
	S += c_pxi_y1_1_mem0 >= 141
	c_pxi_y1_1_mem0 += MAS_MEM[10]

	c_pxi_y1_1_mem1 = S.Task('c_pxi_y1_1_mem1', length=1, delay_cost=1)
	S += c_pxi_y1_1_mem1 >= 141
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
