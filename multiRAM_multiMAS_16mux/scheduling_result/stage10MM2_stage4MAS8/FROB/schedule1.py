...
def solve():
	...
	c10_t5 = S.Task('c10_t5', length=4, delay_cost=1)
	c10_t5 += alt(MAS)
	...
	c20_t5 = S.Task('c20_t5', length=4, delay_cost=1)
	c20_t5 += alt(MAS)
	...
	c01_t5 = S.Task('c01_t5', length=4, delay_cost=1)
	c01_t5 += alt(MAS)
	...
	c11_t5 = S.Task('c11_t5', length=4, delay_cost=1)
	c11_t5 += alt(MAS)
	...
	c21_t5 = S.Task('c21_t5', length=4, delay_cost=1)
	c21_t5 += alt(MAS)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FROB/schedule1.png"
	if(S.solution() != []):
