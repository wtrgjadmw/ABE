...
def solve():
	...
	S += c_t4010_in*MAS_in[6]<=c_t4010*MAS[6]

	S += c_t4010_in*MAS_in[7]<=c_t4010*MAS[7]
	...
	S += c_t4011_in*MAS_in[6]<=c_t4011*MAS[6]

	S += c_t4011_in*MAS_in[7]<=c_t4011*MAS[7]
	...
	S += c_t5000_in*MAS_in[6]<=c_t5000*MAS[6]

	S += c_t5000_in*MAS_in[7]<=c_t5000*MAS[7]
	...
	S += c_t5001_in*MAS_in[6]<=c_t5001*MAS[6]

	S += c_t5001_in*MAS_in[7]<=c_t5001*MAS[7]
	...
	S += c_t5010_in*MAS_in[6]<=c_t5010*MAS[6]

	S += c_t5010_in*MAS_in[7]<=c_t5010*MAS[7]
	...
	S += c_t5011_in*MAS_in[6]<=c_t5011*MAS[6]

	S += c_t5011_in*MAS_in[7]<=c_t5011*MAS[7]
	...
	S += c_t0_t01_in*MAS_in[6]<=c_t0_t01*MAS[6]

	S += c_t0_t01_in*MAS_in[7]<=c_t0_t01*MAS[7]
	...
	S += c_t0_t2_t3_in*MAS_in[6]<=c_t0_t2_t3*MAS[6]

	S += c_t0_t2_t3_in*MAS_in[7]<=c_t0_t2_t3*MAS[7]
	...
	S += c_t0_t30_in*MAS_in[6]<=c_t0_t30*MAS[6]

	S += c_t0_t30_in*MAS_in[7]<=c_t0_t30*MAS[7]
	...
	S += c_t1_t01_in*MAS_in[6]<=c_t1_t01*MAS[6]

	S += c_t1_t01_in*MAS_in[7]<=c_t1_t01*MAS[7]
	...
	S += c_t1_t30_in*MAS_in[6]<=c_t1_t30*MAS[6]

	S += c_t1_t30_in*MAS_in[7]<=c_t1_t30*MAS[7]
	...
	S += c_t1_t3_t5_in*MAS_in[6]<=c_t1_t3_t5*MAS[6]

	S += c_t1_t3_t5_in*MAS_in[7]<=c_t1_t3_t5*MAS[7]

	c_t1_t3_t5_mem0 = S.Task('c_t1_t3_t5_mem0', length=1, delay_cost=1)
	c_t1_t3_t5_mem0 += MM_MEM[0]
	S += 19 < c_t1_t3_t5_mem0
	...
	S += c_t2_t01_in*MAS_in[6]<=c_t2_t01*MAS[6]

	S += c_t2_t01_in*MAS_in[7]<=c_t2_t01*MAS[7]
	...
	S += c_t2_t2_t3_in*MAS_in[6]<=c_t2_t2_t3*MAS[6]

	S += c_t2_t2_t3_in*MAS_in[7]<=c_t2_t2_t3*MAS[7]

	c_t2_t2_t3_mem0 = S.Task('c_t2_t2_t3_mem0', length=1, delay_cost=1)
	c_t2_t2_t3_mem0 += MAS_MEM[0]
	S += 16 < c_t2_t2_t3_mem0
	...
	S += c_t2_t30_in*MAS_in[6]<=c_t2_t30*MAS[6]

	S += c_t2_t30_in*MAS_in[7]<=c_t2_t30*MAS[7]
	...
	S += c_t3_a1_0_in*MAS_in[6]<=c_t3_a1_0*MAS[6]

	S += c_t3_a1_0_in*MAS_in[7]<=c_t3_a1_0*MAS[7]
	...
	S += c_t3_a1_1_in*MAS_in[6]<=c_t3_a1_1*MAS[6]

	S += c_t3_a1_1_in*MAS_in[7]<=c_t3_a1_1*MAS[7]
	...
	S += c_t3_t10_in*MAS_in[6]<=c_t3_t10*MAS[6]

	S += c_t3_t10_in*MAS_in[7]<=c_t3_t10*MAS[7]
	...
	S += c_t4_a1_0_in*MAS_in[6]<=c_t4_a1_0*MAS[6]

	S += c_t4_a1_0_in*MAS_in[7]<=c_t4_a1_0*MAS[7]
	...
	S += (c_t4010*MAS[6])-1 < c_t4_a1_0_mem0*MAS_MEM[12]
	S += (c_t4010*MAS[7])-1 < c_t4_a1_0_mem0*MAS_MEM[14]
	...
	S += (c_t4011*MAS[6])-1 < c_t4_a1_0_mem1*MAS_MEM[13]
	S += (c_t4011*MAS[7])-1 < c_t4_a1_0_mem1*MAS_MEM[15]
	...
	S += c_t4_a1_1_in*MAS_in[6]<=c_t4_a1_1*MAS[6]

	S += c_t4_a1_1_in*MAS_in[7]<=c_t4_a1_1*MAS[7]
	...
	S += (c_t4011*MAS[6])-1 < c_t4_a1_1_mem0*MAS_MEM[12]
	S += (c_t4011*MAS[7])-1 < c_t4_a1_1_mem0*MAS_MEM[14]
	...
	S += (c_t4010*MAS[6])-1 < c_t4_a1_1_mem1*MAS_MEM[13]
	S += (c_t4010*MAS[7])-1 < c_t4_a1_1_mem1*MAS_MEM[15]
	...
	S += c_t4_t10_in*MAS_in[6]<=c_t4_t10*MAS[6]

	S += c_t4_t10_in*MAS_in[7]<=c_t4_t10*MAS[7]
	...
	S += (c_t4010*MAS[6])-1 < c_t4_t10_mem1*MAS_MEM[13]
	S += (c_t4010*MAS[7])-1 < c_t4_t10_mem1*MAS_MEM[15]
	...
	S += (c_t4011*MAS[6])-1 < c_t4_t11_mem1*MAS_MEM[13]
	S += (c_t4011*MAS[7])-1 < c_t4_t11_mem1*MAS_MEM[15]
	...
	S += (c_t4010*MAS[6])-1 < c_t4_t3_t0_mem1*MAS_MEM[13]
	S += (c_t4010*MAS[7])-1 < c_t4_t3_t0_mem1*MAS_MEM[15]
	...
	S += (c_t4011*MAS[6])-1 < c_t4_t3_t1_mem1*MAS_MEM[13]
	S += (c_t4011*MAS[7])-1 < c_t4_t3_t1_mem1*MAS_MEM[15]
	...
	S += c_t4_t3_t3_in*MAS_in[6]<=c_t4_t3_t3*MAS[6]

	S += c_t4_t3_t3_in*MAS_in[7]<=c_t4_t3_t3*MAS[7]
	...
	S += (c_t4010*MAS[6])-1 < c_t4_t3_t3_mem0*MAS_MEM[12]
	S += (c_t4010*MAS[7])-1 < c_t4_t3_t3_mem0*MAS_MEM[14]
	...
	S += (c_t4011*MAS[6])-1 < c_t4_t3_t3_mem1*MAS_MEM[13]
	S += (c_t4011*MAS[7])-1 < c_t4_t3_t3_mem1*MAS_MEM[15]
	...
	S += c_t5_a1_0_in*MAS_in[6]<=c_t5_a1_0*MAS[6]

	S += c_t5_a1_0_in*MAS_in[7]<=c_t5_a1_0*MAS[7]
	...
	S += (c_t5010*MAS[6])-1 < c_t5_a1_0_mem0*MAS_MEM[12]
	S += (c_t5010*MAS[7])-1 < c_t5_a1_0_mem0*MAS_MEM[14]
	...
	S += (c_t5011*MAS[6])-1 < c_t5_a1_0_mem1*MAS_MEM[13]
	S += (c_t5011*MAS[7])-1 < c_t5_a1_0_mem1*MAS_MEM[15]
	...
	S += c_t5_a1_1_in*MAS_in[6]<=c_t5_a1_1*MAS[6]

	S += c_t5_a1_1_in*MAS_in[7]<=c_t5_a1_1*MAS[7]
	...
	S += (c_t5011*MAS[6])-1 < c_t5_a1_1_mem0*MAS_MEM[12]
	S += (c_t5011*MAS[7])-1 < c_t5_a1_1_mem0*MAS_MEM[14]
	...
	S += (c_t5010*MAS[6])-1 < c_t5_a1_1_mem1*MAS_MEM[13]
	S += (c_t5010*MAS[7])-1 < c_t5_a1_1_mem1*MAS_MEM[15]
	...
	S += c_t5_t10_in*MAS_in[6]<=c_t5_t10*MAS[6]

	S += c_t5_t10_in*MAS_in[7]<=c_t5_t10*MAS[7]
	...
	S += (c_t5000*MAS[6])-1 < c_t5_t10_mem0*MAS_MEM[12]
	S += (c_t5000*MAS[7])-1 < c_t5_t10_mem0*MAS_MEM[14]
	...
	S += (c_t5010*MAS[6])-1 < c_t5_t10_mem1*MAS_MEM[13]
	S += (c_t5010*MAS[7])-1 < c_t5_t10_mem1*MAS_MEM[15]
	...
	S += (c_t5001*MAS[6])-1 < c_t5_t11_mem0*MAS_MEM[12]
	S += (c_t5001*MAS[7])-1 < c_t5_t11_mem0*MAS_MEM[14]
	...
	S += (c_t5011*MAS[6])-1 < c_t5_t11_mem1*MAS_MEM[13]
	S += (c_t5011*MAS[7])-1 < c_t5_t11_mem1*MAS_MEM[15]
	...
	S += (c_t5000*MAS[6])-1 < c_t5_t3_t0_mem0*MAS_MEM[12]
	S += (c_t5000*MAS[7])-1 < c_t5_t3_t0_mem0*MAS_MEM[14]
	...
	S += (c_t5010*MAS[6])-1 < c_t5_t3_t0_mem1*MAS_MEM[13]
	S += (c_t5010*MAS[7])-1 < c_t5_t3_t0_mem1*MAS_MEM[15]
	...
	S += (c_t5001*MAS[6])-1 < c_t5_t3_t1_mem0*MAS_MEM[12]
	S += (c_t5001*MAS[7])-1 < c_t5_t3_t1_mem0*MAS_MEM[14]
	...
	S += (c_t5011*MAS[6])-1 < c_t5_t3_t1_mem1*MAS_MEM[13]
	S += (c_t5011*MAS[7])-1 < c_t5_t3_t1_mem1*MAS_MEM[15]
	...
	S += c_t5_t3_t2_in*MAS_in[6]<=c_t5_t3_t2*MAS[6]

	S += c_t5_t3_t2_in*MAS_in[7]<=c_t5_t3_t2*MAS[7]
	...
	S += (c_t5000*MAS[6])-1 < c_t5_t3_t2_mem0*MAS_MEM[12]
	S += (c_t5000*MAS[7])-1 < c_t5_t3_t2_mem0*MAS_MEM[14]
	...
	S += (c_t5001*MAS[6])-1 < c_t5_t3_t2_mem1*MAS_MEM[13]
	S += (c_t5001*MAS[7])-1 < c_t5_t3_t2_mem1*MAS_MEM[15]
	...
	S += c_t5_t3_t3_in*MAS_in[6]<=c_t5_t3_t3*MAS[6]

	S += c_t5_t3_t3_in*MAS_in[7]<=c_t5_t3_t3*MAS[7]
	...
	S += (c_t5010*MAS[6])-1 < c_t5_t3_t3_mem0*MAS_MEM[12]
	S += (c_t5010*MAS[7])-1 < c_t5_t3_t3_mem0*MAS_MEM[14]
	...
	S += (c_t5011*MAS[6])-1 < c_t5_t3_t3_mem1*MAS_MEM[13]
	S += (c_t5011*MAS[7])-1 < c_t5_t3_t3_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/SQR/schedule1.png"
	if(S.solution() != []):
