...
def solve():
	...
	S += c_t0_t21_in*MAS_in[5]<=c_t0_t21*MAS[5]

	S += c_t0_t21_in*MAS_in[6]<=c_t0_t21*MAS[6]

	S += c_t0_t21_in*MAS_in[7]<=c_t0_t21*MAS[7]
	...
	S += c_t0_t50_in*MAS_in[6]<=c_t0_t50*MAS[6]

	S += c_t0_t50_in*MAS_in[7]<=c_t0_t50*MAS[7]
	...
	S += c_t1_t21_in*MAS_in[5]<=c_t1_t21*MAS[5]

	S += c_t1_t21_in*MAS_in[6]<=c_t1_t21*MAS[6]

	S += c_t1_t21_in*MAS_in[7]<=c_t1_t21*MAS[7]
	...
	S += c_t1_t50_in*MAS_in[6]<=c_t1_t50*MAS[6]

	S += c_t1_t50_in*MAS_in[7]<=c_t1_t50*MAS[7]
	...
	S += c_t2_t21_in*MAS_in[6]<=c_t2_t21*MAS[6]

	S += c_t2_t21_in*MAS_in[7]<=c_t2_t21*MAS[7]
	...
	S += c_t2_t50_in*MAS_in[6]<=c_t2_t50*MAS[6]

	S += c_t2_t50_in*MAS_in[7]<=c_t2_t50*MAS[7]
	...
	S += c_t4_t2_t5_in*MAS_in[5]<=c_t4_t2_t5*MAS[5]

	S += c_t4_t2_t5_in*MAS_in[6]<=c_t4_t2_t5*MAS[6]

	S += c_t4_t2_t5_in*MAS_in[7]<=c_t4_t2_t5*MAS[7]
	...
	S += c_t5_t20_in*MAS_in[5]<=c_t5_t20*MAS[5]

	S += c_t5_t20_in*MAS_in[6]<=c_t5_t20*MAS[6]

	S += c_t5_t20_in*MAS_in[7]<=c_t5_t20*MAS[7]
	...
	S += c_s0011_in*MAS_in[5]<=c_s0011*MAS[5]

	S += c_s0011_in*MAS_in[6]<=c_s0011*MAS[6]

	S += c_s0011_in*MAS_in[7]<=c_s0011*MAS[7]
	...
	S += c_s010_in*MAS_in[5]<=c_s010*MAS[5]

	S += c_s010_in*MAS_in[6]<=c_s010*MAS[6]

	S += c_s010_in*MAS_in[7]<=c_s010*MAS[7]
	...
	S += c_s1011_in*MAS_in[5]<=c_s1011*MAS[5]

	S += c_s1011_in*MAS_in[6]<=c_s1011*MAS[6]

	S += c_s1011_in*MAS_in[7]<=c_s1011*MAS[7]
	...
	S += c_s1110_in*MAS_in[5]<=c_s1110*MAS[5]

	S += c_s1110_in*MAS_in[6]<=c_s1110*MAS[6]

	S += c_s1110_in*MAS_in[7]<=c_s1110*MAS[7]
	...
	S += c_s2011_in*MAS_in[5]<=c_s2011*MAS[5]

	S += c_s2011_in*MAS_in[6]<=c_s2011*MAS[6]

	S += c_s2011_in*MAS_in[7]<=c_s2011*MAS[7]
	...
	S += c_s210_in*MAS_in[5]<=c_s210*MAS[5]

	S += c_s210_in*MAS_in[6]<=c_s210*MAS[6]

	S += c_s210_in*MAS_in[7]<=c_s210*MAS[7]
	...
	S += c_t6_y1_0_in*MAS_in[5]<=c_t6_y1_0*MAS[5]

	S += c_t6_y1_0_in*MAS_in[6]<=c_t6_y1_0*MAS[6]

	S += c_t6_y1_0_in*MAS_in[7]<=c_t6_y1_0*MAS[7]
	...
	S += c_t6_y1_1_in*MAS_in[5]<=c_t6_y1_1*MAS[5]

	S += c_t6_y1_1_in*MAS_in[6]<=c_t6_y1_1*MAS[6]

	S += c_t6_y1_1_in*MAS_in[7]<=c_t6_y1_1*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/SQR/schedule4.png"
	if(S.solution() != []):
