...
def solve():
	...
	# new tasks
	c0_t41 = S.Task('c0_t41', length=4, delay_cost=1)
	c0_t41 += alt(MAS)
	...
	S += c0_t41_in*MAS_in[6]<=c0_t41*MAS[6]

	S += c0_t41_in*MAS_in[7]<=c0_t41*MAS[7]
	...
	c0_s00 = S.Task('c0_s00', length=4, delay_cost=1)
	c0_s00 += alt(MAS)
	...
	S += c0_s00_in*MAS_in[6]<=c0_s00*MAS[6]

	S += c0_s00_in*MAS_in[7]<=c0_s00*MAS[7]

	c0_s00_mem0 = S.Task('c0_s00_mem0', length=1, delay_cost=1)
	c0_s00_mem0 += MAS_MEM[10]
	S += 59 < c0_s00_mem0
	...
	c0_s01 = S.Task('c0_s01', length=4, delay_cost=1)
	c0_s01 += alt(MAS)
	...
	S += c0_s01_in*MAS_in[6]<=c0_s01*MAS[6]

	S += c0_s01_in*MAS_in[7]<=c0_s01*MAS[7]

	c0_s01_mem0 = S.Task('c0_s01_mem0', length=1, delay_cost=1)
	c0_s01_mem0 += MAS_MEM[10]
	S += 59 < c0_s01_mem0
	...
	c0_t51 = S.Task('c0_t51', length=4, delay_cost=1)
	c0_t51 += alt(MAS)
	...
	S += c0_t51_in*MAS_in[6]<=c0_t51*MAS[6]

	S += c0_t51_in*MAS_in[7]<=c0_t51*MAS[7]

	c0_t51_mem0 = S.Task('c0_t51_mem0', length=1, delay_cost=1)
	c0_t51_mem0 += MAS_MEM[10]
	S += 57 < c0_t51_mem0
	...
	c1_t41 = S.Task('c1_t41', length=4, delay_cost=1)
	c1_t41 += alt(MAS)
	...
	S += c1_t41_in*MAS_in[6]<=c1_t41*MAS[6]

	S += c1_t41_in*MAS_in[7]<=c1_t41*MAS[7]
	...
	c1_t41_mem1 += MAS_MEM[11]
	S += 63 < c1_t41_mem1
	S += c1_t41_mem1 <= c1_t41

	c1_s00 = S.Task('c1_s00', length=4, delay_cost=1)
	c1_s00 += alt(MAS)
	...
	S += c1_s00_in*MAS_in[6]<=c1_s00*MAS[6]

	S += c1_s00_in*MAS_in[7]<=c1_s00*MAS[7]

	c1_s00_mem0 = S.Task('c1_s00_mem0', length=1, delay_cost=1)
	c1_s00_mem0 += MAS_MEM[14]
	S += 58 < c1_s00_mem0
	S += c1_s00_mem0 <= c1_s00

	c1_s00_mem1 = S.Task('c1_s00_mem1', length=1, delay_cost=1)
	c1_s00_mem1 += MAS_MEM[7]
	S += 65 < c1_s00_mem1
	S += c1_s00_mem1 <= c1_s00

	c1_s01 = S.Task('c1_s01', length=4, delay_cost=1)
	c1_s01 += alt(MAS)
	...
	S += c1_s01_in*MAS_in[6]<=c1_s01*MAS[6]

	S += c1_s01_in*MAS_in[7]<=c1_s01*MAS[7]

	c1_s01_mem0 = S.Task('c1_s01_mem0', length=1, delay_cost=1)
	c1_s01_mem0 += MAS_MEM[14]
	S += 58 < c1_s01_mem0
	S += c1_s01_mem0 <= c1_s01

	c1_s01_mem1 = S.Task('c1_s01_mem1', length=1, delay_cost=1)
	c1_s01_mem1 += MAS_MEM[7]
	S += 65 < c1_s01_mem1
	S += c1_s01_mem1 <= c1_s01

	c1_t51 = S.Task('c1_t51', length=4, delay_cost=1)
	c1_t51 += alt(MAS)
	...
	c2_t41 = S.Task('c2_t41', length=4, delay_cost=1)
	c2_t41 += alt(MAS)
	...
	S += c2_t41_in*MAS_in[6]<=c2_t41*MAS[6]

	S += c2_t41_in*MAS_in[7]<=c2_t41*MAS[7]
	...
	c2_s00 = S.Task('c2_s00', length=4, delay_cost=1)
	c2_s00 += alt(MAS)
	...
	S += c2_s00_in*MAS_in[6]<=c2_s00*MAS[6]

	S += c2_s00_in*MAS_in[7]<=c2_s00*MAS[7]
	...
	c2_s01 = S.Task('c2_s01', length=4, delay_cost=1)
	c2_s01 += alt(MAS)
	...
	S += c2_s01_in*MAS_in[6]<=c2_s01*MAS[6]

	S += c2_s01_in*MAS_in[7]<=c2_s01*MAS[7]
	...
	c2_t51 = S.Task('c2_t51', length=4, delay_cost=1)
	c2_t51 += alt(MAS)
	...
	S += c2_t51_in*MAS_in[6]<=c2_t51*MAS[6]

	S += c2_t51_in*MAS_in[7]<=c2_t51*MAS[7]
	...
	S += (c0_s00*MAS[6])-1 < c000_mem1*MAS_MEM[13]
	S += (c0_s00*MAS[7])-1 < c000_mem1*MAS_MEM[15]
	S += c000_mem1 <= c000
	...
	S += (c0_s01*MAS[6])-1 < c001_mem1*MAS_MEM[13]
	S += (c0_s01*MAS[7])-1 < c001_mem1*MAS_MEM[15]
	S += c001_mem1 <= c001
	...
	S += (c0_t41*MAS[6])-1 < c011_mem0*MAS_MEM[12]
	S += (c0_t41*MAS[7])-1 < c011_mem0*MAS_MEM[14]
	S += c011_mem0 <= c011
	...
	S += (c0_t51*MAS[6])-1 < c011_mem1*MAS_MEM[13]
	S += (c0_t51*MAS[7])-1 < c011_mem1*MAS_MEM[15]
	S += c011_mem1 <= c011
	...
	S += (c1_s00*MAS[6])-1 < c100_mem1*MAS_MEM[13]
	S += (c1_s00*MAS[7])-1 < c100_mem1*MAS_MEM[15]
	S += c100_mem1 <= c100
	...
	S += (c1_s01*MAS[6])-1 < c101_mem1*MAS_MEM[13]
	S += (c1_s01*MAS[7])-1 < c101_mem1*MAS_MEM[15]
	S += c101_mem1 <= c101
	...
	S += (c1_t41*MAS[6])-1 < c111_mem0*MAS_MEM[12]
	S += (c1_t41*MAS[7])-1 < c111_mem0*MAS_MEM[14]
	S += c111_mem0 <= c111
	...
	S += (c1_t51*MAS[6])-1 < c111_mem1*MAS_MEM[13]
	S += (c1_t51*MAS[7])-1 < c111_mem1*MAS_MEM[15]
	S += c111_mem1 <= c111
	...
	S += (c2_s00*MAS[6])-1 < c200_mem1*MAS_MEM[13]
	S += (c2_s00*MAS[7])-1 < c200_mem1*MAS_MEM[15]
	S += c200_mem1 <= c200
	...
	S += (c2_s01*MAS[6])-1 < c201_mem1*MAS_MEM[13]
	S += (c2_s01*MAS[7])-1 < c201_mem1*MAS_MEM[15]
	S += c201_mem1 <= c201
	...
	S += (c2_t41*MAS[6])-1 < c211_mem0*MAS_MEM[12]
	S += (c2_t41*MAS[7])-1 < c211_mem0*MAS_MEM[14]
	S += c211_mem0 <= c211
	...
	S += (c2_t51*MAS[6])-1 < c211_mem1*MAS_MEM[13]
	S += (c2_t51*MAS[7])-1 < c211_mem1*MAS_MEM[15]
	S += c211_mem1 <= c211
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_INV_AFTER_FPINV/schedule3.png"
	if(S.solution() != []):
