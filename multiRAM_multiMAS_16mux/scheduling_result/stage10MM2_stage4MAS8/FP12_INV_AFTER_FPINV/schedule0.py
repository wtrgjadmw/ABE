...
def solve():
	...
	S += c_qinv0_t2_in*MAS_in[6]<=c_qinv0_t2*MAS[6]

	S += c_qinv0_t2_in*MAS_in[7]<=c_qinv0_t2*MAS[7]
	...
	S += c_qinv1__t2_in*MAS_in[6]<=c_qinv1__t2*MAS[6]

	S += c_qinv1__t2_in*MAS_in[7]<=c_qinv1__t2*MAS[7]
	...
	S += c0_t0_t2_in*MAS_in[6]<=c0_t0_t2*MAS[6]

	S += c0_t0_t2_in*MAS_in[7]<=c0_t0_t2*MAS[7]
	...
	S += c0_t1_t2_in*MAS_in[6]<=c0_t1_t2*MAS[6]

	S += c0_t1_t2_in*MAS_in[7]<=c0_t1_t2*MAS[7]
	...
	S += c1_t0_t2_in*MAS_in[6]<=c1_t0_t2*MAS[6]

	S += c1_t0_t2_in*MAS_in[7]<=c1_t0_t2*MAS[7]
	...
	S += c1_t1_t2_in*MAS_in[6]<=c1_t1_t2*MAS[6]

	S += c1_t1_t2_in*MAS_in[7]<=c1_t1_t2*MAS[7]
	...
	S += c1_t20_in*MAS_in[6]<=c1_t20*MAS[6]

	S += c1_t20_in*MAS_in[7]<=c1_t20*MAS[7]
	...
	S += c1_t21_in*MAS_in[6]<=c1_t21*MAS[6]

	S += c1_t21_in*MAS_in[7]<=c1_t21*MAS[7]
	...
	S += c2_t0_t2_in*MAS_in[6]<=c2_t0_t2*MAS[6]

	S += c2_t0_t2_in*MAS_in[7]<=c2_t0_t2*MAS[7]
	...
	S += c2_t1_t2_in*MAS_in[6]<=c2_t1_t2*MAS[6]

	S += c2_t1_t2_in*MAS_in[7]<=c2_t1_t2*MAS[7]
	...
	S += c_qinv0_t3_in*MAS_in[6]<=c_qinv0_t3*MAS[6]

	S += c_qinv0_t3_in*MAS_in[7]<=c_qinv0_t3*MAS[7]
	...
	S += c_qinv1__t3_in*MAS_in[6]<=c_qinv1__t3*MAS[6]

	S += c_qinv1__t3_in*MAS_in[7]<=c_qinv1__t3*MAS[7]
	...
	S += c1_t4_t2_in*MAS_in[6]<=c1_t4_t2*MAS[6]

	S += c1_t4_t2_in*MAS_in[7]<=c1_t4_t2*MAS[7]
	...
	S += (c1_t20*MAS[6])-1 < c1_t4_t2_mem0*MAS_MEM[12]
	S += (c1_t20*MAS[7])-1 < c1_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c1_t21*MAS[6])-1 < c1_t4_t2_mem1*MAS_MEM[13]
	S += (c1_t21*MAS[7])-1 < c1_t4_t2_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_INV_AFTER_FPINV/schedule0.png"
	if(S.solution() != []):
