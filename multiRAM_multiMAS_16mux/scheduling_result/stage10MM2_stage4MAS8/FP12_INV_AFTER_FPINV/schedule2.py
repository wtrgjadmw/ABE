...
def solve():
	...
	# new tasks
	c0_t0_t4 = S.Task('c0_t0_t4', length=10, delay_cost=1)
	c0_t0_t4 += alt(MM)
	...
	c0_t0_t4_mem1 += MAS_MEM[13]
	S += 43 < c0_t0_t4_mem1
	S += c0_t0_t4_mem1 <= c0_t0_t4

	c0_t00 = S.Task('c0_t00', length=4, delay_cost=1)
	c0_t00 += alt(MAS)
	...
	S += c0_t00_in*MAS_in[4]<=c0_t00*MAS[4]

	S += c0_t00_in*MAS_in[5]<=c0_t00*MAS[5]

	S += c0_t00_in*MAS_in[6]<=c0_t00*MAS[6]

	S += c0_t00_in*MAS_in[7]<=c0_t00*MAS[7]
	...
	c0_t0_t5 = S.Task('c0_t0_t5', length=4, delay_cost=1)
	c0_t0_t5 += alt(MAS)
	...
	S += c0_t0_t5_in*MAS_in[4]<=c0_t0_t5*MAS[4]

	S += c0_t0_t5_in*MAS_in[5]<=c0_t0_t5*MAS[5]

	S += c0_t0_t5_in*MAS_in[6]<=c0_t0_t5*MAS[6]

	S += c0_t0_t5_in*MAS_in[7]<=c0_t0_t5*MAS[7]
	...
	c0_t1_t4 = S.Task('c0_t1_t4', length=10, delay_cost=1)
	c0_t1_t4 += alt(MM)
	...
	S += c0_t10_in*MAS_in[4]<=c0_t10*MAS[4]

	S += c0_t10_in*MAS_in[5]<=c0_t10*MAS[5]

	S += c0_t10_in*MAS_in[6]<=c0_t10*MAS[6]

	S += c0_t10_in*MAS_in[7]<=c0_t10*MAS[7]
	...
	c0_t1_t5 = S.Task('c0_t1_t5', length=4, delay_cost=1)
	c0_t1_t5 += alt(MAS)
	...
	S += c0_t1_t5_in*MAS_in[4]<=c0_t1_t5*MAS[4]

	S += c0_t1_t5_in*MAS_in[5]<=c0_t1_t5*MAS[5]

	S += c0_t1_t5_in*MAS_in[6]<=c0_t1_t5*MAS[6]

	S += c0_t1_t5_in*MAS_in[7]<=c0_t1_t5*MAS[7]
	...
	c0_t4_t1 = S.Task('c0_t4_t1', length=10, delay_cost=1)
	c0_t4_t1 += alt(MM)
	...
	c0_t4_t3 = S.Task('c0_t4_t3', length=4, delay_cost=1)
	c0_t4_t3 += alt(MAS)
	...
	S += c0_t4_t3_in*MAS_in[4]<=c0_t4_t3*MAS[4]

	S += c0_t4_t3_in*MAS_in[5]<=c0_t4_t3*MAS[5]

	S += c0_t4_t3_in*MAS_in[6]<=c0_t4_t3*MAS[6]

	S += c0_t4_t3_in*MAS_in[7]<=c0_t4_t3*MAS[7]
	...
	c1_t0_t4 = S.Task('c1_t0_t4', length=10, delay_cost=1)
	c1_t0_t4 += alt(MM)
	...
	c1_t00 = S.Task('c1_t00', length=4, delay_cost=1)
	c1_t00 += alt(MAS)
	...
	S += c1_t00_in*MAS_in[4]<=c1_t00*MAS[4]

	S += c1_t00_in*MAS_in[5]<=c1_t00*MAS[5]

	S += c1_t00_in*MAS_in[6]<=c1_t00*MAS[6]

	S += c1_t00_in*MAS_in[7]<=c1_t00*MAS[7]
	...
	c1_t0_t5 = S.Task('c1_t0_t5', length=4, delay_cost=1)
	c1_t0_t5 += alt(MAS)
	...
	S += c1_t0_t5_in*MAS_in[4]<=c1_t0_t5*MAS[4]

	S += c1_t0_t5_in*MAS_in[5]<=c1_t0_t5*MAS[5]

	S += c1_t0_t5_in*MAS_in[6]<=c1_t0_t5*MAS[6]

	S += c1_t0_t5_in*MAS_in[7]<=c1_t0_t5*MAS[7]
	...
	c1_t1_t4 = S.Task('c1_t1_t4', length=10, delay_cost=1)
	c1_t1_t4 += alt(MM)
	...
	c1_t10 = S.Task('c1_t10', length=4, delay_cost=1)
	c1_t10 += alt(MAS)
	...
	S += c1_t10_in*MAS_in[4]<=c1_t10*MAS[4]

	S += c1_t10_in*MAS_in[5]<=c1_t10*MAS[5]

	S += c1_t10_in*MAS_in[6]<=c1_t10*MAS[6]

	S += c1_t10_in*MAS_in[7]<=c1_t10*MAS[7]
	...
	c1_t1_t5 = S.Task('c1_t1_t5', length=4, delay_cost=1)
	c1_t1_t5 += alt(MAS)
	...
	S += c1_t1_t5_in*MAS_in[4]<=c1_t1_t5*MAS[4]

	S += c1_t1_t5_in*MAS_in[5]<=c1_t1_t5*MAS[5]

	S += c1_t1_t5_in*MAS_in[6]<=c1_t1_t5*MAS[6]

	S += c1_t1_t5_in*MAS_in[7]<=c1_t1_t5*MAS[7]
	...
	c1_t4_t1 = S.Task('c1_t4_t1', length=10, delay_cost=1)
	c1_t4_t1 += alt(MM)
	...
	S += c1_t4_t3_in*MAS_in[4]<=c1_t4_t3*MAS[4]

	S += c1_t4_t3_in*MAS_in[5]<=c1_t4_t3*MAS[5]

	S += c1_t4_t3_in*MAS_in[6]<=c1_t4_t3*MAS[6]

	S += c1_t4_t3_in*MAS_in[7]<=c1_t4_t3*MAS[7]
	...
	c1_t4_t3_mem1 += MAS_MEM[13]
	S += 44 < c1_t4_t3_mem1
	S += c1_t4_t3_mem1 <= c1_t4_t3

	c2_t0_t4 = S.Task('c2_t0_t4', length=10, delay_cost=1)
	c2_t0_t4 += alt(MM)
	...
	c2_t00 = S.Task('c2_t00', length=4, delay_cost=1)
	c2_t00 += alt(MAS)
	...
	S += c2_t00_in*MAS_in[4]<=c2_t00*MAS[4]

	S += c2_t00_in*MAS_in[5]<=c2_t00*MAS[5]

	S += c2_t00_in*MAS_in[6]<=c2_t00*MAS[6]

	S += c2_t00_in*MAS_in[7]<=c2_t00*MAS[7]
	...
	c2_t0_t5 = S.Task('c2_t0_t5', length=4, delay_cost=1)
	c2_t0_t5 += alt(MAS)
	...
	S += c2_t0_t5_in*MAS_in[4]<=c2_t0_t5*MAS[4]

	S += c2_t0_t5_in*MAS_in[5]<=c2_t0_t5*MAS[5]

	S += c2_t0_t5_in*MAS_in[6]<=c2_t0_t5*MAS[6]

	S += c2_t0_t5_in*MAS_in[7]<=c2_t0_t5*MAS[7]
	...
	c2_t1_t4 = S.Task('c2_t1_t4', length=10, delay_cost=1)
	c2_t1_t4 += alt(MM)
	...
	c2_t10 = S.Task('c2_t10', length=4, delay_cost=1)
	c2_t10 += alt(MAS)
	...
	S += c2_t10_in*MAS_in[4]<=c2_t10*MAS[4]

	S += c2_t10_in*MAS_in[5]<=c2_t10*MAS[5]

	S += c2_t10_in*MAS_in[6]<=c2_t10*MAS[6]

	S += c2_t10_in*MAS_in[7]<=c2_t10*MAS[7]
	...
	c2_t1_t5 = S.Task('c2_t1_t5', length=4, delay_cost=1)
	c2_t1_t5 += alt(MAS)
	...
	S += c2_t1_t5_in*MAS_in[4]<=c2_t1_t5*MAS[4]

	S += c2_t1_t5_in*MAS_in[5]<=c2_t1_t5*MAS[5]

	S += c2_t1_t5_in*MAS_in[6]<=c2_t1_t5*MAS[6]

	S += c2_t1_t5_in*MAS_in[7]<=c2_t1_t5*MAS[7]
	...
	c2_t4_t1 = S.Task('c2_t4_t1', length=10, delay_cost=1)
	c2_t4_t1 += alt(MM)
	...
	c2_t4_t3 = S.Task('c2_t4_t3', length=4, delay_cost=1)
	c2_t4_t3 += alt(MAS)
	...
	S += c2_t4_t3_in*MAS_in[4]<=c2_t4_t3*MAS[4]

	S += c2_t4_t3_in*MAS_in[5]<=c2_t4_t3*MAS[5]

	S += c2_t4_t3_in*MAS_in[6]<=c2_t4_t3*MAS[6]

	S += c2_t4_t3_in*MAS_in[7]<=c2_t4_t3*MAS[7]

	c2_t4_t3_mem0 = S.Task('c2_t4_t3_mem0', length=1, delay_cost=1)
	c2_t4_t3_mem0 += MAS_MEM[8]
	S += 41 < c2_t4_t3_mem0
	...
	c0_t01 = S.Task('c0_t01', length=4, delay_cost=1)
	c0_t01 += alt(MAS)
	...
	S += c0_t01_in*MAS_in[4]<=c0_t01*MAS[4]

	S += c0_t01_in*MAS_in[5]<=c0_t01*MAS[5]

	S += c0_t01_in*MAS_in[6]<=c0_t01*MAS[6]

	S += c0_t01_in*MAS_in[7]<=c0_t01*MAS[7]
	...
	S += (c0_t0_t5*MAS[6])-1 < c0_t01_mem1*MAS_MEM[13]
	S += (c0_t0_t5*MAS[7])-1 < c0_t01_mem1*MAS_MEM[15]
	S += c0_t01_mem1 <= c0_t01

	c0_t11 = S.Task('c0_t11', length=4, delay_cost=1)
	c0_t11 += alt(MAS)
	...
	S += c0_t11_in*MAS_in[4]<=c0_t11*MAS[4]

	S += c0_t11_in*MAS_in[5]<=c0_t11*MAS[5]

	S += c0_t11_in*MAS_in[6]<=c0_t11*MAS[6]

	S += c0_t11_in*MAS_in[7]<=c0_t11*MAS[7]
	...
	S += (c0_t1_t5*MAS[6])-1 < c0_t11_mem1*MAS_MEM[13]
	S += (c0_t1_t5*MAS[7])-1 < c0_t11_mem1*MAS_MEM[15]
	S += c0_t11_mem1 <= c0_t11

	c0_t4_t4 = S.Task('c0_t4_t4', length=10, delay_cost=1)
	c0_t4_t4 += alt(MM)
	...
	S += (c0_t4_t3*MAS[6])-1 < c0_t4_t4_mem1*MAS_MEM[13]
	S += (c0_t4_t3*MAS[7])-1 < c0_t4_t4_mem1*MAS_MEM[15]
	S += c0_t4_t4_mem1 <= c0_t4_t4

	c0_t40 = S.Task('c0_t40', length=4, delay_cost=1)
	c0_t40 += alt(MAS)
	...
	S += c0_t40_in*MAS_in[4]<=c0_t40*MAS[4]

	S += c0_t40_in*MAS_in[5]<=c0_t40*MAS[5]

	S += c0_t40_in*MAS_in[6]<=c0_t40*MAS[6]

	S += c0_t40_in*MAS_in[7]<=c0_t40*MAS[7]
	...
	c0_t4_t5 = S.Task('c0_t4_t5', length=4, delay_cost=1)
	c0_t4_t5 += alt(MAS)
	...
	S += c0_t4_t5_in*MAS_in[4]<=c0_t4_t5*MAS[4]

	S += c0_t4_t5_in*MAS_in[5]<=c0_t4_t5*MAS[5]

	S += c0_t4_t5_in*MAS_in[6]<=c0_t4_t5*MAS[6]

	S += c0_t4_t5_in*MAS_in[7]<=c0_t4_t5*MAS[7]
	...
	c0_t50 = S.Task('c0_t50', length=4, delay_cost=1)
	c0_t50 += alt(MAS)
	...
	S += c0_t50_in*MAS_in[4]<=c0_t50*MAS[4]

	S += c0_t50_in*MAS_in[5]<=c0_t50*MAS[5]

	S += c0_t50_in*MAS_in[6]<=c0_t50*MAS[6]

	S += c0_t50_in*MAS_in[7]<=c0_t50*MAS[7]
	...
	S += (c0_t00*MAS[6])-1 < c0_t50_mem0*MAS_MEM[12]
	S += (c0_t00*MAS[7])-1 < c0_t50_mem0*MAS_MEM[14]
	...
	S += (c0_t10*MAS[6])-1 < c0_t50_mem1*MAS_MEM[13]
	S += (c0_t10*MAS[7])-1 < c0_t50_mem1*MAS_MEM[15]
	S += c0_t50_mem1 <= c0_t50

	c1_t01 = S.Task('c1_t01', length=4, delay_cost=1)
	c1_t01 += alt(MAS)
	...
	S += c1_t01_in*MAS_in[4]<=c1_t01*MAS[4]

	S += c1_t01_in*MAS_in[5]<=c1_t01*MAS[5]

	S += c1_t01_in*MAS_in[6]<=c1_t01*MAS[6]

	S += c1_t01_in*MAS_in[7]<=c1_t01*MAS[7]
	...
	S += (c1_t0_t5*MAS[6])-1 < c1_t01_mem1*MAS_MEM[13]
	S += (c1_t0_t5*MAS[7])-1 < c1_t01_mem1*MAS_MEM[15]
	S += c1_t01_mem1 <= c1_t01

	c1_t11 = S.Task('c1_t11', length=4, delay_cost=1)
	c1_t11 += alt(MAS)
	...
	S += c1_t11_in*MAS_in[4]<=c1_t11*MAS[4]

	S += c1_t11_in*MAS_in[5]<=c1_t11*MAS[5]

	S += c1_t11_in*MAS_in[6]<=c1_t11*MAS[6]

	S += c1_t11_in*MAS_in[7]<=c1_t11*MAS[7]
	...
	S += (c1_t1_t5*MAS[6])-1 < c1_t11_mem1*MAS_MEM[13]
	S += (c1_t1_t5*MAS[7])-1 < c1_t11_mem1*MAS_MEM[15]
	S += c1_t11_mem1 <= c1_t11

	c1_t4_t4 = S.Task('c1_t4_t4', length=10, delay_cost=1)
	c1_t4_t4 += alt(MM)
	...
	S += (c1_t4_t3*MAS[6])-1 < c1_t4_t4_mem1*MAS_MEM[13]
	S += (c1_t4_t3*MAS[7])-1 < c1_t4_t4_mem1*MAS_MEM[15]
	S += c1_t4_t4_mem1 <= c1_t4_t4

	c1_t40 = S.Task('c1_t40', length=4, delay_cost=1)
	c1_t40 += alt(MAS)
	...
	S += c1_t40_in*MAS_in[4]<=c1_t40*MAS[4]

	S += c1_t40_in*MAS_in[5]<=c1_t40*MAS[5]

	S += c1_t40_in*MAS_in[6]<=c1_t40*MAS[6]

	S += c1_t40_in*MAS_in[7]<=c1_t40*MAS[7]
	...
	c1_t4_t5 = S.Task('c1_t4_t5', length=4, delay_cost=1)
	c1_t4_t5 += alt(MAS)
	...
	S += c1_t4_t5_in*MAS_in[4]<=c1_t4_t5*MAS[4]

	S += c1_t4_t5_in*MAS_in[5]<=c1_t4_t5*MAS[5]

	S += c1_t4_t5_in*MAS_in[6]<=c1_t4_t5*MAS[6]

	S += c1_t4_t5_in*MAS_in[7]<=c1_t4_t5*MAS[7]
	...
	c1_t50 = S.Task('c1_t50', length=4, delay_cost=1)
	c1_t50 += alt(MAS)
	...
	S += c1_t50_in*MAS_in[4]<=c1_t50*MAS[4]

	S += c1_t50_in*MAS_in[5]<=c1_t50*MAS[5]

	S += c1_t50_in*MAS_in[6]<=c1_t50*MAS[6]

	S += c1_t50_in*MAS_in[7]<=c1_t50*MAS[7]
	...
	S += (c1_t00*MAS[6])-1 < c1_t50_mem0*MAS_MEM[12]
	S += (c1_t00*MAS[7])-1 < c1_t50_mem0*MAS_MEM[14]
	...
	S += (c1_t10*MAS[6])-1 < c1_t50_mem1*MAS_MEM[13]
	S += (c1_t10*MAS[7])-1 < c1_t50_mem1*MAS_MEM[15]
	S += c1_t50_mem1 <= c1_t50

	c2_t01 = S.Task('c2_t01', length=4, delay_cost=1)
	c2_t01 += alt(MAS)
	...
	S += c2_t01_in*MAS_in[4]<=c2_t01*MAS[4]

	S += c2_t01_in*MAS_in[5]<=c2_t01*MAS[5]

	S += c2_t01_in*MAS_in[6]<=c2_t01*MAS[6]

	S += c2_t01_in*MAS_in[7]<=c2_t01*MAS[7]
	...
	S += (c2_t0_t5*MAS[6])-1 < c2_t01_mem1*MAS_MEM[13]
	S += (c2_t0_t5*MAS[7])-1 < c2_t01_mem1*MAS_MEM[15]
	S += c2_t01_mem1 <= c2_t01

	c2_t11 = S.Task('c2_t11', length=4, delay_cost=1)
	c2_t11 += alt(MAS)
	...
	S += c2_t11_in*MAS_in[4]<=c2_t11*MAS[4]

	S += c2_t11_in*MAS_in[5]<=c2_t11*MAS[5]

	S += c2_t11_in*MAS_in[6]<=c2_t11*MAS[6]

	S += c2_t11_in*MAS_in[7]<=c2_t11*MAS[7]
	...
	S += (c2_t1_t5*MAS[6])-1 < c2_t11_mem1*MAS_MEM[13]
	S += (c2_t1_t5*MAS[7])-1 < c2_t11_mem1*MAS_MEM[15]
	S += c2_t11_mem1 <= c2_t11

	c2_t4_t4 = S.Task('c2_t4_t4', length=10, delay_cost=1)
	c2_t4_t4 += alt(MM)
	...
	S += (c2_t4_t3*MAS[6])-1 < c2_t4_t4_mem1*MAS_MEM[13]
	S += (c2_t4_t3*MAS[7])-1 < c2_t4_t4_mem1*MAS_MEM[15]
	S += c2_t4_t4_mem1 <= c2_t4_t4

	c2_t40 = S.Task('c2_t40', length=4, delay_cost=1)
	c2_t40 += alt(MAS)
	...
	S += c2_t40_in*MAS_in[4]<=c2_t40*MAS[4]

	S += c2_t40_in*MAS_in[5]<=c2_t40*MAS[5]

	S += c2_t40_in*MAS_in[6]<=c2_t40*MAS[6]

	S += c2_t40_in*MAS_in[7]<=c2_t40*MAS[7]
	...
	c2_t4_t5 = S.Task('c2_t4_t5', length=4, delay_cost=1)
	c2_t4_t5 += alt(MAS)
	...
	S += c2_t4_t5_in*MAS_in[4]<=c2_t4_t5*MAS[4]

	S += c2_t4_t5_in*MAS_in[5]<=c2_t4_t5*MAS[5]

	S += c2_t4_t5_in*MAS_in[6]<=c2_t4_t5*MAS[6]

	S += c2_t4_t5_in*MAS_in[7]<=c2_t4_t5*MAS[7]
	...
	c2_t50 = S.Task('c2_t50', length=4, delay_cost=1)
	c2_t50 += alt(MAS)
	...
	S += c2_t50_in*MAS_in[4]<=c2_t50*MAS[4]

	S += c2_t50_in*MAS_in[5]<=c2_t50*MAS[5]

	S += c2_t50_in*MAS_in[6]<=c2_t50*MAS[6]

	S += c2_t50_in*MAS_in[7]<=c2_t50*MAS[7]
	...
	S += (c2_t00*MAS[6])-1 < c2_t50_mem0*MAS_MEM[12]
	S += (c2_t00*MAS[7])-1 < c2_t50_mem0*MAS_MEM[14]
	...
	S += (c2_t10*MAS[6])-1 < c2_t50_mem1*MAS_MEM[13]
	S += (c2_t10*MAS[7])-1 < c2_t50_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_INV_AFTER_FPINV/schedule2.png"
	if(S.solution() != []):
