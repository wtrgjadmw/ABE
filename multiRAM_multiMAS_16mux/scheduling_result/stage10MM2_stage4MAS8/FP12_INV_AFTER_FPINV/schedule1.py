...
def solve():
	...
	c0_t20 = S.Task('c0_t20', length=4, delay_cost=1)
	S += c0_t20 >= 3
	c0_t20 += MAS[0]
	...
	c0_t21 = S.Task('c0_t21', length=4, delay_cost=1)
	S += c0_t21 >= 4
	c0_t21 += MAS[7]
	...
	c2_t20 = S.Task('c2_t20', length=4, delay_cost=1)
	S += c2_t20 >= 5
	c2_t20 += MAS[5]
	...
	c2_t21 = S.Task('c2_t21', length=4, delay_cost=1)
	S += c2_t21 >= 6
	c2_t21 += MAS[4]
	...
	S += c0_t4_t2_mem1 >= 7
	c0_t4_t2_mem1 += MAS_MEM[15]

	c1_t20 = S.Task('c1_t20', length=4, delay_cost=1)
	S += c1_t20 >= 7
	c1_t20 += MAS[1]
	...
	c0_t4_t2 = S.Task('c0_t4_t2', length=4, delay_cost=1)
	S += c0_t4_t2 >= 8
	c0_t4_t2 += MAS[1]

	c1_t1_t2_in = S.Task('c1_t1_t2_in', length=1, delay_cost=1)
	S += c1_t1_t2_in >= 8
	c1_t1_t2_in += MAS_in[4]
	...
	c1_t21 = S.Task('c1_t21', length=4, delay_cost=1)
	S += c1_t21 >= 8
	c1_t21 += MAS[4]

	c0_t1_t2_in = S.Task('c0_t1_t2_in', length=1, delay_cost=1)
	S += c0_t1_t2_in >= 9
	c0_t1_t2_in += MAS_in[3]
	...
	c1_t1_t2 = S.Task('c1_t1_t2', length=4, delay_cost=1)
	S += c1_t1_t2 >= 9
	c1_t1_t2 += MAS[4]

	c2_t4_t2_in = S.Task('c2_t4_t2_in', length=1, delay_cost=1)
	S += c2_t4_t2_in >= 9
	c2_t4_t2_in += MAS_in[7]
	...
	c0_t1_t2 = S.Task('c0_t1_t2', length=4, delay_cost=1)
	S += c0_t1_t2 >= 10
	c0_t1_t2 += MAS[3]

	c1_t0_t2_in = S.Task('c1_t0_t2_in', length=1, delay_cost=1)
	S += c1_t0_t2_in >= 10
	c1_t0_t2_in += MAS_in[6]
	...
	c2_t4_t2 = S.Task('c2_t4_t2', length=4, delay_cost=1)
	S += c2_t4_t2 >= 10
	c2_t4_t2 += MAS[7]

	c0_t0_t2_in = S.Task('c0_t0_t2_in', length=1, delay_cost=1)
	S += c0_t0_t2_in >= 11
	c0_t0_t2_in += MAS_in[3]
	...
	c1_t0_t2 = S.Task('c1_t0_t2', length=4, delay_cost=1)
	S += c1_t0_t2 >= 11
	c1_t0_t2 += MAS[6]
	...
	c0_t0_t2 = S.Task('c0_t0_t2', length=4, delay_cost=1)
	S += c0_t0_t2 >= 12
	c0_t0_t2 += MAS[3]

	c1_t4_t2 = S.Task('c1_t4_t2', length=4, delay_cost=1)
	S += c1_t4_t2 >= 12
	c1_t4_t2 += MAS[0]
	...
	c_qinv0_t3 = S.Task('c_qinv0_t3', length=4, delay_cost=1)
	S += c_qinv0_t3 >= 12
	c_qinv0_t3 += MAS[4]

	c_qinv1__t3_in = S.Task('c_qinv1__t3_in', length=1, delay_cost=1)
	S += c_qinv1__t3_in >= 12
	c_qinv1__t3_in += MAS_in[4]
	...
	c_qinv1__t2 = S.Task('c_qinv1__t2', length=4, delay_cost=1)
	S += c_qinv1__t2 >= 15
	c_qinv1__t2 += MAS[6]
	...
	S += c_qinv0_t1_mem1 >= 18
	c_qinv0_t1_mem1 += MM_MEM[1]

	c_qinv0_t2 = S.Task('c_qinv0_t2', length=4, delay_cost=1)
	S += c_qinv0_t2 >= 18
	c_qinv0_t2 += MAS[0]
	...
	S += c_qinv00_in*MAS_in[2]<=c_qinv00*MAS[2]

	S += c_qinv00_in*MAS_in[3]<=c_qinv00*MAS[3]

	S += c_qinv00_in*MAS_in[4]<=c_qinv00*MAS[4]

	S += c_qinv00_in*MAS_in[5]<=c_qinv00*MAS[5]

	S += c_qinv00_in*MAS_in[6]<=c_qinv00*MAS[6]

	S += c_qinv00_in*MAS_in[7]<=c_qinv00*MAS[7]
	...
	c_qinv0_t5 = S.Task('c_qinv0_t5', length=4, delay_cost=1)
	c_qinv0_t5 += alt(MAS)
	...
	S += c_qinv0_t5_in*MAS_in[2]<=c_qinv0_t5*MAS[2]

	S += c_qinv0_t5_in*MAS_in[3]<=c_qinv0_t5*MAS[3]

	S += c_qinv0_t5_in*MAS_in[4]<=c_qinv0_t5*MAS[4]

	S += c_qinv0_t5_in*MAS_in[5]<=c_qinv0_t5*MAS[5]

	S += c_qinv0_t5_in*MAS_in[6]<=c_qinv0_t5*MAS[6]

	S += c_qinv0_t5_in*MAS_in[7]<=c_qinv0_t5*MAS[7]

	c_qinv0_t5_mem0 = S.Task('c_qinv0_t5_mem0', length=1, delay_cost=1)
	c_qinv0_t5_mem0 += MM_MEM[0]
	S += 26 < c_qinv0_t5_mem0
	S += c_qinv0_t5_mem0 <= c_qinv0_t5

	c_qinv0_t5_mem1 = S.Task('c_qinv0_t5_mem1', length=1, delay_cost=1)
	c_qinv0_t5_mem1 += MM_MEM[1]
	S += 28 < c_qinv0_t5_mem1
	S += c_qinv0_t5_mem1 <= c_qinv0_t5

	c_qinv1__t4 = S.Task('c_qinv1__t4', length=10, delay_cost=1)
	c_qinv1__t4 += alt(MM)
	...
	S += c_qinv1__t4_in*MM_in[1]<=c_qinv1__t4*MM[1]
	c_qinv1__t4_mem0 = S.Task('c_qinv1__t4_mem0', length=1, delay_cost=1)
	c_qinv1__t4_mem0 += MAS_MEM[12]
	S += 18 < c_qinv1__t4_mem0
	S += c_qinv1__t4_mem0 <= c_qinv1__t4

	c_qinv1__t4_mem1 = S.Task('c_qinv1__t4_mem1', length=1, delay_cost=1)
	c_qinv1__t4_mem1 += MAS_MEM[9]
	S += 16 < c_qinv1__t4_mem1
	S += c_qinv1__t4_mem1 <= c_qinv1__t4

	c_qinv1_0 = S.Task('c_qinv1_0', length=4, delay_cost=1)
	c_qinv1_0 += alt(MAS)
	...
	S += c_qinv1_0_in*MAS_in[2]<=c_qinv1_0*MAS[2]

	S += c_qinv1_0_in*MAS_in[3]<=c_qinv1_0*MAS[3]

	S += c_qinv1_0_in*MAS_in[4]<=c_qinv1_0*MAS[4]

	S += c_qinv1_0_in*MAS_in[5]<=c_qinv1_0*MAS[5]

	S += c_qinv1_0_in*MAS_in[6]<=c_qinv1_0*MAS[6]

	S += c_qinv1_0_in*MAS_in[7]<=c_qinv1_0*MAS[7]
	...
	c_qinv1__t5 = S.Task('c_qinv1__t5', length=4, delay_cost=1)
	c_qinv1__t5 += alt(MAS)
	...
	S += c_qinv1__t5_in*MAS_in[2]<=c_qinv1__t5*MAS[2]

	S += c_qinv1__t5_in*MAS_in[3]<=c_qinv1__t5*MAS[3]

	S += c_qinv1__t5_in*MAS_in[4]<=c_qinv1__t5*MAS[4]

	S += c_qinv1__t5_in*MAS_in[5]<=c_qinv1__t5*MAS[5]

	S += c_qinv1__t5_in*MAS_in[6]<=c_qinv1__t5*MAS[6]

	S += c_qinv1__t5_in*MAS_in[7]<=c_qinv1__t5*MAS[7]

	c_qinv1__t5_mem0 = S.Task('c_qinv1__t5_mem0', length=1, delay_cost=1)
	c_qinv1__t5_mem0 += MM_MEM[0]
	S += 29 < c_qinv1__t5_mem0
	S += c_qinv1__t5_mem0 <= c_qinv1__t5

	c_qinv1__t5_mem1 = S.Task('c_qinv1__t5_mem1', length=1, delay_cost=1)
	c_qinv1__t5_mem1 += MM_MEM[3]
	S += 25 < c_qinv1__t5_mem1
	S += c_qinv1__t5_mem1 <= c_qinv1__t5

	c_qinv01 = S.Task('c_qinv01', length=4, delay_cost=1)
	c_qinv01 += alt(MAS)
	...
	S += c_qinv01_in*MAS_in[2]<=c_qinv01*MAS[2]

	S += c_qinv01_in*MAS_in[3]<=c_qinv01*MAS[3]

	S += c_qinv01_in*MAS_in[4]<=c_qinv01*MAS[4]

	S += c_qinv01_in*MAS_in[5]<=c_qinv01*MAS[5]

	S += c_qinv01_in*MAS_in[6]<=c_qinv01*MAS[6]

	S += c_qinv01_in*MAS_in[7]<=c_qinv01*MAS[7]
	...
	S += (c_qinv0_t4*MM[1])-1 < c_qinv01_mem0*MM_MEM[2]
	...
	S += (c_qinv0_t5*MAS[4])-1 < c_qinv01_mem1*MAS_MEM[9]
	S += (c_qinv0_t5*MAS[5])-1 < c_qinv01_mem1*MAS_MEM[11]
	S += (c_qinv0_t5*MAS[6])-1 < c_qinv01_mem1*MAS_MEM[13]
	S += (c_qinv0_t5*MAS[7])-1 < c_qinv01_mem1*MAS_MEM[15]
	S += c_qinv01_mem1 <= c_qinv01

	c_qinv1_1 = S.Task('c_qinv1_1', length=4, delay_cost=1)
	c_qinv1_1 += alt(MAS)
	...
	S += c_qinv1_1_in*MAS_in[2]<=c_qinv1_1*MAS[2]

	S += c_qinv1_1_in*MAS_in[3]<=c_qinv1_1*MAS[3]

	S += c_qinv1_1_in*MAS_in[4]<=c_qinv1_1*MAS[4]

	S += c_qinv1_1_in*MAS_in[5]<=c_qinv1_1*MAS[5]

	S += c_qinv1_1_in*MAS_in[6]<=c_qinv1_1*MAS[6]

	S += c_qinv1_1_in*MAS_in[7]<=c_qinv1_1*MAS[7]
	...
	S += (c_qinv1__t4*MM[1])-1 < c_qinv1_1_mem0*MM_MEM[2]
	...
	S += (c_qinv1__t5*MAS[4])-1 < c_qinv1_1_mem1*MAS_MEM[9]
	S += (c_qinv1__t5*MAS[5])-1 < c_qinv1_1_mem1*MAS_MEM[11]
	S += (c_qinv1__t5*MAS[6])-1 < c_qinv1_1_mem1*MAS_MEM[13]
	S += (c_qinv1__t5*MAS[7])-1 < c_qinv1_1_mem1*MAS_MEM[15]
	S += c_qinv1_1_mem1 <= c_qinv1_1

	c0_t0_t0 = S.Task('c0_t0_t0', length=10, delay_cost=1)
	c0_t0_t0 += alt(MM)
	c0_t0_t0_in = S.Task('c0_t0_t0_in', length=1, delay_cost=1)
	c0_t0_t0_in += alt(MM_in)
	S += c0_t0_t0_in*MM_in[0]<=c0_t0_t0*MM[0]
	S += c0_t0_t0_in*MM_in[1]<=c0_t0_t0*MM[1]
	...
	S += (c_qinv00*MAS[4])-1 < c0_t0_t0_mem1*MAS_MEM[9]
	S += (c_qinv00*MAS[5])-1 < c0_t0_t0_mem1*MAS_MEM[11]
	S += (c_qinv00*MAS[6])-1 < c0_t0_t0_mem1*MAS_MEM[13]
	S += (c_qinv00*MAS[7])-1 < c0_t0_t0_mem1*MAS_MEM[15]
	S += c0_t0_t0_mem1 <= c0_t0_t0

	c0_t1_t0 = S.Task('c0_t1_t0', length=10, delay_cost=1)
	c0_t1_t0 += alt(MM)
	c0_t1_t0_in = S.Task('c0_t1_t0_in', length=1, delay_cost=1)
	c0_t1_t0_in += alt(MM_in)
	S += c0_t1_t0_in*MM_in[0]<=c0_t1_t0*MM[0]
	S += c0_t1_t0_in*MM_in[1]<=c0_t1_t0*MM[1]
	...
	S += (c_qinv1_0*MAS[4])-1 < c0_t1_t0_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c0_t1_t0_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c0_t1_t0_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c0_t1_t0_mem1*MAS_MEM[15]
	S += c0_t1_t0_mem1 <= c0_t1_t0

	c0_t30 = S.Task('c0_t30', length=4, delay_cost=1)
	c0_t30 += alt(MAS)
	...
	S += c0_t30_in*MAS_in[2]<=c0_t30*MAS[2]

	S += c0_t30_in*MAS_in[3]<=c0_t30*MAS[3]

	S += c0_t30_in*MAS_in[4]<=c0_t30*MAS[4]

	S += c0_t30_in*MAS_in[5]<=c0_t30*MAS[5]

	S += c0_t30_in*MAS_in[6]<=c0_t30*MAS[6]

	S += c0_t30_in*MAS_in[7]<=c0_t30*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c0_t30_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c0_t30_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c0_t30_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c0_t30_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_0*MAS[4])-1 < c0_t30_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c0_t30_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c0_t30_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c0_t30_mem1*MAS_MEM[15]
	S += c0_t30_mem1 <= c0_t30

	c1_t0_t0 = S.Task('c1_t0_t0', length=10, delay_cost=1)
	c1_t0_t0 += alt(MM)
	c1_t0_t0_in = S.Task('c1_t0_t0_in', length=1, delay_cost=1)
	c1_t0_t0_in += alt(MM_in)
	S += c1_t0_t0_in*MM_in[0]<=c1_t0_t0*MM[0]
	S += c1_t0_t0_in*MM_in[1]<=c1_t0_t0*MM[1]
	...
	S += (c_qinv00*MAS[4])-1 < c1_t0_t0_mem1*MAS_MEM[9]
	S += (c_qinv00*MAS[5])-1 < c1_t0_t0_mem1*MAS_MEM[11]
	S += (c_qinv00*MAS[6])-1 < c1_t0_t0_mem1*MAS_MEM[13]
	S += (c_qinv00*MAS[7])-1 < c1_t0_t0_mem1*MAS_MEM[15]
	S += c1_t0_t0_mem1 <= c1_t0_t0

	c1_t1_t0 = S.Task('c1_t1_t0', length=10, delay_cost=1)
	c1_t1_t0 += alt(MM)
	c1_t1_t0_in = S.Task('c1_t1_t0_in', length=1, delay_cost=1)
	c1_t1_t0_in += alt(MM_in)
	S += c1_t1_t0_in*MM_in[0]<=c1_t1_t0*MM[0]
	S += c1_t1_t0_in*MM_in[1]<=c1_t1_t0*MM[1]
	...
	S += (c_qinv1_0*MAS[4])-1 < c1_t1_t0_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c1_t1_t0_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c1_t1_t0_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c1_t1_t0_mem1*MAS_MEM[15]
	S += c1_t1_t0_mem1 <= c1_t1_t0

	c1_t30 = S.Task('c1_t30', length=4, delay_cost=1)
	c1_t30 += alt(MAS)
	...
	S += c1_t30_in*MAS_in[2]<=c1_t30*MAS[2]

	S += c1_t30_in*MAS_in[3]<=c1_t30*MAS[3]

	S += c1_t30_in*MAS_in[4]<=c1_t30*MAS[4]

	S += c1_t30_in*MAS_in[5]<=c1_t30*MAS[5]

	S += c1_t30_in*MAS_in[6]<=c1_t30*MAS[6]

	S += c1_t30_in*MAS_in[7]<=c1_t30*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c1_t30_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c1_t30_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c1_t30_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c1_t30_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_0*MAS[4])-1 < c1_t30_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c1_t30_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c1_t30_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c1_t30_mem1*MAS_MEM[15]
	S += c1_t30_mem1 <= c1_t30

	c2_t0_t0 = S.Task('c2_t0_t0', length=10, delay_cost=1)
	c2_t0_t0 += alt(MM)
	c2_t0_t0_in = S.Task('c2_t0_t0_in', length=1, delay_cost=1)
	c2_t0_t0_in += alt(MM_in)
	S += c2_t0_t0_in*MM_in[0]<=c2_t0_t0*MM[0]
	S += c2_t0_t0_in*MM_in[1]<=c2_t0_t0*MM[1]
	...
	S += (c_qinv00*MAS[4])-1 < c2_t0_t0_mem1*MAS_MEM[9]
	S += (c_qinv00*MAS[5])-1 < c2_t0_t0_mem1*MAS_MEM[11]
	S += (c_qinv00*MAS[6])-1 < c2_t0_t0_mem1*MAS_MEM[13]
	S += (c_qinv00*MAS[7])-1 < c2_t0_t0_mem1*MAS_MEM[15]
	S += c2_t0_t0_mem1 <= c2_t0_t0

	c2_t1_t0 = S.Task('c2_t1_t0', length=10, delay_cost=1)
	c2_t1_t0 += alt(MM)
	c2_t1_t0_in = S.Task('c2_t1_t0_in', length=1, delay_cost=1)
	c2_t1_t0_in += alt(MM_in)
	S += c2_t1_t0_in*MM_in[0]<=c2_t1_t0*MM[0]
	S += c2_t1_t0_in*MM_in[1]<=c2_t1_t0*MM[1]
	...
	S += (c_qinv1_0*MAS[4])-1 < c2_t1_t0_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c2_t1_t0_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c2_t1_t0_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c2_t1_t0_mem1*MAS_MEM[15]
	S += c2_t1_t0_mem1 <= c2_t1_t0

	c2_t30 = S.Task('c2_t30', length=4, delay_cost=1)
	c2_t30 += alt(MAS)
	...
	S += c2_t30_in*MAS_in[2]<=c2_t30*MAS[2]

	S += c2_t30_in*MAS_in[3]<=c2_t30*MAS[3]

	S += c2_t30_in*MAS_in[4]<=c2_t30*MAS[4]

	S += c2_t30_in*MAS_in[5]<=c2_t30*MAS[5]

	S += c2_t30_in*MAS_in[6]<=c2_t30*MAS[6]

	S += c2_t30_in*MAS_in[7]<=c2_t30*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c2_t30_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c2_t30_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c2_t30_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c2_t30_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_0*MAS[4])-1 < c2_t30_mem1*MAS_MEM[9]
	S += (c_qinv1_0*MAS[5])-1 < c2_t30_mem1*MAS_MEM[11]
	S += (c_qinv1_0*MAS[6])-1 < c2_t30_mem1*MAS_MEM[13]
	S += (c_qinv1_0*MAS[7])-1 < c2_t30_mem1*MAS_MEM[15]
	S += c2_t30_mem1 <= c2_t30

	c0_t0_t1 = S.Task('c0_t0_t1', length=10, delay_cost=1)
	c0_t0_t1 += alt(MM)
	c0_t0_t1_in = S.Task('c0_t0_t1_in', length=1, delay_cost=1)
	c0_t0_t1_in += alt(MM_in)
	S += c0_t0_t1_in*MM_in[0]<=c0_t0_t1*MM[0]
	S += c0_t0_t1_in*MM_in[1]<=c0_t0_t1*MM[1]
	...
	S += (c_qinv01*MAS[4])-1 < c0_t0_t1_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c0_t0_t1_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c0_t0_t1_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c0_t0_t1_mem1*MAS_MEM[15]
	S += c0_t0_t1_mem1 <= c0_t0_t1

	c0_t0_t3 = S.Task('c0_t0_t3', length=4, delay_cost=1)
	c0_t0_t3 += alt(MAS)
	...
	S += c0_t0_t3_in*MAS_in[2]<=c0_t0_t3*MAS[2]

	S += c0_t0_t3_in*MAS_in[3]<=c0_t0_t3*MAS[3]

	S += c0_t0_t3_in*MAS_in[4]<=c0_t0_t3*MAS[4]

	S += c0_t0_t3_in*MAS_in[5]<=c0_t0_t3*MAS[5]

	S += c0_t0_t3_in*MAS_in[6]<=c0_t0_t3*MAS[6]

	S += c0_t0_t3_in*MAS_in[7]<=c0_t0_t3*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c0_t0_t3_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c0_t0_t3_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c0_t0_t3_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c0_t0_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv01*MAS[4])-1 < c0_t0_t3_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c0_t0_t3_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c0_t0_t3_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c0_t0_t3_mem1*MAS_MEM[15]
	S += c0_t0_t3_mem1 <= c0_t0_t3

	c0_t1_t1 = S.Task('c0_t1_t1', length=10, delay_cost=1)
	c0_t1_t1 += alt(MM)
	c0_t1_t1_in = S.Task('c0_t1_t1_in', length=1, delay_cost=1)
	c0_t1_t1_in += alt(MM_in)
	S += c0_t1_t1_in*MM_in[0]<=c0_t1_t1*MM[0]
	S += c0_t1_t1_in*MM_in[1]<=c0_t1_t1*MM[1]
	...
	S += (c_qinv1_1*MAS[4])-1 < c0_t1_t1_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c0_t1_t1_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c0_t1_t1_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c0_t1_t1_mem1*MAS_MEM[15]
	S += c0_t1_t1_mem1 <= c0_t1_t1

	c0_t1_t3 = S.Task('c0_t1_t3', length=4, delay_cost=1)
	c0_t1_t3 += alt(MAS)
	...
	S += c0_t1_t3_in*MAS_in[2]<=c0_t1_t3*MAS[2]

	S += c0_t1_t3_in*MAS_in[3]<=c0_t1_t3*MAS[3]

	S += c0_t1_t3_in*MAS_in[4]<=c0_t1_t3*MAS[4]

	S += c0_t1_t3_in*MAS_in[5]<=c0_t1_t3*MAS[5]

	S += c0_t1_t3_in*MAS_in[6]<=c0_t1_t3*MAS[6]

	S += c0_t1_t3_in*MAS_in[7]<=c0_t1_t3*MAS[7]
	...
	S += (c_qinv1_0*MAS[4])-1 < c0_t1_t3_mem0*MAS_MEM[8]
	S += (c_qinv1_0*MAS[5])-1 < c0_t1_t3_mem0*MAS_MEM[10]
	S += (c_qinv1_0*MAS[6])-1 < c0_t1_t3_mem0*MAS_MEM[12]
	S += (c_qinv1_0*MAS[7])-1 < c0_t1_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c0_t1_t3_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c0_t1_t3_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c0_t1_t3_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c0_t1_t3_mem1*MAS_MEM[15]
	S += c0_t1_t3_mem1 <= c0_t1_t3

	c0_t31 = S.Task('c0_t31', length=4, delay_cost=1)
	c0_t31 += alt(MAS)
	...
	S += c0_t31_in*MAS_in[2]<=c0_t31*MAS[2]

	S += c0_t31_in*MAS_in[3]<=c0_t31*MAS[3]

	S += c0_t31_in*MAS_in[4]<=c0_t31*MAS[4]

	S += c0_t31_in*MAS_in[5]<=c0_t31*MAS[5]

	S += c0_t31_in*MAS_in[6]<=c0_t31*MAS[6]

	S += c0_t31_in*MAS_in[7]<=c0_t31*MAS[7]
	...
	S += (c_qinv01*MAS[4])-1 < c0_t31_mem0*MAS_MEM[8]
	S += (c_qinv01*MAS[5])-1 < c0_t31_mem0*MAS_MEM[10]
	S += (c_qinv01*MAS[6])-1 < c0_t31_mem0*MAS_MEM[12]
	S += (c_qinv01*MAS[7])-1 < c0_t31_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c0_t31_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c0_t31_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c0_t31_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c0_t31_mem1*MAS_MEM[15]
	S += c0_t31_mem1 <= c0_t31

	c0_t4_t0 = S.Task('c0_t4_t0', length=10, delay_cost=1)
	c0_t4_t0 += alt(MM)
	c0_t4_t0_in = S.Task('c0_t4_t0_in', length=1, delay_cost=1)
	c0_t4_t0_in += alt(MM_in)
	S += c0_t4_t0_in*MM_in[0]<=c0_t4_t0*MM[0]
	S += c0_t4_t0_in*MM_in[1]<=c0_t4_t0*MM[1]
	...
	S += (c0_t30*MAS[4])-1 < c0_t4_t0_mem1*MAS_MEM[9]
	S += (c0_t30*MAS[5])-1 < c0_t4_t0_mem1*MAS_MEM[11]
	S += (c0_t30*MAS[6])-1 < c0_t4_t0_mem1*MAS_MEM[13]
	S += (c0_t30*MAS[7])-1 < c0_t4_t0_mem1*MAS_MEM[15]
	S += c0_t4_t0_mem1 <= c0_t4_t0

	c1_t0_t1 = S.Task('c1_t0_t1', length=10, delay_cost=1)
	c1_t0_t1 += alt(MM)
	c1_t0_t1_in = S.Task('c1_t0_t1_in', length=1, delay_cost=1)
	c1_t0_t1_in += alt(MM_in)
	S += c1_t0_t1_in*MM_in[0]<=c1_t0_t1*MM[0]
	S += c1_t0_t1_in*MM_in[1]<=c1_t0_t1*MM[1]
	...
	S += (c_qinv01*MAS[4])-1 < c1_t0_t1_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c1_t0_t1_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c1_t0_t1_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c1_t0_t1_mem1*MAS_MEM[15]
	S += c1_t0_t1_mem1 <= c1_t0_t1

	c1_t0_t3 = S.Task('c1_t0_t3', length=4, delay_cost=1)
	c1_t0_t3 += alt(MAS)
	...
	S += c1_t0_t3_in*MAS_in[2]<=c1_t0_t3*MAS[2]

	S += c1_t0_t3_in*MAS_in[3]<=c1_t0_t3*MAS[3]

	S += c1_t0_t3_in*MAS_in[4]<=c1_t0_t3*MAS[4]

	S += c1_t0_t3_in*MAS_in[5]<=c1_t0_t3*MAS[5]

	S += c1_t0_t3_in*MAS_in[6]<=c1_t0_t3*MAS[6]

	S += c1_t0_t3_in*MAS_in[7]<=c1_t0_t3*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c1_t0_t3_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c1_t0_t3_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c1_t0_t3_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c1_t0_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv01*MAS[4])-1 < c1_t0_t3_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c1_t0_t3_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c1_t0_t3_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c1_t0_t3_mem1*MAS_MEM[15]
	S += c1_t0_t3_mem1 <= c1_t0_t3

	c1_t1_t1 = S.Task('c1_t1_t1', length=10, delay_cost=1)
	c1_t1_t1 += alt(MM)
	c1_t1_t1_in = S.Task('c1_t1_t1_in', length=1, delay_cost=1)
	c1_t1_t1_in += alt(MM_in)
	S += c1_t1_t1_in*MM_in[0]<=c1_t1_t1*MM[0]
	S += c1_t1_t1_in*MM_in[1]<=c1_t1_t1*MM[1]
	...
	S += (c_qinv1_1*MAS[4])-1 < c1_t1_t1_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c1_t1_t1_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c1_t1_t1_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c1_t1_t1_mem1*MAS_MEM[15]
	S += c1_t1_t1_mem1 <= c1_t1_t1

	c1_t1_t3 = S.Task('c1_t1_t3', length=4, delay_cost=1)
	c1_t1_t3 += alt(MAS)
	...
	S += c1_t1_t3_in*MAS_in[2]<=c1_t1_t3*MAS[2]

	S += c1_t1_t3_in*MAS_in[3]<=c1_t1_t3*MAS[3]

	S += c1_t1_t3_in*MAS_in[4]<=c1_t1_t3*MAS[4]

	S += c1_t1_t3_in*MAS_in[5]<=c1_t1_t3*MAS[5]

	S += c1_t1_t3_in*MAS_in[6]<=c1_t1_t3*MAS[6]

	S += c1_t1_t3_in*MAS_in[7]<=c1_t1_t3*MAS[7]
	...
	S += (c_qinv1_0*MAS[4])-1 < c1_t1_t3_mem0*MAS_MEM[8]
	S += (c_qinv1_0*MAS[5])-1 < c1_t1_t3_mem0*MAS_MEM[10]
	S += (c_qinv1_0*MAS[6])-1 < c1_t1_t3_mem0*MAS_MEM[12]
	S += (c_qinv1_0*MAS[7])-1 < c1_t1_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c1_t1_t3_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c1_t1_t3_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c1_t1_t3_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c1_t1_t3_mem1*MAS_MEM[15]
	S += c1_t1_t3_mem1 <= c1_t1_t3

	c1_t31 = S.Task('c1_t31', length=4, delay_cost=1)
	c1_t31 += alt(MAS)
	...
	S += c1_t31_in*MAS_in[2]<=c1_t31*MAS[2]

	S += c1_t31_in*MAS_in[3]<=c1_t31*MAS[3]

	S += c1_t31_in*MAS_in[4]<=c1_t31*MAS[4]

	S += c1_t31_in*MAS_in[5]<=c1_t31*MAS[5]

	S += c1_t31_in*MAS_in[6]<=c1_t31*MAS[6]

	S += c1_t31_in*MAS_in[7]<=c1_t31*MAS[7]
	...
	S += (c_qinv01*MAS[4])-1 < c1_t31_mem0*MAS_MEM[8]
	S += (c_qinv01*MAS[5])-1 < c1_t31_mem0*MAS_MEM[10]
	S += (c_qinv01*MAS[6])-1 < c1_t31_mem0*MAS_MEM[12]
	S += (c_qinv01*MAS[7])-1 < c1_t31_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c1_t31_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c1_t31_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c1_t31_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c1_t31_mem1*MAS_MEM[15]
	S += c1_t31_mem1 <= c1_t31

	c1_t4_t0 = S.Task('c1_t4_t0', length=10, delay_cost=1)
	c1_t4_t0 += alt(MM)
	c1_t4_t0_in = S.Task('c1_t4_t0_in', length=1, delay_cost=1)
	c1_t4_t0_in += alt(MM_in)
	S += c1_t4_t0_in*MM_in[0]<=c1_t4_t0*MM[0]
	S += c1_t4_t0_in*MM_in[1]<=c1_t4_t0*MM[1]
	...
	S += (c1_t30*MAS[4])-1 < c1_t4_t0_mem1*MAS_MEM[9]
	S += (c1_t30*MAS[5])-1 < c1_t4_t0_mem1*MAS_MEM[11]
	S += (c1_t30*MAS[6])-1 < c1_t4_t0_mem1*MAS_MEM[13]
	S += (c1_t30*MAS[7])-1 < c1_t4_t0_mem1*MAS_MEM[15]
	S += c1_t4_t0_mem1 <= c1_t4_t0

	c2_t0_t1 = S.Task('c2_t0_t1', length=10, delay_cost=1)
	c2_t0_t1 += alt(MM)
	c2_t0_t1_in = S.Task('c2_t0_t1_in', length=1, delay_cost=1)
	c2_t0_t1_in += alt(MM_in)
	S += c2_t0_t1_in*MM_in[0]<=c2_t0_t1*MM[0]
	S += c2_t0_t1_in*MM_in[1]<=c2_t0_t1*MM[1]
	...
	S += (c_qinv01*MAS[4])-1 < c2_t0_t1_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c2_t0_t1_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c2_t0_t1_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c2_t0_t1_mem1*MAS_MEM[15]
	S += c2_t0_t1_mem1 <= c2_t0_t1

	c2_t0_t3 = S.Task('c2_t0_t3', length=4, delay_cost=1)
	c2_t0_t3 += alt(MAS)
	...
	S += c2_t0_t3_in*MAS_in[2]<=c2_t0_t3*MAS[2]

	S += c2_t0_t3_in*MAS_in[3]<=c2_t0_t3*MAS[3]

	S += c2_t0_t3_in*MAS_in[4]<=c2_t0_t3*MAS[4]

	S += c2_t0_t3_in*MAS_in[5]<=c2_t0_t3*MAS[5]

	S += c2_t0_t3_in*MAS_in[6]<=c2_t0_t3*MAS[6]

	S += c2_t0_t3_in*MAS_in[7]<=c2_t0_t3*MAS[7]
	...
	S += (c_qinv00*MAS[4])-1 < c2_t0_t3_mem0*MAS_MEM[8]
	S += (c_qinv00*MAS[5])-1 < c2_t0_t3_mem0*MAS_MEM[10]
	S += (c_qinv00*MAS[6])-1 < c2_t0_t3_mem0*MAS_MEM[12]
	S += (c_qinv00*MAS[7])-1 < c2_t0_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv01*MAS[4])-1 < c2_t0_t3_mem1*MAS_MEM[9]
	S += (c_qinv01*MAS[5])-1 < c2_t0_t3_mem1*MAS_MEM[11]
	S += (c_qinv01*MAS[6])-1 < c2_t0_t3_mem1*MAS_MEM[13]
	S += (c_qinv01*MAS[7])-1 < c2_t0_t3_mem1*MAS_MEM[15]
	S += c2_t0_t3_mem1 <= c2_t0_t3

	c2_t1_t1 = S.Task('c2_t1_t1', length=10, delay_cost=1)
	c2_t1_t1 += alt(MM)
	c2_t1_t1_in = S.Task('c2_t1_t1_in', length=1, delay_cost=1)
	c2_t1_t1_in += alt(MM_in)
	S += c2_t1_t1_in*MM_in[0]<=c2_t1_t1*MM[0]
	S += c2_t1_t1_in*MM_in[1]<=c2_t1_t1*MM[1]
	...
	S += (c_qinv1_1*MAS[4])-1 < c2_t1_t1_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c2_t1_t1_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c2_t1_t1_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c2_t1_t1_mem1*MAS_MEM[15]
	S += c2_t1_t1_mem1 <= c2_t1_t1

	c2_t1_t3 = S.Task('c2_t1_t3', length=4, delay_cost=1)
	c2_t1_t3 += alt(MAS)
	...
	S += c2_t1_t3_in*MAS_in[2]<=c2_t1_t3*MAS[2]

	S += c2_t1_t3_in*MAS_in[3]<=c2_t1_t3*MAS[3]

	S += c2_t1_t3_in*MAS_in[4]<=c2_t1_t3*MAS[4]

	S += c2_t1_t3_in*MAS_in[5]<=c2_t1_t3*MAS[5]

	S += c2_t1_t3_in*MAS_in[6]<=c2_t1_t3*MAS[6]

	S += c2_t1_t3_in*MAS_in[7]<=c2_t1_t3*MAS[7]
	...
	S += (c_qinv1_0*MAS[4])-1 < c2_t1_t3_mem0*MAS_MEM[8]
	S += (c_qinv1_0*MAS[5])-1 < c2_t1_t3_mem0*MAS_MEM[10]
	S += (c_qinv1_0*MAS[6])-1 < c2_t1_t3_mem0*MAS_MEM[12]
	S += (c_qinv1_0*MAS[7])-1 < c2_t1_t3_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c2_t1_t3_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c2_t1_t3_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c2_t1_t3_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c2_t1_t3_mem1*MAS_MEM[15]
	S += c2_t1_t3_mem1 <= c2_t1_t3

	c2_t31 = S.Task('c2_t31', length=4, delay_cost=1)
	c2_t31 += alt(MAS)
	...
	S += c2_t31_in*MAS_in[2]<=c2_t31*MAS[2]

	S += c2_t31_in*MAS_in[3]<=c2_t31*MAS[3]

	S += c2_t31_in*MAS_in[4]<=c2_t31*MAS[4]

	S += c2_t31_in*MAS_in[5]<=c2_t31*MAS[5]

	S += c2_t31_in*MAS_in[6]<=c2_t31*MAS[6]

	S += c2_t31_in*MAS_in[7]<=c2_t31*MAS[7]
	...
	S += (c_qinv01*MAS[4])-1 < c2_t31_mem0*MAS_MEM[8]
	S += (c_qinv01*MAS[5])-1 < c2_t31_mem0*MAS_MEM[10]
	S += (c_qinv01*MAS[6])-1 < c2_t31_mem0*MAS_MEM[12]
	S += (c_qinv01*MAS[7])-1 < c2_t31_mem0*MAS_MEM[14]
	...
	S += (c_qinv1_1*MAS[4])-1 < c2_t31_mem1*MAS_MEM[9]
	S += (c_qinv1_1*MAS[5])-1 < c2_t31_mem1*MAS_MEM[11]
	S += (c_qinv1_1*MAS[6])-1 < c2_t31_mem1*MAS_MEM[13]
	S += (c_qinv1_1*MAS[7])-1 < c2_t31_mem1*MAS_MEM[15]
	S += c2_t31_mem1 <= c2_t31

	c2_t4_t0 = S.Task('c2_t4_t0', length=10, delay_cost=1)
	c2_t4_t0 += alt(MM)
	c2_t4_t0_in = S.Task('c2_t4_t0_in', length=1, delay_cost=1)
	c2_t4_t0_in += alt(MM_in)
	S += c2_t4_t0_in*MM_in[0]<=c2_t4_t0*MM[0]
	S += c2_t4_t0_in*MM_in[1]<=c2_t4_t0*MM[1]
	...
	S += (c2_t30*MAS[4])-1 < c2_t4_t0_mem1*MAS_MEM[9]
	S += (c2_t30*MAS[5])-1 < c2_t4_t0_mem1*MAS_MEM[11]
	S += (c2_t30*MAS[6])-1 < c2_t4_t0_mem1*MAS_MEM[13]
	S += (c2_t30*MAS[7])-1 < c2_t4_t0_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/FP12_INV_AFTER_FPINV/schedule1.png"
	if(S.solution() != []):
