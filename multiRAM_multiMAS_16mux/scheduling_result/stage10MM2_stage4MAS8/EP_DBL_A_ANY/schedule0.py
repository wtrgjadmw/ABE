...
def solve():
	...
	S += t24_in*MAS_in[4]<=t24*MAS[4]

	S += t24_in*MAS_in[5]<=t24*MAS[5]

	S += t24_in*MAS_in[6]<=t24*MAS[6]

	S += t24_in*MAS_in[7]<=t24*MAS[7]
	...
	S += (t6*MAS[4])-1 < t14_mem1*MAS_MEM[9]
	S += (t6*MAS[5])-1 < t14_mem1*MAS_MEM[11]
	S += (t6*MAS[6])-1 < t14_mem1*MAS_MEM[13]
	S += (t6*MAS[7])-1 < t14_mem1*MAS_MEM[15]
	S += t14_mem1 <= t14
	...
	S += (t19*MAS[4])-1 < t20_mem1*MAS_MEM[9]
	S += (t19*MAS[5])-1 < t20_mem1*MAS_MEM[11]
	S += (t19*MAS[6])-1 < t20_mem1*MAS_MEM[13]
	S += (t19*MAS[7])-1 < t20_mem1*MAS_MEM[15]
	S += t20_mem1 <= t20
	...
	S += (t24*MAS[4])-1 < t25_mem0*MAS_MEM[8]
	S += (t24*MAS[5])-1 < t25_mem0*MAS_MEM[10]
	S += (t24*MAS[6])-1 < t25_mem0*MAS_MEM[12]
	S += (t24*MAS[7])-1 < t25_mem0*MAS_MEM[14]
	S += t25_mem0 <= t25
	...
	S += (t24*MAS[4])-1 < t26_mem0*MAS_MEM[8]
	S += (t24*MAS[5])-1 < t26_mem0*MAS_MEM[10]
	S += (t24*MAS[6])-1 < t26_mem0*MAS_MEM[12]
	S += (t24*MAS[7])-1 < t26_mem0*MAS_MEM[14]
	S += t26_mem0 <= t26
	...
	S += (t20*MAS[4])-1 < t21_mem0*MAS_MEM[8]
	S += (t20*MAS[5])-1 < t21_mem0*MAS_MEM[10]
	S += (t20*MAS[6])-1 < t21_mem0*MAS_MEM[12]
	S += (t20*MAS[7])-1 < t21_mem0*MAS_MEM[14]
	S += t21_mem0 <= t21
	...
	S += t27_in*MAS_in[4]<=t27*MAS[4]

	S += t27_in*MAS_in[5]<=t27*MAS[5]

	S += t27_in*MAS_in[6]<=t27*MAS[6]

	S += t27_in*MAS_in[7]<=t27*MAS[7]
	...
	S += (t9*MAS[6])-1 < t11_mem1*MAS_MEM[13]
	S += (t9*MAS[7])-1 < t11_mem1*MAS_MEM[15]
	S += t11_mem1 <= t11
	...
	S += (t21*MAS[6])-1 < t22_mem0*MAS_MEM[12]
	S += (t21*MAS[7])-1 < t22_mem0*MAS_MEM[14]
	S += t22_mem0 <= t22
	...
	new_PZ = S.Task('new_PZ', length=4, delay_cost=1)
	new_PZ += alt(MAS)
	...
	S += new_PZ_in*MAS_in[4]<=new_PZ*MAS[4]

	S += new_PZ_in*MAS_in[5]<=new_PZ*MAS[5]

	S += new_PZ_in*MAS_in[6]<=new_PZ*MAS[6]

	S += new_PZ_in*MAS_in[7]<=new_PZ*MAS[7]
	...
	S += (t27*MAS[4])-1 < new_PZ_mem0*MAS_MEM[8]
	S += (t27*MAS[5])-1 < new_PZ_mem0*MAS_MEM[10]
	S += (t27*MAS[6])-1 < new_PZ_mem0*MAS_MEM[12]
	S += (t27*MAS[7])-1 < new_PZ_mem0*MAS_MEM[14]
	...
	S += (t27*MAS[4])-1 < new_PZ_mem1*MAS_MEM[9]
	S += (t27*MAS[5])-1 < new_PZ_mem1*MAS_MEM[11]
	S += (t27*MAS[6])-1 < new_PZ_mem1*MAS_MEM[13]
	S += (t27*MAS[7])-1 < new_PZ_mem1*MAS_MEM[15]
	S += new_PZ_mem1 <= new_PZ

	t12 = S.Task('t12', length=10, delay_cost=1)
	t12 += alt(MM)
	...
	S += (t10*MAS[6])-1 < t12_mem0*MAS_MEM[12]
	S += (t10*MAS[7])-1 < t12_mem0*MAS_MEM[14]
	S += t12_mem0 <= t12
	...
	S += (t4*MAS[4])-1 < t13_mem0*MAS_MEM[8]
	S += (t4*MAS[5])-1 < t13_mem0*MAS_MEM[10]
	S += (t4*MAS[6])-1 < t13_mem0*MAS_MEM[12]
	S += (t4*MAS[7])-1 < t13_mem0*MAS_MEM[14]
	S += t13_mem0 <= t13
	...
	S += (t10*MAS[6])-1 < t13_mem1*MAS_MEM[13]
	S += (t10*MAS[7])-1 < t13_mem1*MAS_MEM[15]
	S += t13_mem1 <= t13

	new_PY = S.Task('new_PY', length=4, delay_cost=1)
	new_PY += alt(MAS)
	...
	new_PX = S.Task('new_PX', length=4, delay_cost=1)
	new_PX += alt(MAS)
	...
	S += new_PX_in*MAS_in[4]<=new_PX*MAS[4]

	S += new_PX_in*MAS_in[5]<=new_PX*MAS[5]

	S += new_PX_in*MAS_in[6]<=new_PX*MAS[6]

	S += new_PX_in*MAS_in[7]<=new_PX*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/EP_DBL_A_ANY/schedule0.png"
	if(S.solution() != []):
