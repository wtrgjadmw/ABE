...
def solve():
	...
	S += t410_mem0 >= 46
	t410_mem0 += MAS_MEM[14]

	t410_mem1 = S.Task('t410_mem1', length=1, delay_cost=1)
	S += t410_mem1 >= 46
	t410_mem1 += MAS_MEM[11]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/SPARSE/schedule4.png"
	if(S.solution() != []):
