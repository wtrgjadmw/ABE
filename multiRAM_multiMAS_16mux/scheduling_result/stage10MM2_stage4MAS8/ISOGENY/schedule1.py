...
def solve():
	...
	S += Z_exp5_in*MM_in[1]<=Z_exp5*MM[1]
	...
	S += NX2__in*MAS_in[3]<=NX2_*MAS[3]

	S += NX2__in*MAS_in[4]<=NX2_*MAS[4]

	S += NX2__in*MAS_in[5]<=NX2_*MAS[5]

	S += NX2__in*MAS_in[6]<=NX2_*MAS[6]

	S += NX2__in*MAS_in[7]<=NX2_*MAS[7]
	...
	S += k0_7_Z4_in*MM_in[1]<=k0_7_Z4*MM[1]
	...
	S += k1_7_Z4_in*MM_in[1]<=k1_7_Z4*MM[1]
	...
	S += NY2__in*MAS_in[3]<=NY2_*MAS[3]

	S += NY2__in*MAS_in[4]<=NY2_*MAS[4]

	S += NY2__in*MAS_in[5]<=NY2_*MAS[5]

	S += NY2__in*MAS_in[6]<=NY2_*MAS[6]

	S += NY2__in*MAS_in[7]<=NY2_*MAS[7]
	...
	S += k2_11_Z4_in*MM_in[1]<=k2_11_Z4*MM[1]
	...
	S += k3_12_Z4_in*MM_in[1]<=k3_12_Z4*MM[1]
	...
	S += (NX2_*MAS[4])-1 < NX2_mem0*MAS_MEM[8]
	S += (NX2_*MAS[5])-1 < NX2_mem0*MAS_MEM[10]
	S += (NX2_*MAS[6])-1 < NX2_mem0*MAS_MEM[12]
	S += (NX2_*MAS[7])-1 < NX2_mem0*MAS_MEM[14]
	S += NX2_mem0 <= NX2
	...
	S += k0_6_Z5_in*MM_in[1]<=k0_6_Z5*MM[1]
	...
	S += (Z_exp5*MM[1])-1 < k0_6_Z5_mem1*MM_MEM[3]
	...
	S += DX2__in*MAS_in[3]<=DX2_*MAS[3]

	S += DX2__in*MAS_in[4]<=DX2_*MAS[4]

	S += DX2__in*MAS_in[5]<=DX2_*MAS[5]

	S += DX2__in*MAS_in[6]<=DX2_*MAS[6]

	S += DX2__in*MAS_in[7]<=DX2_*MAS[7]

	DX2__mem0 = S.Task('DX2__mem0', length=1, delay_cost=1)
	DX2__mem0 += alt(MM_MEM)
	S += (DX1*MM[0])-1 < DX2__mem0*MM_MEM[0]
	S += (DX1*MM[1])-1 < DX2__mem0*MM_MEM[2]
	S += DX2__mem0 <= DX2_
	...
	S += k1_6_Z5_in*MM_in[1]<=k1_6_Z5*MM[1]
	...
	S += (Z_exp5*MM[1])-1 < k1_6_Z5_mem1*MM_MEM[3]
	...
	S += (NY2_*MAS[4])-1 < NY2_mem0*MAS_MEM[8]
	S += (NY2_*MAS[5])-1 < NY2_mem0*MAS_MEM[10]
	S += (NY2_*MAS[6])-1 < NY2_mem0*MAS_MEM[12]
	S += (NY2_*MAS[7])-1 < NY2_mem0*MAS_MEM[14]
	S += NY2_mem0 <= NY2
	...
	S += k2_10_Z5_in*MM_in[1]<=k2_10_Z5*MM[1]
	...
	S += (Z_exp5*MM[1])-1 < k2_10_Z5_mem1*MM_MEM[3]
	...
	S += DY2__in*MAS_in[3]<=DY2_*MAS[3]

	S += DY2__in*MAS_in[4]<=DY2_*MAS[4]

	S += DY2__in*MAS_in[5]<=DY2_*MAS[5]

	S += DY2__in*MAS_in[6]<=DY2_*MAS[6]

	S += DY2__in*MAS_in[7]<=DY2_*MAS[7]

	DY2__mem0 = S.Task('DY2__mem0', length=1, delay_cost=1)
	DY2__mem0 += alt(MM_MEM)
	S += (DY1*MM[0])-1 < DY2__mem0*MM_MEM[0]
	S += (DY1*MM[1])-1 < DY2__mem0*MM_MEM[2]
	S += DY2__mem0 <= DY2_
	...
	S += k3_11_Z5_in*MM_in[1]<=k3_11_Z5*MM[1]
	...
	S += (Z_exp5*MM[1])-1 < k3_11_Z5_mem1*MM_MEM[3]
	...
	S += NX3__in*MAS_in[3]<=NX3_*MAS[3]

	S += NX3__in*MAS_in[4]<=NX3_*MAS[4]

	S += NX3__in*MAS_in[5]<=NX3_*MAS[5]

	S += NX3__in*MAS_in[6]<=NX3_*MAS[6]

	S += NX3__in*MAS_in[7]<=NX3_*MAS[7]

	NX3__mem0 = S.Task('NX3__mem0', length=1, delay_cost=1)
	NX3__mem0 += alt(MM_MEM)
	S += (NX2*MM[0])-1 < NX3__mem0*MM_MEM[0]
	S += (NX2*MM[1])-1 < NX3__mem0*MM_MEM[2]
	S += NX3__mem0 <= NX3_
	...
	S += k0_5_Z6_in*MM_in[1]<=k0_5_Z6*MM[1]
	...
	S += (Z_exp6*MM[1])-1 < k0_5_Z6_mem1*MM_MEM[3]
	...
	S += (DX2_*MAS[4])-1 < DX2_mem0*MAS_MEM[8]
	S += (DX2_*MAS[5])-1 < DX2_mem0*MAS_MEM[10]
	S += (DX2_*MAS[6])-1 < DX2_mem0*MAS_MEM[12]
	S += (DX2_*MAS[7])-1 < DX2_mem0*MAS_MEM[14]
	S += DX2_mem0 <= DX2
	...
	S += k1_5_Z6_in*MM_in[1]<=k1_5_Z6*MM[1]
	...
	S += (Z_exp6*MM[1])-1 < k1_5_Z6_mem1*MM_MEM[3]
	...
	S += NY3__in*MAS_in[3]<=NY3_*MAS[3]

	S += NY3__in*MAS_in[4]<=NY3_*MAS[4]

	S += NY3__in*MAS_in[5]<=NY3_*MAS[5]

	S += NY3__in*MAS_in[6]<=NY3_*MAS[6]

	S += NY3__in*MAS_in[7]<=NY3_*MAS[7]

	NY3__mem0 = S.Task('NY3__mem0', length=1, delay_cost=1)
	NY3__mem0 += alt(MM_MEM)
	S += (NY2*MM[0])-1 < NY3__mem0*MM_MEM[0]
	S += (NY2*MM[1])-1 < NY3__mem0*MM_MEM[2]
	S += NY3__mem0 <= NY3_
	...
	S += k2_9_Z6_in*MM_in[1]<=k2_9_Z6*MM[1]
	...
	S += (Z_exp6*MM[1])-1 < k2_9_Z6_mem1*MM_MEM[3]
	...
	S += (DY2_*MAS[5])-1 < DY2_mem0*MAS_MEM[10]
	S += (DY2_*MAS[6])-1 < DY2_mem0*MAS_MEM[12]
	S += (DY2_*MAS[7])-1 < DY2_mem0*MAS_MEM[14]
	S += DY2_mem0 <= DY2
	...
	S += k3_10_Z6_in*MM_in[1]<=k3_10_Z6*MM[1]
	...
	S += (Z_exp6*MM[1])-1 < k3_10_Z6_mem1*MM_MEM[3]
	...
	S += (NX3_*MAS[4])-1 < NX3_mem0*MAS_MEM[8]
	S += (NX3_*MAS[5])-1 < NX3_mem0*MAS_MEM[10]
	S += (NX3_*MAS[6])-1 < NX3_mem0*MAS_MEM[12]
	S += (NX3_*MAS[7])-1 < NX3_mem0*MAS_MEM[14]
	S += NX3_mem0 <= NX3
	...
	S += k0_4_Z7_in*MM_in[1]<=k0_4_Z7*MM[1]
	...
	S += (Z_exp7*MM[1])-1 < k0_4_Z7_mem1*MM_MEM[3]
	...
	S += DX3__in*MAS_in[3]<=DX3_*MAS[3]

	S += DX3__in*MAS_in[4]<=DX3_*MAS[4]

	S += DX3__in*MAS_in[5]<=DX3_*MAS[5]

	S += DX3__in*MAS_in[6]<=DX3_*MAS[6]

	S += DX3__in*MAS_in[7]<=DX3_*MAS[7]

	DX3__mem0 = S.Task('DX3__mem0', length=1, delay_cost=1)
	DX3__mem0 += alt(MM_MEM)
	S += (DX2*MM[0])-1 < DX3__mem0*MM_MEM[0]
	S += (DX2*MM[1])-1 < DX3__mem0*MM_MEM[2]
	S += DX3__mem0 <= DX3_

	DX3__mem1 = S.Task('DX3__mem1', length=1, delay_cost=1)
	DX3__mem1 += alt(MM_MEM)
	S += (k1_7_Z4*MM[0])-1 < DX3__mem1*MM_MEM[1]
	S += (k1_7_Z4*MM[1])-1 < DX3__mem1*MM_MEM[3]
	S += DX3__mem1 <= DX3_
	...
	S += k1_4_Z7_in*MM_in[1]<=k1_4_Z7*MM[1]
	...
	S += (Z_exp7*MM[1])-1 < k1_4_Z7_mem1*MM_MEM[3]
	...
	S += (NY3_*MAS[4])-1 < NY3_mem0*MAS_MEM[8]
	S += (NY3_*MAS[5])-1 < NY3_mem0*MAS_MEM[10]
	S += (NY3_*MAS[6])-1 < NY3_mem0*MAS_MEM[12]
	S += (NY3_*MAS[7])-1 < NY3_mem0*MAS_MEM[14]
	S += NY3_mem0 <= NY3
	...
	S += k2_8_Z7_in*MM_in[1]<=k2_8_Z7*MM[1]
	...
	S += (Z_exp7*MM[1])-1 < k2_8_Z7_mem1*MM_MEM[3]
	...
	S += DY3__in*MAS_in[3]<=DY3_*MAS[3]

	S += DY3__in*MAS_in[4]<=DY3_*MAS[4]

	S += DY3__in*MAS_in[5]<=DY3_*MAS[5]

	S += DY3__in*MAS_in[6]<=DY3_*MAS[6]

	S += DY3__in*MAS_in[7]<=DY3_*MAS[7]

	DY3__mem0 = S.Task('DY3__mem0', length=1, delay_cost=1)
	DY3__mem0 += alt(MM_MEM)
	S += (DY2*MM[0])-1 < DY3__mem0*MM_MEM[0]
	S += (DY2*MM[1])-1 < DY3__mem0*MM_MEM[2]
	S += DY3__mem0 <= DY3_

	DY3__mem1 = S.Task('DY3__mem1', length=1, delay_cost=1)
	DY3__mem1 += alt(MM_MEM)
	S += (k3_12_Z4*MM[0])-1 < DY3__mem1*MM_MEM[1]
	S += (k3_12_Z4*MM[1])-1 < DY3__mem1*MM_MEM[3]
	S += DY3__mem1 <= DY3_
	...
	S += k3_9_Z7_in*MM_in[1]<=k3_9_Z7*MM[1]
	...
	S += (Z_exp7*MM[1])-1 < k3_9_Z7_mem1*MM_MEM[3]
	...
	S += NX4__in*MAS_in[3]<=NX4_*MAS[3]

	S += NX4__in*MAS_in[4]<=NX4_*MAS[4]

	S += NX4__in*MAS_in[5]<=NX4_*MAS[5]

	S += NX4__in*MAS_in[6]<=NX4_*MAS[6]

	S += NX4__in*MAS_in[7]<=NX4_*MAS[7]

	NX4__mem0 = S.Task('NX4__mem0', length=1, delay_cost=1)
	NX4__mem0 += alt(MM_MEM)
	S += (NX3*MM[0])-1 < NX4__mem0*MM_MEM[0]
	S += (NX3*MM[1])-1 < NX4__mem0*MM_MEM[2]
	S += NX4__mem0 <= NX4_

	NX4__mem1 = S.Task('NX4__mem1', length=1, delay_cost=1)
	NX4__mem1 += alt(MM_MEM)
	S += (k0_7_Z4*MM[0])-1 < NX4__mem1*MM_MEM[1]
	S += (k0_7_Z4*MM[1])-1 < NX4__mem1*MM_MEM[3]
	S += NX4__mem1 <= NX4_
	...
	S += k0_3_Z8_in*MM_in[1]<=k0_3_Z8*MM[1]
	...
	S += (Z_exp8*MM[1])-1 < k0_3_Z8_mem1*MM_MEM[3]
	...
	S += (DX3_*MAS[4])-1 < DX3_mem0*MAS_MEM[8]
	S += (DX3_*MAS[5])-1 < DX3_mem0*MAS_MEM[10]
	S += (DX3_*MAS[6])-1 < DX3_mem0*MAS_MEM[12]
	S += (DX3_*MAS[7])-1 < DX3_mem0*MAS_MEM[14]
	S += DX3_mem0 <= DX3
	...
	S += k1_3_Z8_in*MM_in[1]<=k1_3_Z8*MM[1]
	...
	S += (Z_exp8*MM[1])-1 < k1_3_Z8_mem1*MM_MEM[3]
	...
	S += NY4__in*MAS_in[3]<=NY4_*MAS[3]

	S += NY4__in*MAS_in[4]<=NY4_*MAS[4]

	S += NY4__in*MAS_in[5]<=NY4_*MAS[5]

	S += NY4__in*MAS_in[6]<=NY4_*MAS[6]

	S += NY4__in*MAS_in[7]<=NY4_*MAS[7]

	NY4__mem0 = S.Task('NY4__mem0', length=1, delay_cost=1)
	NY4__mem0 += alt(MM_MEM)
	S += (NY3*MM[0])-1 < NY4__mem0*MM_MEM[0]
	S += (NY3*MM[1])-1 < NY4__mem0*MM_MEM[2]
	S += NY4__mem0 <= NY4_

	NY4__mem1 = S.Task('NY4__mem1', length=1, delay_cost=1)
	NY4__mem1 += alt(MM_MEM)
	S += (k2_11_Z4*MM[0])-1 < NY4__mem1*MM_MEM[1]
	S += (k2_11_Z4*MM[1])-1 < NY4__mem1*MM_MEM[3]
	S += NY4__mem1 <= NY4_
	...
	S += k2_7_Z8_in*MM_in[1]<=k2_7_Z8*MM[1]
	...
	S += (Z_exp8*MM[1])-1 < k2_7_Z8_mem1*MM_MEM[3]
	...
	S += (DY3_*MAS[4])-1 < DY3_mem0*MAS_MEM[8]
	S += (DY3_*MAS[5])-1 < DY3_mem0*MAS_MEM[10]
	S += (DY3_*MAS[6])-1 < DY3_mem0*MAS_MEM[12]
	S += (DY3_*MAS[7])-1 < DY3_mem0*MAS_MEM[14]
	S += DY3_mem0 <= DY3
	...
	S += k3_8_Z8_in*MM_in[1]<=k3_8_Z8*MM[1]
	...
	S += (Z_exp8*MM[1])-1 < k3_8_Z8_mem1*MM_MEM[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS8/ISOGENY/schedule1.png"
	if(S.solution() != []):
