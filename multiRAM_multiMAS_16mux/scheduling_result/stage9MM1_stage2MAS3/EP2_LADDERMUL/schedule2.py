...
def solve():
	...
	T10_t4_mem1 += alt(MAS_MEM)
	S += (T10_t3*MAS[0])-1 < T10_t4_mem1*MAS_MEM[1]
	S += (T10_t3*MAS[1])-1 < T10_t4_mem1*MAS_MEM[3]
	S += (T10_t3*MAS[2])-1 < T10_t4_mem1*MAS_MEM[5]
	...
	S += (T10_t0*MM[0])-1 < T100_mem0*MM_MEM[0]
	S += T100_mem0 <= T100

	T100_mem1 = S.Task('T100_mem1', length=1, delay_cost=1)
	T100_mem1 += alt(MM_MEM)
	S += (T10_t1*MM[0])-1 < T100_mem1*MM_MEM[1]
	S += T100_mem1 <= T100
	...
	T10_t5_mem0 += alt(MM_MEM)
	S += (T10_t0*MM[0])-1 < T10_t5_mem0*MM_MEM[0]
	S += T10_t5_mem0 <= T10_t5

	T10_t5_mem1 = S.Task('T10_t5_mem1', length=1, delay_cost=1)
	T10_t5_mem1 += alt(MM_MEM)
	S += (T10_t1*MM[0])-1 < T10_t5_mem1*MM_MEM[1]
	...
	T11_t4_mem1 += alt(MAS_MEM)
	S += (T11_t3*MAS[0])-1 < T11_t4_mem1*MAS_MEM[1]
	S += (T11_t3*MAS[1])-1 < T11_t4_mem1*MAS_MEM[3]
	S += (T11_t3*MAS[2])-1 < T11_t4_mem1*MAS_MEM[5]
	...
	T110_mem0 += alt(MM_MEM)
	S += (T11_t0*MM[0])-1 < T110_mem0*MM_MEM[0]
	S += T110_mem0 <= T110

	T110_mem1 = S.Task('T110_mem1', length=1, delay_cost=1)
	T110_mem1 += alt(MM_MEM)
	S += (T11_t1*MM[0])-1 < T110_mem1*MM_MEM[1]
	S += T110_mem1 <= T110
	...
	T11_t5_mem0 += alt(MM_MEM)
	S += (T11_t0*MM[0])-1 < T11_t5_mem0*MM_MEM[0]
	S += T11_t5_mem0 <= T11_t5

	T11_t5_mem1 = S.Task('T11_t5_mem1', length=1, delay_cost=1)
	T11_t5_mem1 += alt(MM_MEM)
	S += (T11_t1*MM[0])-1 < T11_t5_mem1*MM_MEM[1]
	...
	T16_t0_mem0 += alt(MAS_MEM)
	S += (T10*MAS[0])-1 < T16_t0_mem0*MAS_MEM[0]
	S += (T10*MAS[1])-1 < T16_t0_mem0*MAS_MEM[2]
	S += (T10*MAS[2])-1 < T16_t0_mem0*MAS_MEM[4]
	...
	T16_t1_mem0 += alt(MAS_MEM)
	S += (T11*MAS[0])-1 < T16_t1_mem0*MAS_MEM[0]
	S += (T11*MAS[1])-1 < T16_t1_mem0*MAS_MEM[2]
	S += (T11*MAS[2])-1 < T16_t1_mem0*MAS_MEM[4]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS3/EP2_LADDERMUL/schedule2.png"
	if(S.solution() != []):
