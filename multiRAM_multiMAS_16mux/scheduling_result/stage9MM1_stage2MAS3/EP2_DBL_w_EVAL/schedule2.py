...
def solve():
	...
	S += (t90*MAS[0])-1 < c200_mem0*MAS_MEM[0]
	S += (t90*MAS[1])-1 < c200_mem0*MAS_MEM[2]
	S += (t90*MAS[2])-1 < c200_mem0*MAS_MEM[4]
	S += c200_mem0 <= c200
	...
	S += (t61*MAS[0])-1 < new_TX_t1_mem1*MAS_MEM[1]
	S += (t61*MAS[1])-1 < new_TX_t1_mem1*MAS_MEM[3]
	S += (t61*MAS[2])-1 < new_TX_t1_mem1*MAS_MEM[5]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS3/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
