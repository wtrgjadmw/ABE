...
def solve():
	...
	S += c_cc_t2_t3_mem0 >= 26
	c_cc_t2_t3_mem0 += MAS_MEM[0]

	c_cc_t2_t3_mem1 = S.Task('c_cc_t2_t3_mem1', length=1, delay_cost=1)
	S += c_cc_t2_t3_mem1 >= 26
	...
	S += c_ac_t0_t4_mem0 >= 35
	c_ac_t0_t4_mem0 += MAS_MEM[6]

	c_ac_t0_t4_mem1 = S.Task('c_ac_t0_t4_mem1', length=1, delay_cost=1)
	S += c_ac_t0_t4_mem1 >= 35
	...
	S += c_bc_t4_t0_mem0 >= 50
	c_bc_t4_t0_mem0 += MAS_MEM[6]

	c_bc_t4_t0_mem1 = S.Task('c_bc_t4_t0_mem1', length=1, delay_cost=1)
	S += c_bc_t4_t0_mem1 >= 50
	...
	S += c_ac_t1_t5_mem0 >= 52
	c_ac_t1_t5_mem0 += MM_MEM[2]

	c_ac_t1_t5_mem1 = S.Task('c_ac_t1_t5_mem1', length=1, delay_cost=1)
	S += c_ac_t1_t5_mem1 >= 52
	...
	S += c_bc_t0_t5_mem0 >= 54
	c_bc_t0_t5_mem0 += MM_MEM[2]

	c_bc_t0_t5_mem1 = S.Task('c_bc_t0_t5_mem1', length=1, delay_cost=1)
	S += c_bc_t0_t5_mem1 >= 54
	...
	S += c_bc_t1_t5_mem0 >= 55
	c_bc_t1_t5_mem0 += MM_MEM[2]

	c_bc_t1_t5_mem1 = S.Task('c_bc_t1_t5_mem1', length=1, delay_cost=1)
	S += c_bc_t1_t5_mem1 >= 55
	...
	S += c_ab_t4_t0_mem0 >= 56
	c_ab_t4_t0_mem0 += MAS_MEM[0]

	c_ab_t4_t0_mem1 = S.Task('c_ab_t4_t0_mem1', length=1, delay_cost=1)
	S += c_ab_t4_t0_mem1 >= 56
	...
	S += c_bc_t4_t5_mem0 >= 70
	c_bc_t4_t5_mem0 += MM_MEM[2]

	c_bc_t4_t5_mem1 = S.Task('c_bc_t4_t5_mem1', length=1, delay_cost=1)
	S += c_bc_t4_t5_mem1 >= 70
	...
	c_qinv_bb_t1_mem0 += MAS_MEM[10]
	S += 123 < c_qinv_bb_t1_mem0
	S += c_qinv_bb_t1_mem0 <= c_qinv_bb_t1

	c_qinv_bb_t1_mem1 = S.Task('c_qinv_bb_t1_mem1', length=1, delay_cost=1)
	c_qinv_bb_t1_mem1 += MAS_MEM[11]
	S += 123 < c_qinv_bb_t1_mem1
	...
	c_qinv_bb_t2_mem1 += MAS_MEM[11]
	S += 123 < c_qinv_bb_t2_mem1
	...
	c_qinv_bb_t3_mem1 += MAS_MEM[11]
	S += 123 < c_qinv_bb_t3_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS6/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
