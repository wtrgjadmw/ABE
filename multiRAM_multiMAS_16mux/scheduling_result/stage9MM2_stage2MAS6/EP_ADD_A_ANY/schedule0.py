...
def solve():
	...
	t19 = S.Task('t19', length=9, delay_cost=1)
	t19 += alt(MM)
	...
	t18 = S.Task('t18', length=9, delay_cost=1)
	t18 += alt(MM)
	...
	t35 = S.Task('t35', length=9, delay_cost=1)
	t35 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM2_stage2MAS6/EP_ADD_A_ANY/schedule0.png"
	if(S.solution() != []):
