...
def solve():
	...
	DY4__mem1 += alt(MM_MEM)
	S += (k3_11_Z5*MM[0])-1 < DY4__mem1*MM_MEM[1]
	S += (k3_11_Z5*MM[1])-1 < DY4__mem1*MM_MEM[3]
	S += DY4__mem1 <= DY4_
	...
	NX5__mem1 += alt(MM_MEM)
	S += (k0_6_Z5*MM[0])-1 < NX5__mem1*MM_MEM[1]
	S += (k0_6_Z5*MM[1])-1 < NX5__mem1*MM_MEM[3]
	S += NX5__mem1 <= NX5_
	...
	NX6__mem1 += alt(MM_MEM)
	S += (k0_5_Z6*MM[0])-1 < NX6__mem1*MM_MEM[1]
	S += (k0_5_Z6*MM[1])-1 < NX6__mem1*MM_MEM[3]
	S += NX6__mem1 <= NX6_
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM2_stage1MAS4/ISOGENY/schedule2.png"
	if(S.solution() != []):
