...
def solve():
	...
	S += c_t3_t4_t4_mem0 >= 70
	c_t3_t4_t4_mem0 += MAS_MEM[6]

	c_t3_t4_t4_mem1 = S.Task('c_t3_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t4_mem1 >= 70
	...
	S += c_t3_t4_t5_mem0 >= 71
	c_t3_t4_t5_mem0 += MM_MEM[2]

	c_t3_t4_t5_mem1 = S.Task('c_t3_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t5_mem1 >= 71
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM2_stage2MAS4/MUL/schedule7.png"
	if(S.solution() != []):
