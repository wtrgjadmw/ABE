...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM2_stage2MAS4/FP12_INV_BEFORE_FPINV/schedule4.png"
	if(S.solution() != []):
