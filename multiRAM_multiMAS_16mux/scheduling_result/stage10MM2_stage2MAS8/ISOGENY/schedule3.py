...
def solve():
	...
	S += DX7__in*MAS_in[6]<=DX7_*MAS[6]

	S += DX7__in*MAS_in[7]<=DX7_*MAS[7]
	...
	S += DY7__in*MAS_in[6]<=DY7_*MAS[6]

	S += DY7__in*MAS_in[7]<=DY7_*MAS[7]
	...
	S += NX8__in*MAS_in[6]<=NX8_*MAS[6]

	S += NX8__in*MAS_in[7]<=NX8_*MAS[7]
	...
	S += NY8__in*MAS_in[6]<=NY8_*MAS[6]

	S += NY8__in*MAS_in[7]<=NY8_*MAS[7]
	...
	S += DX8__in*MAS_in[6]<=DX8_*MAS[6]

	S += DX8__in*MAS_in[7]<=DX8_*MAS[7]
	...
	S += DY8__in*MAS_in[6]<=DY8_*MAS[6]

	S += DY8__in*MAS_in[7]<=DY8_*MAS[7]
	...
	S += NX9__in*MAS_in[6]<=NX9_*MAS[6]

	S += NX9__in*MAS_in[7]<=NX9_*MAS[7]
	...
	S += NY9__in*MAS_in[6]<=NY9_*MAS[6]

	S += NY9__in*MAS_in[7]<=NY9_*MAS[7]
	...
	S += DX9__in*MAS_in[6]<=DX9_*MAS[6]

	S += DX9__in*MAS_in[7]<=DX9_*MAS[7]
	...
	S += DY9__in*MAS_in[6]<=DY9_*MAS[6]

	S += DY9__in*MAS_in[7]<=DY9_*MAS[7]
	...
	S += NX10__in*MAS_in[6]<=NX10_*MAS[6]

	S += NX10__in*MAS_in[7]<=NX10_*MAS[7]
	...
	S += NY10__in*MAS_in[6]<=NY10_*MAS[6]

	S += NY10__in*MAS_in[7]<=NY10_*MAS[7]
	...
	S += DX_in*MAS_in[6]<=DX*MAS[6]

	S += DX_in*MAS_in[7]<=DX*MAS[7]
	...
	S += DY10__in*MAS_in[6]<=DY10_*MAS[6]

	S += DY10__in*MAS_in[7]<=DY10_*MAS[7]
	...
	S += NX_in*MAS_in[6]<=NX*MAS[6]

	S += NX_in*MAS_in[7]<=NX*MAS[7]
	...
	S += NY11__in*MAS_in[6]<=NY11_*MAS[6]

	S += NY11__in*MAS_in[7]<=NY11_*MAS[7]
	...
	S += DY11__in*MAS_in[6]<=DY11_*MAS[6]

	S += DY11__in*MAS_in[7]<=DY11_*MAS[7]
	...
	S += NY12__in*MAS_in[6]<=NY12_*MAS[6]

	S += NY12__in*MAS_in[7]<=NY12_*MAS[7]
	...
	S += DY12__in*MAS_in[6]<=DY12_*MAS[6]

	S += DY12__in*MAS_in[7]<=DY12_*MAS[7]
	...
	S += NY13__in*MAS_in[6]<=NY13_*MAS[6]

	S += NY13__in*MAS_in[7]<=NY13_*MAS[7]
	...
	S += DY13__in*MAS_in[6]<=DY13_*MAS[6]

	S += DY13__in*MAS_in[7]<=DY13_*MAS[7]
	...
	S += NY14__in*MAS_in[6]<=NY14_*MAS[6]

	S += NY14__in*MAS_in[7]<=NY14_*MAS[7]
	...
	S += DY14__in*MAS_in[6]<=DY14_*MAS[6]

	S += DY14__in*MAS_in[7]<=DY14_*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/ISOGENY/schedule3.png"
	if(S.solution() != []):
