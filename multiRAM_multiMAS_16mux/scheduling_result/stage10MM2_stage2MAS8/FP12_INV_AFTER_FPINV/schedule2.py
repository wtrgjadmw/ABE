...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/FP12_INV_AFTER_FPINV/schedule2.png"
	if(S.solution() != []):
