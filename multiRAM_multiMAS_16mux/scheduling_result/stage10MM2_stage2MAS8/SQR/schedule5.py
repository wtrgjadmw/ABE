...
def solve():
	...
	S += c_t3_t3_t4_mem0 >= 38
	c_t3_t3_t4_mem0 += MAS_MEM[12]

	c_t3_t3_t4_mem1 = S.Task('c_t3_t3_t4_mem1', length=1, delay_cost=1)
	S += c_t3_t3_t4_mem1 >= 38
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/SQR/schedule5.png"
	if(S.solution() != []):
