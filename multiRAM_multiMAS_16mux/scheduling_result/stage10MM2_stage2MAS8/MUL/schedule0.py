...
def solve():
	...
	S += c_t2_t0_t2_in*MAS_in[4]<=c_t2_t0_t2*MAS[4]

	S += c_t2_t0_t2_in*MAS_in[5]<=c_t2_t0_t2*MAS[5]

	S += c_t2_t0_t2_in*MAS_in[6]<=c_t2_t0_t2*MAS[6]

	S += c_t2_t0_t2_in*MAS_in[7]<=c_t2_t0_t2*MAS[7]
	...
	S += c_t2_t0_t3_in*MAS_in[4]<=c_t2_t0_t3*MAS[4]

	S += c_t2_t0_t3_in*MAS_in[5]<=c_t2_t0_t3*MAS[5]

	S += c_t2_t0_t3_in*MAS_in[6]<=c_t2_t0_t3*MAS[6]

	S += c_t2_t0_t3_in*MAS_in[7]<=c_t2_t0_t3*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/MUL/schedule0.png"
	if(S.solution() != []):
