...
def solve():
	...
	S += c_aa_a1_0_in*MAS_in[4]<=c_aa_a1_0*MAS[4]

	S += c_aa_a1_0_in*MAS_in[5]<=c_aa_a1_0*MAS[5]

	S += c_aa_a1_0_in*MAS_in[6]<=c_aa_a1_0*MAS[6]

	S += c_aa_a1_0_in*MAS_in[7]<=c_aa_a1_0*MAS[7]
	...
	S += c_aa_a1_1_in*MAS_in[4]<=c_aa_a1_1*MAS[4]

	S += c_aa_a1_1_in*MAS_in[5]<=c_aa_a1_1*MAS[5]

	S += c_aa_a1_1_in*MAS_in[6]<=c_aa_a1_1*MAS[6]

	S += c_aa_a1_1_in*MAS_in[7]<=c_aa_a1_1*MAS[7]
	...
	S += c_aa_t10_in*MAS_in[4]<=c_aa_t10*MAS[4]

	S += c_aa_t10_in*MAS_in[5]<=c_aa_t10*MAS[5]

	S += c_aa_t10_in*MAS_in[6]<=c_aa_t10*MAS[6]

	S += c_aa_t10_in*MAS_in[7]<=c_aa_t10*MAS[7]
	...
	S += c_aa_t11_in*MAS_in[4]<=c_aa_t11*MAS[4]

	S += c_aa_t11_in*MAS_in[5]<=c_aa_t11*MAS[5]

	S += c_aa_t11_in*MAS_in[6]<=c_aa_t11*MAS[6]

	S += c_aa_t11_in*MAS_in[7]<=c_aa_t11*MAS[7]
	...
	S += c_aa_t3_t0_in*MM_in[1]<=c_aa_t3_t0*MM[1]
	...
	S += c_aa_t3_t1_in*MM_in[1]<=c_aa_t3_t1*MM[1]
	...
	S += c_aa_t3_t2_in*MAS_in[4]<=c_aa_t3_t2*MAS[4]

	S += c_aa_t3_t2_in*MAS_in[5]<=c_aa_t3_t2*MAS[5]

	S += c_aa_t3_t2_in*MAS_in[6]<=c_aa_t3_t2*MAS[6]

	S += c_aa_t3_t2_in*MAS_in[7]<=c_aa_t3_t2*MAS[7]
	...
	S += c_aa_t3_t3_in*MAS_in[4]<=c_aa_t3_t3*MAS[4]

	S += c_aa_t3_t3_in*MAS_in[5]<=c_aa_t3_t3*MAS[5]

	S += c_aa_t3_t3_in*MAS_in[6]<=c_aa_t3_t3*MAS[6]

	S += c_aa_t3_t3_in*MAS_in[7]<=c_aa_t3_t3*MAS[7]
	...
	S += c_bb_a1_0_in*MAS_in[4]<=c_bb_a1_0*MAS[4]

	S += c_bb_a1_0_in*MAS_in[5]<=c_bb_a1_0*MAS[5]

	S += c_bb_a1_0_in*MAS_in[6]<=c_bb_a1_0*MAS[6]

	S += c_bb_a1_0_in*MAS_in[7]<=c_bb_a1_0*MAS[7]
	...
	S += c_bb_a1_1_in*MAS_in[4]<=c_bb_a1_1*MAS[4]

	S += c_bb_a1_1_in*MAS_in[5]<=c_bb_a1_1*MAS[5]

	S += c_bb_a1_1_in*MAS_in[6]<=c_bb_a1_1*MAS[6]

	S += c_bb_a1_1_in*MAS_in[7]<=c_bb_a1_1*MAS[7]
	...
	S += c_bb_t10_in*MAS_in[4]<=c_bb_t10*MAS[4]

	S += c_bb_t10_in*MAS_in[5]<=c_bb_t10*MAS[5]

	S += c_bb_t10_in*MAS_in[6]<=c_bb_t10*MAS[6]

	S += c_bb_t10_in*MAS_in[7]<=c_bb_t10*MAS[7]
	...
	S += c_bb_t11_in*MAS_in[4]<=c_bb_t11*MAS[4]

	S += c_bb_t11_in*MAS_in[5]<=c_bb_t11*MAS[5]

	S += c_bb_t11_in*MAS_in[6]<=c_bb_t11*MAS[6]

	S += c_bb_t11_in*MAS_in[7]<=c_bb_t11*MAS[7]
	...
	S += c_bb_t3_t0_in*MM_in[1]<=c_bb_t3_t0*MM[1]
	...
	S += c_bb_t3_t1_in*MM_in[1]<=c_bb_t3_t1*MM[1]
	...
	S += c_bb_t3_t2_in*MAS_in[4]<=c_bb_t3_t2*MAS[4]

	S += c_bb_t3_t2_in*MAS_in[5]<=c_bb_t3_t2*MAS[5]

	S += c_bb_t3_t2_in*MAS_in[6]<=c_bb_t3_t2*MAS[6]

	S += c_bb_t3_t2_in*MAS_in[7]<=c_bb_t3_t2*MAS[7]
	...
	S += c_bb_t3_t3_in*MAS_in[4]<=c_bb_t3_t3*MAS[4]

	S += c_bb_t3_t3_in*MAS_in[5]<=c_bb_t3_t3*MAS[5]

	S += c_bb_t3_t3_in*MAS_in[6]<=c_bb_t3_t3*MAS[6]

	S += c_bb_t3_t3_in*MAS_in[7]<=c_bb_t3_t3*MAS[7]
	...
	S += c_cc_a1_0_in*MAS_in[4]<=c_cc_a1_0*MAS[4]

	S += c_cc_a1_0_in*MAS_in[5]<=c_cc_a1_0*MAS[5]

	S += c_cc_a1_0_in*MAS_in[6]<=c_cc_a1_0*MAS[6]

	S += c_cc_a1_0_in*MAS_in[7]<=c_cc_a1_0*MAS[7]
	...
	S += c_cc_a1_1_in*MAS_in[4]<=c_cc_a1_1*MAS[4]

	S += c_cc_a1_1_in*MAS_in[5]<=c_cc_a1_1*MAS[5]

	S += c_cc_a1_1_in*MAS_in[6]<=c_cc_a1_1*MAS[6]

	S += c_cc_a1_1_in*MAS_in[7]<=c_cc_a1_1*MAS[7]
	...
	S += c_cc_t10_in*MAS_in[4]<=c_cc_t10*MAS[4]

	S += c_cc_t10_in*MAS_in[5]<=c_cc_t10*MAS[5]

	S += c_cc_t10_in*MAS_in[6]<=c_cc_t10*MAS[6]

	S += c_cc_t10_in*MAS_in[7]<=c_cc_t10*MAS[7]
	...
	S += c_cc_t11_in*MAS_in[4]<=c_cc_t11*MAS[4]

	S += c_cc_t11_in*MAS_in[5]<=c_cc_t11*MAS[5]

	S += c_cc_t11_in*MAS_in[6]<=c_cc_t11*MAS[6]

	S += c_cc_t11_in*MAS_in[7]<=c_cc_t11*MAS[7]
	...
	S += c_cc_t3_t0_in*MM_in[1]<=c_cc_t3_t0*MM[1]
	...
	S += c_cc_t3_t1_in*MM_in[1]<=c_cc_t3_t1*MM[1]
	...
	S += c_cc_t3_t2_in*MAS_in[4]<=c_cc_t3_t2*MAS[4]

	S += c_cc_t3_t2_in*MAS_in[5]<=c_cc_t3_t2*MAS[5]

	S += c_cc_t3_t2_in*MAS_in[6]<=c_cc_t3_t2*MAS[6]

	S += c_cc_t3_t2_in*MAS_in[7]<=c_cc_t3_t2*MAS[7]
	...
	S += c_cc_t3_t3_in*MAS_in[4]<=c_cc_t3_t3*MAS[4]

	S += c_cc_t3_t3_in*MAS_in[5]<=c_cc_t3_t3*MAS[5]

	S += c_cc_t3_t3_in*MAS_in[6]<=c_cc_t3_t3*MAS[6]

	S += c_cc_t3_t3_in*MAS_in[7]<=c_cc_t3_t3*MAS[7]
	...
	S += c_ab_t0_t0_in*MM_in[1]<=c_ab_t0_t0*MM[1]
	...
	S += c_ab_t0_t1_in*MM_in[1]<=c_ab_t0_t1*MM[1]
	...
	S += c_ab_t0_t2_in*MAS_in[4]<=c_ab_t0_t2*MAS[4]

	S += c_ab_t0_t2_in*MAS_in[5]<=c_ab_t0_t2*MAS[5]

	S += c_ab_t0_t2_in*MAS_in[6]<=c_ab_t0_t2*MAS[6]

	S += c_ab_t0_t2_in*MAS_in[7]<=c_ab_t0_t2*MAS[7]
	...
	S += c_ab_t0_t3_in*MAS_in[4]<=c_ab_t0_t3*MAS[4]

	S += c_ab_t0_t3_in*MAS_in[5]<=c_ab_t0_t3*MAS[5]

	S += c_ab_t0_t3_in*MAS_in[6]<=c_ab_t0_t3*MAS[6]

	S += c_ab_t0_t3_in*MAS_in[7]<=c_ab_t0_t3*MAS[7]
	...
	S += c_ab_t1_t0_in*MM_in[1]<=c_ab_t1_t0*MM[1]
	...
	S += c_ab_t1_t1_in*MM_in[1]<=c_ab_t1_t1*MM[1]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/FP12_INV_BEFORE_FPINV/schedule0.png"
	if(S.solution() != []):
