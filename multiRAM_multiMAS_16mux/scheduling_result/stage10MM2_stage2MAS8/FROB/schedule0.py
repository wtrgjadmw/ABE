...
def solve():
	...
	S += c10_t2_in*MAS_in[4]<=c10_t2*MAS[4]

	S += c10_t2_in*MAS_in[5]<=c10_t2*MAS[5]

	S += c10_t2_in*MAS_in[6]<=c10_t2*MAS[6]

	S += c10_t2_in*MAS_in[7]<=c10_t2*MAS[7]
	...
	S += c10_t3_in*MAS_in[4]<=c10_t3*MAS[4]

	S += c10_t3_in*MAS_in[5]<=c10_t3*MAS[5]

	S += c10_t3_in*MAS_in[6]<=c10_t3*MAS[6]

	S += c10_t3_in*MAS_in[7]<=c10_t3*MAS[7]
	...
	S += c20_t2_in*MAS_in[4]<=c20_t2*MAS[4]

	S += c20_t2_in*MAS_in[5]<=c20_t2*MAS[5]

	S += c20_t2_in*MAS_in[6]<=c20_t2*MAS[6]

	S += c20_t2_in*MAS_in[7]<=c20_t2*MAS[7]
	...
	S += c20_t3_in*MAS_in[4]<=c20_t3*MAS[4]

	S += c20_t3_in*MAS_in[5]<=c20_t3*MAS[5]

	S += c20_t3_in*MAS_in[6]<=c20_t3*MAS[6]

	S += c20_t3_in*MAS_in[7]<=c20_t3*MAS[7]
	...
	S += c01_t2_in*MAS_in[4]<=c01_t2*MAS[4]

	S += c01_t2_in*MAS_in[5]<=c01_t2*MAS[5]

	S += c01_t2_in*MAS_in[6]<=c01_t2*MAS[6]

	S += c01_t2_in*MAS_in[7]<=c01_t2*MAS[7]
	...
	S += c01_t3_in*MAS_in[4]<=c01_t3*MAS[4]

	S += c01_t3_in*MAS_in[5]<=c01_t3*MAS[5]

	S += c01_t3_in*MAS_in[6]<=c01_t3*MAS[6]

	S += c01_t3_in*MAS_in[7]<=c01_t3*MAS[7]
	...
	S += c11_t2_in*MAS_in[4]<=c11_t2*MAS[4]

	S += c11_t2_in*MAS_in[5]<=c11_t2*MAS[5]

	S += c11_t2_in*MAS_in[6]<=c11_t2*MAS[6]

	S += c11_t2_in*MAS_in[7]<=c11_t2*MAS[7]
	...
	S += c11_t3_in*MAS_in[4]<=c11_t3*MAS[4]

	S += c11_t3_in*MAS_in[5]<=c11_t3*MAS[5]

	S += c11_t3_in*MAS_in[6]<=c11_t3*MAS[6]

	S += c11_t3_in*MAS_in[7]<=c11_t3*MAS[7]
	...
	S += c21_t2_in*MAS_in[4]<=c21_t2*MAS[4]

	S += c21_t2_in*MAS_in[5]<=c21_t2*MAS[5]

	S += c21_t2_in*MAS_in[6]<=c21_t2*MAS[6]

	S += c21_t2_in*MAS_in[7]<=c21_t2*MAS[7]
	...
	S += c21_t3_in*MAS_in[4]<=c21_t3*MAS[4]

	S += c21_t3_in*MAS_in[5]<=c21_t3*MAS[5]

	S += c21_t3_in*MAS_in[6]<=c21_t3*MAS[6]

	S += c21_t3_in*MAS_in[7]<=c21_t3*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/FROB/schedule0.png"
	if(S.solution() != []):
