...
def solve():
	...
	c20_t2 = S.Task('c20_t2', length=2, delay_cost=1)
	S += c20_t2 >= 3
	c20_t2 += MAS[1]
	...
	c01_t0 = S.Task('c01_t0', length=10, delay_cost=1)
	S += c01_t0 >= 4
	c01_t0 += MM[0]
	...
	c21_t0 = S.Task('c21_t0', length=10, delay_cost=1)
	S += c21_t0 >= 5
	c21_t0 += MM[0]

	c10_t0 = S.Task('c10_t0', length=10, delay_cost=1)
	S += c10_t0 >= 6
	c10_t0 += MM[1]
	...
	c11_t3 = S.Task('c11_t3', length=2, delay_cost=1)
	S += c11_t3 >= 7
	c11_t3 += MAS[4]

	c10_t3 = S.Task('c10_t3', length=2, delay_cost=1)
	S += c10_t3 >= 8
	c10_t3 += MAS[0]
	...
	c20_t3 = S.Task('c20_t3', length=2, delay_cost=1)
	S += c20_t3 >= 9
	c20_t3 += MAS[4]
	...
	c11_t1 = S.Task('c11_t1', length=10, delay_cost=1)
	S += c11_t1 >= 10
	c11_t1 += MM[1]

	c10_t2 = S.Task('c10_t2', length=2, delay_cost=1)
	S += c10_t2 >= 11
	c10_t2 += MAS[1]
	...
	c20_t1 = S.Task('c20_t1', length=10, delay_cost=1)
	S += c20_t1 >= 12
	c20_t1 += MM[1]

	c11_t2 = S.Task('c11_t2', length=2, delay_cost=1)
	S += c11_t2 >= 13
	c11_t2 += MAS[7]
	...
	c20_t0 = S.Task('c20_t0', length=10, delay_cost=1)
	S += c20_t0 >= 14
	c20_t0 += MM[0]

	c01_t2 = S.Task('c01_t2', length=2, delay_cost=1)
	S += c01_t2 >= 15
	c01_t2 += MAS[3]
	...
	c11_t0 = S.Task('c11_t0', length=10, delay_cost=1)
	S += c11_t0 >= 16
	c11_t0 += MM[1]

	c01_t1 = S.Task('c01_t1', length=10, delay_cost=1)
	S += c01_t1 >= 17
	c01_t1 += MM[0]
	...
	c01_t3 = S.Task('c01_t3', length=2, delay_cost=1)
	S += c01_t3 >= 18
	c01_t3 += MAS[6]
	...
	c21_t3 = S.Task('c21_t3', length=2, delay_cost=1)
	S += c21_t3 >= 19
	c21_t3 += MAS[7]

	c10_t1 = S.Task('c10_t1', length=10, delay_cost=1)
	S += c10_t1 >= 20
	c10_t1 += MM[0]
	...
	c21_t1 = S.Task('c21_t1', length=10, delay_cost=1)
	S += c21_t1 >= 21
	c21_t1 += MM[0]
	...
	c21_t2 = S.Task('c21_t2', length=2, delay_cost=1)
	S += c21_t2 >= 22
	c21_t2 += MAS[3]


	# new tasks
	c10_t4 = S.Task('c10_t4', length=10, delay_cost=1)
	c10_t4 += alt(MM)
	c10_t4_in = S.Task('c10_t4_in', length=1, delay_cost=1)
	c10_t4_in += alt(MM_in)
	S += c10_t4_in*MM_in[0]<=c10_t4*MM[0]
	S += c10_t4_in*MM_in[1]<=c10_t4*MM[1]
	...
	c10_t5 = S.Task('c10_t5', length=2, delay_cost=1)
	c10_t5 += alt(MAS)
	...
	S += c10_t5_in*MAS_in[2]<=c10_t5*MAS[2]

	S += c10_t5_in*MAS_in[3]<=c10_t5*MAS[3]

	S += c10_t5_in*MAS_in[4]<=c10_t5*MAS[4]

	S += c10_t5_in*MAS_in[5]<=c10_t5*MAS[5]

	S += c10_t5_in*MAS_in[6]<=c10_t5*MAS[6]

	S += c10_t5_in*MAS_in[7]<=c10_t5*MAS[7]

	c10_t5_mem0 = S.Task('c10_t5_mem0', length=1, delay_cost=1)
	c10_t5_mem0 += MM_MEM[2]
	S += 15 < c10_t5_mem0
	...
	c20_t5 = S.Task('c20_t5', length=2, delay_cost=1)
	c20_t5 += alt(MAS)
	...
	S += c20_t5_in*MAS_in[2]<=c20_t5*MAS[2]

	S += c20_t5_in*MAS_in[3]<=c20_t5*MAS[3]

	S += c20_t5_in*MAS_in[4]<=c20_t5*MAS[4]

	S += c20_t5_in*MAS_in[5]<=c20_t5*MAS[5]

	S += c20_t5_in*MAS_in[6]<=c20_t5*MAS[6]

	S += c20_t5_in*MAS_in[7]<=c20_t5*MAS[7]
	...
	c01_t5 = S.Task('c01_t5', length=2, delay_cost=1)
	c01_t5 += alt(MAS)
	...
	S += c01_t5_in*MAS_in[2]<=c01_t5*MAS[2]

	S += c01_t5_in*MAS_in[3]<=c01_t5*MAS[3]

	S += c01_t5_in*MAS_in[4]<=c01_t5*MAS[4]

	S += c01_t5_in*MAS_in[5]<=c01_t5*MAS[5]

	S += c01_t5_in*MAS_in[6]<=c01_t5*MAS[6]

	S += c01_t5_in*MAS_in[7]<=c01_t5*MAS[7]
	...
	c11_t5 = S.Task('c11_t5', length=2, delay_cost=1)
	c11_t5 += alt(MAS)
	...
	S += c11_t5_in*MAS_in[2]<=c11_t5*MAS[2]

	S += c11_t5_in*MAS_in[3]<=c11_t5*MAS[3]

	S += c11_t5_in*MAS_in[4]<=c11_t5*MAS[4]

	S += c11_t5_in*MAS_in[5]<=c11_t5*MAS[5]

	S += c11_t5_in*MAS_in[6]<=c11_t5*MAS[6]

	S += c11_t5_in*MAS_in[7]<=c11_t5*MAS[7]

	c11_t5_mem0 = S.Task('c11_t5_mem0', length=1, delay_cost=1)
	c11_t5_mem0 += MM_MEM[2]
	S += 25 < c11_t5_mem0
	S += c11_t5_mem0 <= c11_t5

	c11_t5_mem1 = S.Task('c11_t5_mem1', length=1, delay_cost=1)
	c11_t5_mem1 += MM_MEM[3]
	S += 19 < c11_t5_mem1
	S += c11_t5_mem1 <= c11_t5

	c21_t4 = S.Task('c21_t4', length=10, delay_cost=1)
	c21_t4 += alt(MM)
	c21_t4_in = S.Task('c21_t4_in', length=1, delay_cost=1)
	c21_t4_in += alt(MM_in)
	S += c21_t4_in*MM_in[0]<=c21_t4*MM[0]
	S += c21_t4_in*MM_in[1]<=c21_t4*MM[1]
	c21_t4_mem0 = S.Task('c21_t4_mem0', length=1, delay_cost=1)
	c21_t4_mem0 += MAS_MEM[6]
	S += 23 < c21_t4_mem0
	S += c21_t4_mem0 <= c21_t4

	c21_t4_mem1 = S.Task('c21_t4_mem1', length=1, delay_cost=1)
	c21_t4_mem1 += MAS_MEM[15]
	S += 20 < c21_t4_mem1
	...
	c21_t5 = S.Task('c21_t5', length=2, delay_cost=1)
	c21_t5 += alt(MAS)
	...
	S += c21_t5_in*MAS_in[2]<=c21_t5*MAS[2]

	S += c21_t5_in*MAS_in[3]<=c21_t5*MAS[3]

	S += c21_t5_in*MAS_in[4]<=c21_t5*MAS[4]

	S += c21_t5_in*MAS_in[5]<=c21_t5*MAS[5]

	S += c21_t5_in*MAS_in[6]<=c21_t5*MAS[6]

	S += c21_t5_in*MAS_in[7]<=c21_t5*MAS[7]
	...
	S += (c10_t4*MM[1])-1 < c101_mem0*MM_MEM[2]
	S += c101_mem0 <= c101
	...
	S += (c10_t5*MAS[5])-1 < c101_mem1*MAS_MEM[11]
	S += (c10_t5*MAS[6])-1 < c101_mem1*MAS_MEM[13]
	S += (c10_t5*MAS[7])-1 < c101_mem1*MAS_MEM[15]
	S += c101_mem1 <= c101
	...
	S += (c20_t4*MM[1])-1 < c201_mem0*MM_MEM[2]
	S += c201_mem0 <= c201
	...
	S += (c20_t5*MAS[4])-1 < c201_mem1*MAS_MEM[9]
	S += (c20_t5*MAS[5])-1 < c201_mem1*MAS_MEM[11]
	S += (c20_t5*MAS[6])-1 < c201_mem1*MAS_MEM[13]
	S += (c20_t5*MAS[7])-1 < c201_mem1*MAS_MEM[15]
	S += c201_mem1 <= c201
	...
	S += (c01_t4*MM[1])-1 < c011_mem0*MM_MEM[2]
	S += c011_mem0 <= c011
	...
	S += (c01_t5*MAS[5])-1 < c011_mem1*MAS_MEM[11]
	S += (c01_t5*MAS[6])-1 < c011_mem1*MAS_MEM[13]
	S += (c01_t5*MAS[7])-1 < c011_mem1*MAS_MEM[15]
	S += c011_mem1 <= c011
	...
	S += (c11_t4*MM[1])-1 < c111_mem0*MM_MEM[2]
	S += c111_mem0 <= c111
	...
	S += (c11_t5*MAS[4])-1 < c111_mem1*MAS_MEM[9]
	S += (c11_t5*MAS[5])-1 < c111_mem1*MAS_MEM[11]
	S += (c11_t5*MAS[6])-1 < c111_mem1*MAS_MEM[13]
	S += (c11_t5*MAS[7])-1 < c111_mem1*MAS_MEM[15]
	S += c111_mem1 <= c111
	...
	S += (c21_t4*MM[1])-1 < c211_mem0*MM_MEM[2]
	S += c211_mem0 <= c211
	...
	S += (c21_t5*MAS[4])-1 < c211_mem1*MAS_MEM[9]
	S += (c21_t5*MAS[5])-1 < c211_mem1*MAS_MEM[11]
	S += (c21_t5*MAS[6])-1 < c211_mem1*MAS_MEM[13]
	S += (c21_t5*MAS[7])-1 < c211_mem1*MAS_MEM[15]
	S += c211_mem1 <= c211
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/FROB/schedule1.png"
	if(S.solution() != []):
