...
def solve():
	...
	S += T16_t2_mem0 >= 25
	T16_t2_mem0 += MAS_MEM[14]

	T16_t2_mem1 = S.Task('T16_t2_mem1', length=1, delay_cost=1)
	S += T16_t2_mem1 >= 25
	T16_t2_mem1 += MAS_MEM[13]
	...
	S += T14_t1_mem0 >= 44
	T14_t1_mem0 += MAS_MEM[12]

	T14_t1_mem1 = S.Task('T14_t1_mem1', length=1, delay_cost=1)
	S += T14_t1_mem1 >= 44
	T14_t1_mem1 += MAS_MEM[13]
	...
	S += T20_t3_in*MAS_in[6]<=T20_t3*MAS[6]

	S += T20_t3_in*MAS_in[7]<=T20_t3*MAS[7]
	...
	S += T22_t0_in*MAS_in[6]<=T22_t0*MAS[6]

	S += T22_t0_in*MAS_in[7]<=T22_t0*MAS[7]
	...
	S += T22_t1_in*MAS_in[6]<=T22_t1*MAS[6]

	S += T22_t1_in*MAS_in[7]<=T22_t1*MAS[7]
	...
	S += T23_t0_in*MAS_in[6]<=T23_t0*MAS[6]

	S += T23_t0_in*MAS_in[7]<=T23_t0*MAS[7]
	...
	S += T23_t1_in*MAS_in[6]<=T23_t1*MAS[6]

	S += T23_t1_in*MAS_in[7]<=T23_t1*MAS[7]
	...
	S += T24_t5_in*MAS_in[6]<=T24_t5*MAS[6]

	S += T24_t5_in*MAS_in[7]<=T24_t5*MAS[7]
	...
	S += Z3_t3_in*MAS_in[6]<=Z3_t3*MAS[6]

	S += Z3_t3_in*MAS_in[7]<=Z3_t3*MAS[7]
	...
	S += T20_t5_in*MAS_in[6]<=T20_t5*MAS[6]

	S += T20_t5_in*MAS_in[7]<=T20_t5*MAS[7]
	...
	S += T22_t5_in*MAS_in[6]<=T22_t5*MAS[6]

	S += T22_t5_in*MAS_in[7]<=T22_t5*MAS[7]
	...
	S += T23_t5_in*MAS_in[6]<=T23_t5*MAS[6]

	S += T23_t5_in*MAS_in[7]<=T23_t5*MAS[7]
	...
	S += Z30_in*MAS_in[6]<=Z30*MAS[6]

	S += Z30_in*MAS_in[7]<=Z30*MAS[7]
	...
	S += Z3_t5_in*MAS_in[6]<=Z3_t5*MAS[6]

	S += Z3_t5_in*MAS_in[7]<=Z3_t5*MAS[7]
	...
	S += Z31_in*MAS_in[6]<=Z31*MAS[6]

	S += Z31_in*MAS_in[7]<=Z31*MAS[7]
	...
	S += X31_in*MAS_in[6]<=X31*MAS[6]

	S += X31_in*MAS_in[7]<=X31*MAS[7]
	...
	S += X41_in*MAS_in[6]<=X41*MAS[6]

	S += X41_in*MAS_in[7]<=X41*MAS[7]
	...
	S += X30_in*MAS_in[6]<=X30*MAS[6]

	S += X30_in*MAS_in[7]<=X30*MAS[7]
	...
	S += Z40_in*MAS_in[6]<=Z40*MAS[6]

	S += Z40_in*MAS_in[7]<=Z40*MAS[7]
	...
	S += X40_in*MAS_in[6]<=X40*MAS[6]

	S += X40_in*MAS_in[7]<=X40*MAS[7]
	...
	S += Z41_in*MAS_in[6]<=Z41*MAS[6]

	S += Z41_in*MAS_in[7]<=Z41*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage2MAS8/EP2_LADDERMUL/schedule3.png"
	if(S.solution() != []):
