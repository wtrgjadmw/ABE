...
def solve():
	...
	S += (t130*MAS[3])-1 < t140_mem0*MAS_MEM[6]
	S += t140_mem0 <= t140
	...
	S += (t131*MAS[0])-1 < c001_mem0*MAS_MEM[0]
	S += (t131*MAS[1])-1 < c001_mem0*MAS_MEM[2]
	S += (t131*MAS[2])-1 < c001_mem0*MAS_MEM[4]
	S += (t131*MAS[3])-1 < c001_mem0*MAS_MEM[6]
	S += c001_mem0 <= c001

	c001_mem1 = S.Task('c001_mem1', length=1, delay_cost=1)
	c001_mem1 += alt(MAS_MEM)
	S += (t131*MAS[0])-1 < c001_mem1*MAS_MEM[1]
	S += (t131*MAS[1])-1 < c001_mem1*MAS_MEM[3]
	S += (t131*MAS[2])-1 < c001_mem1*MAS_MEM[5]
	S += (t131*MAS[3])-1 < c001_mem1*MAS_MEM[7]
	S += c001_mem1 <= c001
	...
	S += (t130*MAS[3])-1 < c000_mem0*MAS_MEM[6]
	S += c000_mem0 <= c000
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage1MAS4/SQR012345/schedule3.png"
	if(S.solution() != []):
