...
def solve():
	...
	c_pbc_t51_mem0 += alt(MAS_MEM)
	S += (c_pbc_t01*MAS[0])-1 < c_pbc_t51_mem0*MAS_MEM[0]
	S += (c_pbc_t01*MAS[1])-1 < c_pbc_t51_mem0*MAS_MEM[2]
	...
	c_pbc01_mem0 += alt(MAS_MEM)
	S += (c_pbc_t01*MAS[0])-1 < c_pbc01_mem0*MAS_MEM[0]
	S += (c_pbc_t01*MAS[1])-1 < c_pbc01_mem0*MAS_MEM[2]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM1_stage2MAS2/FP12_INV_BEFORE_FPINV/schedule8.png"
	if(S.solution() != []):
