...
def solve():
	...
	t32 = S.Task('t32', length=7, delay_cost=1)
	t32 += alt(MM)
	...
	t33 = S.Task('t33', length=7, delay_cost=1)
	t33 += alt(MM)
	...
	t34 = S.Task('t34', length=7, delay_cost=1)
	t34 += alt(MM)
	...
	t36 = S.Task('t36', length=7, delay_cost=1)
	t36 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM1_stage2MAS2/EP_ADD_A_ANY/schedule1.png"
	if(S.solution() != []):
