...
def solve():
	...
	T6 = S.Task('T6', length=9, delay_cost=1)
	T6 += alt(MM)
	...
	T9 = S.Task('T9', length=9, delay_cost=1)
	T9 += alt(MM)
	...
	T11 = S.Task('T11', length=9, delay_cost=1)
	T11 += alt(MM)
	...
	T16 = S.Task('T16', length=9, delay_cost=1)
	T16 += alt(MM)
	...
	Z2_new = S.Task('Z2_new', length=9, delay_cost=1)
	Z2_new += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS2/EP_LADDERMUL/schedule0.png"
	if(S.solution() != []):
