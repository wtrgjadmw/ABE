...
def solve():
	...
	S += c_t1_t1_t4_mem0 >= 13
	c_t1_t1_t4_mem0 += MAS_MEM[0]

	c_t1_t1_t4_mem1 = S.Task('c_t1_t1_t4_mem1', length=1, delay_cost=1)
	S += c_t1_t1_t4_mem1 >= 13
	...
	S += c_t2_t0_t5_mem0 >= 24
	c_t2_t0_t5_mem0 += MM_MEM[0]

	c_t2_t0_t5_mem1 = S.Task('c_t2_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t2_t0_t5_mem1 >= 24
	...
	S += c_t2_t4_t3_mem0 >= 46
	c_t2_t4_t3_mem0 += MAS_MEM[0]

	c_t2_t4_t3_mem1 = S.Task('c_t2_t4_t3_mem1', length=1, delay_cost=1)
	S += c_t2_t4_t3_mem1 >= 46
	...
	S += c_t3_t0_t5_mem0 >= 51
	c_t3_t0_t5_mem0 += MM_MEM[0]

	c_t3_t0_t5_mem1 = S.Task('c_t3_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t5_mem1 >= 51
	...
	S += c_t4_t1_t0_mem0 >= 62
	c_t4_t1_t0_mem0 += MAS_MEM[2]

	c_t4_t1_t0_mem1 = S.Task('c_t4_t1_t0_mem1', length=1, delay_cost=1)
	S += c_t4_t1_t0_mem1 >= 62
	...
	S += c_t5_t1_t2_mem0 >= 63
	c_t5_t1_t2_mem0 += MAS_MEM[0]

	c_t5_t1_t2_mem1 = S.Task('c_t5_t1_t2_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t2_mem1 >= 63
	...
	S += c_t4_t0_t5_mem0 >= 67
	c_t4_t0_t5_mem0 += MM_MEM[0]

	c_t4_t0_t5_mem1 = S.Task('c_t4_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t5_mem1 >= 67
	...
	S += c_t5_t0_t5_mem0 >= 75
	c_t5_t0_t5_mem0 += MM_MEM[0]

	c_t5_t0_t5_mem1 = S.Task('c_t5_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t5_t0_t5_mem1 >= 75
	...
	S += c_t5_t4_t0_mem0 >= 75
	c_t5_t4_t0_mem0 += MAS_MEM[0]

	c_t5_t4_t0_mem1 = S.Task('c_t5_t4_t0_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t0_mem1 >= 75
	...
	S += c_t5_t0_t4_mem0 >= 77
	c_t5_t0_t4_mem0 += MAS_MEM[0]

	c_t5_t0_t4_mem1 = S.Task('c_t5_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t5_t0_t4_mem1 >= 77
	...
	S += c_t3_t4_t1_mem0 >= 79
	c_t3_t4_t1_mem0 += MAS_MEM[0]

	c_t3_t4_t1_mem1 = S.Task('c_t3_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t1_mem1 >= 79
	...
	S += c_t5_t4_t2_mem0 >= 80
	c_t5_t4_t2_mem0 += MAS_MEM[0]

	c_t5_t4_t2_mem1 = S.Task('c_t5_t4_t2_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t2_mem1 >= 80
	...
	S += c_t5_t4_t3_mem0 >= 81
	c_t5_t4_t3_mem0 += MAS_MEM[0]

	c_t5_t4_t3_mem1 = S.Task('c_t5_t4_t3_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t3_mem1 >= 81
	...
	S += c_t5_t1_t4_mem0 >= 82
	c_t5_t1_t4_mem0 += MAS_MEM[0]

	c_t5_t1_t4_mem1 = S.Task('c_t5_t1_t4_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t4_mem1 >= 82
	...
	S += c_t5_t1_t5_mem0 >= 82
	c_t5_t1_t5_mem0 += MM_MEM[0]

	c_t5_t1_t5_mem1 = S.Task('c_t5_t1_t5_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t5_mem1 >= 82
	...
	S += c_t4_t4_t4_mem0 >= 87
	c_t4_t4_t4_mem0 += MAS_MEM[0]

	c_t4_t4_t4_mem1 = S.Task('c_t4_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t4_t4_t4_mem1 >= 87
	...
	S += c_t3_t4_t4_mem0 >= 88
	c_t3_t4_t4_mem0 += MAS_MEM[0]

	c_t3_t4_t4_mem1 = S.Task('c_t3_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t4_mem1 >= 88
	...
	S += c_t5_t4_t5_mem0 >= 88
	c_t5_t4_t5_mem0 += MM_MEM[0]

	c_t5_t4_t5_mem1 = S.Task('c_t5_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t5_mem1 >= 88
	...
	S += c_t3_t4_t5_mem0 >= 89
	c_t3_t4_t5_mem0 += MM_MEM[0]

	c_t3_t4_t5_mem1 = S.Task('c_t3_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t5_mem1 >= 89
	...
	S += c_t9_y1_1_mem0 >= 113
	c_t9_y1_1_mem0 += MAS_MEM[0]

	c_t9_y1_1_mem1 = S.Task('c_t9_y1_1_mem1', length=1, delay_cost=1)
	S += c_t9_y1_1_mem1 >= 113
	...
	c_t7111_mem0 += alt(MAS_MEM)
	S += (c_t411*MAS[0])-1 < c_t7111_mem0*MAS_MEM[0]
	S += (c_t411*MAS[1])-1 < c_t7111_mem0*MAS_MEM[2]
	...
	c_t7_y1_0_mem0 += alt(MAS_MEM)
	S += (c_t7110*MAS[0])-1 < c_t7_y1_0_mem0*MAS_MEM[0]
	S += (c_t7110*MAS[1])-1 < c_t7_y1_0_mem0*MAS_MEM[2]
	...
	c_t7_y1_1_mem1 += alt(MAS_MEM)
	S += (c_t7110*MAS[0])-1 < c_t7_y1_1_mem1*MAS_MEM[1]
	S += (c_t7110*MAS[1])-1 < c_t7_y1_1_mem1*MAS_MEM[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS2/MUL/schedule7.png"
	if(S.solution() != []):
