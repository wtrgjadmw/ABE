...
def solve():
	...
	X_new_t1_mem0 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < X_new_t1_mem0*MAS_MEM[0]
	S += (r21*MAS[1])-1 < X_new_t1_mem0*MAS_MEM[2]
	S += (r21*MAS[2])-1 < X_new_t1_mem0*MAS_MEM[4]
	S += (r21*MAS[3])-1 < X_new_t1_mem0*MAS_MEM[6]
	...
	X_new_t2_mem1 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < X_new_t2_mem1*MAS_MEM[1]
	S += (r21*MAS[1])-1 < X_new_t2_mem1*MAS_MEM[3]
	S += (r21*MAS[2])-1 < X_new_t2_mem1*MAS_MEM[5]
	S += (r21*MAS[3])-1 < X_new_t2_mem1*MAS_MEM[7]
	...
	r14_t1_mem0 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < r14_t1_mem0*MAS_MEM[0]
	S += (r21*MAS[1])-1 < r14_t1_mem0*MAS_MEM[2]
	S += (r21*MAS[2])-1 < r14_t1_mem0*MAS_MEM[4]
	S += (r21*MAS[3])-1 < r14_t1_mem0*MAS_MEM[6]
	...
	r14_t2_mem1 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < r14_t2_mem1*MAS_MEM[1]
	S += (r21*MAS[1])-1 < r14_t2_mem1*MAS_MEM[3]
	S += (r21*MAS[2])-1 < r14_t2_mem1*MAS_MEM[5]
	S += (r21*MAS[3])-1 < r14_t2_mem1*MAS_MEM[7]
	...
	Z_new_t1_mem0 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < Z_new_t1_mem0*MAS_MEM[0]
	S += (r21*MAS[1])-1 < Z_new_t1_mem0*MAS_MEM[2]
	S += (r21*MAS[2])-1 < Z_new_t1_mem0*MAS_MEM[4]
	S += (r21*MAS[3])-1 < Z_new_t1_mem0*MAS_MEM[6]
	...
	Z_new_t2_mem1 += alt(MAS_MEM)
	S += (r21*MAS[0])-1 < Z_new_t2_mem1*MAS_MEM[1]
	S += (r21*MAS[1])-1 < Z_new_t2_mem1*MAS_MEM[3]
	S += (r21*MAS[2])-1 < Z_new_t2_mem1*MAS_MEM[5]
	S += (r21*MAS[3])-1 < Z_new_t2_mem1*MAS_MEM[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM2_stage2MAS4/EP2_YRECOVER/schedule2.png"
	if(S.solution() != []):
