...
def solve():
	...
	S += c_pbc_t00_in*MAS_in[6]<=c_pbc_t00*MAS[6]

	S += c_pbc_t00_in*MAS_in[7]<=c_pbc_t00*MAS[7]
	...
	S += c_pbc_t0_t5_in*MAS_in[6]<=c_pbc_t0_t5*MAS[6]

	S += c_pbc_t0_t5_in*MAS_in[7]<=c_pbc_t0_t5*MAS[7]
	...
	S += c_pbc_t20_in*MAS_in[6]<=c_pbc_t20*MAS[6]

	S += c_pbc_t20_in*MAS_in[7]<=c_pbc_t20*MAS[7]
	...
	S += c_pbc_t21_in*MAS_in[6]<=c_pbc_t21*MAS[6]

	S += c_pbc_t21_in*MAS_in[7]<=c_pbc_t21*MAS[7]
	...
	S += c_pcb_t10_in*MAS_in[6]<=c_pcb_t10*MAS[6]

	S += c_pcb_t10_in*MAS_in[7]<=c_pcb_t10*MAS[7]
	...
	S += c_pcb_t1_t5_in*MAS_in[6]<=c_pcb_t1_t5*MAS[6]

	S += c_pcb_t1_t5_in*MAS_in[7]<=c_pcb_t1_t5*MAS[7]
	...
	S += c_pcb_t20_in*MAS_in[6]<=c_pcb_t20*MAS[6]

	S += c_pcb_t20_in*MAS_in[7]<=c_pcb_t20*MAS[7]
	...
	S += c_pcb_t21_in*MAS_in[6]<=c_pcb_t21*MAS[6]

	S += c_pcb_t21_in*MAS_in[7]<=c_pcb_t21*MAS[7]

	c_pcb_t21_mem0 = S.Task('c_pcb_t21_mem0', length=1, delay_cost=1)
	c_pcb_t21_mem0 += MAS_MEM[10]
	S += 105 < c_pcb_t21_mem0
	...
	S += c_paa_t0_t2_in*MAS_in[6]<=c_paa_t0_t2*MAS[6]

	S += c_paa_t0_t2_in*MAS_in[7]<=c_paa_t0_t2*MAS[7]
	...
	S += c_paa_t10_in*MAS_in[6]<=c_paa_t10*MAS[6]

	S += c_paa_t10_in*MAS_in[7]<=c_paa_t10*MAS[7]
	...
	S += c_paa_t1_t5_in*MAS_in[6]<=c_paa_t1_t5*MAS[6]

	S += c_paa_t1_t5_in*MAS_in[7]<=c_paa_t1_t5*MAS[7]
	...
	S += c_paa_t20_in*MAS_in[6]<=c_paa_t20*MAS[6]

	S += c_paa_t20_in*MAS_in[7]<=c_paa_t20*MAS[7]

	c_paa_t20_mem0 = S.Task('c_paa_t20_mem0', length=1, delay_cost=1)
	c_paa_t20_mem0 += MAS_MEM[12]
	S += 100 < c_paa_t20_mem0
	...
	S += c_paa_t21_in*MAS_in[6]<=c_paa_t21*MAS[6]

	S += c_paa_t21_in*MAS_in[7]<=c_paa_t21*MAS[7]

	c_paa_t21_mem0 = S.Task('c_paa_t21_mem0', length=1, delay_cost=1)
	c_paa_t21_mem0 += MAS_MEM[6]
	S += 103 < c_paa_t21_mem0
	...
	S += c_pbc_t01_in*MAS_in[6]<=c_pbc_t01*MAS[6]

	S += c_pbc_t01_in*MAS_in[7]<=c_pbc_t01*MAS[7]
	...
	S += (c_pbc_t0_t5*MAS[6])-1 < c_pbc_t01_mem1*MAS_MEM[13]
	S += (c_pbc_t0_t5*MAS[7])-1 < c_pbc_t01_mem1*MAS_MEM[15]
	...
	S += (c_pbc_t1_t2*MAS[6])-1 < c_pbc_t1_t4_mem0*MAS_MEM[12]
	S += (c_pbc_t1_t2*MAS[7])-1 < c_pbc_t1_t4_mem0*MAS_MEM[14]
	...
	S += c_pbc_t10_in*MAS_in[6]<=c_pbc_t10*MAS[6]

	S += c_pbc_t10_in*MAS_in[7]<=c_pbc_t10*MAS[7]
	...
	S += c_pbc_t1_t5_in*MAS_in[6]<=c_pbc_t1_t5*MAS[6]

	S += c_pbc_t1_t5_in*MAS_in[7]<=c_pbc_t1_t5*MAS[7]
	...
	S += c_pbc_t4_t2_in*MAS_in[6]<=c_pbc_t4_t2*MAS[6]

	S += c_pbc_t4_t2_in*MAS_in[7]<=c_pbc_t4_t2*MAS[7]
	...
	S += (c_pbc_t20*MAS[6])-1 < c_pbc_t4_t2_mem0*MAS_MEM[12]
	S += (c_pbc_t20*MAS[7])-1 < c_pbc_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c_pbc_t21*MAS[6])-1 < c_pbc_t4_t2_mem1*MAS_MEM[13]
	S += (c_pbc_t21*MAS[7])-1 < c_pbc_t4_t2_mem1*MAS_MEM[15]
	...
	S += (c_pcb_t0_t2*MAS[6])-1 < c_pcb_t0_t4_mem0*MAS_MEM[12]
	S += (c_pcb_t0_t2*MAS[7])-1 < c_pcb_t0_t4_mem0*MAS_MEM[14]
	...
	S += c_pcb_t00_in*MAS_in[6]<=c_pcb_t00*MAS[6]

	S += c_pcb_t00_in*MAS_in[7]<=c_pcb_t00*MAS[7]
	...
	S += c_pcb_t0_t5_in*MAS_in[6]<=c_pcb_t0_t5*MAS[6]

	S += c_pcb_t0_t5_in*MAS_in[7]<=c_pcb_t0_t5*MAS[7]
	...
	S += c_pcb_t11_in*MAS_in[6]<=c_pcb_t11*MAS[6]

	S += c_pcb_t11_in*MAS_in[7]<=c_pcb_t11*MAS[7]
	...
	S += (c_pcb_t1_t5*MAS[6])-1 < c_pcb_t11_mem1*MAS_MEM[13]
	S += (c_pcb_t1_t5*MAS[7])-1 < c_pcb_t11_mem1*MAS_MEM[15]
	...
	S += (c_pcb_t20*MAS[6])-1 < c_pcb_t4_t0_mem0*MAS_MEM[12]
	S += (c_pcb_t20*MAS[7])-1 < c_pcb_t4_t0_mem0*MAS_MEM[14]
	...
	S += c_pcb_t4_t2_in*MAS_in[6]<=c_pcb_t4_t2*MAS[6]

	S += c_pcb_t4_t2_in*MAS_in[7]<=c_pcb_t4_t2*MAS[7]
	...
	S += (c_pcb_t20*MAS[6])-1 < c_pcb_t4_t2_mem0*MAS_MEM[12]
	S += (c_pcb_t20*MAS[7])-1 < c_pcb_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c_pcb_t21*MAS[6])-1 < c_pcb_t4_t2_mem1*MAS_MEM[13]
	S += (c_pcb_t21*MAS[7])-1 < c_pcb_t4_t2_mem1*MAS_MEM[15]
	...
	S += (c_paa_t0_t2*MAS[6])-1 < c_paa_t0_t4_mem0*MAS_MEM[12]
	S += (c_paa_t0_t2*MAS[7])-1 < c_paa_t0_t4_mem0*MAS_MEM[14]
	...
	S += c_paa_t00_in*MAS_in[6]<=c_paa_t00*MAS[6]

	S += c_paa_t00_in*MAS_in[7]<=c_paa_t00*MAS[7]
	...
	S += c_paa_t0_t5_in*MAS_in[6]<=c_paa_t0_t5*MAS[6]

	S += c_paa_t0_t5_in*MAS_in[7]<=c_paa_t0_t5*MAS[7]
	...
	S += c_paa_t11_in*MAS_in[6]<=c_paa_t11*MAS[6]

	S += c_paa_t11_in*MAS_in[7]<=c_paa_t11*MAS[7]
	...
	S += (c_paa_t1_t5*MAS[6])-1 < c_paa_t11_mem1*MAS_MEM[13]
	S += (c_paa_t1_t5*MAS[7])-1 < c_paa_t11_mem1*MAS_MEM[15]
	...
	S += (c_paa_t21*MAS[6])-1 < c_paa_t4_t1_mem0*MAS_MEM[12]
	S += (c_paa_t21*MAS[7])-1 < c_paa_t4_t1_mem0*MAS_MEM[14]
	...
	S += c_paa_t4_t2_in*MAS_in[6]<=c_paa_t4_t2*MAS[6]

	S += c_paa_t4_t2_in*MAS_in[7]<=c_paa_t4_t2*MAS[7]
	...
	S += (c_paa_t20*MAS[6])-1 < c_paa_t4_t2_mem0*MAS_MEM[12]
	S += (c_paa_t20*MAS[7])-1 < c_paa_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c_paa_t21*MAS[6])-1 < c_paa_t4_t2_mem1*MAS_MEM[13]
	S += (c_paa_t21*MAS[7])-1 < c_paa_t4_t2_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/FP12_INV_BEFORE_FPINV/schedule7.png"
	if(S.solution() != []):
