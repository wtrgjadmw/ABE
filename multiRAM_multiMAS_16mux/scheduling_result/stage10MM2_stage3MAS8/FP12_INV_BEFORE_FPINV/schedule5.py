...
def solve():
	...
	S += c_aa_t20_in*MAS_in[6]<=c_aa_t20*MAS[6]

	S += c_aa_t20_in*MAS_in[7]<=c_aa_t20*MAS[7]
	...
	S += c_aa_t2_t5_in*MAS_in[6]<=c_aa_t2_t5*MAS[6]

	S += c_aa_t2_t5_in*MAS_in[7]<=c_aa_t2_t5*MAS[7]

	c_aa_t2_t5_mem0 = S.Task('c_aa_t2_t5_mem0', length=1, delay_cost=1)
	c_aa_t2_t5_mem0 += MM_MEM[2]
	S += 87 < c_aa_t2_t5_mem0
	S += c_aa_t2_t5_mem0 <= c_aa_t2_t5

	c_aa_t2_t5_mem1 = S.Task('c_aa_t2_t5_mem1', length=1, delay_cost=1)
	c_aa_t2_t5_mem1 += MM_MEM[3]
	S += 90 < c_aa_t2_t5_mem1
	...
	S += c_aa_t40_in*MAS_in[6]<=c_aa_t40*MAS[6]

	S += c_aa_t40_in*MAS_in[7]<=c_aa_t40*MAS[7]
	...
	S += c_aa_t41_in*MAS_in[6]<=c_aa_t41*MAS[6]

	S += c_aa_t41_in*MAS_in[7]<=c_aa_t41*MAS[7]
	...
	S += c_aa11_in*MAS_in[6]<=c_aa11*MAS[6]

	S += c_aa11_in*MAS_in[7]<=c_aa11*MAS[7]
	...
	S += c_bb_t20_in*MAS_in[6]<=c_bb_t20*MAS[6]

	S += c_bb_t20_in*MAS_in[7]<=c_bb_t20*MAS[7]
	...
	S += c_bb_t2_t5_in*MAS_in[6]<=c_bb_t2_t5*MAS[6]

	S += c_bb_t2_t5_in*MAS_in[7]<=c_bb_t2_t5*MAS[7]
	...
	S += c_bb_t40_in*MAS_in[6]<=c_bb_t40*MAS[6]

	S += c_bb_t40_in*MAS_in[7]<=c_bb_t40*MAS[7]
	...
	S += c_bb_t41_in*MAS_in[6]<=c_bb_t41*MAS[6]

	S += c_bb_t41_in*MAS_in[7]<=c_bb_t41*MAS[7]
	...
	S += c_bb11_in*MAS_in[6]<=c_bb11*MAS[6]

	S += c_bb11_in*MAS_in[7]<=c_bb11*MAS[7]
	...
	S += c_cc_t20_in*MAS_in[6]<=c_cc_t20*MAS[6]

	S += c_cc_t20_in*MAS_in[7]<=c_cc_t20*MAS[7]
	...
	S += c_cc_t2_t5_in*MAS_in[6]<=c_cc_t2_t5*MAS[6]

	S += c_cc_t2_t5_in*MAS_in[7]<=c_cc_t2_t5*MAS[7]
	...
	S += c_cc_t40_in*MAS_in[6]<=c_cc_t40*MAS[6]

	S += c_cc_t40_in*MAS_in[7]<=c_cc_t40*MAS[7]
	...
	S += c_cc_t41_in*MAS_in[6]<=c_cc_t41*MAS[6]

	S += c_cc_t41_in*MAS_in[7]<=c_cc_t41*MAS[7]
	...
	S += c_cc11_in*MAS_in[6]<=c_cc11*MAS[6]

	S += c_cc11_in*MAS_in[7]<=c_cc11*MAS[7]
	...
	S += c_ab_t41_in*MAS_in[6]<=c_ab_t41*MAS[6]

	S += c_ab_t41_in*MAS_in[7]<=c_ab_t41*MAS[7]
	...
	S += c_ab_s00_in*MAS_in[6]<=c_ab_s00*MAS[6]

	S += c_ab_s00_in*MAS_in[7]<=c_ab_s00*MAS[7]
	...
	S += c_ab_s01_in*MAS_in[6]<=c_ab_s01*MAS[6]

	S += c_ab_s01_in*MAS_in[7]<=c_ab_s01*MAS[7]
	...
	S += c_ab_t51_in*MAS_in[6]<=c_ab_t51*MAS[6]

	S += c_ab_t51_in*MAS_in[7]<=c_ab_t51*MAS[7]
	...
	S += c_ab10_in*MAS_in[6]<=c_ab10*MAS[6]

	S += c_ab10_in*MAS_in[7]<=c_ab10*MAS[7]
	...
	S += c_bc_t41_in*MAS_in[6]<=c_bc_t41*MAS[6]

	S += c_bc_t41_in*MAS_in[7]<=c_bc_t41*MAS[7]
	...
	S += c_bc_s00_in*MAS_in[6]<=c_bc_s00*MAS[6]

	S += c_bc_s00_in*MAS_in[7]<=c_bc_s00*MAS[7]
	...
	S += c_bc_s01_in*MAS_in[6]<=c_bc_s01*MAS[6]

	S += c_bc_s01_in*MAS_in[7]<=c_bc_s01*MAS[7]
	...
	S += c_bc_t51_in*MAS_in[6]<=c_bc_t51*MAS[6]

	S += c_bc_t51_in*MAS_in[7]<=c_bc_t51*MAS[7]
	...
	S += c_bc10_in*MAS_in[6]<=c_bc10*MAS[6]

	S += c_bc10_in*MAS_in[7]<=c_bc10*MAS[7]
	...
	S += c_ac_t41_in*MAS_in[6]<=c_ac_t41*MAS[6]

	S += c_ac_t41_in*MAS_in[7]<=c_ac_t41*MAS[7]
	...
	S += c_ac_s00_in*MAS_in[6]<=c_ac_s00*MAS[6]

	S += c_ac_s00_in*MAS_in[7]<=c_ac_s00*MAS[7]
	...
	S += c_ac_s01_in*MAS_in[6]<=c_ac_s01*MAS[6]

	S += c_ac_s01_in*MAS_in[7]<=c_ac_s01*MAS[7]
	...
	S += c_ac_t51_in*MAS_in[6]<=c_ac_t51*MAS[6]

	S += c_ac_t51_in*MAS_in[7]<=c_ac_t51*MAS[7]
	...
	S += c_ac10_in*MAS_in[6]<=c_ac10*MAS[6]

	S += c_ac10_in*MAS_in[7]<=c_ac10*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/FP12_INV_BEFORE_FPINV/schedule5.png"
	if(S.solution() != []):
