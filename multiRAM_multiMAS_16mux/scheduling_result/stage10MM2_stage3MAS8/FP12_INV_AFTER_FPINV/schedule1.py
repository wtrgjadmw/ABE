...
def solve():
	...
	S += c0_t20_in*MAS_in[6]<=c0_t20*MAS[6]

	S += c0_t20_in*MAS_in[7]<=c0_t20*MAS[7]
	...
	S += c0_t21_in*MAS_in[6]<=c0_t21*MAS[6]

	S += c0_t21_in*MAS_in[7]<=c0_t21*MAS[7]
	...
	S += c2_t20_in*MAS_in[6]<=c2_t20*MAS[6]

	S += c2_t20_in*MAS_in[7]<=c2_t20*MAS[7]
	...
	S += c2_t21_in*MAS_in[6]<=c2_t21*MAS[6]

	S += c2_t21_in*MAS_in[7]<=c2_t21*MAS[7]
	...
	S += c0_t4_t2_in*MAS_in[6]<=c0_t4_t2*MAS[6]

	S += c0_t4_t2_in*MAS_in[7]<=c0_t4_t2*MAS[7]
	...
	S += (c0_t20*MAS[6])-1 < c0_t4_t2_mem0*MAS_MEM[12]
	S += (c0_t20*MAS[7])-1 < c0_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c0_t21*MAS[6])-1 < c0_t4_t2_mem1*MAS_MEM[13]
	S += (c0_t21*MAS[7])-1 < c0_t4_t2_mem1*MAS_MEM[15]
	...
	S += c2_t4_t2_in*MAS_in[6]<=c2_t4_t2*MAS[6]

	S += c2_t4_t2_in*MAS_in[7]<=c2_t4_t2*MAS[7]
	...
	S += (c2_t20*MAS[6])-1 < c2_t4_t2_mem0*MAS_MEM[12]
	S += (c2_t20*MAS[7])-1 < c2_t4_t2_mem0*MAS_MEM[14]
	...
	S += (c2_t21*MAS[6])-1 < c2_t4_t2_mem1*MAS_MEM[13]
	S += (c2_t21*MAS[7])-1 < c2_t4_t2_mem1*MAS_MEM[15]
	...
	c0_t4_t0_mem0 += alt(MAS_MEM)
	S += (c0_t20*MAS[0])-1 < c0_t4_t0_mem0*MAS_MEM[0]
	S += (c0_t20*MAS[1])-1 < c0_t4_t0_mem0*MAS_MEM[2]
	S += (c0_t20*MAS[2])-1 < c0_t4_t0_mem0*MAS_MEM[4]
	S += (c0_t20*MAS[3])-1 < c0_t4_t0_mem0*MAS_MEM[6]
	S += (c0_t20*MAS[4])-1 < c0_t4_t0_mem0*MAS_MEM[8]
	S += (c0_t20*MAS[5])-1 < c0_t4_t0_mem0*MAS_MEM[10]
	S += (c0_t20*MAS[6])-1 < c0_t4_t0_mem0*MAS_MEM[12]
	S += (c0_t20*MAS[7])-1 < c0_t4_t0_mem0*MAS_MEM[14]
	...
	c2_t4_t0_mem0 += alt(MAS_MEM)
	S += (c2_t20*MAS[0])-1 < c2_t4_t0_mem0*MAS_MEM[0]
	S += (c2_t20*MAS[1])-1 < c2_t4_t0_mem0*MAS_MEM[2]
	S += (c2_t20*MAS[2])-1 < c2_t4_t0_mem0*MAS_MEM[4]
	S += (c2_t20*MAS[3])-1 < c2_t4_t0_mem0*MAS_MEM[6]
	S += (c2_t20*MAS[4])-1 < c2_t4_t0_mem0*MAS_MEM[8]
	S += (c2_t20*MAS[5])-1 < c2_t4_t0_mem0*MAS_MEM[10]
	S += (c2_t20*MAS[6])-1 < c2_t4_t0_mem0*MAS_MEM[12]
	S += (c2_t20*MAS[7])-1 < c2_t4_t0_mem0*MAS_MEM[14]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/FP12_INV_AFTER_FPINV/schedule1.png"
	if(S.solution() != []):
