...
def solve():
	...
	S += c_t0_t2_t2_in*MAS_in[6]<=c_t0_t2_t2*MAS[6]

	S += c_t0_t2_t2_in*MAS_in[7]<=c_t0_t2_t2*MAS[7]
	...
	S += c_t0_t31_in*MAS_in[6]<=c_t0_t31*MAS[6]

	S += c_t0_t31_in*MAS_in[7]<=c_t0_t31*MAS[7]
	...
	S += c_t1_t2_t2_in*MAS_in[6]<=c_t1_t2_t2*MAS[6]

	S += c_t1_t2_t2_in*MAS_in[7]<=c_t1_t2_t2*MAS[7]
	...
	S += c_t1_t31_in*MAS_in[6]<=c_t1_t31*MAS[6]

	S += c_t1_t31_in*MAS_in[7]<=c_t1_t31*MAS[7]
	...
	S += c_t2_t2_t2_in*MAS_in[6]<=c_t2_t2_t2*MAS[6]

	S += c_t2_t2_t2_in*MAS_in[7]<=c_t2_t2_t2*MAS[7]
	...
	S += c_t2_t31_in*MAS_in[6]<=c_t2_t31*MAS[6]

	S += c_t2_t31_in*MAS_in[7]<=c_t2_t31*MAS[7]
	...
	S += c_t3_t3_t5_in*MAS_in[6]<=c_t3_t3_t5*MAS[6]

	S += c_t3_t3_t5_in*MAS_in[7]<=c_t3_t3_t5*MAS[7]
	...
	S += c_t4_t2_t3_in*MAS_in[6]<=c_t4_t2_t3*MAS[6]

	S += c_t4_t2_t3_in*MAS_in[7]<=c_t4_t2_t3*MAS[7]
	...
	S += c_t4_t3_t5_in*MAS_in[6]<=c_t4_t3_t5*MAS[6]

	S += c_t4_t3_t5_in*MAS_in[7]<=c_t4_t3_t5*MAS[7]

	c_t4_t3_t5_mem0 = S.Task('c_t4_t3_t5_mem0', length=1, delay_cost=1)
	c_t4_t3_t5_mem0 += MM_MEM[0]
	S += 46 < c_t4_t3_t5_mem0
	...
	S += c_t5_t2_t3_in*MAS_in[6]<=c_t5_t2_t3*MAS[6]

	S += c_t5_t2_t3_in*MAS_in[7]<=c_t5_t2_t3*MAS[7]

	c_t5_t2_t3_mem0 = S.Task('c_t5_t2_t3_mem0', length=1, delay_cost=1)
	c_t5_t2_t3_mem0 += MAS_MEM[0]
	S += 42 < c_t5_t2_t3_mem0
	...
	S += c_t5_t3_t5_in*MAS_in[6]<=c_t5_t3_t5*MAS[6]

	S += c_t5_t3_t5_in*MAS_in[7]<=c_t5_t3_t5*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/SQR/schedule2.png"
	if(S.solution() != []):
