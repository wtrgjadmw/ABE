...
def solve():
	...
	S += c_t2_t1_t1_mem0 >= 13
	c_t2_t1_t1_mem0 += MAIN_MEM_r[0]

	c_t2_t1_t1_mem1 = S.Task('c_t2_t1_t1_mem1', length=1, delay_cost=1)
	S += c_t2_t1_t1_mem1 >= 13
	...
	S += c_t0_t1_t2_mem0 >= 17
	c_t0_t1_t2_mem0 += MAIN_MEM_r[0]

	c_t0_t1_t2_mem1 = S.Task('c_t0_t1_t2_mem1', length=1, delay_cost=1)
	S += c_t0_t1_t2_mem1 >= 17
	...
	S += c_t2_t0_t4_mem0 >= 24
	c_t2_t0_t4_mem0 += MAS_MEM[8]

	c_t2_t0_t4_mem1 = S.Task('c_t2_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t2_t0_t4_mem1 >= 24
	c_t2_t0_t4_mem1 += MAS_MEM[15]
	...
	S += c_t0_t0_t0_mem0 >= 27
	c_t0_t0_t0_mem0 += MAIN_MEM_r[0]

	c_t0_t0_t0_mem1 = S.Task('c_t0_t0_t0_mem1', length=1, delay_cost=1)
	S += c_t0_t0_t0_mem1 >= 27
	...
	S += c_t4_t1_t0_mem0 >= 34
	c_t4_t1_t0_mem0 += MAS_MEM[6]

	c_t4_t1_t0_mem1 = S.Task('c_t4_t1_t0_mem1', length=1, delay_cost=1)
	S += c_t4_t1_t0_mem1 >= 34
	...
	S += c_t4_t1_t2_mem0 >= 38
	c_t4_t1_t2_mem0 += MAS_MEM[6]

	c_t4_t1_t2_mem1 = S.Task('c_t4_t1_t2_mem1', length=1, delay_cost=1)
	S += c_t4_t1_t2_mem1 >= 38
	...
	S += c_t4_t0_t3_mem0 >= 45
	c_t4_t0_t3_mem0 += MAS_MEM[8]

	c_t4_t0_t3_mem1 = S.Task('c_t4_t0_t3_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t3_mem1 >= 45
	...
	S += c_t5_t0_t1_mem0 >= 47
	c_t5_t0_t1_mem0 += MAS_MEM[10]

	c_t5_t0_t1_mem1 = S.Task('c_t5_t0_t1_mem1', length=1, delay_cost=1)
	S += c_t5_t0_t1_mem1 >= 47
	...
	S += c_t3_t0_t3_mem0 >= 50
	c_t3_t0_t3_mem0 += MAS_MEM[2]

	c_t3_t0_t3_mem1 = S.Task('c_t3_t0_t3_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t3_mem1 >= 50
	...
	S += c_t3_t4_t1_mem0 >= 53
	c_t3_t4_t1_mem0 += MAS_MEM[14]

	c_t3_t4_t1_mem1 = S.Task('c_t3_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t1_mem1 >= 53
	...
	S += c_t3_t0_t0_mem0 >= 54
	c_t3_t0_t0_mem0 += MAS_MEM[14]

	c_t3_t0_t0_mem1 = S.Task('c_t3_t0_t0_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t0_mem1 >= 54
	...
	S += c_t4_t0_t4_mem0 >= 54
	c_t4_t0_t4_mem0 += MAS_MEM[10]

	c_t4_t0_t4_mem1 = S.Task('c_t4_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t4_mem1 >= 54
	...
	S += c_t3_t0_t2_mem0 >= 55
	c_t3_t0_t2_mem0 += MAS_MEM[14]

	c_t3_t0_t2_mem1 = S.Task('c_t3_t0_t2_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t2_mem1 >= 55
	...
	S += c_t5_t1_t2_mem0 >= 60
	c_t5_t1_t2_mem0 += MAS_MEM[0]

	c_t5_t1_t2_mem1 = S.Task('c_t5_t1_t2_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t2_mem1 >= 60
	...
	S += c_t4_t1_t4_mem0 >= 66
	c_t4_t1_t4_mem0 += MAS_MEM[8]

	c_t4_t1_t4_mem1 = S.Task('c_t4_t1_t4_mem1', length=1, delay_cost=1)
	S += c_t4_t1_t4_mem1 >= 66
	...
	S += c_t5_t4_t4_mem0 >= 67
	c_t5_t4_t4_mem0 += MAS_MEM[4]

	c_t5_t4_t4_mem1 = S.Task('c_t5_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t4_mem1 >= 67
	...
	S += c_t4_t4_t3_mem0 >= 68
	c_t4_t4_t3_mem0 += MAS_MEM[12]

	c_t4_t4_t3_mem1 = S.Task('c_t4_t4_t3_mem1', length=1, delay_cost=1)
	S += c_t4_t4_t3_mem1 >= 68
	...
	S += c_t3_t1_t5_mem0 >= 75
	c_t3_t1_t5_mem0 += MM_MEM[2]

	c_t3_t1_t5_mem1 = S.Task('c_t3_t1_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t1_t5_mem1 >= 75
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/MUL/schedule6.png"
	if(S.solution() != []):
