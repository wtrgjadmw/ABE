...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/MUL/schedule5.png"
	if(S.solution() != []):
