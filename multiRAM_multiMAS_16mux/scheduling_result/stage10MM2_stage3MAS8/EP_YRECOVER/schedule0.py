...
def solve():
	...
	# new tasks
	r1 = S.Task('r1', length=10, delay_cost=1)
	r1 += alt(MM)
	...
	r3 = S.Task('r3', length=10, delay_cost=1)
	r3 += alt(MM)
	...
	r4 = S.Task('r4', length=10, delay_cost=1)
	r4 += alt(MM)
	...
	r5 = S.Task('r5', length=10, delay_cost=1)
	r5 += alt(MM)
	...
	r6 = S.Task('r6', length=10, delay_cost=1)
	r6 += alt(MM)
	...
	r12 = S.Task('r12', length=10, delay_cost=1)
	r12 += alt(MM)
	...
	r13 = S.Task('r13', length=10, delay_cost=1)
	r13 += alt(MM)
	...
	r2 = S.Task('r2', length=3, delay_cost=1)
	r2 += alt(MAS)
	...
	S += r2_in*MAS_in[4]<=r2*MAS[4]

	S += r2_in*MAS_in[5]<=r2*MAS[5]

	S += r2_in*MAS_in[6]<=r2*MAS[6]

	S += r2_in*MAS_in[7]<=r2*MAS[7]
	...
	r7 = S.Task('r7', length=3, delay_cost=1)
	r7 += alt(MAS)
	...
	S += r7_in*MAS_in[4]<=r7*MAS[4]

	S += r7_in*MAS_in[5]<=r7*MAS[5]

	S += r7_in*MAS_in[6]<=r7*MAS[6]

	S += r7_in*MAS_in[7]<=r7*MAS[7]
	...
	r8 = S.Task('r8', length=3, delay_cost=1)
	r8 += alt(MAS)
	...
	S += r8_in*MAS_in[4]<=r8*MAS[4]

	S += r8_in*MAS_in[5]<=r8*MAS[5]

	S += r8_in*MAS_in[6]<=r8*MAS[6]

	S += r8_in*MAS_in[7]<=r8*MAS[7]
	...
	r9 = S.Task('r9', length=10, delay_cost=1)
	r9 += alt(MM)
	...
	S += (r7*MAS[4])-1 < r9_mem1*MAS_MEM[9]
	S += (r7*MAS[5])-1 < r9_mem1*MAS_MEM[11]
	S += (r7*MAS[6])-1 < r9_mem1*MAS_MEM[13]
	S += (r7*MAS[7])-1 < r9_mem1*MAS_MEM[15]
	S += r9_mem1 <= r9

	r11 = S.Task('r11', length=10, delay_cost=1)
	r11 += alt(MM)
	...
	S += (r10*MAS[4])-1 < r11_mem0*MAS_MEM[8]
	S += (r10*MAS[5])-1 < r11_mem0*MAS_MEM[10]
	S += (r10*MAS[6])-1 < r11_mem0*MAS_MEM[12]
	S += (r10*MAS[7])-1 < r11_mem0*MAS_MEM[14]
	S += r11_mem0 <= r11
	...
	S += (r10*MAS[4])-1 < r11_mem1*MAS_MEM[9]
	S += (r10*MAS[5])-1 < r11_mem1*MAS_MEM[11]
	S += (r10*MAS[6])-1 < r11_mem1*MAS_MEM[13]
	S += (r10*MAS[7])-1 < r11_mem1*MAS_MEM[15]
	S += r11_mem1 <= r11

	PX_new = S.Task('PX_new', length=10, delay_cost=1)
	PX_new += alt(MM)
	...
	S += (r2*MAS[4])-1 < PX_new_mem0*MAS_MEM[8]
	S += (r2*MAS[5])-1 < PX_new_mem0*MAS_MEM[10]
	S += (r2*MAS[6])-1 < PX_new_mem0*MAS_MEM[12]
	S += (r2*MAS[7])-1 < PX_new_mem0*MAS_MEM[14]
	...
	r14 = S.Task('r14', length=10, delay_cost=1)
	r14 += alt(MM)
	...
	S += (r2*MAS[4])-1 < r14_mem0*MAS_MEM[8]
	S += (r2*MAS[5])-1 < r14_mem0*MAS_MEM[10]
	S += (r2*MAS[6])-1 < r14_mem0*MAS_MEM[12]
	S += (r2*MAS[7])-1 < r14_mem0*MAS_MEM[14]
	S += r14_mem0 <= r14
	...
	Z1_new = S.Task('Z1_new', length=10, delay_cost=1)
	Z1_new += alt(MM)
	...
	S += (r2*MAS[4])-1 < Z1_new_mem0*MAS_MEM[8]
	S += (r2*MAS[5])-1 < Z1_new_mem0*MAS_MEM[10]
	S += (r2*MAS[6])-1 < Z1_new_mem0*MAS_MEM[12]
	S += (r2*MAS[7])-1 < Z1_new_mem0*MAS_MEM[14]
	...
	r15 = S.Task('r15', length=10, delay_cost=1)
	r15 += alt(MM)
	...
	S += (r8*MAS[4])-1 < r15_mem0*MAS_MEM[8]
	S += (r8*MAS[5])-1 < r15_mem0*MAS_MEM[10]
	S += (r8*MAS[6])-1 < r15_mem0*MAS_MEM[12]
	S += (r8*MAS[7])-1 < r15_mem0*MAS_MEM[14]
	S += r15_mem0 <= r15
	...
	r16 = S.Task('r16', length=10, delay_cost=1)
	r16 += alt(MM)
	...
	r17 = S.Task('r17', length=3, delay_cost=1)
	r17 += alt(MAS)
	...
	S += r17_in*MAS_in[4]<=r17*MAS[4]

	S += r17_in*MAS_in[5]<=r17*MAS[5]

	S += r17_in*MAS_in[6]<=r17*MAS[6]

	S += r17_in*MAS_in[7]<=r17*MAS[7]
	...
	S += (r17*MAS[4])-1 < PY_new_mem0*MAS_MEM[8]
	S += (r17*MAS[5])-1 < PY_new_mem0*MAS_MEM[10]
	S += (r17*MAS[6])-1 < PY_new_mem0*MAS_MEM[12]
	S += (r17*MAS[7])-1 < PY_new_mem0*MAS_MEM[14]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/EP_YRECOVER/schedule0.png"
	if(S.solution() != []):
