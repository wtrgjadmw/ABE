...
def solve():
	...
	S += xit20_in*MAS_in[4]<=xit20*MAS[4]

	S += xit20_in*MAS_in[5]<=xit20*MAS[5]

	S += xit20_in*MAS_in[6]<=xit20*MAS[6]

	S += xit20_in*MAS_in[7]<=xit20*MAS[7]
	...
	S += (t20*MM[1])-1 < xit20_mem1*MM_MEM[3]
	S += xit20_mem1 <= xit20
	...
	S += xit21_in*MAS_in[4]<=xit21*MAS[4]

	S += xit21_in*MAS_in[5]<=xit21*MAS[5]

	S += xit21_in*MAS_in[6]<=xit21*MAS[6]

	S += xit21_in*MAS_in[7]<=xit21*MAS[7]
	...
	S += (t21*MM[1])-1 < xit21_mem1*MM_MEM[3]
	S += xit21_mem1 <= xit21
	...
	S += xi2t40_in*MM_in[1]<=xi2t40*MM[1]
	...
	S += (xit20*MAS[5])-1 < xi2t40_mem0*MAS_MEM[10]
	S += (xit20*MAS[6])-1 < xi2t40_mem0*MAS_MEM[12]
	S += (xit20*MAS[7])-1 < xi2t40_mem0*MAS_MEM[14]
	...
	S += (xit20*MAS[4])-1 < xi2t40_mem1*MAS_MEM[9]
	S += (xit20*MAS[5])-1 < xi2t40_mem1*MAS_MEM[11]
	S += (xit20*MAS[6])-1 < xi2t40_mem1*MAS_MEM[13]
	S += (xit20*MAS[7])-1 < xi2t40_mem1*MAS_MEM[15]
	...
	S += xi2t41_in*MM_in[1]<=xi2t41*MM[1]
	...
	S += (xit21*MAS[5])-1 < xi2t41_mem0*MAS_MEM[10]
	S += (xit21*MAS[6])-1 < xi2t41_mem0*MAS_MEM[12]
	S += (xit21*MAS[7])-1 < xi2t41_mem0*MAS_MEM[14]
	...
	S += (xit21*MAS[4])-1 < xi2t41_mem1*MAS_MEM[9]
	S += (xit21*MAS[5])-1 < xi2t41_mem1*MAS_MEM[11]
	S += (xit21*MAS[6])-1 < xi2t41_mem1*MAS_MEM[13]
	S += (xit21*MAS[7])-1 < xi2t41_mem1*MAS_MEM[15]
	...
	S += D_a_0_in*MAS_in[4]<=D_a_0*MAS[4]

	S += D_a_0_in*MAS_in[5]<=D_a_0*MAS[5]

	S += D_a_0_in*MAS_in[6]<=D_a_0*MAS[6]

	S += D_a_0_in*MAS_in[7]<=D_a_0*MAS[7]
	...
	S += (xit20*MAS[5])-1 < D_a_0_mem0*MAS_MEM[10]
	S += (xit20*MAS[6])-1 < D_a_0_mem0*MAS_MEM[12]
	S += (xit20*MAS[7])-1 < D_a_0_mem0*MAS_MEM[14]
	S += D_a_0_mem0 <= D_a_0

	D_a_0_mem1 = S.Task('D_a_0_mem1', length=1, delay_cost=1)
	D_a_0_mem1 += alt(MM_MEM)
	S += (xi2t40*MM[0])-1 < D_a_0_mem1*MM_MEM[1]
	S += (xi2t40*MM[1])-1 < D_a_0_mem1*MM_MEM[3]
	S += D_a_0_mem1 <= D_a_0
	...
	S += D_a_1_in*MAS_in[4]<=D_a_1*MAS[4]

	S += D_a_1_in*MAS_in[5]<=D_a_1*MAS[5]

	S += D_a_1_in*MAS_in[6]<=D_a_1*MAS[6]

	S += D_a_1_in*MAS_in[7]<=D_a_1*MAS[7]
	...
	S += (xit21*MAS[5])-1 < D_a_1_mem0*MAS_MEM[10]
	S += (xit21*MAS[6])-1 < D_a_1_mem0*MAS_MEM[12]
	S += (xit21*MAS[7])-1 < D_a_1_mem0*MAS_MEM[14]
	S += D_a_1_mem0 <= D_a_1

	D_a_1_mem1 = S.Task('D_a_1_mem1', length=1, delay_cost=1)
	D_a_1_mem1 += alt(MM_MEM)
	S += (xi2t41*MM[0])-1 < D_a_1_mem1*MM_MEM[1]
	S += (xi2t41*MM[1])-1 < D_a_1_mem1*MM_MEM[3]
	S += D_a_1_mem1 <= D_a_1
	...
	S += (D_a_0*MAS[5])-1 < negD0_mem0*MAS_MEM[10]
	S += (D_a_0*MAS[6])-1 < negD0_mem0*MAS_MEM[12]
	S += (D_a_0*MAS[7])-1 < negD0_mem0*MAS_MEM[14]
	S += negD0_mem0 <= negD0
	...
	S += (D_a_1*MAS[5])-1 < negD1_mem0*MAS_MEM[10]
	S += (D_a_1*MAS[6])-1 < negD1_mem0*MAS_MEM[12]
	S += (D_a_1*MAS[7])-1 < negD1_mem0*MAS_MEM[14]
	S += negD1_mem0 <= negD1
	...
	S += N_b0_in*MAS_in[4]<=N_b0*MAS[4]

	S += N_b0_in*MAS_in[5]<=N_b0*MAS[5]

	S += N_b0_in*MAS_in[6]<=N_b0*MAS[6]

	S += N_b0_in*MAS_in[7]<=N_b0*MAS[7]
	...
	S += (D_a_0*MAS[5])-1 < N_b0_mem0*MAS_MEM[10]
	S += (D_a_0*MAS[6])-1 < N_b0_mem0*MAS_MEM[12]
	S += (D_a_0*MAS[7])-1 < N_b0_mem0*MAS_MEM[14]
	S += N_b0_mem0 <= N_b0
	...
	S += N_b1_in*MAS_in[4]<=N_b1*MAS[4]

	S += N_b1_in*MAS_in[5]<=N_b1*MAS[5]

	S += N_b1_in*MAS_in[6]<=N_b1*MAS[6]

	S += N_b1_in*MAS_in[7]<=N_b1*MAS[7]
	...
	S += (D_a_1*MAS[5])-1 < N_b1_mem0*MAS_MEM[10]
	S += (D_a_1*MAS[6])-1 < N_b1_mem0*MAS_MEM[12]
	S += (D_a_1*MAS[7])-1 < N_b1_mem0*MAS_MEM[14]
	S += N_b1_mem0 <= N_b1
	...
	S += D0_in*MAS_in[4]<=D0*MAS[4]

	S += D0_in*MAS_in[5]<=D0*MAS[5]

	S += D0_in*MAS_in[6]<=D0*MAS[6]

	S += D0_in*MAS_in[7]<=D0*MAS[7]
	...
	S += (negD0*MM[1])-1 < D0_mem1*MM_MEM[3]
	S += D0_mem1 <= D0
	...
	S += D1_in*MAS_in[4]<=D1*MAS[4]

	S += D1_in*MAS_in[5]<=D1*MAS[5]

	S += D1_in*MAS_in[6]<=D1*MAS[6]

	S += D1_in*MAS_in[7]<=D1*MAS[7]
	...
	S += (negD1*MM[1])-1 < D1_mem1*MM_MEM[3]
	S += D1_mem1 <= D1
	...
	S += (N_b0*MAS[5])-1 < N0_mem1*MAS_MEM[11]
	S += (N_b0*MAS[6])-1 < N0_mem1*MAS_MEM[13]
	S += (N_b0*MAS[7])-1 < N0_mem1*MAS_MEM[15]
	S += N0_mem1 <= N0
	...
	S += (N_b1*MAS[5])-1 < N1_mem1*MAS_MEM[11]
	S += (N_b1*MAS[6])-1 < N1_mem1*MAS_MEM[13]
	S += (N_b1*MAS[7])-1 < N1_mem1*MAS_MEM[15]
	S += N1_mem1 <= N1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/2xSSWU_BEFORE_EXP/schedule0.png"
	if(S.solution() != []):
