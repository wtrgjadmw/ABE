...
def solve():
	...
	S += t1_t2_in*MAS_in[6]<=t1_t2*MAS[6]

	S += t1_t2_in*MAS_in[7]<=t1_t2*MAS[7]
	...
	S += t1_t3_in*MAS_in[6]<=t1_t3*MAS[6]

	S += t1_t3_in*MAS_in[7]<=t1_t3*MAS[7]
	...
	S += t4_t0_t2_in*MAS_in[6]<=t4_t0_t2*MAS[6]

	S += t4_t0_t2_in*MAS_in[7]<=t4_t0_t2*MAS[7]
	...
	S += t4_t0_t3_in*MAS_in[6]<=t4_t0_t3*MAS[6]

	S += t4_t0_t3_in*MAS_in[7]<=t4_t0_t3*MAS[7]
	...
	S += t4_t1_t2_in*MAS_in[6]<=t4_t1_t2*MAS[6]

	S += t4_t1_t2_in*MAS_in[7]<=t4_t1_t2*MAS[7]
	...
	S += t4_t1_t3_in*MAS_in[6]<=t4_t1_t3*MAS[6]

	S += t4_t1_t3_in*MAS_in[7]<=t4_t1_t3*MAS[7]
	...
	S += t4_t2_t2_in*MAS_in[6]<=t4_t2_t2*MAS[6]

	S += t4_t2_t2_in*MAS_in[7]<=t4_t2_t2*MAS[7]
	...
	S += t4_t2_t3_in*MAS_in[6]<=t4_t2_t3*MAS[6]

	S += t4_t2_t3_in*MAS_in[7]<=t4_t2_t3*MAS[7]
	...
	S += t4_t40_in*MAS_in[6]<=t4_t40*MAS[6]

	S += t4_t40_in*MAS_in[7]<=t4_t40*MAS[7]
	...
	S += t4_t41_in*MAS_in[6]<=t4_t41*MAS[6]

	S += t4_t41_in*MAS_in[7]<=t4_t41*MAS[7]
	...
	S += t4_t50_in*MAS_in[6]<=t4_t50*MAS[6]

	S += t4_t50_in*MAS_in[7]<=t4_t50*MAS[7]
	...
	S += t4_t51_in*MAS_in[6]<=t4_t51*MAS[6]

	S += t4_t51_in*MAS_in[7]<=t4_t51*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/SPARSE/schedule0.png"
	if(S.solution() != []):
