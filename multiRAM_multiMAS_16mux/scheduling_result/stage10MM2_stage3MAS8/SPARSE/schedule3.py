...
def solve():
	...
	t4_t6_t1 = S.Task('t4_t6_t1', length=10, delay_cost=1)
	S += t4_t6_t1 >= 16
	t4_t6_t1 += MM[0]

	t4_t0_t4 = S.Task('t4_t0_t4', length=10, delay_cost=1)
	S += t4_t0_t4 >= 17
	t4_t0_t4 += MM[1]
	...
	t4_t2_t4 = S.Task('t4_t2_t4', length=10, delay_cost=1)
	S += t4_t2_t4 >= 20
	t4_t2_t4 += MM[0]
	...
	t4_t1_t4 = S.Task('t4_t1_t4', length=10, delay_cost=1)
	S += t4_t1_t4 >= 26
	t4_t1_t4 += MM[1]
	...
	t4_t6_t0 = S.Task('t4_t6_t0', length=10, delay_cost=1)
	S += t4_t6_t0 >= 29
	t4_t6_t0 += MM[1]
	...
	t1_t4 = S.Task('t1_t4', length=10, delay_cost=1)
	S += t1_t4 >= 32
	t1_t4 += MM[1]
	...
	S += t5_t1_t1_mem0 >= 38
	t5_t1_t1_mem0 += MAS_MEM[10]

	t5_t1_t1_mem1 = S.Task('t5_t1_t1_mem1', length=1, delay_cost=1)
	S += t5_t1_t1_mem1 >= 38
	t5_t1_t1_mem1 += MAS_MEM[15]
	...
	t5_t1_t1 = S.Task('t5_t1_t1', length=10, delay_cost=1)
	S += t5_t1_t1 >= 39
	t5_t1_t1 += MM[0]
	...
	t5_t2_t1 = S.Task('t5_t2_t1', length=10, delay_cost=1)
	S += t5_t2_t1 >= 40
	t5_t2_t1 += MM[1]
	...
	t4_t8_t4 = S.Task('t4_t8_t4', length=10, delay_cost=1)
	S += t4_t8_t4 >= 42
	t4_t8_t4 += MM[1]
	...
	t5_t0_t1 = S.Task('t5_t0_t1', length=10, delay_cost=1)
	S += t5_t0_t1 >= 43
	t5_t0_t1 += MM[0]

	t5_t0_t3_in = S.Task('t5_t0_t3_in', length=1, delay_cost=1)
	S += t5_t0_t3_in >= 43
	t5_t0_t3_in += MAS_in[5]
	...
	S += t5_t40_mem1 >= 44
	t5_t40_mem1 += MAS_MEM[11]

	t5_t8_t0 = S.Task('t5_t8_t0', length=10, delay_cost=1)
	S += t5_t8_t0 >= 44
	t5_t8_t0 += MM[0]
	...
	S += t5_t1_t2_mem0 >= 45
	t5_t1_t2_mem0 += MAS_MEM[10]

	t5_t1_t2_mem1 = S.Task('t5_t1_t2_mem1', length=1, delay_cost=1)
	S += t5_t1_t2_mem1 >= 45
	t5_t1_t2_mem1 += MAS_MEM[11]

	t5_t2_t0 = S.Task('t5_t2_t0', length=10, delay_cost=1)
	S += t5_t2_t0 >= 45
	t5_t2_t0 += MM[1]
	...
	t5_t0_t0 = S.Task('t5_t0_t0', length=10, delay_cost=1)
	S += t5_t0_t0 >= 46
	t5_t0_t0 += MM[0]
	...
	S += t5_t41_mem1 >= 47
	t5_t41_mem1 += MAS_MEM[11]

	t5_t8_t1 = S.Task('t5_t8_t1', length=10, delay_cost=1)
	S += t5_t8_t1 >= 47
	t5_t8_t1 += MM[0]

	t5_t1_t0 = S.Task('t5_t1_t0', length=10, delay_cost=1)
	S += t5_t1_t0 >= 48
	t5_t1_t0 += MM[1]
	...
	S += t4_t01_in*MAS_in[4]<=t4_t01*MAS[4]

	S += t4_t01_in*MAS_in[5]<=t4_t01*MAS[5]

	S += t4_t01_in*MAS_in[6]<=t4_t01*MAS[6]

	S += t4_t01_in*MAS_in[7]<=t4_t01*MAS[7]
	...
	S += t4_t11_in*MAS_in[4]<=t4_t11*MAS[4]

	S += t4_t11_in*MAS_in[5]<=t4_t11*MAS[5]

	S += t4_t11_in*MAS_in[6]<=t4_t11*MAS[6]

	S += t4_t11_in*MAS_in[7]<=t4_t11*MAS[7]
	...
	S += t4_t21_in*MAS_in[4]<=t4_t21*MAS[4]

	S += t4_t21_in*MAS_in[5]<=t4_t21*MAS[5]

	S += t4_t21_in*MAS_in[6]<=t4_t21*MAS[6]

	S += t4_t21_in*MAS_in[7]<=t4_t21*MAS[7]
	...
	t4_t6_t4 = S.Task('t4_t6_t4', length=10, delay_cost=1)
	t4_t6_t4 += alt(MM)
	...
	S += t4_t60_in*MAS_in[4]<=t4_t60*MAS[4]

	S += t4_t60_in*MAS_in[5]<=t4_t60*MAS[5]

	S += t4_t60_in*MAS_in[6]<=t4_t60*MAS[6]

	S += t4_t60_in*MAS_in[7]<=t4_t60*MAS[7]
	...
	S += t4_t6_t5_in*MAS_in[4]<=t4_t6_t5*MAS[4]

	S += t4_t6_t5_in*MAS_in[5]<=t4_t6_t5*MAS[5]

	S += t4_t6_t5_in*MAS_in[6]<=t4_t6_t5*MAS[6]

	S += t4_t6_t5_in*MAS_in[7]<=t4_t6_t5*MAS[7]
	...
	S += t4_t70_in*MAS_in[4]<=t4_t70*MAS[4]

	S += t4_t70_in*MAS_in[5]<=t4_t70*MAS[5]

	S += t4_t70_in*MAS_in[6]<=t4_t70*MAS[6]

	S += t4_t70_in*MAS_in[7]<=t4_t70*MAS[7]
	...
	S += t4_t81_in*MAS_in[4]<=t4_t81*MAS[4]

	S += t4_t81_in*MAS_in[5]<=t4_t81*MAS[5]

	S += t4_t81_in*MAS_in[6]<=t4_t81*MAS[6]

	S += t4_t81_in*MAS_in[7]<=t4_t81*MAS[7]
	...
	S += t420_in*MAS_in[4]<=t420*MAS[4]

	S += t420_in*MAS_in[5]<=t420*MAS[5]

	S += t420_in*MAS_in[6]<=t420*MAS[6]

	S += t420_in*MAS_in[7]<=t420*MAS[7]

	t420_mem0 = S.Task('t420_mem0', length=1, delay_cost=1)
	t420_mem0 += MAS_MEM[12]
	S += 30 < t420_mem0
	S += t420_mem0 <= t420
	...
	t5_t0_t4 = S.Task('t5_t0_t4', length=10, delay_cost=1)
	t5_t0_t4 += alt(MM)
	...
	S += t5_t00_in*MAS_in[4]<=t5_t00*MAS[4]

	S += t5_t00_in*MAS_in[5]<=t5_t00*MAS[5]

	S += t5_t00_in*MAS_in[6]<=t5_t00*MAS[6]

	S += t5_t00_in*MAS_in[7]<=t5_t00*MAS[7]
	...
	S += t5_t0_t5_in*MAS_in[4]<=t5_t0_t5*MAS[4]

	S += t5_t0_t5_in*MAS_in[5]<=t5_t0_t5*MAS[5]

	S += t5_t0_t5_in*MAS_in[6]<=t5_t0_t5*MAS[6]

	S += t5_t0_t5_in*MAS_in[7]<=t5_t0_t5*MAS[7]
	...
	t5_t1_t4 = S.Task('t5_t1_t4', length=10, delay_cost=1)
	t5_t1_t4 += alt(MM)
	...
	S += t5_t10_in*MAS_in[4]<=t5_t10*MAS[4]

	S += t5_t10_in*MAS_in[5]<=t5_t10*MAS[5]

	S += t5_t10_in*MAS_in[6]<=t5_t10*MAS[6]

	S += t5_t10_in*MAS_in[7]<=t5_t10*MAS[7]
	...
	S += t5_t1_t5_in*MAS_in[4]<=t5_t1_t5*MAS[4]

	S += t5_t1_t5_in*MAS_in[5]<=t5_t1_t5*MAS[5]

	S += t5_t1_t5_in*MAS_in[6]<=t5_t1_t5*MAS[6]

	S += t5_t1_t5_in*MAS_in[7]<=t5_t1_t5*MAS[7]
	...
	t5_t2_t4 = S.Task('t5_t2_t4', length=10, delay_cost=1)
	t5_t2_t4 += alt(MM)
	...
	S += t5_t20_in*MAS_in[4]<=t5_t20*MAS[4]

	S += t5_t20_in*MAS_in[5]<=t5_t20*MAS[5]

	S += t5_t20_in*MAS_in[6]<=t5_t20*MAS[6]

	S += t5_t20_in*MAS_in[7]<=t5_t20*MAS[7]
	...
	S += t5_t2_t5_in*MAS_in[4]<=t5_t2_t5*MAS[4]

	S += t5_t2_t5_in*MAS_in[5]<=t5_t2_t5*MAS[5]

	S += t5_t2_t5_in*MAS_in[6]<=t5_t2_t5*MAS[6]

	S += t5_t2_t5_in*MAS_in[7]<=t5_t2_t5*MAS[7]
	...
	t5_t6_t0 = S.Task('t5_t6_t0', length=10, delay_cost=1)
	t5_t6_t0 += alt(MM)
	...
	t5_t6_t1 = S.Task('t5_t6_t1', length=10, delay_cost=1)
	t5_t6_t1 += alt(MM)
	...
	S += t5_t6_t2_in*MAS_in[4]<=t5_t6_t2*MAS[4]

	S += t5_t6_t2_in*MAS_in[5]<=t5_t6_t2*MAS[5]

	S += t5_t6_t2_in*MAS_in[6]<=t5_t6_t2*MAS[6]

	S += t5_t6_t2_in*MAS_in[7]<=t5_t6_t2*MAS[7]
	...
	S += t5_t6_t3_in*MAS_in[4]<=t5_t6_t3*MAS[4]

	S += t5_t6_t3_in*MAS_in[5]<=t5_t6_t3*MAS[5]

	S += t5_t6_t3_in*MAS_in[6]<=t5_t6_t3*MAS[6]

	S += t5_t6_t3_in*MAS_in[7]<=t5_t6_t3*MAS[7]
	...
	t5_t8_t4 = S.Task('t5_t8_t4', length=10, delay_cost=1)
	t5_t8_t4 += alt(MM)
	...
	S += t5_t80_in*MAS_in[4]<=t5_t80*MAS[4]

	S += t5_t80_in*MAS_in[5]<=t5_t80*MAS[5]

	S += t5_t80_in*MAS_in[6]<=t5_t80*MAS[6]

	S += t5_t80_in*MAS_in[7]<=t5_t80*MAS[7]
	...
	S += t5_t8_t5_in*MAS_in[4]<=t5_t8_t5*MAS[4]

	S += t5_t8_t5_in*MAS_in[5]<=t5_t8_t5*MAS[5]

	S += t5_t8_t5_in*MAS_in[6]<=t5_t8_t5*MAS[6]

	S += t5_t8_t5_in*MAS_in[7]<=t5_t8_t5*MAS[7]
	...
	S += t4_t100_in*MAS_in[4]<=t4_t100*MAS[4]

	S += t4_t100_in*MAS_in[5]<=t4_t100*MAS[5]

	S += t4_t100_in*MAS_in[6]<=t4_t100*MAS[6]

	S += t4_t100_in*MAS_in[7]<=t4_t100*MAS[7]

	t4_t100_mem0 = S.Task('t4_t100_mem0', length=1, delay_cost=1)
	t4_t100_mem0 += MAS_MEM[12]
	S += 23 < t4_t100_mem0
	...
	S += t4_t101_in*MAS_in[4]<=t4_t101*MAS[4]

	S += t4_t101_in*MAS_in[5]<=t4_t101*MAS[5]

	S += t4_t101_in*MAS_in[6]<=t4_t101*MAS[6]

	S += t4_t101_in*MAS_in[7]<=t4_t101*MAS[7]
	...
	S += t4_t61_in*MAS_in[4]<=t4_t61*MAS[4]

	S += t4_t61_in*MAS_in[5]<=t4_t61*MAS[5]

	S += t4_t61_in*MAS_in[6]<=t4_t61*MAS[6]

	S += t4_t61_in*MAS_in[7]<=t4_t61*MAS[7]
	...
	S += t4_t71_in*MAS_in[4]<=t4_t71*MAS[4]

	S += t4_t71_in*MAS_in[5]<=t4_t71*MAS[5]

	S += t4_t71_in*MAS_in[6]<=t4_t71*MAS[6]

	S += t4_t71_in*MAS_in[7]<=t4_t71*MAS[7]
	...
	S += t410_in*MAS_in[4]<=t410*MAS[4]

	S += t410_in*MAS_in[5]<=t410*MAS[5]

	S += t410_in*MAS_in[6]<=t410*MAS[6]

	S += t410_in*MAS_in[7]<=t410*MAS[7]
	...
	S += t421_in*MAS_in[4]<=t421*MAS[4]

	S += t421_in*MAS_in[5]<=t421*MAS[5]

	S += t421_in*MAS_in[6]<=t421*MAS[6]

	S += t421_in*MAS_in[7]<=t421*MAS[7]
	...
	S += t5_t01_in*MAS_in[4]<=t5_t01*MAS[4]

	S += t5_t01_in*MAS_in[5]<=t5_t01*MAS[5]

	S += t5_t01_in*MAS_in[6]<=t5_t01*MAS[6]

	S += t5_t01_in*MAS_in[7]<=t5_t01*MAS[7]
	...
	S += t5_t11_in*MAS_in[4]<=t5_t11*MAS[4]

	S += t5_t11_in*MAS_in[5]<=t5_t11*MAS[5]

	S += t5_t11_in*MAS_in[6]<=t5_t11*MAS[6]

	S += t5_t11_in*MAS_in[7]<=t5_t11*MAS[7]
	...
	S += t5_t21_in*MAS_in[4]<=t5_t21*MAS[4]

	S += t5_t21_in*MAS_in[5]<=t5_t21*MAS[5]

	S += t5_t21_in*MAS_in[6]<=t5_t21*MAS[6]

	S += t5_t21_in*MAS_in[7]<=t5_t21*MAS[7]
	...
	t5_t6_t4 = S.Task('t5_t6_t4', length=10, delay_cost=1)
	t5_t6_t4 += alt(MM)
	...
	S += t5_t60_in*MAS_in[4]<=t5_t60*MAS[4]

	S += t5_t60_in*MAS_in[5]<=t5_t60*MAS[5]

	S += t5_t60_in*MAS_in[6]<=t5_t60*MAS[6]

	S += t5_t60_in*MAS_in[7]<=t5_t60*MAS[7]
	...
	S += t5_t6_t5_in*MAS_in[4]<=t5_t6_t5*MAS[4]

	S += t5_t6_t5_in*MAS_in[5]<=t5_t6_t5*MAS[5]

	S += t5_t6_t5_in*MAS_in[6]<=t5_t6_t5*MAS[6]

	S += t5_t6_t5_in*MAS_in[7]<=t5_t6_t5*MAS[7]
	...
	S += t5_t70_in*MAS_in[4]<=t5_t70*MAS[4]

	S += t5_t70_in*MAS_in[5]<=t5_t70*MAS[5]

	S += t5_t70_in*MAS_in[6]<=t5_t70*MAS[6]

	S += t5_t70_in*MAS_in[7]<=t5_t70*MAS[7]
	...
	S += t5_t81_in*MAS_in[4]<=t5_t81*MAS[4]

	S += t5_t81_in*MAS_in[5]<=t5_t81*MAS[5]

	S += t5_t81_in*MAS_in[6]<=t5_t81*MAS[6]

	S += t5_t81_in*MAS_in[7]<=t5_t81*MAS[7]
	...
	S += t520_in*MAS_in[4]<=t520*MAS[4]

	S += t520_in*MAS_in[5]<=t520*MAS[5]

	S += t520_in*MAS_in[6]<=t520*MAS[6]

	S += t520_in*MAS_in[7]<=t520*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/SPARSE/schedule3.png"
	if(S.solution() != []):
