...
def solve():
	...
	S += t4_t00_in*MAS_in[4]<=t4_t00*MAS[4]

	S += t4_t00_in*MAS_in[5]<=t4_t00*MAS[5]

	S += t4_t00_in*MAS_in[6]<=t4_t00*MAS[6]

	S += t4_t00_in*MAS_in[7]<=t4_t00*MAS[7]
	...
	S += t4_t0_t5_in*MAS_in[4]<=t4_t0_t5*MAS[4]

	S += t4_t0_t5_in*MAS_in[5]<=t4_t0_t5*MAS[5]

	S += t4_t0_t5_in*MAS_in[6]<=t4_t0_t5*MAS[6]

	S += t4_t0_t5_in*MAS_in[7]<=t4_t0_t5*MAS[7]
	...
	S += t4_t10_in*MAS_in[4]<=t4_t10*MAS[4]

	S += t4_t10_in*MAS_in[5]<=t4_t10*MAS[5]

	S += t4_t10_in*MAS_in[6]<=t4_t10*MAS[6]

	S += t4_t10_in*MAS_in[7]<=t4_t10*MAS[7]
	...
	S += t4_t1_t5_in*MAS_in[4]<=t4_t1_t5*MAS[4]

	S += t4_t1_t5_in*MAS_in[5]<=t4_t1_t5*MAS[5]

	S += t4_t1_t5_in*MAS_in[6]<=t4_t1_t5*MAS[6]

	S += t4_t1_t5_in*MAS_in[7]<=t4_t1_t5*MAS[7]
	...
	S += t4_t20_in*MAS_in[4]<=t4_t20*MAS[4]

	S += t4_t20_in*MAS_in[5]<=t4_t20*MAS[5]

	S += t4_t20_in*MAS_in[6]<=t4_t20*MAS[6]

	S += t4_t20_in*MAS_in[7]<=t4_t20*MAS[7]
	...
	S += t4_t2_t5_in*MAS_in[4]<=t4_t2_t5*MAS[4]

	S += t4_t2_t5_in*MAS_in[5]<=t4_t2_t5*MAS[5]

	S += t4_t2_t5_in*MAS_in[6]<=t4_t2_t5*MAS[6]

	S += t4_t2_t5_in*MAS_in[7]<=t4_t2_t5*MAS[7]
	...
	S += t4_t6_t2_in*MAS_in[4]<=t4_t6_t2*MAS[4]

	S += t4_t6_t2_in*MAS_in[5]<=t4_t6_t2*MAS[5]

	S += t4_t6_t2_in*MAS_in[6]<=t4_t6_t2*MAS[6]

	S += t4_t6_t2_in*MAS_in[7]<=t4_t6_t2*MAS[7]
	...
	S += t4_t6_t3_in*MAS_in[4]<=t4_t6_t3*MAS[4]

	S += t4_t6_t3_in*MAS_in[5]<=t4_t6_t3*MAS[5]

	S += t4_t6_t3_in*MAS_in[6]<=t4_t6_t3*MAS[6]

	S += t4_t6_t3_in*MAS_in[7]<=t4_t6_t3*MAS[7]
	...
	S += t4_t80_in*MAS_in[4]<=t4_t80*MAS[4]

	S += t4_t80_in*MAS_in[5]<=t4_t80*MAS[5]

	S += t4_t80_in*MAS_in[6]<=t4_t80*MAS[6]

	S += t4_t80_in*MAS_in[7]<=t4_t80*MAS[7]
	...
	S += t4_t8_t5_in*MAS_in[4]<=t4_t8_t5*MAS[4]

	S += t4_t8_t5_in*MAS_in[5]<=t4_t8_t5*MAS[5]

	S += t4_t8_t5_in*MAS_in[6]<=t4_t8_t5*MAS[6]

	S += t4_t8_t5_in*MAS_in[7]<=t4_t8_t5*MAS[7]
	...
	S += t5_t0_t3_in*MAS_in[4]<=t5_t0_t3*MAS[4]

	S += t5_t0_t3_in*MAS_in[5]<=t5_t0_t3*MAS[5]

	S += t5_t0_t3_in*MAS_in[6]<=t5_t0_t3*MAS[6]

	S += t5_t0_t3_in*MAS_in[7]<=t5_t0_t3*MAS[7]
	...
	S += t5_t1_t2_in*MAS_in[4]<=t5_t1_t2*MAS[4]

	S += t5_t1_t2_in*MAS_in[5]<=t5_t1_t2*MAS[5]

	S += t5_t1_t2_in*MAS_in[6]<=t5_t1_t2*MAS[6]

	S += t5_t1_t2_in*MAS_in[7]<=t5_t1_t2*MAS[7]
	...
	S += t5_t1_t3_in*MAS_in[4]<=t5_t1_t3*MAS[4]

	S += t5_t1_t3_in*MAS_in[5]<=t5_t1_t3*MAS[5]

	S += t5_t1_t3_in*MAS_in[6]<=t5_t1_t3*MAS[6]

	S += t5_t1_t3_in*MAS_in[7]<=t5_t1_t3*MAS[7]
	...
	S += t5_t2_t2_in*MAS_in[4]<=t5_t2_t2*MAS[4]

	S += t5_t2_t2_in*MAS_in[5]<=t5_t2_t2*MAS[5]

	S += t5_t2_t2_in*MAS_in[6]<=t5_t2_t2*MAS[6]

	S += t5_t2_t2_in*MAS_in[7]<=t5_t2_t2*MAS[7]
	...
	S += t5_t2_t3_in*MAS_in[4]<=t5_t2_t3*MAS[4]

	S += t5_t2_t3_in*MAS_in[5]<=t5_t2_t3*MAS[5]

	S += t5_t2_t3_in*MAS_in[6]<=t5_t2_t3*MAS[6]

	S += t5_t2_t3_in*MAS_in[7]<=t5_t2_t3*MAS[7]
	...
	S += t5_t40_in*MAS_in[4]<=t5_t40*MAS[4]

	S += t5_t40_in*MAS_in[5]<=t5_t40*MAS[5]

	S += t5_t40_in*MAS_in[6]<=t5_t40*MAS[6]

	S += t5_t40_in*MAS_in[7]<=t5_t40*MAS[7]
	...
	S += t5_t41_in*MAS_in[4]<=t5_t41*MAS[4]

	S += t5_t41_in*MAS_in[5]<=t5_t41*MAS[5]

	S += t5_t41_in*MAS_in[6]<=t5_t41*MAS[6]

	S += t5_t41_in*MAS_in[7]<=t5_t41*MAS[7]
	...
	S += t5_t50_in*MAS_in[4]<=t5_t50*MAS[4]

	S += t5_t50_in*MAS_in[5]<=t5_t50*MAS[5]

	S += t5_t50_in*MAS_in[6]<=t5_t50*MAS[6]

	S += t5_t50_in*MAS_in[7]<=t5_t50*MAS[7]
	...
	S += t5_t51_in*MAS_in[4]<=t5_t51*MAS[4]

	S += t5_t51_in*MAS_in[5]<=t5_t51*MAS[5]

	S += t5_t51_in*MAS_in[6]<=t5_t51*MAS[6]

	S += t5_t51_in*MAS_in[7]<=t5_t51*MAS[7]
	...
	S += t5_t8_t3_in*MAS_in[4]<=t5_t8_t3*MAS[4]

	S += t5_t8_t3_in*MAS_in[5]<=t5_t8_t3*MAS[5]

	S += t5_t8_t3_in*MAS_in[6]<=t5_t8_t3*MAS[6]

	S += t5_t8_t3_in*MAS_in[7]<=t5_t8_t3*MAS[7]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage3MAS8/SPARSE/schedule2.png"
	if(S.solution() != []):
