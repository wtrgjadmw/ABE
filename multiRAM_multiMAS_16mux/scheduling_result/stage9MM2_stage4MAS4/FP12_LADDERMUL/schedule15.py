...
def solve():
	...
	S += d_t5_t2_t5_mem0 >= 77
	d_t5_t2_t5_mem0 += MM_MEM[0]

	d_t5_t2_t5_mem1 = S.Task('d_t5_t2_t5_mem1', length=1, delay_cost=1)
	S += d_t5_t2_t5_mem1 >= 77
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM2_stage4MAS4/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
