...
def solve():
	...
	# new tasks
	c10_t4 = S.Task('c10_t4', length=6, delay_cost=1)
	c10_t4 += alt(MM)
	...
	c20_t4 = S.Task('c20_t4', length=6, delay_cost=1)
	c20_t4 += alt(MM)
	...
	c01_t4 = S.Task('c01_t4', length=6, delay_cost=1)
	c01_t4 += alt(MM)
	...
	c11_t4 = S.Task('c11_t4', length=6, delay_cost=1)
	c11_t4 += alt(MM)
	...
	c21_t4 = S.Task('c21_t4', length=6, delay_cost=1)
	c21_t4 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage3MAS6/FROB/schedule1.png"
	if(S.solution() != []):
