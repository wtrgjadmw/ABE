...
def solve():
	...
	S += (c_pbc_t1_t5*MAS[4])-1 < c_pbc_t11_mem1*MAS_MEM[9]
	S += (c_pbc_t1_t5*MAS[5])-1 < c_pbc_t11_mem1*MAS_MEM[11]
	...
	S += (c_pbc_t10*MAS[4])-1 < c_pbc_t50_mem1*MAS_MEM[9]
	S += (c_pbc_t10*MAS[5])-1 < c_pbc_t50_mem1*MAS_MEM[11]
	...
	c_pbc_s00_mem0 += alt(MAS_MEM)
	S += (c_pbc_t10*MAS[0])-1 < c_pbc_s00_mem0*MAS_MEM[0]
	S += (c_pbc_t10*MAS[1])-1 < c_pbc_s00_mem0*MAS_MEM[2]
	S += (c_pbc_t10*MAS[2])-1 < c_pbc_s00_mem0*MAS_MEM[4]
	S += (c_pbc_t10*MAS[3])-1 < c_pbc_s00_mem0*MAS_MEM[6]
	S += (c_pbc_t10*MAS[4])-1 < c_pbc_s00_mem0*MAS_MEM[8]
	S += (c_pbc_t10*MAS[5])-1 < c_pbc_s00_mem0*MAS_MEM[10]
	...
	c_pbc_s01_mem1 += alt(MAS_MEM)
	S += (c_pbc_t10*MAS[0])-1 < c_pbc_s01_mem1*MAS_MEM[1]
	S += (c_pbc_t10*MAS[1])-1 < c_pbc_s01_mem1*MAS_MEM[3]
	S += (c_pbc_t10*MAS[2])-1 < c_pbc_s01_mem1*MAS_MEM[5]
	S += (c_pbc_t10*MAS[3])-1 < c_pbc_s01_mem1*MAS_MEM[7]
	S += (c_pbc_t10*MAS[4])-1 < c_pbc_s01_mem1*MAS_MEM[9]
	S += (c_pbc_t10*MAS[5])-1 < c_pbc_s01_mem1*MAS_MEM[11]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage3MAS6/FP12_INV_BEFORE_FPINV/schedule8.png"
	if(S.solution() != []):
