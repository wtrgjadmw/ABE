...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS6/FP12_INV_AFTER_FPINV/schedule3.png"
	if(S.solution() != []):
