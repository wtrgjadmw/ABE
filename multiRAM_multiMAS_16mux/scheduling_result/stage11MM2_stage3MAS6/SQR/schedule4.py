...
def solve():
	...
	S += c_t1_t3_t4_mem0 >= 32
	c_t1_t3_t4_mem0 += MAS_MEM[10]

	c_t1_t3_t4_mem1 = S.Task('c_t1_t3_t4_mem1', length=1, delay_cost=1)
	S += c_t1_t3_t4_mem1 >= 32
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS6/SQR/schedule4.png"
	if(S.solution() != []):
