...
def solve():
	...
	S += c_t1_t0_t0_mem0 >= 37
	c_t1_t0_t0_mem0 += MAIN_MEM_r[0]

	c_t1_t0_t0_mem1 = S.Task('c_t1_t0_t0_mem1', length=1, delay_cost=1)
	S += c_t1_t0_t0_mem1 >= 37
	...
	S += c_t0_t0_t3_mem0 >= 52
	c_t0_t0_t3_mem0 += MAIN_MEM_r[0]

	c_t0_t0_t3_mem1 = S.Task('c_t0_t0_t3_mem1', length=1, delay_cost=1)
	S += c_t0_t0_t3_mem1 >= 52
	...
	c_t0_t4_t1_mem1 += MAS_MEM[11]
	S += 48 < c_t0_t4_t1_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage2MAS6/FP12_LADDERMUL/schedule4.png"
	if(S.solution() != []):
