...
def solve():
	...
	S += c_t3_t0_t4_mem0 >= 54
	c_t3_t0_t4_mem0 += MAS_MEM[6]

	c_t3_t0_t4_mem1 = S.Task('c_t3_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t4_mem1 >= 54
	...
	S += c_t4_t0_t5_mem0 >= 56
	c_t4_t0_t5_mem0 += MM_MEM[2]

	c_t4_t0_t5_mem1 = S.Task('c_t4_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t5_mem1 >= 56
	...
	S += c_t3_t4_t2_mem0 >= 57
	c_t3_t4_t2_mem0 += MAS_MEM[10]

	c_t3_t4_t2_mem1 = S.Task('c_t3_t4_t2_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t2_mem1 >= 57
	...
	S += c_t3_t4_t4_mem0 >= 60
	c_t3_t4_t4_mem0 += MAS_MEM[6]

	c_t3_t4_t4_mem1 = S.Task('c_t3_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t4_mem1 >= 60
	...
	S += c_t3_t4_t5_mem0 >= 70
	c_t3_t4_t5_mem0 += MM_MEM[2]

	c_t3_t4_t5_mem1 = S.Task('c_t3_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t5_mem1 >= 70
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage2MAS6/MUL/schedule6.png"
	if(S.solution() != []):
