...
def solve():
	...
	S += c_t4_t4_t4_mem0 >= 64
	c_t4_t4_t4_mem0 += MAS_MEM[8]

	c_t4_t4_t4_mem1 = S.Task('c_t4_t4_t4_mem1', length=1, delay_cost=1)
	S += c_t4_t4_t4_mem1 >= 64
	...
	S += c_t4_t4_t5_mem0 >= 70
	c_t4_t4_t5_mem0 += MM_MEM[2]

	c_t4_t4_t5_mem1 = S.Task('c_t4_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t4_t5_mem1 >= 70
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage1MAS6/MUL/schedule7.png"
	if(S.solution() != []):
