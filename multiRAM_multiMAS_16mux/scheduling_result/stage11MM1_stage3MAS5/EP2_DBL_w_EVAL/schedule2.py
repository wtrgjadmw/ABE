...
def solve():
	...
	t120_mem0 += alt(MM_MEM)
	S += (t12_t0*MM[0])-1 < t120_mem0*MM_MEM[0]
	S += t120_mem0 <= t120
	...
	t12_t5_mem0 += alt(MM_MEM)
	S += (t12_t0*MM[0])-1 < t12_t5_mem0*MM_MEM[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM1_stage3MAS5/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
