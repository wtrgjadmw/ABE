...
def solve():
	...
	aND20_mem1 += alt(MM_MEM)
	S += (ND20*MM[0])-1 < aND20_mem1*MM_MEM[1]
	S += aND20_mem1 <= aND20
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM1_stage3MAS5/2xSSWU_BEFORE_EXP/schedule1.png"
	if(S.solution() != []):
