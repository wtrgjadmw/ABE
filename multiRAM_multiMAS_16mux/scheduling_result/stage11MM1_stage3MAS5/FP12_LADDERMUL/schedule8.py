...
def solve():
	...
	S += c_t2_t0_t4_mem0 >= 80
	c_t2_t0_t4_mem0 += MAS_MEM[8]

	c_t2_t0_t4_mem1 = S.Task('c_t2_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t2_t0_t4_mem1 >= 80
	...
	S += c_t5_t0_t2_mem0 >= 93
	c_t5_t0_t2_mem0 += MAS_MEM[4]

	c_t5_t0_t2_mem1 = S.Task('c_t5_t0_t2_mem1', length=1, delay_cost=1)
	S += c_t5_t0_t2_mem1 >= 93
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM1_stage3MAS5/FP12_LADDERMUL/schedule8.png"
	if(S.solution() != []):
