...
def solve():
	...
	S += d_t0_t3_t5_mem0 >= 31
	d_t0_t3_t5_mem0 += MM_MEM[0]

	d_t0_t3_t5_mem1 = S.Task('d_t0_t3_t5_mem1', length=1, delay_cost=1)
	S += d_t0_t3_t5_mem1 >= 31
	...
	S += d_t5_t3_t0_mem0 >= 64
	d_t5_t3_t0_mem0 += MAS_MEM[10]

	d_t5_t3_t0_mem1 = S.Task('d_t5_t3_t0_mem1', length=1, delay_cost=1)
	S += d_t5_t3_t0_mem1 >= 64
	...
	S += c_t0_t1_t5_mem0 >= 69
	c_t0_t1_t5_mem0 += MM_MEM[2]

	c_t0_t1_t5_mem1 = S.Task('c_t0_t1_t5_mem1', length=1, delay_cost=1)
	S += c_t0_t1_t5_mem1 >= 69
	...
	c_t0_t4_t3_mem1 += MAS_MEM[11]
	S += 44 < c_t0_t4_t3_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS6/FP12_LADDERMUL/schedule5.png"
	if(S.solution() != []):
