...
def solve():
	...
	S += c_pcb_t51_mem0 >= 126
	c_pcb_t51_mem0 += MAS_MEM[10]

	c_pcb_t51_mem1 = S.Task('c_pcb_t51_mem1', length=1, delay_cost=1)
	S += c_pcb_t51_mem1 >= 126
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS6/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
