...
def solve():
	...
	S += c_t1_t1_t0_mem0 >= 12
	c_t1_t1_t0_mem0 += MAIN_MEM_r[0]

	c_t1_t1_t0_mem1 = S.Task('c_t1_t1_t0_mem1', length=1, delay_cost=1)
	S += c_t1_t1_t0_mem1 >= 12
	...
	S += c_t1_t1_t1_mem0 >= 21
	c_t1_t1_t1_mem0 += MAIN_MEM_r[0]

	c_t1_t1_t1_mem1 = S.Task('c_t1_t1_t1_mem1', length=1, delay_cost=1)
	S += c_t1_t1_t1_mem1 >= 21
	...
	S += c_t1_t0_t3_mem0 >= 23
	c_t1_t0_t3_mem0 += MAIN_MEM_r[0]

	c_t1_t0_t3_mem1 = S.Task('c_t1_t0_t3_mem1', length=1, delay_cost=1)
	S += c_t1_t0_t3_mem1 >= 23
	...
	c_t2_t4_t0_mem0 += MAS_MEM[10]
	S += 61 < c_t2_t4_t0_mem0
	S += c_t2_t4_t0_mem0 <= c_t2_t4_t0

	c_t2_t4_t0_mem1 = S.Task('c_t2_t4_t0_mem1', length=1, delay_cost=1)
	c_t2_t4_t0_mem1 += MAS_MEM[5]
	S += 39 < c_t2_t4_t0_mem1
	...
	c_t2_t4_t2_mem0 += MAS_MEM[10]
	S += 61 < c_t2_t4_t2_mem0
	S += c_t2_t4_t2_mem0 <= c_t2_t4_t2

	c_t2_t4_t2_mem1 = S.Task('c_t2_t4_t2_mem1', length=1, delay_cost=1)
	c_t2_t4_t2_mem1 += MAS_MEM[5]
	S += 60 < c_t2_t4_t2_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage10MM2_stage4MAS6/MUL/schedule2.png"
	if(S.solution() != []):
