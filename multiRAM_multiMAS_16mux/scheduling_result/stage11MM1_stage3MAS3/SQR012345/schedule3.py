...
def solve():
	...
	S += (t130*MAS[0])-1 < t140_mem0*MAS_MEM[0]
	S += (t130*MAS[1])-1 < t140_mem0*MAS_MEM[2]
	S += (t130*MAS[2])-1 < t140_mem0*MAS_MEM[4]
	S += t140_mem0 <= t140
	...
	S += (t170*MAS[0])-1 < c110_mem1*MAS_MEM[1]
	S += (t170*MAS[1])-1 < c110_mem1*MAS_MEM[3]
	S += (t170*MAS[2])-1 < c110_mem1*MAS_MEM[5]
	S += c110_mem1 <= c110
	...
	t210_mem0 += alt(MAS_MEM)
	S += (t200*MAS[0])-1 < t210_mem0*MAS_MEM[0]
	S += (t200*MAS[1])-1 < t210_mem0*MAS_MEM[2]
	S += (t200*MAS[2])-1 < t210_mem0*MAS_MEM[4]
	S += t210_mem0 <= t210
	...
	t211_mem0 += alt(MAS_MEM)
	S += (t201*MAS[0])-1 < t211_mem0*MAS_MEM[0]
	S += (t201*MAS[1])-1 < t211_mem0*MAS_MEM[2]
	S += (t201*MAS[2])-1 < t211_mem0*MAS_MEM[4]
	S += t211_mem0 <= t211
	...
	S += (t130*MAS[0])-1 < c000_mem0*MAS_MEM[0]
	S += (t130*MAS[1])-1 < c000_mem0*MAS_MEM[2]
	S += (t130*MAS[2])-1 < c000_mem0*MAS_MEM[4]
	S += c000_mem0 <= c000
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM1_stage3MAS3/SQR012345/schedule3.png"
	if(S.solution() != []):
