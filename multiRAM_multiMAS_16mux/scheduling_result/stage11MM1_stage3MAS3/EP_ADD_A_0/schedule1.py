...
def solve():
	...
	Z_Hash1_new_mem0 += alt(MM_MEM)
	S += (t29*MM[0])-1 < Z_Hash1_new_mem0*MM_MEM[0]
	S += Z_Hash1_new_mem0 <= Z_Hash1_new

	Z_Hash1_new_mem1 = S.Task('Z_Hash1_new_mem1', length=1, delay_cost=1)
	Z_Hash1_new_mem1 += alt(MM_MEM)
	S += (t28*MM[0])-1 < Z_Hash1_new_mem1*MM_MEM[1]
	...
	X_Hash1_new_mem0 += alt(MM_MEM)
	S += (t25*MM[0])-1 < X_Hash1_new_mem0*MM_MEM[0]
	...
	Y_Hash1_new_mem0 += alt(MM_MEM)
	S += (t27*MM[0])-1 < Y_Hash1_new_mem0*MM_MEM[0]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM1_stage3MAS3/EP_ADD_A_0/schedule1.png"
	if(S.solution() != []):
