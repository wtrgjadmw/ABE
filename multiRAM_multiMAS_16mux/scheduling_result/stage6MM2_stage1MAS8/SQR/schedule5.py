...
def solve():
	...
	S += c_t3_t3_t0_mem0 >= 25
	c_t3_t3_t0_mem0 += MAS_MEM[14]

	c_t3_t3_t0_mem1 = S.Task('c_t3_t3_t0_mem1', length=1, delay_cost=1)
	S += c_t3_t3_t0_mem1 >= 25
	...
	S += c_t1_t2_t1_mem0 >= 40
	c_t1_t2_t1_mem0 += MAS_MEM[8]

	c_t1_t2_t1_mem1 = S.Task('c_t1_t2_t1_mem1', length=1, delay_cost=1)
	S += c_t1_t2_t1_mem1 >= 40
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage1MAS8/SQR/schedule5.png"
	if(S.solution() != []):
