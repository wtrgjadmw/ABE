...
def solve():
	...
	S += c_t1_t0_t5_mem0 >= 15
	c_t1_t0_t5_mem0 += MM_MEM[0]

	c_t1_t0_t5_mem1 = S.Task('c_t1_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t1_t0_t5_mem1 >= 15
	...
	S += c_t1_t4_t0_mem0 >= 17
	c_t1_t4_t0_mem0 += MAS_MEM[0]

	c_t1_t4_t0_mem1 = S.Task('c_t1_t4_t0_mem1', length=1, delay_cost=1)
	S += c_t1_t4_t0_mem1 >= 17
	...
	S += c_t0_t4_t5_mem0 >= 35
	c_t0_t4_t5_mem0 += MM_MEM[2]

	c_t0_t4_t5_mem1 = S.Task('c_t0_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t0_t4_t5_mem1 >= 35
	...
	S += c_t3_t4_t1_mem0 >= 42
	c_t3_t4_t1_mem0 += MAS_MEM[12]

	c_t3_t4_t1_mem1 = S.Task('c_t3_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t1_mem1 >= 42
	...
	S += c_t3_t0_t5_mem0 >= 44
	c_t3_t0_t5_mem0 += MM_MEM[2]

	c_t3_t0_t5_mem1 = S.Task('c_t3_t0_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t0_t5_mem1 >= 44
	...
	S += c_t3_t4_t5_mem0 >= 49
	c_t3_t4_t5_mem0 += MM_MEM[2]

	c_t3_t4_t5_mem1 = S.Task('c_t3_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t5_mem1 >= 49
	...
	S += c_t2_s00_mem1 >= 53
	c_t2_s00_mem1 += MAS_MEM[13]

	c_t2_s01_mem0 = S.Task('c_t2_s01_mem0', length=1, delay_cost=1)
	S += c_t2_s01_mem0 >= 53
	c_t2_s01_mem0 += MAS_MEM[12]
	...
	S += c_t5_t1_t4_mem0 >= 59
	c_t5_t1_t4_mem0 += MAS_MEM[10]

	c_t5_t1_t4_mem1 = S.Task('c_t5_t1_t4_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t4_mem1 >= 59
	...
	S += c_t5_t4_t5_mem0 >= 66
	c_t5_t4_t5_mem0 += MM_MEM[0]

	c_t5_t4_t5_mem1 = S.Task('c_t5_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t5_t4_t5_mem1 >= 66
	...
	S += c_t4_t4_t5_mem0 >= 69
	c_t4_t4_t5_mem0 += MM_MEM[0]

	c_t4_t4_t5_mem1 = S.Task('c_t4_t4_t5_mem1', length=1, delay_cost=1)
	S += c_t4_t4_t5_mem1 >= 69
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage1MAS8/MUL/schedule6.png"
	if(S.solution() != []):
