...
def solve():
	...
	S += (t170*MAS[5])-1 < c000_mem1*MAS_MEM[11]
	S += (t170*MAS[6])-1 < c000_mem1*MAS_MEM[13]
	S += (t170*MAS[7])-1 < c000_mem1*MAS_MEM[15]
	S += c000_mem1 <= c000
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage1MAS8/EP2_ADD_w_EVAL/schedule2.png"
	if(S.solution() != []):
