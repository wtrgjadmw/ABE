...
def solve():
	...
	S += d_t3_t2_t0_mem0 >= 42
	d_t3_t2_t0_mem0 += MAS_MEM[4]

	d_t3_t2_t0_mem1 = S.Task('d_t3_t2_t0_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t0_mem1 >= 42
	...
	S += d_t3_t2_t1_mem0 >= 42
	d_t3_t2_t1_mem0 += MAS_MEM[6]

	d_t3_t2_t1_mem1 = S.Task('d_t3_t2_t1_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t1_mem1 >= 42
	...
	S += d_t3_t2_t4_mem0 >= 53
	d_t3_t2_t4_mem0 += MAS_MEM[4]

	d_t3_t2_t4_mem1 = S.Task('d_t3_t2_t4_mem1', length=1, delay_cost=1)
	S += d_t3_t2_t4_mem1 >= 53
	...
	S += c_t9_y1_1_mem0 >= 126
	c_t9_y1_1_mem0 += MAS_MEM[6]

	c_t9_y1_1_mem1 = S.Task('c_t9_y1_1_mem1', length=1, delay_cost=1)
	S += c_t9_y1_1_mem1 >= 126
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS4/FP12_LADDERMUL/schedule15.png"
	if(S.solution() != []):
