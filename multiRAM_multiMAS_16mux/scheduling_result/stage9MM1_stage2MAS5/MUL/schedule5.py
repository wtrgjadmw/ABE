...
def solve():
	...
	S += c_t3_t4_t3_mem0 >= 62
	c_t3_t4_t3_mem0 += MAS_MEM[8]

	c_t3_t4_t3_mem1 = S.Task('c_t3_t4_t3_mem1', length=1, delay_cost=1)
	S += c_t3_t4_t3_mem1 >= 62
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS5/MUL/schedule5.png"
	if(S.solution() != []):
