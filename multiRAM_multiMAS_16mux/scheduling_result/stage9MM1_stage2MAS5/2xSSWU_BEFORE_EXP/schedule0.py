...
def solve():
	...
	xit20 = S.Task('xit20', length=9, delay_cost=1)
	xit20 += alt(MM)
	...
	xit21 = S.Task('xit21', length=9, delay_cost=1)
	xit21 += alt(MM)
	...
	D0 = S.Task('D0', length=9, delay_cost=1)
	D0 += alt(MM)
	...
	D1 = S.Task('D1', length=9, delay_cost=1)
	D1 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS5/2xSSWU_BEFORE_EXP/schedule0.png"
	if(S.solution() != []):
