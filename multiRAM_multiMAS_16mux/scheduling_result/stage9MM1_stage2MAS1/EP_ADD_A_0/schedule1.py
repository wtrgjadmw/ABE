...
def solve():
	...
	PZ_new = S.Task('PZ_new', length=9, delay_cost=1)
	PZ_new += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM1_stage2MAS1/EP_ADD_A_0/schedule1.png"
	if(S.solution() != []):
