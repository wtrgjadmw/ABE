...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage4MAS6/FP12_INV_BEFORE_FPINV/schedule5.png"
	if(S.solution() != []):
