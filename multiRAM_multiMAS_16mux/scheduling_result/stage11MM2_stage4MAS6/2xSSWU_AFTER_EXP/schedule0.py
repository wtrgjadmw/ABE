...
def solve():
	...
	alpha2V_U0 = S.Task('alpha2V_U0', length=4, delay_cost=1)
	alpha2V_U0 += alt(MAS)
	...
	alpha2V_U1 = S.Task('alpha2V_U1', length=4, delay_cost=1)
	alpha2V_U1 += alt(MAS)
	...
	y_alt0 = S.Task('y_alt0', length=4, delay_cost=1)
	y_alt0 += alt(MAS)
	...
	y_alt1 = S.Task('y_alt1', length=4, delay_cost=1)
	y_alt1 += alt(MAS)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage4MAS6/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
