...
def solve():
	...
	S += c_t2_t0_t4_mem0 >= 11
	c_t2_t0_t4_mem0 += MAS_MEM[0]

	c_t2_t0_t4_mem1 = S.Task('c_t2_t0_t4_mem1', length=1, delay_cost=1)
	S += c_t2_t0_t4_mem1 >= 11
	...
	S += c_t1_t4_t1_mem0 >= 26
	c_t1_t4_t1_mem0 += MAS_MEM[8]

	c_t1_t4_t1_mem1 = S.Task('c_t1_t4_t1_mem1', length=1, delay_cost=1)
	S += c_t1_t4_t1_mem1 >= 26
	...
	S += c_t0_t1_t4_mem0 >= 29
	c_t0_t1_t4_mem0 += MAS_MEM[2]

	c_t0_t1_t4_mem1 = S.Task('c_t0_t1_t4_mem1', length=1, delay_cost=1)
	S += c_t0_t1_t4_mem1 >= 29
	...
	S += c_t0_t4_t2_mem0 >= 30
	c_t0_t4_t2_mem0 += MAS_MEM[2]

	c_t0_t4_t2_mem1 = S.Task('c_t0_t4_t2_mem1', length=1, delay_cost=1)
	S += c_t0_t4_t2_mem1 >= 30
	...
	S += c_t2_t4_t3_mem0 >= 47
	c_t2_t4_t3_mem0 += MAS_MEM[4]

	c_t2_t4_t3_mem1 = S.Task('c_t2_t4_t3_mem1', length=1, delay_cost=1)
	S += c_t2_t4_t3_mem1 >= 47
	...
	S += c_t5_t1_t3_mem0 >= 48
	c_t5_t1_t3_mem0 += MAS_MEM[8]

	c_t5_t1_t3_mem1 = S.Task('c_t5_t1_t3_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t3_mem1 >= 48
	...
	S += c_t5_t1_t1_mem0 >= 61
	c_t5_t1_t1_mem0 += MAS_MEM[0]

	c_t5_t1_t1_mem1 = S.Task('c_t5_t1_t1_mem1', length=1, delay_cost=1)
	S += c_t5_t1_t1_mem1 >= 61
	...
	S += c_t4_t0_t0_mem0 >= 62
	c_t4_t0_t0_mem0 += MAS_MEM[10]

	c_t4_t0_t0_mem1 = S.Task('c_t4_t0_t0_mem1', length=1, delay_cost=1)
	S += c_t4_t0_t0_mem1 >= 62
	...
	S += c_t3_t1_t0_mem0 >= 63
	c_t3_t1_t0_mem0 += MAS_MEM[8]

	c_t3_t1_t0_mem1 = S.Task('c_t3_t1_t0_mem1', length=1, delay_cost=1)
	S += c_t3_t1_t0_mem1 >= 63
	...
	S += c_t3_t1_t2_mem0 >= 64
	c_t3_t1_t2_mem0 += MAS_MEM[8]

	c_t3_t1_t2_mem1 = S.Task('c_t3_t1_t2_mem1', length=1, delay_cost=1)
	S += c_t3_t1_t2_mem1 >= 64
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage4MAS6/MUL/schedule4.png"
	if(S.solution() != []):
