...
def solve():
	...
	S += c_qinv0_t2_mem0 >= 127
	c_qinv0_t2_mem0 += MAS_MEM[4]

	c_qinv0_t2_mem1 = S.Task('c_qinv0_t2_mem1', length=1, delay_cost=1)
	S += c_qinv0_t2_mem1 >= 127
	...
	c_qinv_denom0_mem1 += MAS_MEM[7]
	S += 130 < c_qinv_denom0_mem1
	...
	c_qinv1__t1_mem0 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv1__t1_mem0*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv1__t1_mem0*MAS_MEM[2]
	S += (c_q11*MAS[2])-1 < c_qinv1__t1_mem0*MAS_MEM[4]
	S += (c_q11*MAS[3])-1 < c_qinv1__t1_mem0*MAS_MEM[6]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage6MM1_stage1MAS4/INV/schedule11.png"
	if(S.solution() != []):
