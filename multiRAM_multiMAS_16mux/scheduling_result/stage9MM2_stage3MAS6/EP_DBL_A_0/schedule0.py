...
def solve():
	...
	t4 = S.Task('t4', length=9, delay_cost=1)
	t4 += alt(MM)
	...
	new_PZ = S.Task('new_PZ', length=9, delay_cost=1)
	new_PZ += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM2_stage3MAS6/EP_DBL_A_0/schedule0.png"
	if(S.solution() != []):
