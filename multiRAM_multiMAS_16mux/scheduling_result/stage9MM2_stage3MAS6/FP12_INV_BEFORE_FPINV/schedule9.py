...
def solve():
	...
	S += c_aa_t3_t5_mem0 >= 22
	c_aa_t3_t5_mem0 += MM_MEM[2]

	c_aa_t3_t5_mem1 = S.Task('c_aa_t3_t5_mem1', length=1, delay_cost=1)
	S += c_aa_t3_t5_mem1 >= 22
	...
	S += c_ac_t4_t0_mem0 >= 35
	c_ac_t4_t0_mem0 += MAS_MEM[10]

	c_ac_t4_t0_mem1 = S.Task('c_ac_t4_t0_mem1', length=1, delay_cost=1)
	S += c_ac_t4_t0_mem1 >= 35
	...
	S += c_ab_t1_t3_in >= 38
	c_ab_t1_t3_in += MAS_in[4]

	c_ab_t1_t3_mem0 = S.Task('c_ab_t1_t3_mem0', length=1, delay_cost=1)
	S += c_ab_t1_t3_mem0 >= 38
	...
	S += c_ab_t1_t4_mem0 >= 41
	c_ab_t1_t4_mem0 += MAS_MEM[2]

	c_ab_t1_t4_mem1 = S.Task('c_ab_t1_t4_mem1', length=1, delay_cost=1)
	S += c_ab_t1_t4_mem1 >= 41
	...
	S += c_bb_t40_mem1 >= 45
	c_bb_t40_mem1 += MAS_MEM[11]

	c_bb_t41_in = S.Task('c_bb_t41_in', length=1, delay_cost=1)
	S += c_bb_t41_in >= 45
	c_bb_t41_in += MAS_in[5]

	c_bb_t41_mem0 = S.Task('c_bb_t41_mem0', length=1, delay_cost=1)
	S += c_bb_t41_mem0 >= 45
	c_bb_t41_mem0 += MAS_MEM[10]
	...
	S += c_bc_t1_t3_mem0 >= 48
	c_bc_t1_t3_mem0 += MAIN_MEM_r[0]

	c_bc_t1_t3_mem1 = S.Task('c_bc_t1_t3_mem1', length=1, delay_cost=1)
	S += c_bc_t1_t3_mem1 >= 48
	...
	S += c_ac_t0_t5_mem0 >= 49
	c_ac_t0_t5_mem0 += MM_MEM[2]

	c_ac_t0_t5_mem1 = S.Task('c_ac_t0_t5_mem1', length=1, delay_cost=1)
	S += c_ac_t0_t5_mem1 >= 49
	...
	S += c_bc_t4_t2_mem0 >= 60
	c_bc_t4_t2_mem0 += MAS_MEM[0]

	c_bc_t4_t2_mem1 = S.Task('c_bc_t4_t2_mem1', length=1, delay_cost=1)
	S += c_bc_t4_t2_mem1 >= 60
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage9MM2_stage3MAS6/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
