...
def solve():
	...
	c0_t4_t3_mem0 += alt(MAS_MEM)
	S += (c0_t30*MAS[0])-1 < c0_t4_t3_mem0*MAS_MEM[0]
	S += (c0_t30*MAS[1])-1 < c0_t4_t3_mem0*MAS_MEM[2]
	S += (c0_t30*MAS[2])-1 < c0_t4_t3_mem0*MAS_MEM[4]
	S += (c0_t30*MAS[3])-1 < c0_t4_t3_mem0*MAS_MEM[6]
	...
	c0_t40_mem0 += alt(MM_MEM)
	S += (c0_t4_t0*MM[0])-1 < c0_t40_mem0*MM_MEM[0]
	S += (c0_t4_t0*MM[1])-1 < c0_t40_mem0*MM_MEM[2]
	...
	c0_t4_t5_mem0 += alt(MM_MEM)
	S += (c0_t4_t0*MM[0])-1 < c0_t4_t5_mem0*MM_MEM[0]
	S += (c0_t4_t0*MM[1])-1 < c0_t4_t5_mem0*MM_MEM[2]
	...
	c2_t40_mem0 += alt(MM_MEM)
	S += (c2_t4_t0*MM[0])-1 < c2_t40_mem0*MM_MEM[0]
	S += (c2_t4_t0*MM[1])-1 < c2_t40_mem0*MM_MEM[2]
	...
	c2_t4_t5_mem0 += alt(MM_MEM)
	S += (c2_t4_t0*MM[0])-1 < c2_t4_t5_mem0*MM_MEM[0]
	S += (c2_t4_t0*MM[1])-1 < c2_t4_t5_mem0*MM_MEM[2]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS4/FP12_INV_AFTER_FPINV/schedule2.png"
	if(S.solution() != []):
