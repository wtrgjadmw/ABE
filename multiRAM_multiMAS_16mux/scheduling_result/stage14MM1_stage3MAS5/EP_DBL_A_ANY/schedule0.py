...
def solve():
	...
	t12 = S.Task('t12', length=14, delay_cost=1)
	t12 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage14MM1_stage3MAS5/EP_DBL_A_ANY/schedule0.png"
	if(S.solution() != []):
