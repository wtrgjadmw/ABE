...
def solve():
	...
	t3alpha0 = S.Task('t3alpha0', length=14, delay_cost=1)
	t3alpha0 += alt(MM)
	...
	t3alpha1 = S.Task('t3alpha1', length=14, delay_cost=1)
	t3alpha1 += alt(MM)
	...
	Y_Hash0 = S.Task('Y_Hash0', length=14, delay_cost=1)
	Y_Hash0 += alt(MM)
	...
	Y_Hash1 = S.Task('Y_Hash1', length=14, delay_cost=1)
	Y_Hash1 += alt(MM)
