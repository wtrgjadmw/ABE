...
def solve():
	...
	alphaD0 = S.Task('alphaD0', length=8, delay_cost=1)
	alphaD0 += alt(MM)
	...
	alphaD1 = S.Task('alphaD1', length=8, delay_cost=1)
	alphaD1 += alt(MM)
	...
	t3alphaD0 = S.Task('t3alphaD0', length=8, delay_cost=1)
	t3alphaD0 += alt(MM)
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage2MAS6/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
