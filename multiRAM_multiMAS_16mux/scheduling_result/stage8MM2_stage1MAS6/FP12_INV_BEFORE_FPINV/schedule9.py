...
def solve():
	...
	S += c_ab_t4_t2_mem0 >= 44
	c_ab_t4_t2_mem0 += MAS_MEM[10]

	c_ab_t4_t2_mem1 = S.Task('c_ab_t4_t2_mem1', length=1, delay_cost=1)
	S += c_ab_t4_t2_mem1 >= 44
	...
	S += c_ab_t4_t1_mem0 >= 49
	c_ab_t4_t1_mem0 += MAS_MEM[10]

	c_ab_t4_t1_mem1 = S.Task('c_ab_t4_t1_mem1', length=1, delay_cost=1)
	S += c_ab_t4_t1_mem1 >= 49
	...
	S += c_ab_t4_t4_mem0 >= 52
	c_ab_t4_t4_mem0 += MAS_MEM[6]

	c_ab_t4_t4_mem1 = S.Task('c_ab_t4_t4_mem1', length=1, delay_cost=1)
	S += c_ab_t4_t4_mem1 >= 52
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS6/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
