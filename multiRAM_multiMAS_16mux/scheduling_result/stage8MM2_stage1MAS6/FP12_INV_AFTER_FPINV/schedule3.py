...
def solve():
	...
	c0_t41_mem1 += alt(MAS_MEM)
	S += (c0_t4_t5*MAS[0])-1 < c0_t41_mem1*MAS_MEM[1]
	S += (c0_t4_t5*MAS[1])-1 < c0_t41_mem1*MAS_MEM[3]
	S += (c0_t4_t5*MAS[2])-1 < c0_t41_mem1*MAS_MEM[5]
	S += (c0_t4_t5*MAS[3])-1 < c0_t41_mem1*MAS_MEM[7]
	S += (c0_t4_t5*MAS[4])-1 < c0_t41_mem1*MAS_MEM[9]
	S += (c0_t4_t5*MAS[5])-1 < c0_t41_mem1*MAS_MEM[11]
	...
	S += (c0_t40*MAS[0])-1 < c010_mem0*MAS_MEM[0]
	S += (c0_t40*MAS[1])-1 < c010_mem0*MAS_MEM[2]
	S += (c0_t40*MAS[2])-1 < c010_mem0*MAS_MEM[4]
	S += (c0_t40*MAS[3])-1 < c010_mem0*MAS_MEM[6]
	S += (c0_t40*MAS[4])-1 < c010_mem0*MAS_MEM[8]
	S += (c0_t40*MAS[5])-1 < c010_mem0*MAS_MEM[10]
	S += c010_mem0 <= c010
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS6/FP12_INV_AFTER_FPINV/schedule3.png"
	if(S.solution() != []):
