...
def solve():
	...
	c1_t4_t0_mem0 += alt(MAS_MEM)
	S += (c1_t20*MAS[0])-1 < c1_t4_t0_mem0*MAS_MEM[0]
	S += (c1_t20*MAS[1])-1 < c1_t4_t0_mem0*MAS_MEM[2]
	S += (c1_t20*MAS[2])-1 < c1_t4_t0_mem0*MAS_MEM[4]
	S += (c1_t20*MAS[3])-1 < c1_t4_t0_mem0*MAS_MEM[6]
	S += (c1_t20*MAS[4])-1 < c1_t4_t0_mem0*MAS_MEM[8]
	S += (c1_t20*MAS[5])-1 < c1_t4_t0_mem0*MAS_MEM[10]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM2_stage1MAS6/FP12_INV_AFTER_FPINV/schedule1.png"
	if(S.solution() != []):
