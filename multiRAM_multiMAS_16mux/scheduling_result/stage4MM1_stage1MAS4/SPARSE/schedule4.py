...
def solve():
	...
	t4_t2_t1 = S.Task('t4_t2_t1', length=4, delay_cost=1)
	S += t4_t2_t1 >= 1
	t4_t2_t1 += MM[0]
	...
	t4_t8_t1 = S.Task('t4_t8_t1', length=4, delay_cost=1)
	S += t4_t8_t1 >= 3
	t4_t8_t1 += MM[0]
	...
	t4_t8_t0 = S.Task('t4_t8_t0', length=4, delay_cost=1)
	S += t4_t8_t0 >= 4
	t4_t8_t0 += MM[0]
	...
	t4_t0_t0 = S.Task('t4_t0_t0', length=4, delay_cost=1)
	S += t4_t0_t0 >= 7
	t4_t0_t0 += MM[0]
	...
	t4_t2_t0 = S.Task('t4_t2_t0', length=4, delay_cost=1)
	S += t4_t2_t0 >= 8
	t4_t2_t0 += MM[0]
	...
	t4_t1_t0 = S.Task('t4_t1_t0', length=4, delay_cost=1)
	S += t4_t1_t0 >= 9
	t4_t1_t0 += MM[0]
	...
	t4_t1_t1 = S.Task('t4_t1_t1', length=4, delay_cost=1)
	S += t4_t1_t1 >= 10
	t4_t1_t1 += MM[0]
	...
	t4_t0_t1 = S.Task('t4_t0_t1', length=4, delay_cost=1)
	S += t4_t0_t1 >= 11
	t4_t0_t1 += MM[0]
	...
	t4_t0_t4 = S.Task('t4_t0_t4', length=4, delay_cost=1)
	S += t4_t0_t4 >= 21
	t4_t0_t4 += MM[0]
	...
	t4_t6_t1 = S.Task('t4_t6_t1', length=4, delay_cost=1)
	S += t4_t6_t1 >= 25
	t4_t6_t1 += MM[0]

	t1_t4 = S.Task('t1_t4', length=4, delay_cost=1)
	S += t1_t4 >= 26
	t1_t4 += MM[0]
	...
	t4_t6_t0 = S.Task('t4_t6_t0', length=4, delay_cost=1)
	S += t4_t6_t0 >= 27
	t4_t6_t0 += MM[0]
	...
	t4_t2_t4 = S.Task('t4_t2_t4', length=4, delay_cost=1)
	S += t4_t2_t4 >= 29
	t4_t2_t4 += MM[0]
	...
	t4_t6_t4 = S.Task('t4_t6_t4', length=4, delay_cost=1)
	S += t4_t6_t4 >= 30
	t4_t6_t4 += MM[0]
	...
	t4_t1_t4 = S.Task('t4_t1_t4', length=4, delay_cost=1)
	S += t4_t1_t4 >= 31
	t4_t1_t4 += MM[0]
	...
	t5_t0_t4 = S.Task('t5_t0_t4', length=4, delay_cost=1)
	S += t5_t0_t4 >= 37
	t5_t0_t4 += MM[0]
	...
	t5_t1_t0 = S.Task('t5_t1_t0', length=4, delay_cost=1)
	S += t5_t1_t0 >= 39
	t5_t1_t0 += MM[0]
	...
	t5_t1_t1 = S.Task('t5_t1_t1', length=4, delay_cost=1)
	S += t5_t1_t1 >= 40
	t5_t1_t1 += MM[0]
	...
	t5_t2_t0 = S.Task('t5_t2_t0', length=4, delay_cost=1)
	S += t5_t2_t0 >= 41
	t5_t2_t0 += MM[0]
	...
	t5_t2_t1 = S.Task('t5_t2_t1', length=4, delay_cost=1)
	S += t5_t2_t1 >= 42
	t5_t2_t1 += MM[0]
	...
	t4_t8_t4 = S.Task('t4_t8_t4', length=4, delay_cost=1)
	S += t4_t8_t4 >= 43
	t4_t8_t4 += MM[0]
	...
	t5_t0_t1 = S.Task('t5_t0_t1', length=4, delay_cost=1)
	S += t5_t0_t1 >= 44
	t5_t0_t1 += MM[0]
	...
	t5_t0_t0 = S.Task('t5_t0_t0', length=4, delay_cost=1)
	S += t5_t0_t0 >= 45
	t5_t0_t0 += MM[0]
	...
	t5_t8_t1 = S.Task('t5_t8_t1', length=4, delay_cost=1)
	S += t5_t8_t1 >= 46
	t5_t8_t1 += MM[0]
	...
	t5_t8_t0 = S.Task('t5_t8_t0', length=4, delay_cost=1)
	S += t5_t8_t0 >= 47
	t5_t8_t0 += MM[0]
	...
	t5_t1_t4 = S.Task('t5_t1_t4', length=4, delay_cost=1)
	S += t5_t1_t4 >= 48
	t5_t1_t4 += MM[0]
	...
	t5_t8_t4 = S.Task('t5_t8_t4', length=4, delay_cost=1)
	S += t5_t8_t4 >= 49
	t5_t8_t4 += MM[0]
	...
	t5_t2_t4 = S.Task('t5_t2_t4', length=4, delay_cost=1)
	S += t5_t2_t4 >= 50
	t5_t2_t4 += MM[0]
	...
	t5_t6_t1 = S.Task('t5_t6_t1', length=4, delay_cost=1)
	S += t5_t6_t1 >= 51
	t5_t6_t1 += MM[0]
	...
	t5_t6_t0 = S.Task('t5_t6_t0', length=4, delay_cost=1)
	S += t5_t6_t0 >= 52
	t5_t6_t0 += MM[0]
	...
	t5_t6_t4 = S.Task('t5_t6_t4', length=4, delay_cost=1)
	S += t5_t6_t4 >= 53
	t5_t6_t4 += MM[0]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage1MAS4/SPARSE/schedule4.png"
	if(S.solution() != []):
