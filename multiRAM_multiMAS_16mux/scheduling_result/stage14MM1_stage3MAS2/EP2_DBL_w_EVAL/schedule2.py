...
def solve():
	...
	t180_mem0 += alt(MM_MEM)
	S += (t18_t2*MM[0])-1 < t180_mem0*MM_MEM[0]
	S += t180_mem0 <= t180
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage14MM1_stage3MAS2/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
