...
def solve():
	...
	S += (c_qinv0_t1*MM[1])-1 < c_qinv00_mem1*MM_MEM[3]
	...
	S += (c_qinv0_t1*MM[1])-1 < c_qinv0_t5_mem1*MM_MEM[3]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage2MAS4/FP12_INV_AFTER_FPINV/schedule1.png"
	if(S.solution() != []):
