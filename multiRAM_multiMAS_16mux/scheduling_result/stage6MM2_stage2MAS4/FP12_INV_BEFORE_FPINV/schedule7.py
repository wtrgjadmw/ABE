...
def solve():
	...
	c_pbc_t20_mem0 += alt(MAS_MEM)
	S += (c_pb00*MAS[0])-1 < c_pbc_t20_mem0*MAS_MEM[0]
	S += (c_pb00*MAS[1])-1 < c_pbc_t20_mem0*MAS_MEM[2]
	S += (c_pb00*MAS[2])-1 < c_pbc_t20_mem0*MAS_MEM[4]
	S += (c_pb00*MAS[3])-1 < c_pbc_t20_mem0*MAS_MEM[6]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM2_stage2MAS4/FP12_INV_BEFORE_FPINV/schedule7.png"
	if(S.solution() != []):
