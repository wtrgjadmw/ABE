...
def solve():
	...
	S += t6_t3_mem0 >= 46
	t6_t3_mem0 += MAS_MEM[12]

	t6_t3_mem1 = S.Task('t6_t3_mem1', length=1, delay_cost=1)
	S += t6_t3_mem1 >= 46
	t6_t3_mem1 += MAS_MEM[15]
	...
	S += (t60*MAS[5])-1 < t80_mem0*MAS_MEM[10]
	S += (t60*MAS[6])-1 < t80_mem0*MAS_MEM[12]
	S += (t60*MAS[7])-1 < t80_mem0*MAS_MEM[14]
	S += t80_mem0 <= t80
	...
	S += (t90*MAS[5])-1 < t100_mem0*MAS_MEM[10]
	S += (t90*MAS[6])-1 < t100_mem0*MAS_MEM[12]
	S += (t90*MAS[7])-1 < t100_mem0*MAS_MEM[14]
	S += t100_mem0 <= t100
	...
	S += (t90*MAS[5])-1 < t100_mem1*MAS_MEM[11]
	S += (t90*MAS[6])-1 < t100_mem1*MAS_MEM[13]
	S += (t90*MAS[7])-1 < t100_mem1*MAS_MEM[15]
	S += t100_mem1 <= t100
	...
	S += (t60*MAS[5])-1 < t14_t0_mem1*MAS_MEM[11]
	S += (t60*MAS[6])-1 < t14_t0_mem1*MAS_MEM[13]
	S += (t60*MAS[7])-1 < t14_t0_mem1*MAS_MEM[15]
	...
	S += (t60*MAS[5])-1 < new_TZ_t0_mem1*MAS_MEM[11]
	S += (t60*MAS[6])-1 < new_TZ_t0_mem1*MAS_MEM[13]
	S += (t60*MAS[7])-1 < new_TZ_t0_mem1*MAS_MEM[15]
	...
	S += (t61*MAS[5])-1 < t81_mem0*MAS_MEM[10]
	S += (t61*MAS[6])-1 < t81_mem0*MAS_MEM[12]
	S += (t61*MAS[7])-1 < t81_mem0*MAS_MEM[14]
	S += t81_mem0 <= t81
	...
	S += (t91*MAS[5])-1 < t101_mem0*MAS_MEM[10]
	S += (t91*MAS[6])-1 < t101_mem0*MAS_MEM[12]
	S += (t91*MAS[7])-1 < t101_mem0*MAS_MEM[14]
	S += t101_mem0 <= t101
	...
	S += (t91*MAS[5])-1 < t101_mem1*MAS_MEM[11]
	S += (t91*MAS[6])-1 < t101_mem1*MAS_MEM[13]
	S += (t91*MAS[7])-1 < t101_mem1*MAS_MEM[15]
	S += t101_mem1 <= t101
	...
	S += (t80*MAS[5])-1 < t110_mem0*MAS_MEM[10]
	S += (t80*MAS[6])-1 < t110_mem0*MAS_MEM[12]
	S += (t80*MAS[7])-1 < t110_mem0*MAS_MEM[14]
	S += t110_mem0 <= t110
	...
	S += (t61*MAS[5])-1 < t14_t1_mem1*MAS_MEM[11]
	S += (t61*MAS[6])-1 < t14_t1_mem1*MAS_MEM[13]
	S += (t61*MAS[7])-1 < t14_t1_mem1*MAS_MEM[15]
	...
	S += (t60*MAS[5])-1 < t14_t3_mem0*MAS_MEM[10]
	S += (t60*MAS[6])-1 < t14_t3_mem0*MAS_MEM[12]
	S += (t60*MAS[7])-1 < t14_t3_mem0*MAS_MEM[14]
	...
	S += (t61*MAS[5])-1 < t14_t3_mem1*MAS_MEM[11]
	S += (t61*MAS[6])-1 < t14_t3_mem1*MAS_MEM[13]
	S += (t61*MAS[7])-1 < t14_t3_mem1*MAS_MEM[15]
	...
	S += (t61*MAS[5])-1 < new_TZ_t1_mem1*MAS_MEM[11]
	S += (t61*MAS[6])-1 < new_TZ_t1_mem1*MAS_MEM[13]
	S += (t61*MAS[7])-1 < new_TZ_t1_mem1*MAS_MEM[15]
	...
	S += new_TZ_t3_in*MAS_in[5]<=new_TZ_t3*MAS[5]

	S += new_TZ_t3_in*MAS_in[6]<=new_TZ_t3*MAS[6]

	S += new_TZ_t3_in*MAS_in[7]<=new_TZ_t3*MAS[7]
	...
	S += (t60*MAS[5])-1 < new_TZ_t3_mem0*MAS_MEM[10]
	S += (t60*MAS[6])-1 < new_TZ_t3_mem0*MAS_MEM[12]
	S += (t60*MAS[7])-1 < new_TZ_t3_mem0*MAS_MEM[14]
	...
	S += (t61*MAS[5])-1 < new_TZ_t3_mem1*MAS_MEM[11]
	S += (t61*MAS[6])-1 < new_TZ_t3_mem1*MAS_MEM[13]
	S += (t61*MAS[7])-1 < new_TZ_t3_mem1*MAS_MEM[15]
	...
	S += (t81*MAS[5])-1 < t111_mem0*MAS_MEM[10]
	S += (t81*MAS[6])-1 < t111_mem0*MAS_MEM[12]
	S += (t81*MAS[7])-1 < t111_mem0*MAS_MEM[14]
	S += t111_mem0 <= t111
	...
	S += (t110*MAS[5])-1 < t120_mem0*MAS_MEM[10]
	S += (t110*MAS[6])-1 < t120_mem0*MAS_MEM[12]
	S += (t110*MAS[7])-1 < t120_mem0*MAS_MEM[14]
	S += t120_mem0 <= t120
	...
	S += (t90*MAS[5])-1 < t120_mem1*MAS_MEM[11]
	S += (t90*MAS[6])-1 < t120_mem1*MAS_MEM[13]
	S += (t90*MAS[7])-1 < t120_mem1*MAS_MEM[15]
	S += t120_mem1 <= t120
	...
	S += (t110*MAS[5])-1 < new_TX_t0_mem1*MAS_MEM[11]
	S += (t110*MAS[6])-1 < new_TX_t0_mem1*MAS_MEM[13]
	S += (t110*MAS[7])-1 < new_TX_t0_mem1*MAS_MEM[15]
	...
	S += (new_TZ_t3*MAS[5])-1 < new_TZ_t4_mem1*MAS_MEM[11]
	S += (new_TZ_t3*MAS[6])-1 < new_TZ_t4_mem1*MAS_MEM[13]
	S += (new_TZ_t3*MAS[7])-1 < new_TZ_t4_mem1*MAS_MEM[15]
	...
	S += new_TZ_t5_in*MAS_in[5]<=new_TZ_t5*MAS[5]

	S += new_TZ_t5_in*MAS_in[6]<=new_TZ_t5*MAS[6]

	S += new_TZ_t5_in*MAS_in[7]<=new_TZ_t5*MAS[7]
	...
	S += (t91*MAS[5])-1 < t121_mem1*MAS_MEM[11]
	S += (t91*MAS[6])-1 < t121_mem1*MAS_MEM[13]
	S += (t91*MAS[7])-1 < t121_mem1*MAS_MEM[15]
	S += t121_mem1 <= t121
	...
	S += (t111*MAS[5])-1 < new_TX_t1_mem1*MAS_MEM[11]
	S += (t111*MAS[6])-1 < new_TX_t1_mem1*MAS_MEM[13]
	S += (t111*MAS[7])-1 < new_TX_t1_mem1*MAS_MEM[15]
	...
	S += (t110*MAS[5])-1 < new_TX_t3_mem0*MAS_MEM[10]
	S += (t110*MAS[6])-1 < new_TX_t3_mem0*MAS_MEM[12]
	S += (t110*MAS[7])-1 < new_TX_t3_mem0*MAS_MEM[14]
	...
	S += (t111*MAS[5])-1 < new_TX_t3_mem1*MAS_MEM[11]
	S += (t111*MAS[6])-1 < new_TX_t3_mem1*MAS_MEM[13]
	S += (t111*MAS[7])-1 < new_TX_t3_mem1*MAS_MEM[15]
	...
	S += (t120*MAS[6])-1 < t13_t0_mem1*MAS_MEM[13]
	S += (t120*MAS[7])-1 < t13_t0_mem1*MAS_MEM[15]
	...
	S += (new_TZ_t5*MAS[5])-1 < new_TZ1_mem1*MAS_MEM[11]
	S += (new_TZ_t5*MAS[6])-1 < new_TZ1_mem1*MAS_MEM[13]
	S += (new_TZ_t5*MAS[7])-1 < new_TZ1_mem1*MAS_MEM[15]
	...
	S += (new_TX_t3*MAS[5])-1 < new_TX_t4_mem1*MAS_MEM[11]
	S += (new_TX_t3*MAS[6])-1 < new_TX_t4_mem1*MAS_MEM[13]
	S += (new_TX_t3*MAS[7])-1 < new_TX_t4_mem1*MAS_MEM[15]
	...
	S += (t121*MAS[5])-1 < t13_t1_mem1*MAS_MEM[11]
	S += (t121*MAS[6])-1 < t13_t1_mem1*MAS_MEM[13]
	S += (t121*MAS[7])-1 < t13_t1_mem1*MAS_MEM[15]
	...
	S += t13_t3_in*MAS_in[6]<=t13_t3*MAS[6]

	S += t13_t3_in*MAS_in[7]<=t13_t3*MAS[7]
	...
	S += (t120*MAS[6])-1 < t13_t3_mem0*MAS_MEM[12]
	S += (t120*MAS[7])-1 < t13_t3_mem0*MAS_MEM[14]
	...
	S += (t121*MAS[5])-1 < t13_t3_mem1*MAS_MEM[11]
	S += (t121*MAS[6])-1 < t13_t3_mem1*MAS_MEM[13]
	S += (t121*MAS[7])-1 < t13_t3_mem1*MAS_MEM[15]
	...
	S += (t13_t3*MAS[5])-1 < t13_t4_mem1*MAS_MEM[11]
	S += (t13_t3*MAS[6])-1 < t13_t4_mem1*MAS_MEM[13]
	S += (t13_t3*MAS[7])-1 < t13_t4_mem1*MAS_MEM[15]
	...
	S += t13_t5_in*MAS_in[5]<=t13_t5*MAS[5]

	S += t13_t5_in*MAS_in[6]<=t13_t5*MAS[6]

	S += t13_t5_in*MAS_in[7]<=t13_t5*MAS[7]
	...
	S += (t13_t5*MAS[5])-1 < t131_mem1*MAS_MEM[11]
	S += (t13_t5*MAS[6])-1 < t131_mem1*MAS_MEM[13]
	S += (t13_t5*MAS[7])-1 < t131_mem1*MAS_MEM[15]
	S += t131_mem1 <= t131
	...
	S += (t130*MAS[5])-1 < t150_mem0*MAS_MEM[10]
	S += (t130*MAS[6])-1 < t150_mem0*MAS_MEM[12]
	S += (t130*MAS[7])-1 < t150_mem0*MAS_MEM[14]
	S += t150_mem0 <= t150
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/EP2_ADD_w_EVAL/schedule2.png"
	if(S.solution() != []):
