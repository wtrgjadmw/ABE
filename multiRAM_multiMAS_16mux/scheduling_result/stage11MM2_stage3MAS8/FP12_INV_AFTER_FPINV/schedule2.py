...
def solve():
	...
	c2_t1_t4_mem0 += MAS_MEM[10]
	S += 15 < c2_t1_t4_mem0
	S += c2_t1_t4_mem0 <= c2_t1_t4

	c2_t1_t4_mem1 = S.Task('c2_t1_t4_mem1', length=1, delay_cost=1)
	c2_t1_t4_mem1 += alt(MAS_MEM)
	S += (c2_t1_t3*MAS[0])-1 < c2_t1_t4_mem1*MAS_MEM[1]
	S += (c2_t1_t3*MAS[1])-1 < c2_t1_t4_mem1*MAS_MEM[3]
	S += (c2_t1_t3*MAS[2])-1 < c2_t1_t4_mem1*MAS_MEM[5]
	S += (c2_t1_t3*MAS[3])-1 < c2_t1_t4_mem1*MAS_MEM[7]
	S += (c2_t1_t3*MAS[4])-1 < c2_t1_t4_mem1*MAS_MEM[9]
	S += (c2_t1_t3*MAS[5])-1 < c2_t1_t4_mem1*MAS_MEM[11]
	S += (c2_t1_t3*MAS[6])-1 < c2_t1_t4_mem1*MAS_MEM[13]
	S += (c2_t1_t3*MAS[7])-1 < c2_t1_t4_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/FP12_INV_AFTER_FPINV/schedule2.png"
	if(S.solution() != []):
