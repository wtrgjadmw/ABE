...
def solve():
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/2xSSWU_BEFORE_EXP/schedule1.png"
	if(S.solution() != []):
