...
def solve():
	...
	S += (t24*MAS[6])-1 < t25_mem1*MAS_MEM[13]
	S += (t24*MAS[7])-1 < t25_mem1*MAS_MEM[15]
	S += t25_mem1 <= t25
	...
	S += t29_in*MAS_in[4]<=t29*MAS[4]

	S += t29_in*MAS_in[5]<=t29*MAS[5]

	S += t29_in*MAS_in[6]<=t29*MAS[6]

	S += t29_in*MAS_in[7]<=t29*MAS[7]
	...
	S += (t12*MAS[6])-1 < t18_mem1*MAS_MEM[13]
	S += (t12*MAS[7])-1 < t18_mem1*MAS_MEM[15]
	S += t18_mem1 <= t18
	...
	S += (t12*MAS[6])-1 < t27_mem1*MAS_MEM[13]
	S += (t12*MAS[7])-1 < t27_mem1*MAS_MEM[15]
	S += t27_mem1 <= t27
	...
	S += t28_in*MAS_in[4]<=t28*MAS[4]

	S += t28_in*MAS_in[5]<=t28*MAS[5]

	S += t28_in*MAS_in[6]<=t28*MAS[6]

	S += t28_in*MAS_in[7]<=t28*MAS[7]
	...
	S += (t25*MAS[6])-1 < t28_mem0*MAS_MEM[12]
	S += (t25*MAS[7])-1 < t28_mem0*MAS_MEM[14]
	S += t28_mem0 <= t28
	...
	S += (t29*MAS[5])-1 < t30_mem1*MAS_MEM[11]
	S += (t29*MAS[6])-1 < t30_mem1*MAS_MEM[13]
	S += (t29*MAS[7])-1 < t30_mem1*MAS_MEM[15]
	S += t30_mem1 <= t30
	...
	S += (t7*MAS[5])-1 < t35_mem0*MAS_MEM[10]
	S += (t7*MAS[6])-1 < t35_mem0*MAS_MEM[12]
	S += (t7*MAS[7])-1 < t35_mem0*MAS_MEM[14]
	S += t35_mem0 <= t35
	...
	S += (t28*MAS[5])-1 < t35_mem1*MAS_MEM[11]
	S += (t28*MAS[6])-1 < t35_mem1*MAS_MEM[13]
	S += (t28*MAS[7])-1 < t35_mem1*MAS_MEM[15]
	S += t35_mem1 <= t35
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/EP_ADD_A_ANY/schedule0.png"
	if(S.solution() != []):
