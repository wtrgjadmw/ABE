...
def solve():
	...
	c_qinv_bb_t1_mem0 += MAS_MEM[8]
	S += 134 < c_qinv_bb_t1_mem0
	S += c_qinv_bb_t1_mem0 <= c_qinv_bb_t1

	c_qinv_bb_t1_mem1 = S.Task('c_qinv_bb_t1_mem1', length=1, delay_cost=1)
	c_qinv_bb_t1_mem1 += MAS_MEM[9]
	S += 134 < c_qinv_bb_t1_mem1
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
