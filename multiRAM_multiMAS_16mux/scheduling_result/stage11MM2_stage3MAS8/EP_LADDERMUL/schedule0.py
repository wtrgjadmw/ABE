...
def solve():
	...
	T4 = S.Task('T4', length=11, delay_cost=1)
	T4 += alt(MM)
	...
	T6 = S.Task('T6', length=11, delay_cost=1)
	T6 += alt(MM)
	...
	T9 = S.Task('T9', length=11, delay_cost=1)
	T9 += alt(MM)
	...
	T11 = S.Task('T11', length=11, delay_cost=1)
	T11 += alt(MM)
	...
	S += T15_in*MAS_in[6]<=T15*MAS[6]

	S += T15_in*MAS_in[7]<=T15*MAS[7]
	...
	S += (T13*MAS[6])-1 < T14_mem0*MAS_MEM[12]
	S += (T13*MAS[7])-1 < T14_mem0*MAS_MEM[14]
	S += T14_mem0 <= T14
	...
	S += (T13*MAS[6])-1 < T14_mem1*MAS_MEM[13]
	S += (T13*MAS[7])-1 < T14_mem1*MAS_MEM[15]
	S += T14_mem1 <= T14

	T16 = S.Task('T16', length=11, delay_cost=1)
	T16 += alt(MM)
	...
	S += (T15*MAS[6])-1 < T17_mem1*MAS_MEM[13]
	S += (T15*MAS[7])-1 < T17_mem1*MAS_MEM[15]
	S += T17_mem1 <= T17
	...
	S += (T12*MAS[6])-1 < T24_mem1*MAS_MEM[13]
	S += (T12*MAS[7])-1 < T24_mem1*MAS_MEM[15]
	S += T24_mem1 <= T24
	...
	S += (T15*MAS[6])-1 < T20_mem0*MAS_MEM[12]
	S += (T15*MAS[7])-1 < T20_mem0*MAS_MEM[14]
	S += T20_mem0 <= T20
	...
	S += (T18*MAS[6])-1 < T20_mem1*MAS_MEM[13]
	S += (T18*MAS[7])-1 < T20_mem1*MAS_MEM[15]
	S += T20_mem1 <= T20
	...
	S += (T21*MAS[6])-1 < T22_mem1*MAS_MEM[13]
	S += (T21*MAS[7])-1 < T22_mem1*MAS_MEM[15]
	S += T22_mem1 <= T22
	...
	S += (T19*MAS[6])-1 < T23_mem0*MAS_MEM[12]
	S += (T19*MAS[7])-1 < T23_mem0*MAS_MEM[14]
	S += T23_mem0 <= T23
	...
	S += (T19*MAS[6])-1 < T23_mem1*MAS_MEM[13]
	S += (T19*MAS[7])-1 < T23_mem1*MAS_MEM[15]
	S += T23_mem1 <= T23

	Z2_new = S.Task('Z2_new', length=11, delay_cost=1)
	Z2_new += alt(MM)
	...
	S += T25_in*MAS_in[6]<=T25*MAS[6]

	S += T25_in*MAS_in[7]<=T25*MAS[7]
	...
	S += X2_new_in*MAS_in[6]<=X2_new*MAS[6]

	S += X2_new_in*MAS_in[7]<=X2_new*MAS[7]
	...
	S += X1_new_in*MAS_in[6]<=X1_new*MAS[6]

	S += X1_new_in*MAS_in[7]<=X1_new*MAS[7]
	...
	S += Z1_new_in*MAS_in[6]<=Z1_new*MAS[6]

	S += Z1_new_in*MAS_in[7]<=Z1_new*MAS[7]
	...
	S += (T25*MAS[6])-1 < Z1_new_mem1*MAS_MEM[13]
	S += (T25*MAS[7])-1 < Z1_new_mem1*MAS_MEM[15]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage11MM2_stage3MAS8/EP_LADDERMUL/schedule0.png"
	if(S.solution() != []):
