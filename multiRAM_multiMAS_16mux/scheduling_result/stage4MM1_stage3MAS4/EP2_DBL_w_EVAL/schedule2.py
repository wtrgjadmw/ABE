...
def solve():
	...
	t12_t1 = S.Task('t12_t1', length=4, delay_cost=1)
	S += t12_t1 >= 23
	t12_t1 += MM[0]
	...
	t18_t3 = S.Task('t18_t3', length=4, delay_cost=1)
	S += t18_t3 >= 28
	t18_t3 += MM[0]
	...
	t12_t0 = S.Task('t12_t0', length=4, delay_cost=1)
	S += t12_t0 >= 31
	t12_t0 += MM[0]
	...
	t18_t2 = S.Task('t18_t2', length=4, delay_cost=1)
	S += t18_t2 >= 33
	t18_t2 += MM[0]
	...
	t12_t4 = S.Task('t12_t4', length=4, delay_cost=1)
	t12_t4 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage3MAS4/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
