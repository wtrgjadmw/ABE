...
def solve():
	...
	t7 = S.Task('t7', length=7, delay_cost=1)
	t7 += alt(MM)
	...
	t17 = S.Task('t17', length=7, delay_cost=1)
	t17 += alt(MM)
	...
	t22 = S.Task('t22', length=7, delay_cost=1)
	t22 += alt(MM)
	...
	t12 = S.Task('t12', length=7, delay_cost=1)
	t12 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage1MAS8/EP_DBL_A_ANY/schedule0.png"
	if(S.solution() != []):
