...
def solve():
	...
	S += t2_t0_mem1 >= 23
	t2_t0_mem1 += MAS_MEM[15]

	t2_t3_mem0 = S.Task('t2_t3_mem0', length=1, delay_cost=1)
	S += t2_t3_mem0 >= 23
	t2_t3_mem0 += MAS_MEM[14]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage1MAS8/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
