...
def solve():
	...
	S += c_t1_t2_t4_mem0 >= 41
	c_t1_t2_t4_mem0 += MAS_MEM[12]

	c_t1_t2_t4_mem1 = S.Task('c_t1_t2_t4_mem1', length=1, delay_cost=1)
	S += c_t1_t2_t4_mem1 >= 41
	c_t1_t2_t4_mem1 += MAS_MEM[11]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage1MAS8/SQR/schedule5.png"
	if(S.solution() != []):
