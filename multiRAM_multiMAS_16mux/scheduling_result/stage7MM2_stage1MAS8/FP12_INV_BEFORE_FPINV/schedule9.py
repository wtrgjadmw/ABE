...
def solve():
	...
	S += c_pcb_t1_t1_mem0 >= 75
	c_pcb_t1_t1_mem0 += MAS_MEM[12]
	...
	S += c_pbc_t4_t0_mem0 >= 87
	c_pbc_t4_t0_mem0 += MAS_MEM[14]

	c_pbc_t4_t0_mem1 = S.Task('c_pbc_t4_t0_mem1', length=1, delay_cost=1)
	S += c_pbc_t4_t0_mem1 >= 87
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM2_stage1MAS8/FP12_INV_BEFORE_FPINV/schedule9.png"
	if(S.solution() != []):
