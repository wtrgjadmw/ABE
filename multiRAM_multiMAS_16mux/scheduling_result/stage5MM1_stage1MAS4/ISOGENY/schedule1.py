...
def solve():
	...
	S += (k2_12_Z3*MM[0])-1 < NY3__mem1*MM_MEM[1]
	S += NY3__mem1 <= NY3_
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage1MAS4/ISOGENY/schedule1.png"
	if(S.solution() != []):
