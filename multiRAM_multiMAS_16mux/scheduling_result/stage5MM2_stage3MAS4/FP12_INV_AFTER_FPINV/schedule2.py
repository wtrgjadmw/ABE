...
def solve():
	...
	c0_t4_t1_mem1 += alt(MAS_MEM)
	S += (c0_t31*MAS[0])-1 < c0_t4_t1_mem1*MAS_MEM[1]
	S += (c0_t31*MAS[1])-1 < c0_t4_t1_mem1*MAS_MEM[3]
	S += (c0_t31*MAS[2])-1 < c0_t4_t1_mem1*MAS_MEM[5]
	S += (c0_t31*MAS[3])-1 < c0_t4_t1_mem1*MAS_MEM[7]
	...
	c0_t4_t3_mem1 += alt(MAS_MEM)
	S += (c0_t31*MAS[0])-1 < c0_t4_t3_mem1*MAS_MEM[1]
	S += (c0_t31*MAS[1])-1 < c0_t4_t3_mem1*MAS_MEM[3]
	S += (c0_t31*MAS[2])-1 < c0_t4_t3_mem1*MAS_MEM[5]
	S += (c0_t31*MAS[3])-1 < c0_t4_t3_mem1*MAS_MEM[7]
	...
	c1_t00_mem0 += alt(MM_MEM)
	S += (c1_t0_t0*MM[0])-1 < c1_t00_mem0*MM_MEM[0]
	S += (c1_t0_t0*MM[1])-1 < c1_t00_mem0*MM_MEM[2]
	...
	c1_t0_t5_mem0 += alt(MM_MEM)
	S += (c1_t0_t0*MM[0])-1 < c1_t0_t5_mem0*MM_MEM[0]
	S += (c1_t0_t0*MM[1])-1 < c1_t0_t5_mem0*MM_MEM[2]
	...
	c1_t1_t4_mem1 += alt(MAS_MEM)
	S += (c1_t1_t3*MAS[0])-1 < c1_t1_t4_mem1*MAS_MEM[1]
	S += (c1_t1_t3*MAS[1])-1 < c1_t1_t4_mem1*MAS_MEM[3]
	S += (c1_t1_t3*MAS[2])-1 < c1_t1_t4_mem1*MAS_MEM[5]
	S += (c1_t1_t3*MAS[3])-1 < c1_t1_t4_mem1*MAS_MEM[7]
	...
	c1_t10_mem1 += alt(MM_MEM)
	S += (c1_t1_t0*MM[0])-1 < c1_t10_mem1*MM_MEM[1]
	S += (c1_t1_t0*MM[1])-1 < c1_t10_mem1*MM_MEM[3]
	...
	c1_t1_t5_mem0 += alt(MM_MEM)
	S += (c1_t1_t0*MM[0])-1 < c1_t1_t5_mem0*MM_MEM[0]
	S += (c1_t1_t0*MM[1])-1 < c1_t1_t5_mem0*MM_MEM[2]
	...
	c2_t10_mem1 += alt(MM_MEM)
	S += (c2_t1_t0*MM[0])-1 < c2_t10_mem1*MM_MEM[1]
	S += (c2_t1_t0*MM[1])-1 < c2_t10_mem1*MM_MEM[3]
	...
	c2_t1_t5_mem0 += alt(MM_MEM)
	S += (c2_t1_t0*MM[0])-1 < c2_t1_t5_mem0*MM_MEM[0]
	S += (c2_t1_t0*MM[1])-1 < c2_t1_t5_mem0*MM_MEM[2]
	...
	c2_t4_t3_mem0 += alt(MAS_MEM)
	S += (c2_t30*MAS[0])-1 < c2_t4_t3_mem0*MAS_MEM[0]
	S += (c2_t30*MAS[1])-1 < c2_t4_t3_mem0*MAS_MEM[2]
	S += (c2_t30*MAS[2])-1 < c2_t4_t3_mem0*MAS_MEM[4]
	S += (c2_t30*MAS[3])-1 < c2_t4_t3_mem0*MAS_MEM[6]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM2_stage3MAS4/FP12_INV_AFTER_FPINV/schedule2.png"
	if(S.solution() != []):
