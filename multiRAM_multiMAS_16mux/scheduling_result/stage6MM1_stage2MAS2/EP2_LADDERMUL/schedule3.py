...
def solve():
	...
	Z3_t3_mem0 += alt(MAS_MEM)
	S += (T140*MAS[0])-1 < Z3_t3_mem0*MAS_MEM[0]
	S += (T140*MAS[1])-1 < Z3_t3_mem0*MAS_MEM[2]
	S += Z3_t3_mem0 <= Z3_t3
	...
	Z30_mem0 += alt(MM_MEM)
	S += (Z3_t0*MM[0])-1 < Z30_mem0*MM_MEM[0]
	S += Z30_mem0 <= Z30
	...
	Z3_t5_mem0 += alt(MM_MEM)
	S += (Z3_t0*MM[0])-1 < Z3_t5_mem0*MM_MEM[0]
	S += Z3_t5_mem0 <= Z3_t5
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage2MAS2/EP2_LADDERMUL/schedule3.png"
	if(S.solution() != []):
