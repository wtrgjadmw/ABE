...
def solve():
	...
	t6_t4_mem0 += alt(MAS_MEM)
	S += (t6_t2*MAS[0])-1 < t6_t4_mem0*MAS_MEM[0]
	S += (t6_t2*MAS[1])-1 < t6_t4_mem0*MAS_MEM[2]
	S += t6_t4_mem0 <= t6_t4
	...
	t13_t4_mem0 += alt(MAS_MEM)
	S += (t13_t2*MAS[0])-1 < t13_t4_mem0*MAS_MEM[0]
	S += (t13_t2*MAS[1])-1 < t13_t4_mem0*MAS_MEM[2]
	...
	pic_file_name = "/mnt/rose/usr1/fukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage2MAS2/EP2_ADD_w_EVAL/schedule2.png"
	if(S.solution() != []):
