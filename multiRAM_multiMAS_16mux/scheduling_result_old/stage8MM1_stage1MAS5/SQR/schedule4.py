...
def solve():
	...
	S += c_t4_t3_t0_mem0 >= 13
	c_t4_t3_t0_mem0 += MAS_MEM[8]

	c_t4_t3_t0_mem1 = S.Task('c_t4_t3_t0_mem1', length=1, delay_cost=1)
	S += c_t4_t3_t0_mem1 >= 13
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage1MAS5/SQR/schedule4.png"
	if(S.solution() != []):
