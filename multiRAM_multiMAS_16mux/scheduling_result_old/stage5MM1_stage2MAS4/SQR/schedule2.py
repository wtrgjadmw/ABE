...
def solve():
	...
	c_t3_t3_t4_mem0 += alt(MAS_MEM)
	S += (c_t3_t3_t2*MAS[0])-1 < c_t3_t3_t4_mem0*MAS_MEM[0]
	S += (c_t3_t3_t2*MAS[1])-1 < c_t3_t3_t4_mem0*MAS_MEM[2]
	S += (c_t3_t3_t2*MAS[2])-1 < c_t3_t3_t4_mem0*MAS_MEM[4]
	S += (c_t3_t3_t2*MAS[3])-1 < c_t3_t3_t4_mem0*MAS_MEM[6]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage5MM1_stage2MAS4/SQR/schedule2.png"
	if(S.solution() != []):
