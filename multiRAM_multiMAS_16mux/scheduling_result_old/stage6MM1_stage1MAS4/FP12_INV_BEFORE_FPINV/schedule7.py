...
def solve():
	...
	c_pbc_t21_mem0 += alt(MAS_MEM)
	S += (c_pb01*MAS[0])-1 < c_pbc_t21_mem0*MAS_MEM[0]
	S += (c_pb01*MAS[1])-1 < c_pbc_t21_mem0*MAS_MEM[2]
	S += (c_pb01*MAS[2])-1 < c_pbc_t21_mem0*MAS_MEM[4]
	S += (c_pb01*MAS[3])-1 < c_pbc_t21_mem0*MAS_MEM[6]
	...
	c_pcb_t20_mem1 += alt(MAS_MEM)
	S += (c_pc10*MAS[0])-1 < c_pcb_t20_mem1*MAS_MEM[1]
	S += (c_pc10*MAS[1])-1 < c_pcb_t20_mem1*MAS_MEM[3]
	S += (c_pc10*MAS[2])-1 < c_pcb_t20_mem1*MAS_MEM[5]
	S += (c_pc10*MAS[3])-1 < c_pcb_t20_mem1*MAS_MEM[7]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage6MM1_stage1MAS4/FP12_INV_BEFORE_FPINV/schedule7.png"
	if(S.solution() != []):
