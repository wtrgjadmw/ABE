...
def solve():
	...
	r6_t4_mem1 += alt(MAS_MEM)
	S += (r6_t3*MAS[0])-1 < r6_t4_mem1*MAS_MEM[1]
	S += (r6_t3*MAS[1])-1 < r6_t4_mem1*MAS_MEM[3]
	S += (r6_t3*MAS[2])-1 < r6_t4_mem1*MAS_MEM[5]
	S += (r6_t3*MAS[3])-1 < r6_t4_mem1*MAS_MEM[7]
	S += r6_t4_mem1 <= r6_t4
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage8MM1_stage2MAS4/EP2_YRECOVER/schedule1.png"
	if(S.solution() != []):
