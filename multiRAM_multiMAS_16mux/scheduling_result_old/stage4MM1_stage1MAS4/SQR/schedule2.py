...
def solve():
	...
	c_t0_t2_t0_mem0 += alt(MAS_MEM)
	S += (c_t0_t00*MAS[0])-1 < c_t0_t2_t0_mem0*MAS_MEM[0]
	S += (c_t0_t00*MAS[1])-1 < c_t0_t2_t0_mem0*MAS_MEM[2]
	S += (c_t0_t00*MAS[2])-1 < c_t0_t2_t0_mem0*MAS_MEM[4]
	S += (c_t0_t00*MAS[3])-1 < c_t0_t2_t0_mem0*MAS_MEM[6]
	...
	c_t0_t2_t2_mem0 += alt(MAS_MEM)
	S += (c_t0_t00*MAS[0])-1 < c_t0_t2_t2_mem0*MAS_MEM[0]
	S += (c_t0_t00*MAS[1])-1 < c_t0_t2_t2_mem0*MAS_MEM[2]
	S += (c_t0_t00*MAS[2])-1 < c_t0_t2_t2_mem0*MAS_MEM[4]
	S += (c_t0_t00*MAS[3])-1 < c_t0_t2_t2_mem0*MAS_MEM[6]
	S += c_t0_t2_t2_mem0 <= c_t0_t2_t2

	c_t0_t2_t2_mem1 = S.Task('c_t0_t2_t2_mem1', length=1, delay_cost=1)
	c_t0_t2_t2_mem1 += MAS_MEM[7]
	S += 16 < c_t0_t2_t2_mem1
	...
	c_t4_t3_t4_mem0 += alt(MAS_MEM)
	S += (c_t4_t3_t2*MAS[0])-1 < c_t4_t3_t4_mem0*MAS_MEM[0]
	S += (c_t4_t3_t2*MAS[1])-1 < c_t4_t3_t4_mem0*MAS_MEM[2]
	S += (c_t4_t3_t2*MAS[2])-1 < c_t4_t3_t4_mem0*MAS_MEM[4]
	S += (c_t4_t3_t2*MAS[3])-1 < c_t4_t3_t4_mem0*MAS_MEM[6]
	S += c_t4_t3_t4_mem0 <= c_t4_t3_t4

	c_t4_t3_t4_mem1 = S.Task('c_t4_t3_t4_mem1', length=1, delay_cost=1)
	c_t4_t3_t4_mem1 += MAS_MEM[7]
	S += 12 < c_t4_t3_t4_mem1
	...
	c_t5_t00_mem0 += alt(MAS_MEM)
	S += (c_t5000*MAS[0])-1 < c_t5_t00_mem0*MAS_MEM[0]
	S += (c_t5000*MAS[1])-1 < c_t5_t00_mem0*MAS_MEM[2]
	S += (c_t5000*MAS[2])-1 < c_t5_t00_mem0*MAS_MEM[4]
	S += (c_t5000*MAS[3])-1 < c_t5_t00_mem0*MAS_MEM[6]
	...
	c_t5_t01_mem0 += alt(MAS_MEM)
	S += (c_t5001*MAS[0])-1 < c_t5_t01_mem0*MAS_MEM[0]
	S += (c_t5001*MAS[1])-1 < c_t5_t01_mem0*MAS_MEM[2]
	S += (c_t5001*MAS[2])-1 < c_t5_t01_mem0*MAS_MEM[4]
	S += (c_t5001*MAS[3])-1 < c_t5_t01_mem0*MAS_MEM[6]
	...
	c_t5_t2_t3_mem0 += alt(MAS_MEM)
	S += (c_t5_t10*MAS[0])-1 < c_t5_t2_t3_mem0*MAS_MEM[0]
	S += (c_t5_t10*MAS[1])-1 < c_t5_t2_t3_mem0*MAS_MEM[2]
	S += (c_t5_t10*MAS[2])-1 < c_t5_t2_t3_mem0*MAS_MEM[4]
	S += (c_t5_t10*MAS[3])-1 < c_t5_t2_t3_mem0*MAS_MEM[6]
	S += c_t5_t2_t3_mem0 <= c_t5_t2_t3

	c_t5_t2_t3_mem1 = S.Task('c_t5_t2_t3_mem1', length=1, delay_cost=1)
	c_t5_t2_t3_mem1 += alt(MAS_MEM)
	S += (c_t5_t11*MAS[0])-1 < c_t5_t2_t3_mem1*MAS_MEM[1]
	S += (c_t5_t11*MAS[1])-1 < c_t5_t2_t3_mem1*MAS_MEM[3]
	S += (c_t5_t11*MAS[2])-1 < c_t5_t2_t3_mem1*MAS_MEM[5]
	S += (c_t5_t11*MAS[3])-1 < c_t5_t2_t3_mem1*MAS_MEM[7]
	...
	c_t5_t3_t4_mem0 += alt(MAS_MEM)
	S += (c_t5_t3_t2*MAS[0])-1 < c_t5_t3_t4_mem0*MAS_MEM[0]
	S += (c_t5_t3_t2*MAS[1])-1 < c_t5_t3_t4_mem0*MAS_MEM[2]
	S += (c_t5_t3_t2*MAS[2])-1 < c_t5_t3_t4_mem0*MAS_MEM[4]
	S += (c_t5_t3_t2*MAS[3])-1 < c_t5_t3_t4_mem0*MAS_MEM[6]
	...
	c_t5_t30_mem0 += alt(MM_MEM)
	S += (c_t5_t3_t0*MM[0])-1 < c_t5_t30_mem0*MM_MEM[0]
	S += c_t5_t30_mem0 <= c_t5_t30

	c_t5_t30_mem1 = S.Task('c_t5_t30_mem1', length=1, delay_cost=1)
	c_t5_t30_mem1 += alt(MM_MEM)
	S += (c_t5_t3_t1*MM[0])-1 < c_t5_t30_mem1*MM_MEM[1]
	...
	c_t5_t3_t5_mem0 += alt(MM_MEM)
	S += (c_t5_t3_t0*MM[0])-1 < c_t5_t3_t5_mem0*MM_MEM[0]
	S += c_t5_t3_t5_mem0 <= c_t5_t3_t5

	c_t5_t3_t5_mem1 = S.Task('c_t5_t3_t5_mem1', length=1, delay_cost=1)
	c_t5_t3_t5_mem1 += alt(MM_MEM)
	S += (c_t5_t3_t1*MM[0])-1 < c_t5_t3_t5_mem1*MM_MEM[1]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage1MAS4/SQR/schedule2.png"
	if(S.solution() != []):
