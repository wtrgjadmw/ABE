...
def solve():
	...
	c_paa_t20_mem1 += alt(MAS_MEM)
	S += (c_pa10*MAS[0])-1 < c_paa_t20_mem1*MAS_MEM[1]
	S += (c_pa10*MAS[1])-1 < c_paa_t20_mem1*MAS_MEM[3]
	S += (c_pa10*MAS[2])-1 < c_paa_t20_mem1*MAS_MEM[5]
	S += (c_pa10*MAS[3])-1 < c_paa_t20_mem1*MAS_MEM[7]
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage1MAS4/FP12_INV_BEFORE_FPINV/schedule7.png"
	if(S.solution() != []):
