...
def solve():
	...
	# new tasks
	r1_t0 = S.Task('r1_t0', length=4, delay_cost=1)
	r1_t0 += alt(MM)
	...
	r1_t1 = S.Task('r1_t1', length=4, delay_cost=1)
	r1_t1 += alt(MM)
	...
	r3_t0 = S.Task('r3_t0', length=4, delay_cost=1)
	r3_t0 += alt(MM)
	...
	r3_t1 = S.Task('r3_t1', length=4, delay_cost=1)
	r3_t1 += alt(MM)
	...
	r4_t0 = S.Task('r4_t0', length=4, delay_cost=1)
	r4_t0 += alt(MM)
	...
	r4_t1 = S.Task('r4_t1', length=4, delay_cost=1)
	r4_t1 += alt(MM)
	...
	r5_t0 = S.Task('r5_t0', length=4, delay_cost=1)
	r5_t0 += alt(MM)
	...
	r5_t1 = S.Task('r5_t1', length=4, delay_cost=1)
	r5_t1 += alt(MM)
	...
	r6_t0 = S.Task('r6_t0', length=4, delay_cost=1)
	r6_t0 += alt(MM)
	...
	r6_t1 = S.Task('r6_t1', length=4, delay_cost=1)
	r6_t1 += alt(MM)
	...
	r12_t0 = S.Task('r12_t0', length=4, delay_cost=1)
	r12_t0 += alt(MM)
	...
	r12_t1 = S.Task('r12_t1', length=4, delay_cost=1)
	r12_t1 += alt(MM)
	...
	r13_t0 = S.Task('r13_t0', length=4, delay_cost=1)
	r13_t0 += alt(MM)
	...
	r13_t1 = S.Task('r13_t1', length=4, delay_cost=1)
	r13_t1 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage2MAS4/EP2_YRECOVER/schedule0.png"
	if(S.solution() != []):
