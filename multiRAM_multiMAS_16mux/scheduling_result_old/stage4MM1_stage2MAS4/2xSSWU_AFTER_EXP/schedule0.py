...
def solve():
	...
	# new tasks
	alpha0 = S.Task('alpha0', length=4, delay_cost=1)
	alpha0 += alt(MM)
	...
	alpha1 = S.Task('alpha1', length=4, delay_cost=1)
	alpha1 += alt(MM)
	...
	xit2N0 = S.Task('xit2N0', length=4, delay_cost=1)
	xit2N0 += alt(MM)
	...
	xit2N1 = S.Task('xit2N1', length=4, delay_cost=1)
	xit2N1 += alt(MM)
	...
	y20 = S.Task('y20', length=4, delay_cost=1)
	y20 += alt(MM)
	...
	y21 = S.Task('y21', length=4, delay_cost=1)
	y21 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage2MAS4/2xSSWU_AFTER_EXP/schedule0.png"
	if(S.solution() != []):
