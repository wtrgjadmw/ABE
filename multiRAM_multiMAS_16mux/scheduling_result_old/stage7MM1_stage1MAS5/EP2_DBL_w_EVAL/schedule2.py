...
def solve():
	...
	S += (t12_t2*MAS[4])-1 < t12_t4_mem0*MAS_MEM[8]
	...
	S += (t12_t3*MAS[4])-1 < t12_t4_mem1*MAS_MEM[9]
	...
	S += (t01*MAS[4])-1 < c001_mem0*MAS_MEM[8]
	S += c001_mem0 <= c001
	...
	S += (t01*MAS[4])-1 < t161_mem0*MAS_MEM[8]
	S += t161_mem0 <= t161
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage7MM1_stage1MAS5/EP2_DBL_w_EVAL/schedule2.png"
	if(S.solution() != []):
