...
def solve():
	...
	c_pbc_t4_t4 = S.Task('c_pbc_t4_t4', length=4, delay_cost=1)
	S += c_pbc_t4_t4 >= 80
	c_pbc_t4_t4 += MM[0]
	...
	c_paa_t4_t4 = S.Task('c_paa_t4_t4', length=4, delay_cost=1)
	S += c_paa_t4_t4 >= 81
	c_paa_t4_t4 += MM[0]
	...
	c_pcb_t4_t4 = S.Task('c_pcb_t4_t4', length=4, delay_cost=1)
	S += c_pcb_t4_t4 >= 82
	c_pcb_t4_t4 += MM[0]
	...
	c_qinv_bb_t0 = S.Task('c_qinv_bb_t0', length=4, delay_cost=1)
	S += c_qinv_bb_t0 >= 95
	c_qinv_bb_t0 += MM[0]
	...
	c_qinv_aa_t1 = S.Task('c_qinv_aa_t1', length=4, delay_cost=1)
	S += c_qinv_aa_t1 >= 104
	c_qinv_aa_t1 += MM[0]
	...
	S += 97 < c_qinv_bb_t3_mem1
	S += c_qinv_bb_t3_mem1 <= c_qinv_bb_t3

	c_qinv_aa_t0 = S.Task('c_qinv_aa_t0', length=4, delay_cost=1)
	c_qinv_aa_t0 += alt(MM)
	...
	S += 102 < c_qinv_aa_t0_mem0
	S += c_qinv_aa_t0_mem0 <= c_qinv_aa_t0

	c_qinv_bb_t4 = S.Task('c_qinv_bb_t4', length=4, delay_cost=1)
	c_qinv_bb_t4 += alt(MM)
	...
	pic_file_name = "/home/mfukuda/ABE/multiRAM_multiMAS_16mux/scheduling_result/stage4MM1_stage3MAS4/FP12_INV_BEFORE_FPINV/schedule10.png"
	if(S.solution() != []):
