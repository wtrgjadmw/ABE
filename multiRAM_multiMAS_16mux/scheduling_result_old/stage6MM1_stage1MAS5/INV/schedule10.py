...
def solve():
	...
	S += (c_pxi_y1_0*MAS[4])-1 < c_q00_mem0*MAS_MEM[8]
	S += c_q00_mem0 <= c_q00
	...
	S += (c_paa00*MAS[4])-1 < c_q00_mem1*MAS_MEM[9]
	S += c_q00_mem1 <= c_q00
	...
	S += (c_pxi_y1_1*MAS[4])-1 < c_q01_mem0*MAS_MEM[8]
	S += c_q01_mem0 <= c_q01
	...
	S += (c_paa01*MAS[4])-1 < c_q01_mem1*MAS_MEM[9]
	S += c_q01_mem1 <= c_q01
	...
	S += (c_q10*MAS[4])-1 < c_qinv_bb_t0_mem0*MAS_MEM[8]
	...
	S += (c_q10*MAS[4])-1 < c_qinv_bb_t0_mem1*MAS_MEM[9]
	...
	S += (c_q11*MAS[4])-1 < c_qinv_bb_t1_mem0*MAS_MEM[8]
	...
	S += (c_q11*MAS[4])-1 < c_qinv_bb_t1_mem1*MAS_MEM[9]
	...
	S += (c_q10*MAS[4])-1 < c_qinv_bb_t2_mem0*MAS_MEM[8]
	...
	S += (c_q11*MAS[4])-1 < c_qinv_bb_t2_mem1*MAS_MEM[9]
	...
	S += (c_q10*MAS[4])-1 < c_qinv_bb_t3_mem0*MAS_MEM[8]
	...
	S += (c_q11*MAS[4])-1 < c_qinv_bb_t3_mem1*MAS_MEM[9]
	...
	S += (c_q10*MAS[4])-1 < c_qinv1__t2_mem0*MAS_MEM[8]
	...
	S += (c_q11*MAS[4])-1 < c_qinv1__t2_mem1*MAS_MEM[9]
	...
	S += (c_q00*MAS[4])-1 < c_qinv0_t2_mem0*MAS_MEM[8]
	...
	S += (c_q01*MAS[4])-1 < c_qinv0_t2_mem1*MAS_MEM[9]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage6MM1_stage1MAS5/INV/schedule10.png"
	if(S.solution() != []):
