...
def solve():
	...
	S += t6_t4_mem1 >= 34
	t6_t4_mem1 += MAS_MEM[2]

	t7_t3_mem0 = S.Task('t7_t3_mem0', length=1, delay_cost=1)
	S += t7_t3_mem0 >= 34
	t7_t3_mem0 += MAS_MEM[3]
	...
	S += t14_t3_mem0 >= 41
	t14_t3_mem0 += MAS_MEM[1]

	t14_t3_mem1 = S.Task('t14_t3_mem1', length=1, delay_cost=1)
	S += t14_t3_mem1 >= 41
	t14_t3_mem1 += MAS_MEM[2]
	...
	S += (new_TX_t3*MAS[0])-1 < new_TX_t4_mem1*MAS_MEM[0]
	S += (new_TX_t3*MAS[1])-1 < new_TX_t4_mem1*MAS_MEM[1]
	S += (new_TX_t3*MAS[2])-1 < new_TX_t4_mem1*MAS_MEM[2]
	S += (new_TX_t3*MAS[3])-1 < new_TX_t4_mem1*MAS_MEM[3]
	...
	S += (t121*MAS[0])-1 < t13_t1_mem1*MAS_MEM[0]
	S += (t121*MAS[1])-1 < t13_t1_mem1*MAS_MEM[1]
	S += (t121*MAS[2])-1 < t13_t1_mem1*MAS_MEM[2]
	S += (t121*MAS[3])-1 < t13_t1_mem1*MAS_MEM[3]
	...
	S += (t121*MAS[0])-1 < t13_t3_mem1*MAS_MEM[0]
	S += (t121*MAS[1])-1 < t13_t3_mem1*MAS_MEM[1]
	S += (t121*MAS[2])-1 < t13_t3_mem1*MAS_MEM[2]
	S += (t121*MAS[3])-1 < t13_t3_mem1*MAS_MEM[3]
	...
	S += (t13_t3*MAS[0])-1 < t13_t4_mem1*MAS_MEM[0]
	S += (t13_t3*MAS[1])-1 < t13_t4_mem1*MAS_MEM[1]
	S += (t13_t3*MAS[2])-1 < t13_t4_mem1*MAS_MEM[2]
	S += (t13_t3*MAS[3])-1 < t13_t4_mem1*MAS_MEM[3]
	...
	S += (t13_t1*MM[0])-1 < t130_mem1*MM_MEM[0]
	S += t130_mem1 <= t130
	...
	S += (t13_t1*MM[0])-1 < t13_t5_mem1*MM_MEM[0]
	...
	S += (t13_t5*MAS[0])-1 < t131_mem1*MAS_MEM[0]
	S += (t13_t5*MAS[1])-1 < t131_mem1*MAS_MEM[1]
	S += (t13_t5*MAS[2])-1 < t131_mem1*MAS_MEM[2]
	S += (t13_t5*MAS[3])-1 < t131_mem1*MAS_MEM[3]
	S += t131_mem1 <= t131
	...
	S += (t130*MAS[1])-1 < t150_mem0*MAS_MEM[1]
	S += (t130*MAS[2])-1 < t150_mem0*MAS_MEM[2]
	S += (t130*MAS[3])-1 < t150_mem0*MAS_MEM[3]
	S += t150_mem0 <= t150
	...
	S += (t131*MAS[1])-1 < t151_mem0*MAS_MEM[1]
	S += (t131*MAS[2])-1 < t151_mem0*MAS_MEM[2]
	S += (t131*MAS[3])-1 < t151_mem0*MAS_MEM[3]
	S += t151_mem0 <= t151
	...
	new_TY0_mem0 += MAIN_MEM_r
	S += new_TY0_mem0 <= new_TY0

	new_TY0_mem1 = S.Task('new_TY0_mem1', length=1, delay_cost=1)
	new_TY0_mem1 += alt(MAS_MEM)
	S += (t150*MAS[0])-1 < new_TY0_mem1*MAS_MEM[0]
	S += (t150*MAS[1])-1 < new_TY0_mem1*MAS_MEM[1]
	S += (t150*MAS[2])-1 < new_TY0_mem1*MAS_MEM[2]
	S += (t150*MAS[3])-1 < new_TY0_mem1*MAS_MEM[3]
	...
	new_TY1_mem0 += MAIN_MEM_r
	S += new_TY1_mem0 <= new_TY1

	new_TY1_mem1 = S.Task('new_TY1_mem1', length=1, delay_cost=1)
	new_TY1_mem1 += alt(MAS_MEM)
	S += (t151*MAS[0])-1 < new_TY1_mem1*MAS_MEM[0]
	S += (t151*MAS[1])-1 < new_TY1_mem1*MAS_MEM[1]
	S += (t151*MAS[2])-1 < new_TY1_mem1*MAS_MEM[2]
	S += (t151*MAS[3])-1 < new_TY1_mem1*MAS_MEM[3]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/PADD/schedule3.png"
	if(S.solution() != []):
