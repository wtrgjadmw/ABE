...
def solve():
	...
	S += c_paa_t0_t1_mem0 >= 93
	c_paa_t0_t1_mem0 += MAS_MEM[1]

	c_paa_t0_t1_mem1 = S.Task('c_paa_t0_t1_mem1', length=1, delay_cost=1)
	S += c_paa_t0_t1_mem1 >= 93
	...
	S += c_paa_t0_t0_mem0 >= 94
	c_paa_t0_t0_mem0 += MAS_MEM[3]

	c_paa_t0_t0_mem1 = S.Task('c_paa_t0_t0_mem1', length=1, delay_cost=1)
	S += c_paa_t0_t0_mem1 >= 94
	...
	S += c_pcb_t4_t1_mem0 >= 99
	c_pcb_t4_t1_mem0 += MAS_MEM[3]

	c_pcb_t4_t1_mem1 = S.Task('c_pcb_t4_t1_mem1', length=1, delay_cost=1)
	S += c_pcb_t4_t1_mem1 >= 99
	c_pcb_t4_t1_mem1 += MAS_MEM[0]
	...
	S += c_pbc_t51_mem0 >= 106
	c_pbc_t51_mem0 += MAS_MEM[3]

	c_pbc_t51_mem1 = S.Task('c_pbc_t51_mem1', length=1, delay_cost=1)
	S += c_pbc_t51_mem1 >= 106
	c_pbc_t51_mem1 += MAS_MEM[2]
	...
	S += c_pbccb01_mem0 >= 110
	c_pbccb01_mem0 += MAS_MEM[1]

	c_pbccb01_mem1 = S.Task('c_pbccb01_mem1', length=1, delay_cost=1)
	S += c_pbccb01_mem1 >= 110
	c_pbccb01_mem1 += MAS_MEM[0]
	...
	S += c_pbccb11_mem0 >= 114
	c_pbccb11_mem0 += MAS_MEM[3]

	c_pbccb11_mem1 = S.Task('c_pbccb11_mem1', length=1, delay_cost=1)
	S += c_pbccb11_mem1 >= 114
	...
	S += c_qinv1__t2_mem0 >= 116
	c_qinv1__t2_mem0 += MAS_MEM[0]

	c_qinv1__t2_mem1 = S.Task('c_qinv1__t2_mem1', length=1, delay_cost=1)
	S += c_qinv1__t2_mem1 >= 116
	c_qinv1__t2_mem1 += MAS_MEM[2]
	...
	c_qinv_denom0_mem0 += MAS_MEM[0]
	S += 124 < c_qinv_denom0_mem0
	S += c_qinv_denom0_mem0 <= c_qinv_denom0

	c_qinv_denom0_mem1 = S.Task('c_qinv_denom0_mem1', length=1, delay_cost=1)
	c_qinv_denom0_mem1 += MAS_MEM[2]
	S += 123 < c_qinv_denom0_mem1
	...
	S += (c_qinv_denom0*MAS[1])-1 < c_qinv_denom_inv_aa_mem0*MAS_MEM[1]
	S += (c_qinv_denom0*MAS[2])-1 < c_qinv_denom_inv_aa_mem0*MAS_MEM[2]
	S += (c_qinv_denom0*MAS[3])-1 < c_qinv_denom_inv_aa_mem0*MAS_MEM[3]
	...
	S += (c_qinv_denom0*MAS[0])-1 < c_qinv_denom_inv_aa_mem1*MAS_MEM[0]
	S += (c_qinv_denom0*MAS[1])-1 < c_qinv_denom_inv_aa_mem1*MAS_MEM[1]
	S += (c_qinv_denom0*MAS[2])-1 < c_qinv_denom_inv_aa_mem1*MAS_MEM[2]
	S += (c_qinv_denom0*MAS[3])-1 < c_qinv_denom_inv_aa_mem1*MAS_MEM[3]
	...
	S += (c_qinv_denom1*MAS[1])-1 < c_qinv_denom_inv_bb_mem0*MAS_MEM[1]
	S += (c_qinv_denom1*MAS[2])-1 < c_qinv_denom_inv_bb_mem0*MAS_MEM[2]
	S += (c_qinv_denom1*MAS[3])-1 < c_qinv_denom_inv_bb_mem0*MAS_MEM[3]
	...
	S += (c_qinv_denom1*MAS[0])-1 < c_qinv_denom_inv_bb_mem1*MAS_MEM[0]
	S += (c_qinv_denom1*MAS[1])-1 < c_qinv_denom_inv_bb_mem1*MAS_MEM[1]
	S += (c_qinv_denom1*MAS[2])-1 < c_qinv_denom_inv_bb_mem1*MAS_MEM[2]
	S += (c_qinv_denom1*MAS[3])-1 < c_qinv_denom_inv_bb_mem1*MAS_MEM[3]
	...
	S += (c_qinv_denom_inv_bb*MM[0])-1 < c_qinv_denom_inv_denom_mem1*MM_MEM[0]
	...
	S += (c_qinv_denom_inv_denom*MAS[1])-1 < c_qinv_denom_inv_denom_inv_mem0*MAS_MEM[1]
	S += (c_qinv_denom_inv_denom*MAS[2])-1 < c_qinv_denom_inv_denom_inv_mem0*MAS_MEM[2]
	S += (c_qinv_denom_inv_denom*MAS[3])-1 < c_qinv_denom_inv_denom_inv_mem0*MAS_MEM[3]
	...
	S += (c_qinv_denom_inv_denom*MAS[0])-1 < c_qinv_denom_inv_denom_inv_mem1*MAS_MEM[0]
	S += (c_qinv_denom_inv_denom*MAS[1])-1 < c_qinv_denom_inv_denom_inv_mem1*MAS_MEM[1]
	S += (c_qinv_denom_inv_denom*MAS[2])-1 < c_qinv_denom_inv_denom_inv_mem1*MAS_MEM[2]
	S += (c_qinv_denom_inv_denom*MAS[3])-1 < c_qinv_denom_inv_denom_inv_mem1*MAS_MEM[3]
	...
	S += (c_qinv_denom0*MAS[1])-1 < c_qinv_denom_inv0_mem0*MAS_MEM[1]
	S += (c_qinv_denom0*MAS[2])-1 < c_qinv_denom_inv0_mem0*MAS_MEM[2]
	S += (c_qinv_denom0*MAS[3])-1 < c_qinv_denom_inv0_mem0*MAS_MEM[3]
	...
	S += (c_qinv_denom1*MAS[1])-1 < c_qinv_denom_inv1__mem0*MAS_MEM[1]
	S += (c_qinv_denom1*MAS[2])-1 < c_qinv_denom_inv1__mem0*MAS_MEM[2]
	S += (c_qinv_denom1*MAS[3])-1 < c_qinv_denom_inv1__mem0*MAS_MEM[3]
	...
	S += (c_qinv_denom_inv1_*MM[0])-1 < c_qinv0_t3_mem1*MM_MEM[0]
	...
	S += (c_qinv_denom_inv1_*MM[0])-1 < c_qinv1__t3_mem1*MM_MEM[0]
	...
	c_qinv0_t4_mem0 += MAS_MEM[3]
	S += 121 < c_qinv0_t4_mem0
	S += c_qinv0_t4_mem0 <= c_qinv0_t4

	c_qinv0_t4_mem1 = S.Task('c_qinv0_t4_mem1', length=1, delay_cost=1)
	c_qinv0_t4_mem1 += alt(MAS_MEM)
	S += (c_qinv0_t3*MAS[0])-1 < c_qinv0_t4_mem1*MAS_MEM[0]
	S += (c_qinv0_t3*MAS[1])-1 < c_qinv0_t4_mem1*MAS_MEM[1]
	S += (c_qinv0_t3*MAS[2])-1 < c_qinv0_t4_mem1*MAS_MEM[2]
	S += (c_qinv0_t3*MAS[3])-1 < c_qinv0_t4_mem1*MAS_MEM[3]
	...
	S += (c_qinv0_t1*MM[0])-1 < c_qinv00_mem1*MM_MEM[0]
	...
	S += (c_qinv0_t1*MM[0])-1 < c_qinv0_t5_mem1*MM_MEM[0]
	...
	c_qinv1__t4_mem0 += MAS_MEM[1]
	S += 117 < c_qinv1__t4_mem0
	S += c_qinv1__t4_mem0 <= c_qinv1__t4

	c_qinv1__t4_mem1 = S.Task('c_qinv1__t4_mem1', length=1, delay_cost=1)
	c_qinv1__t4_mem1 += alt(MAS_MEM)
	S += (c_qinv1__t3*MAS[0])-1 < c_qinv1__t4_mem1*MAS_MEM[0]
	S += (c_qinv1__t3*MAS[1])-1 < c_qinv1__t4_mem1*MAS_MEM[1]
	S += (c_qinv1__t3*MAS[2])-1 < c_qinv1__t4_mem1*MAS_MEM[2]
	S += (c_qinv1__t3*MAS[3])-1 < c_qinv1__t4_mem1*MAS_MEM[3]
	...
	S += (c_qinv1__t1*MM[0])-1 < c_qinv1_0_mem1*MM_MEM[0]
	...
	S += (c_qinv1__t1*MM[0])-1 < c_qinv1__t5_mem1*MM_MEM[0]
	...
	S += (c_qinv0_t5*MAS[0])-1 < c_qinv01_mem1*MAS_MEM[0]
	S += (c_qinv0_t5*MAS[1])-1 < c_qinv01_mem1*MAS_MEM[1]
	S += (c_qinv0_t5*MAS[2])-1 < c_qinv01_mem1*MAS_MEM[2]
	S += (c_qinv0_t5*MAS[3])-1 < c_qinv01_mem1*MAS_MEM[3]
	...
	S += (c_qinv1__t5*MAS[0])-1 < c_qinv1_1_mem1*MAS_MEM[0]
	S += (c_qinv1__t5*MAS[1])-1 < c_qinv1_1_mem1*MAS_MEM[1]
	S += (c_qinv1__t5*MAS[2])-1 < c_qinv1_1_mem1*MAS_MEM[2]
	S += (c_qinv1__t5*MAS[3])-1 < c_qinv1_1_mem1*MAS_MEM[3]
	...
	c0_t0_t0_mem0 += MAS_MEM[3]
	S += 89 < c0_t0_t0_mem0
	S += c0_t0_t0_mem0 <= c0_t0_t0

	c0_t0_t0_mem1 = S.Task('c0_t0_t0_mem1', length=1, delay_cost=1)
	c0_t0_t0_mem1 += alt(MAS_MEM)
	S += (c_qinv00*MAS[0])-1 < c0_t0_t0_mem1*MAS_MEM[0]
	S += (c_qinv00*MAS[1])-1 < c0_t0_t0_mem1*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c0_t0_t0_mem1*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c0_t0_t0_mem1*MAS_MEM[3]
	...
	c0_t1_t0_mem0 += MAS_MEM[1]
	S += 71 < c0_t1_t0_mem0
	S += c0_t1_t0_mem0 <= c0_t1_t0

	c0_t1_t0_mem1 = S.Task('c0_t1_t0_mem1', length=1, delay_cost=1)
	c0_t1_t0_mem1 += alt(MAS_MEM)
	S += (c_qinv1_0*MAS[0])-1 < c0_t1_t0_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c0_t1_t0_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c0_t1_t0_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c0_t1_t0_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c0_t30_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c0_t30_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c0_t30_mem0*MAS_MEM[3]
	S += c0_t30_mem0 <= c0_t30

	c0_t30_mem1 = S.Task('c0_t30_mem1', length=1, delay_cost=1)
	c0_t30_mem1 += alt(MAS_MEM)
	S += (c_qinv1_0*MAS[0])-1 < c0_t30_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c0_t30_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c0_t30_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c0_t30_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[0])-1 < c1_t0_t0_mem1*MAS_MEM[0]
	S += (c_qinv00*MAS[1])-1 < c1_t0_t0_mem1*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c1_t0_t0_mem1*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c1_t0_t0_mem1*MAS_MEM[3]
	...
	S += (c_qinv1_0*MAS[0])-1 < c1_t1_t0_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c1_t1_t0_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c1_t1_t0_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c1_t1_t0_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c1_t30_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c1_t30_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c1_t30_mem0*MAS_MEM[3]
	S += c1_t30_mem0 <= c1_t30

	c1_t30_mem1 = S.Task('c1_t30_mem1', length=1, delay_cost=1)
	c1_t30_mem1 += alt(MAS_MEM)
	S += (c_qinv1_0*MAS[0])-1 < c1_t30_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c1_t30_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c1_t30_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c1_t30_mem1*MAS_MEM[3]
	...
	c2_t0_t0_mem0 += MAS_MEM[1]
	S += 86 < c2_t0_t0_mem0
	S += c2_t0_t0_mem0 <= c2_t0_t0

	c2_t0_t0_mem1 = S.Task('c2_t0_t0_mem1', length=1, delay_cost=1)
	c2_t0_t0_mem1 += alt(MAS_MEM)
	S += (c_qinv00*MAS[0])-1 < c2_t0_t0_mem1*MAS_MEM[0]
	S += (c_qinv00*MAS[1])-1 < c2_t0_t0_mem1*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c2_t0_t0_mem1*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c2_t0_t0_mem1*MAS_MEM[3]
	...
	c2_t1_t0_mem0 += MAS_MEM[2]
	S += 72 < c2_t1_t0_mem0
	S += c2_t1_t0_mem0 <= c2_t1_t0

	c2_t1_t0_mem1 = S.Task('c2_t1_t0_mem1', length=1, delay_cost=1)
	c2_t1_t0_mem1 += alt(MAS_MEM)
	S += (c_qinv1_0*MAS[0])-1 < c2_t1_t0_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c2_t1_t0_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c2_t1_t0_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c2_t1_t0_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c2_t30_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c2_t30_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c2_t30_mem0*MAS_MEM[3]
	S += c2_t30_mem0 <= c2_t30

	c2_t30_mem1 = S.Task('c2_t30_mem1', length=1, delay_cost=1)
	c2_t30_mem1 += alt(MAS_MEM)
	S += (c_qinv1_0*MAS[0])-1 < c2_t30_mem1*MAS_MEM[0]
	S += (c_qinv1_0*MAS[1])-1 < c2_t30_mem1*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c2_t30_mem1*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c2_t30_mem1*MAS_MEM[3]
	...
	c0_t0_t1_mem0 += MAS_MEM[1]
	S += 90 < c0_t0_t1_mem0
	S += c0_t0_t1_mem0 <= c0_t0_t1

	c0_t0_t1_mem1 = S.Task('c0_t0_t1_mem1', length=1, delay_cost=1)
	c0_t0_t1_mem1 += alt(MAS_MEM)
	S += (c_qinv01*MAS[0])-1 < c0_t0_t1_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c0_t0_t1_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c0_t0_t1_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c0_t0_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c0_t0_t3_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c0_t0_t3_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c0_t0_t3_mem0*MAS_MEM[3]
	S += c0_t0_t3_mem0 <= c0_t0_t3

	c0_t0_t3_mem1 = S.Task('c0_t0_t3_mem1', length=1, delay_cost=1)
	c0_t0_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv01*MAS[0])-1 < c0_t0_t3_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c0_t0_t3_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c0_t0_t3_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c0_t0_t3_mem1*MAS_MEM[3]
	...
	c0_t1_t1_mem0 += MAS_MEM[3]
	S += 74 < c0_t1_t1_mem0
	S += c0_t1_t1_mem0 <= c0_t1_t1

	c0_t1_t1_mem1 = S.Task('c0_t1_t1_mem1', length=1, delay_cost=1)
	c0_t1_t1_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c0_t1_t1_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c0_t1_t1_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c0_t1_t1_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c0_t1_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv1_0*MAS[1])-1 < c0_t1_t3_mem0*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c0_t1_t3_mem0*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c0_t1_t3_mem0*MAS_MEM[3]
	S += c0_t1_t3_mem0 <= c0_t1_t3

	c0_t1_t3_mem1 = S.Task('c0_t1_t3_mem1', length=1, delay_cost=1)
	c0_t1_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c0_t1_t3_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c0_t1_t3_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c0_t1_t3_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c0_t1_t3_mem1*MAS_MEM[3]
	...
	S += (c_qinv01*MAS[1])-1 < c0_t31_mem0*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c0_t31_mem0*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c0_t31_mem0*MAS_MEM[3]
	S += c0_t31_mem0 <= c0_t31

	c0_t31_mem1 = S.Task('c0_t31_mem1', length=1, delay_cost=1)
	c0_t31_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c0_t31_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c0_t31_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c0_t31_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c0_t31_mem1*MAS_MEM[3]
	...
	c0_t4_t0_mem0 += MAS_MEM[3]
	S += 90 < c0_t4_t0_mem0
	S += c0_t4_t0_mem0 <= c0_t4_t0

	c0_t4_t0_mem1 = S.Task('c0_t4_t0_mem1', length=1, delay_cost=1)
	c0_t4_t0_mem1 += alt(MAS_MEM)
	S += (c0_t30*MAS[0])-1 < c0_t4_t0_mem1*MAS_MEM[0]
	S += (c0_t30*MAS[1])-1 < c0_t4_t0_mem1*MAS_MEM[1]
	S += (c0_t30*MAS[2])-1 < c0_t4_t0_mem1*MAS_MEM[2]
	S += (c0_t30*MAS[3])-1 < c0_t4_t0_mem1*MAS_MEM[3]
	...
	c1_t0_t1_mem0 += MAS_MEM[3]
	S += 51 < c1_t0_t1_mem0
	S += c1_t0_t1_mem0 <= c1_t0_t1

	c1_t0_t1_mem1 = S.Task('c1_t0_t1_mem1', length=1, delay_cost=1)
	c1_t0_t1_mem1 += alt(MAS_MEM)
	S += (c_qinv01*MAS[0])-1 < c1_t0_t1_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c1_t0_t1_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c1_t0_t1_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c1_t0_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c1_t0_t3_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c1_t0_t3_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c1_t0_t3_mem0*MAS_MEM[3]
	S += c1_t0_t3_mem0 <= c1_t0_t3

	c1_t0_t3_mem1 = S.Task('c1_t0_t3_mem1', length=1, delay_cost=1)
	c1_t0_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv01*MAS[0])-1 < c1_t0_t3_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c1_t0_t3_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c1_t0_t3_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c1_t0_t3_mem1*MAS_MEM[3]
	...
	c1_t1_t1_mem0 += MAS_MEM[0]
	S += 91 < c1_t1_t1_mem0
	S += c1_t1_t1_mem0 <= c1_t1_t1

	c1_t1_t1_mem1 = S.Task('c1_t1_t1_mem1', length=1, delay_cost=1)
	c1_t1_t1_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c1_t1_t1_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c1_t1_t1_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c1_t1_t1_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c1_t1_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv1_0*MAS[1])-1 < c1_t1_t3_mem0*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c1_t1_t3_mem0*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c1_t1_t3_mem0*MAS_MEM[3]
	S += c1_t1_t3_mem0 <= c1_t1_t3

	c1_t1_t3_mem1 = S.Task('c1_t1_t3_mem1', length=1, delay_cost=1)
	c1_t1_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c1_t1_t3_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c1_t1_t3_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c1_t1_t3_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c1_t1_t3_mem1*MAS_MEM[3]
	...
	S += (c_qinv01*MAS[1])-1 < c1_t31_mem0*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c1_t31_mem0*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c1_t31_mem0*MAS_MEM[3]
	S += c1_t31_mem0 <= c1_t31

	c1_t31_mem1 = S.Task('c1_t31_mem1', length=1, delay_cost=1)
	c1_t31_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c1_t31_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c1_t31_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c1_t31_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c1_t31_mem1*MAS_MEM[3]
	...
	c1_t4_t0_mem0 += MAS_MEM[1]
	S += 93 < c1_t4_t0_mem0
	S += c1_t4_t0_mem0 <= c1_t4_t0

	c1_t4_t0_mem1 = S.Task('c1_t4_t0_mem1', length=1, delay_cost=1)
	c1_t4_t0_mem1 += alt(MAS_MEM)
	S += (c1_t30*MAS[0])-1 < c1_t4_t0_mem1*MAS_MEM[0]
	S += (c1_t30*MAS[1])-1 < c1_t4_t0_mem1*MAS_MEM[1]
	S += (c1_t30*MAS[2])-1 < c1_t4_t0_mem1*MAS_MEM[2]
	S += (c1_t30*MAS[3])-1 < c1_t4_t0_mem1*MAS_MEM[3]
	...
	S += (c_qinv01*MAS[0])-1 < c2_t0_t1_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c2_t0_t1_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c2_t0_t1_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c2_t0_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv00*MAS[1])-1 < c2_t0_t3_mem0*MAS_MEM[1]
	S += (c_qinv00*MAS[2])-1 < c2_t0_t3_mem0*MAS_MEM[2]
	S += (c_qinv00*MAS[3])-1 < c2_t0_t3_mem0*MAS_MEM[3]
	S += c2_t0_t3_mem0 <= c2_t0_t3

	c2_t0_t3_mem1 = S.Task('c2_t0_t3_mem1', length=1, delay_cost=1)
	c2_t0_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv01*MAS[0])-1 < c2_t0_t3_mem1*MAS_MEM[0]
	S += (c_qinv01*MAS[1])-1 < c2_t0_t3_mem1*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c2_t0_t3_mem1*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c2_t0_t3_mem1*MAS_MEM[3]
	...
	c2_t1_t1_mem0 += MAS_MEM[1]
	S += 73 < c2_t1_t1_mem0
	S += c2_t1_t1_mem0 <= c2_t1_t1

	c2_t1_t1_mem1 = S.Task('c2_t1_t1_mem1', length=1, delay_cost=1)
	c2_t1_t1_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c2_t1_t1_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c2_t1_t1_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c2_t1_t1_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c2_t1_t1_mem1*MAS_MEM[3]
	...
	S += (c_qinv1_0*MAS[1])-1 < c2_t1_t3_mem0*MAS_MEM[1]
	S += (c_qinv1_0*MAS[2])-1 < c2_t1_t3_mem0*MAS_MEM[2]
	S += (c_qinv1_0*MAS[3])-1 < c2_t1_t3_mem0*MAS_MEM[3]
	S += c2_t1_t3_mem0 <= c2_t1_t3

	c2_t1_t3_mem1 = S.Task('c2_t1_t3_mem1', length=1, delay_cost=1)
	c2_t1_t3_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c2_t1_t3_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c2_t1_t3_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c2_t1_t3_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c2_t1_t3_mem1*MAS_MEM[3]
	...
	S += (c_qinv01*MAS[1])-1 < c2_t31_mem0*MAS_MEM[1]
	S += (c_qinv01*MAS[2])-1 < c2_t31_mem0*MAS_MEM[2]
	S += (c_qinv01*MAS[3])-1 < c2_t31_mem0*MAS_MEM[3]
	S += c2_t31_mem0 <= c2_t31

	c2_t31_mem1 = S.Task('c2_t31_mem1', length=1, delay_cost=1)
	c2_t31_mem1 += alt(MAS_MEM)
	S += (c_qinv1_1*MAS[0])-1 < c2_t31_mem1*MAS_MEM[0]
	S += (c_qinv1_1*MAS[1])-1 < c2_t31_mem1*MAS_MEM[1]
	S += (c_qinv1_1*MAS[2])-1 < c2_t31_mem1*MAS_MEM[2]
	S += (c_qinv1_1*MAS[3])-1 < c2_t31_mem1*MAS_MEM[3]
	...
	c2_t4_t0_mem0 += MAS_MEM[3]
	S += 88 < c2_t4_t0_mem0
	S += c2_t4_t0_mem0 <= c2_t4_t0

	c2_t4_t0_mem1 = S.Task('c2_t4_t0_mem1', length=1, delay_cost=1)
	c2_t4_t0_mem1 += alt(MAS_MEM)
	S += (c2_t30*MAS[0])-1 < c2_t4_t0_mem1*MAS_MEM[0]
	S += (c2_t30*MAS[1])-1 < c2_t4_t0_mem1*MAS_MEM[1]
	S += (c2_t30*MAS[2])-1 < c2_t4_t0_mem1*MAS_MEM[2]
	S += (c2_t30*MAS[3])-1 < c2_t4_t0_mem1*MAS_MEM[3]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/INV/schedule11.png"
	if(S.solution() != []):
