...
def solve():
	...
	S += (c0_s00*MAS[0])-1 < c000_mem1*MAS_MEM[0]
	S += (c0_s00*MAS[1])-1 < c000_mem1*MAS_MEM[1]
	S += (c0_s00*MAS[2])-1 < c000_mem1*MAS_MEM[2]
	S += (c0_s00*MAS[3])-1 < c000_mem1*MAS_MEM[3]
	S += c000_mem1 <= c000
	...
	S += (c0_s01*MAS[0])-1 < c001_mem1*MAS_MEM[0]
	S += (c0_s01*MAS[1])-1 < c001_mem1*MAS_MEM[1]
	S += (c0_s01*MAS[2])-1 < c001_mem1*MAS_MEM[2]
	S += (c0_s01*MAS[3])-1 < c001_mem1*MAS_MEM[3]
	S += c001_mem1 <= c001
	...
	S += (c0_t41*MAS[1])-1 < c011_mem0*MAS_MEM[1]
	S += (c0_t41*MAS[2])-1 < c011_mem0*MAS_MEM[2]
	S += (c0_t41*MAS[3])-1 < c011_mem0*MAS_MEM[3]
	S += c011_mem0 <= c011

	c011_mem1 = S.Task('c011_mem1', length=1, delay_cost=1)
	c011_mem1 += alt(MAS_MEM)
	S += (c0_t51*MAS[0])-1 < c011_mem1*MAS_MEM[0]
	S += (c0_t51*MAS[1])-1 < c011_mem1*MAS_MEM[1]
	S += (c0_t51*MAS[2])-1 < c011_mem1*MAS_MEM[2]
	S += (c0_t51*MAS[3])-1 < c011_mem1*MAS_MEM[3]
	S += c011_mem1 <= c011
	...
	S += (c1_s00*MAS[0])-1 < c100_mem1*MAS_MEM[0]
	S += (c1_s00*MAS[1])-1 < c100_mem1*MAS_MEM[1]
	S += (c1_s00*MAS[2])-1 < c100_mem1*MAS_MEM[2]
	S += (c1_s00*MAS[3])-1 < c100_mem1*MAS_MEM[3]
	S += c100_mem1 <= c100
	...
	S += (c1_s01*MAS[0])-1 < c101_mem1*MAS_MEM[0]
	S += (c1_s01*MAS[1])-1 < c101_mem1*MAS_MEM[1]
	S += (c1_s01*MAS[2])-1 < c101_mem1*MAS_MEM[2]
	S += (c1_s01*MAS[3])-1 < c101_mem1*MAS_MEM[3]
	S += c101_mem1 <= c101
	...
	S += (c1_t41*MAS[1])-1 < c111_mem0*MAS_MEM[1]
	S += (c1_t41*MAS[2])-1 < c111_mem0*MAS_MEM[2]
	S += (c1_t41*MAS[3])-1 < c111_mem0*MAS_MEM[3]
	S += c111_mem0 <= c111

	c111_mem1 = S.Task('c111_mem1', length=1, delay_cost=1)
	c111_mem1 += alt(MAS_MEM)
	S += (c1_t51*MAS[0])-1 < c111_mem1*MAS_MEM[0]
	S += (c1_t51*MAS[1])-1 < c111_mem1*MAS_MEM[1]
	S += (c1_t51*MAS[2])-1 < c111_mem1*MAS_MEM[2]
	S += (c1_t51*MAS[3])-1 < c111_mem1*MAS_MEM[3]
	S += c111_mem1 <= c111
	...
	S += (c2_s00*MAS[0])-1 < c200_mem1*MAS_MEM[0]
	S += (c2_s00*MAS[1])-1 < c200_mem1*MAS_MEM[1]
	S += (c2_s00*MAS[2])-1 < c200_mem1*MAS_MEM[2]
	S += (c2_s00*MAS[3])-1 < c200_mem1*MAS_MEM[3]
	S += c200_mem1 <= c200
	...
	S += (c2_s01*MAS[0])-1 < c201_mem1*MAS_MEM[0]
	S += (c2_s01*MAS[1])-1 < c201_mem1*MAS_MEM[1]
	S += (c2_s01*MAS[2])-1 < c201_mem1*MAS_MEM[2]
	S += (c2_s01*MAS[3])-1 < c201_mem1*MAS_MEM[3]
	S += c201_mem1 <= c201
	...
	S += (c2_t41*MAS[1])-1 < c211_mem0*MAS_MEM[1]
	S += (c2_t41*MAS[2])-1 < c211_mem0*MAS_MEM[2]
	S += (c2_t41*MAS[3])-1 < c211_mem0*MAS_MEM[3]
	S += c211_mem0 <= c211

	c211_mem1 = S.Task('c211_mem1', length=1, delay_cost=1)
	c211_mem1 += alt(MAS_MEM)
	S += (c2_t51*MAS[0])-1 < c211_mem1*MAS_MEM[0]
	S += (c2_t51*MAS[1])-1 < c211_mem1*MAS_MEM[1]
	S += (c2_t51*MAS[2])-1 < c211_mem1*MAS_MEM[2]
	S += (c2_t51*MAS[3])-1 < c211_mem1*MAS_MEM[3]
	S += c211_mem1 <= c211
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/INV/schedule13.png"
	if(S.solution() != []):
