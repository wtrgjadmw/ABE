...
def solve():
	...
	S += c_t6000_mem0 >= 28
	c_t6000_mem0 += MAS_MEM[3]

	c_t6000_mem1 = S.Task('c_t6000_mem1', length=1, delay_cost=1)
	S += c_t6000_mem1 >= 28
	c_t6000_mem1 += MAS_MEM[2]
	...
	S += c_t7011_mem0 >= 57
	c_t7011_mem0 += MAS_MEM[3]

	c_t7011_mem1 = S.Task('c_t7011_mem1', length=1, delay_cost=1)
	S += c_t7011_mem1 >= 57
	c_t7011_mem1 += MAS_MEM[2]
	...
	S += (c_t600*MAS[1])-1 < c100_mem0*MAS_MEM[1]
	S += (c_t600*MAS[2])-1 < c100_mem0*MAS_MEM[2]
	S += (c_t600*MAS[3])-1 < c100_mem0*MAS_MEM[3]
	S += c100_mem0 <= c100
	...
	S += (c_t601*MAS[1])-1 < c101_mem0*MAS_MEM[1]
	S += (c_t601*MAS[2])-1 < c101_mem0*MAS_MEM[2]
	S += (c_t601*MAS[3])-1 < c101_mem0*MAS_MEM[3]
	S += c101_mem0 <= c101
	...
	S += (c_t611*MAS[1])-1 < c111_mem0*MAS_MEM[1]
	S += (c_t611*MAS[2])-1 < c111_mem0*MAS_MEM[2]
	S += (c_t611*MAS[3])-1 < c111_mem0*MAS_MEM[3]
	S += c111_mem0 <= c111
	...
	c_t7_y1_0_mem0 += MAS_MEM[1]
	S += 83 < c_t7_y1_0_mem0
	S += c_t7_y1_0_mem0 <= c_t7_y1_0

	c_t7_y1_0_mem1 = S.Task('c_t7_y1_0_mem1', length=1, delay_cost=1)
	c_t7_y1_0_mem1 += alt(MAS_MEM)
	S += (c_t7111*MAS[0])-1 < c_t7_y1_0_mem1*MAS_MEM[0]
	S += (c_t7111*MAS[1])-1 < c_t7_y1_0_mem1*MAS_MEM[1]
	S += (c_t7111*MAS[2])-1 < c_t7_y1_0_mem1*MAS_MEM[2]
	S += (c_t7111*MAS[3])-1 < c_t7_y1_0_mem1*MAS_MEM[3]
	...
	S += (c_t7111*MAS[1])-1 < c_t7_y1_1_mem0*MAS_MEM[1]
	S += (c_t7111*MAS[2])-1 < c_t7_y1_1_mem0*MAS_MEM[2]
	S += (c_t7111*MAS[3])-1 < c_t7_y1_1_mem0*MAS_MEM[3]
	...
	S += (c_t7100*MAS[0])-1 < c010_mem1*MAS_MEM[0]
	S += (c_t7100*MAS[1])-1 < c010_mem1*MAS_MEM[1]
	S += (c_t7100*MAS[2])-1 < c010_mem1*MAS_MEM[2]
	S += (c_t7100*MAS[3])-1 < c010_mem1*MAS_MEM[3]
	S += c010_mem1 <= c010
	...
	S += (c_t7101*MAS[0])-1 < c011_mem1*MAS_MEM[0]
	S += (c_t7101*MAS[1])-1 < c011_mem1*MAS_MEM[1]
	S += (c_t7101*MAS[2])-1 < c011_mem1*MAS_MEM[2]
	S += (c_t7101*MAS[3])-1 < c011_mem1*MAS_MEM[3]
	S += c011_mem1 <= c011
	...
	S += (c_t800*MAS[1])-1 < c200_mem0*MAS_MEM[1]
	S += (c_t800*MAS[2])-1 < c200_mem0*MAS_MEM[2]
	S += (c_t800*MAS[3])-1 < c200_mem0*MAS_MEM[3]
	S += c200_mem0 <= c200
	...
	S += (c_t801*MAS[1])-1 < c201_mem0*MAS_MEM[1]
	S += (c_t801*MAS[2])-1 < c201_mem0*MAS_MEM[2]
	S += (c_t801*MAS[3])-1 < c201_mem0*MAS_MEM[3]
	S += c201_mem0 <= c201
	...
	S += (c_t811*MAS[1])-1 < c211_mem0*MAS_MEM[1]
	S += (c_t811*MAS[2])-1 < c211_mem0*MAS_MEM[2]
	S += (c_t811*MAS[3])-1 < c211_mem0*MAS_MEM[3]
	S += c211_mem0 <= c211
	...
	S += (c_t7_y1_0*MAS[0])-1 < c000_mem1*MAS_MEM[0]
	S += (c_t7_y1_0*MAS[1])-1 < c000_mem1*MAS_MEM[1]
	S += (c_t7_y1_0*MAS[2])-1 < c000_mem1*MAS_MEM[2]
	S += (c_t7_y1_0*MAS[3])-1 < c000_mem1*MAS_MEM[3]
	S += c000_mem1 <= c000
	...
	S += (c_t7_y1_1*MAS[0])-1 < c001_mem1*MAS_MEM[0]
	S += (c_t7_y1_1*MAS[1])-1 < c001_mem1*MAS_MEM[1]
	S += (c_t7_y1_1*MAS[2])-1 < c001_mem1*MAS_MEM[2]
	S += (c_t7_y1_1*MAS[3])-1 < c001_mem1*MAS_MEM[3]
	S += c001_mem1 <= c001
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/MUL/schedule8.png"
	if(S.solution() != []):
