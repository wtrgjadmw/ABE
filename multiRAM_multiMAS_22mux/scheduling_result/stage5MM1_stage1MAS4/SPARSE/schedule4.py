...
def solve():
	...
	S += t4_t1_t4_mem1 >= 16
	t4_t1_t4_mem1 += MAS_MEM[0]

	t1_t2_mem0 = S.Task('t1_t2_mem0', length=1, delay_cost=1)
	S += t1_t2_mem0 >= 17
	t1_t2_mem0 += MAIN_MEM_r

	t1_t2_mem1 = S.Task('t1_t2_mem1', length=1, delay_cost=1)
	S += t1_t2_mem1 >= 17
	t1_t2_mem1 += MAIN_MEM_r
	...
	S += t0_t4_mem0 >= 19
	t0_t4_mem0 += MAS_MEM[3]

	t0_t4_mem1 = S.Task('t0_t4_mem1', length=1, delay_cost=1)
	S += t0_t4_mem1 >= 19
	t0_t4_mem1 += MAS_MEM[0]
	...
	S += t4_t2_t1_mem0 >= 22
	t4_t2_t1_mem0 += MAIN_MEM_r

	t4_t2_t1_mem1 = S.Task('t4_t2_t1_mem1', length=1, delay_cost=1)
	S += t4_t2_t1_mem1 >= 22
	t4_t2_t1_mem1 += MAIN_MEM_r
	...
	S += t4_t2_t0_mem0 >= 23
	t4_t2_t0_mem0 += MAIN_MEM_r

	t4_t2_t0_mem1 = S.Task('t4_t2_t0_mem1', length=1, delay_cost=1)
	S += t4_t2_t0_mem1 >= 23
	t4_t2_t0_mem1 += MAIN_MEM_r
	...
	S += t100_mem0 >= 24
	t100_mem0 += MAIN_MEM_r

	t100_mem1 = S.Task('t100_mem1', length=1, delay_cost=1)
	S += t100_mem1 >= 24
	t100_mem1 += MAIN_MEM_r
	...
	S += t4_t2_t3_mem0 >= 27
	t4_t2_t3_mem0 += MAIN_MEM_r

	t4_t2_t3_mem1 = S.Task('t4_t2_t3_mem1', length=1, delay_cost=1)
	S += t4_t2_t3_mem1 >= 27
	t4_t2_t3_mem1 += MAIN_MEM_r
	...
	S += t4_t50_mem0 >= 29
	t4_t50_mem0 += MAIN_MEM_r

	t4_t50_mem1 = S.Task('t4_t50_mem1', length=1, delay_cost=1)
	S += t4_t50_mem1 >= 29
	t4_t50_mem1 += MAIN_MEM_r
	...
	S += t4_t51_mem0 >= 32
	t4_t51_mem0 += MAIN_MEM_r

	t4_t51_mem1 = S.Task('t4_t51_mem1', length=1, delay_cost=1)
	S += t4_t51_mem1 >= 32
	t4_t51_mem1 += MAIN_MEM_r
	...
	S += t101_mem0 >= 34
	t101_mem0 += MAIN_MEM_r

	t101_mem1 = S.Task('t101_mem1', length=1, delay_cost=1)
	S += t101_mem1 >= 34
	t101_mem1 += MAIN_MEM_r
	...
	S += t4_t2_t2_mem0 >= 37
	t4_t2_t2_mem0 += MAIN_MEM_r

	t4_t2_t2_mem1 = S.Task('t4_t2_t2_mem1', length=1, delay_cost=1)
	S += t4_t2_t2_mem1 >= 37
	t4_t2_t2_mem1 += MAIN_MEM_r
	...
	S += t5_t0_t2_mem0 >= 41
	t5_t0_t2_mem0 += MAIN_MEM_r

	t5_t0_t2_mem1 = S.Task('t5_t0_t2_mem1', length=1, delay_cost=1)
	S += t5_t0_t2_mem1 >= 41
	t5_t0_t2_mem1 += MAIN_MEM_r
	...
	S += t5_t0_t1_mem0 >= 43
	t5_t0_t1_mem0 += MAIN_MEM_r

	t5_t0_t1_mem1 = S.Task('t5_t0_t1_mem1', length=1, delay_cost=1)
	S += t5_t0_t1_mem1 >= 43
	t5_t0_t1_mem1 += MAS_MEM[2]
	...
	S += t5_t40_mem0 >= 44
	t5_t40_mem0 += MAIN_MEM_r

	t5_t40_mem1 = S.Task('t5_t40_mem1', length=1, delay_cost=1)
	S += t5_t40_mem1 >= 44
	t5_t40_mem1 += MAS_MEM[0]
	...
	S += t5_t0_t0_mem0 >= 45
	t5_t0_t0_mem0 += MAIN_MEM_r

	t5_t0_t0_mem1 = S.Task('t5_t0_t0_mem1', length=1, delay_cost=1)
	S += t5_t0_t0_mem1 >= 45
	t5_t0_t0_mem1 += MAS_MEM[0]
	...
	S += t5_t41_mem0 >= 45
	t5_t41_mem0 += MAIN_MEM_r

	t5_t41_mem1 = S.Task('t5_t41_mem1', length=1, delay_cost=1)
	S += t5_t41_mem1 >= 45
	t5_t41_mem1 += MAS_MEM[0]
	...
	S += (t01*MAS[0])-1 < t30_mem1*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t30_mem1*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t30_mem1*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t30_mem1*MAS_MEM[3]
	S += t30_mem1 <= t30
	...
	S += (t01*MAS[1])-1 < t31_mem0*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t31_mem0*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t31_mem0*MAS_MEM[3]
	S += t31_mem0 <= t31
	...
	S += (t4_t21*MAS[0])-1 < t4_t100_mem1*MAS_MEM[0]
	S += (t4_t21*MAS[1])-1 < t4_t100_mem1*MAS_MEM[1]
	S += (t4_t21*MAS[2])-1 < t4_t100_mem1*MAS_MEM[2]
	S += (t4_t21*MAS[3])-1 < t4_t100_mem1*MAS_MEM[3]
	...
	S += (t4_t21*MAS[1])-1 < t4_t101_mem0*MAS_MEM[1]
	S += (t4_t21*MAS[2])-1 < t4_t101_mem0*MAS_MEM[2]
	S += (t4_t21*MAS[3])-1 < t4_t101_mem0*MAS_MEM[3]
	S += t4_t101_mem0 <= t4_t101

	t4_t101_mem1 = S.Task('t4_t101_mem1', length=1, delay_cost=1)
	t4_t101_mem1 += MAS_MEM[0]
	S += 29 < t4_t101_mem1
	...
	S += (t4_t6_t5*MAS[0])-1 < t4_t61_mem1*MAS_MEM[0]
	S += (t4_t6_t5*MAS[1])-1 < t4_t61_mem1*MAS_MEM[1]
	S += (t4_t6_t5*MAS[2])-1 < t4_t61_mem1*MAS_MEM[2]
	S += (t4_t6_t5*MAS[3])-1 < t4_t61_mem1*MAS_MEM[3]
	...
	S += (t4_t01*MAS[1])-1 < t4_t71_mem0*MAS_MEM[1]
	S += (t4_t01*MAS[2])-1 < t4_t71_mem0*MAS_MEM[2]
	S += (t4_t01*MAS[3])-1 < t4_t71_mem0*MAS_MEM[3]
	S += t4_t71_mem0 <= t4_t71

	t4_t71_mem1 = S.Task('t4_t71_mem1', length=1, delay_cost=1)
	t4_t71_mem1 += alt(MAS_MEM)
	S += (t4_t11*MAS[0])-1 < t4_t71_mem1*MAS_MEM[0]
	S += (t4_t11*MAS[1])-1 < t4_t71_mem1*MAS_MEM[1]
	S += (t4_t11*MAS[2])-1 < t4_t71_mem1*MAS_MEM[2]
	S += (t4_t11*MAS[3])-1 < t4_t71_mem1*MAS_MEM[3]
	...
	S += (t4_t60*MAS[1])-1 < t410_mem0*MAS_MEM[1]
	S += (t4_t60*MAS[2])-1 < t410_mem0*MAS_MEM[2]
	S += (t4_t60*MAS[3])-1 < t410_mem0*MAS_MEM[3]
	S += t410_mem0 <= t410

	t410_mem1 = S.Task('t410_mem1', length=1, delay_cost=1)
	t410_mem1 += alt(MAS_MEM)
	S += (t4_t70*MAS[0])-1 < t410_mem1*MAS_MEM[0]
	S += (t4_t70*MAS[1])-1 < t410_mem1*MAS_MEM[1]
	S += (t4_t70*MAS[2])-1 < t410_mem1*MAS_MEM[2]
	S += (t4_t70*MAS[3])-1 < t410_mem1*MAS_MEM[3]
	S += t410_mem1 <= t410
	...
	S += (t4_t81*MAS[1])-1 < t421_mem0*MAS_MEM[1]
	S += (t4_t81*MAS[2])-1 < t421_mem0*MAS_MEM[2]
	S += (t4_t81*MAS[3])-1 < t421_mem0*MAS_MEM[3]
	S += t421_mem0 <= t421

	t421_mem1 = S.Task('t421_mem1', length=1, delay_cost=1)
	t421_mem1 += alt(MAS_MEM)
	S += (t4_t11*MAS[0])-1 < t421_mem1*MAS_MEM[0]
	S += (t4_t11*MAS[1])-1 < t421_mem1*MAS_MEM[1]
	S += (t4_t11*MAS[2])-1 < t421_mem1*MAS_MEM[2]
	S += (t4_t11*MAS[3])-1 < t421_mem1*MAS_MEM[3]
	S += t421_mem1 <= t421
	...
	S += (t5_t0_t5*MAS[0])-1 < t5_t01_mem1*MAS_MEM[0]
	S += (t5_t0_t5*MAS[1])-1 < t5_t01_mem1*MAS_MEM[1]
	S += (t5_t0_t5*MAS[2])-1 < t5_t01_mem1*MAS_MEM[2]
	S += (t5_t0_t5*MAS[3])-1 < t5_t01_mem1*MAS_MEM[3]
	...
	S += (t5_t1_t5*MAS[0])-1 < t5_t11_mem1*MAS_MEM[0]
	S += (t5_t1_t5*MAS[1])-1 < t5_t11_mem1*MAS_MEM[1]
	S += (t5_t1_t5*MAS[2])-1 < t5_t11_mem1*MAS_MEM[2]
	S += (t5_t1_t5*MAS[3])-1 < t5_t11_mem1*MAS_MEM[3]
	...
	S += (t5_t2_t5*MAS[0])-1 < t5_t21_mem1*MAS_MEM[0]
	S += (t5_t2_t5*MAS[1])-1 < t5_t21_mem1*MAS_MEM[1]
	S += (t5_t2_t5*MAS[2])-1 < t5_t21_mem1*MAS_MEM[2]
	S += (t5_t2_t5*MAS[3])-1 < t5_t21_mem1*MAS_MEM[3]
	...
	S += (t5_t6_t2*MAS[1])-1 < t5_t6_t4_mem0*MAS_MEM[1]
	S += (t5_t6_t2*MAS[2])-1 < t5_t6_t4_mem0*MAS_MEM[2]
	S += (t5_t6_t2*MAS[3])-1 < t5_t6_t4_mem0*MAS_MEM[3]
	S += t5_t6_t4_mem0 <= t5_t6_t4

	t5_t6_t4_mem1 = S.Task('t5_t6_t4_mem1', length=1, delay_cost=1)
	t5_t6_t4_mem1 += alt(MAS_MEM)
	S += (t5_t6_t3*MAS[0])-1 < t5_t6_t4_mem1*MAS_MEM[0]
	S += (t5_t6_t3*MAS[1])-1 < t5_t6_t4_mem1*MAS_MEM[1]
	S += (t5_t6_t3*MAS[2])-1 < t5_t6_t4_mem1*MAS_MEM[2]
	S += (t5_t6_t3*MAS[3])-1 < t5_t6_t4_mem1*MAS_MEM[3]
	...
	S += (t5_t6_t1*MM[0])-1 < t5_t60_mem1*MM_MEM[0]
	...
	S += (t5_t6_t1*MM[0])-1 < t5_t6_t5_mem1*MM_MEM[0]
	...
	S += (t5_t00*MAS[1])-1 < t5_t70_mem0*MAS_MEM[1]
	S += (t5_t00*MAS[2])-1 < t5_t70_mem0*MAS_MEM[2]
	S += (t5_t00*MAS[3])-1 < t5_t70_mem0*MAS_MEM[3]
	S += t5_t70_mem0 <= t5_t70

	t5_t70_mem1 = S.Task('t5_t70_mem1', length=1, delay_cost=1)
	t5_t70_mem1 += alt(MAS_MEM)
	S += (t5_t10*MAS[0])-1 < t5_t70_mem1*MAS_MEM[0]
	S += (t5_t10*MAS[1])-1 < t5_t70_mem1*MAS_MEM[1]
	S += (t5_t10*MAS[2])-1 < t5_t70_mem1*MAS_MEM[2]
	S += (t5_t10*MAS[3])-1 < t5_t70_mem1*MAS_MEM[3]
	...
	S += (t5_t8_t5*MAS[0])-1 < t5_t81_mem1*MAS_MEM[0]
	S += (t5_t8_t5*MAS[1])-1 < t5_t81_mem1*MAS_MEM[1]
	S += (t5_t8_t5*MAS[2])-1 < t5_t81_mem1*MAS_MEM[2]
	S += (t5_t8_t5*MAS[3])-1 < t5_t81_mem1*MAS_MEM[3]
	...
	S += (t5_t80*MAS[1])-1 < t520_mem0*MAS_MEM[1]
	S += (t5_t80*MAS[2])-1 < t520_mem0*MAS_MEM[2]
	S += (t5_t80*MAS[3])-1 < t520_mem0*MAS_MEM[3]
	S += t520_mem0 <= t520

	t520_mem1 = S.Task('t520_mem1', length=1, delay_cost=1)
	t520_mem1 += alt(MAS_MEM)
	S += (t5_t10*MAS[0])-1 < t520_mem1*MAS_MEM[0]
	S += (t5_t10*MAS[1])-1 < t520_mem1*MAS_MEM[1]
	S += (t5_t10*MAS[2])-1 < t520_mem1*MAS_MEM[2]
	S += (t5_t10*MAS[3])-1 < t520_mem1*MAS_MEM[3]
	S += t520_mem1 <= t520
	...
	S += (t420*MAS[0])-1 < t160_mem1*MAS_MEM[0]
	S += (t420*MAS[1])-1 < t160_mem1*MAS_MEM[1]
	S += (t420*MAS[2])-1 < t160_mem1*MAS_MEM[2]
	S += (t420*MAS[3])-1 < t160_mem1*MAS_MEM[3]
	S += t160_mem1 <= t160
	...
	S += (t21*MAS[0])-1 < t170_mem1*MAS_MEM[0]
	S += (t21*MAS[1])-1 < t170_mem1*MAS_MEM[1]
	S += (t21*MAS[2])-1 < t170_mem1*MAS_MEM[2]
	S += (t21*MAS[3])-1 < t170_mem1*MAS_MEM[3]
	S += t170_mem1 <= t170
	...
	S += (t21*MAS[1])-1 < t171_mem0*MAS_MEM[1]
	S += (t21*MAS[2])-1 < t171_mem0*MAS_MEM[2]
	S += (t21*MAS[3])-1 < t171_mem0*MAS_MEM[3]
	S += t171_mem0 <= t171
	...
	S += (t420*MAS[0])-1 < c110_mem1*MAS_MEM[0]
	S += (t420*MAS[1])-1 < c110_mem1*MAS_MEM[1]
	S += (t420*MAS[2])-1 < c110_mem1*MAS_MEM[2]
	S += (t420*MAS[3])-1 < c110_mem1*MAS_MEM[3]
	S += c110_mem1 <= c110
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/SPARSE/schedule4.png"
	if(S.solution() != []):
