...
def solve():
	...
	t521_mem0 += alt(MAS_MEM)
	S += (t5_t81*MAS[0])-1 < t521_mem0*MAS_MEM[0]
	S += (t5_t81*MAS[1])-1 < t521_mem0*MAS_MEM[1]
	S += (t5_t81*MAS[2])-1 < t521_mem0*MAS_MEM[2]
	S += (t5_t81*MAS[3])-1 < t521_mem0*MAS_MEM[3]
	S += t521_mem0 <= t521
	...
	S += (t5_t100*MAS[0])-1 < t500_mem1*MAS_MEM[0]
	S += (t5_t100*MAS[1])-1 < t500_mem1*MAS_MEM[1]
	S += (t5_t100*MAS[2])-1 < t500_mem1*MAS_MEM[2]
	S += (t5_t100*MAS[3])-1 < t500_mem1*MAS_MEM[3]
	S += t500_mem1 <= t500
	...
	S += (t5_t101*MAS[0])-1 < t501_mem1*MAS_MEM[0]
	S += (t5_t101*MAS[1])-1 < t501_mem1*MAS_MEM[1]
	S += (t5_t101*MAS[2])-1 < t501_mem1*MAS_MEM[2]
	S += (t5_t101*MAS[3])-1 < t501_mem1*MAS_MEM[3]
	S += t501_mem1 <= t501
	...
	S += (t5_t61*MAS[1])-1 < t511_mem0*MAS_MEM[1]
	S += (t5_t61*MAS[2])-1 < t511_mem0*MAS_MEM[2]
	S += (t5_t61*MAS[3])-1 < t511_mem0*MAS_MEM[3]
	S += t511_mem0 <= t511

	t511_mem1 = S.Task('t511_mem1', length=1, delay_cost=1)
	t511_mem1 += alt(MAS_MEM)
	S += (t5_t71*MAS[0])-1 < t511_mem1*MAS_MEM[0]
	S += (t5_t71*MAS[1])-1 < t511_mem1*MAS_MEM[1]
	S += (t5_t71*MAS[2])-1 < t511_mem1*MAS_MEM[2]
	S += (t5_t71*MAS[3])-1 < t511_mem1*MAS_MEM[3]
	S += t511_mem1 <= t511
	...
	S += (t400*MAS[0])-1 < t140_mem1*MAS_MEM[0]
	S += (t400*MAS[1])-1 < t140_mem1*MAS_MEM[1]
	S += (t400*MAS[2])-1 < t140_mem1*MAS_MEM[2]
	S += (t400*MAS[3])-1 < t140_mem1*MAS_MEM[3]
	S += t140_mem1 <= t140
	...
	S += (t401*MAS[0])-1 < t141_mem1*MAS_MEM[0]
	S += (t401*MAS[1])-1 < t141_mem1*MAS_MEM[1]
	S += (t401*MAS[2])-1 < t141_mem1*MAS_MEM[2]
	S += (t401*MAS[3])-1 < t141_mem1*MAS_MEM[3]
	S += t141_mem1 <= t141
	...
	S += (t411*MAS[0])-1 < t151_mem1*MAS_MEM[0]
	S += (t411*MAS[1])-1 < t151_mem1*MAS_MEM[1]
	S += (t411*MAS[2])-1 < t151_mem1*MAS_MEM[2]
	S += (t411*MAS[3])-1 < t151_mem1*MAS_MEM[3]
	S += t151_mem1 <= t151
	...
	S += (t510*MAS[1])-1 < c010_mem0*MAS_MEM[1]
	S += (t510*MAS[2])-1 < c010_mem0*MAS_MEM[2]
	S += (t510*MAS[3])-1 < c010_mem0*MAS_MEM[3]
	S += c010_mem0 <= c010

	c010_mem1 = S.Task('c010_mem1', length=1, delay_cost=1)
	c010_mem1 += alt(MAS_MEM)
	S += (t150*MAS[0])-1 < c010_mem1*MAS_MEM[0]
	S += (t150*MAS[1])-1 < c010_mem1*MAS_MEM[1]
	S += (t150*MAS[2])-1 < c010_mem1*MAS_MEM[2]
	S += (t150*MAS[3])-1 < c010_mem1*MAS_MEM[3]
	S += c010_mem1 <= c010
	...
	S += (t521*MAS[1])-1 < c211_mem0*MAS_MEM[1]
	S += (t521*MAS[2])-1 < c211_mem0*MAS_MEM[2]
	S += (t521*MAS[3])-1 < c211_mem0*MAS_MEM[3]
	S += c211_mem0 <= c211

	c211_mem1 = S.Task('c211_mem1', length=1, delay_cost=1)
	c211_mem1 += alt(MAS_MEM)
	S += (t161*MAS[0])-1 < c211_mem1*MAS_MEM[0]
	S += (t161*MAS[1])-1 < c211_mem1*MAS_MEM[1]
	S += (t161*MAS[2])-1 < c211_mem1*MAS_MEM[2]
	S += (t161*MAS[3])-1 < c211_mem1*MAS_MEM[3]
	S += c211_mem1 <= c211
	...
	S += (t400*MAS[0])-1 < c000_mem1*MAS_MEM[0]
	S += (t400*MAS[1])-1 < c000_mem1*MAS_MEM[1]
	S += (t400*MAS[2])-1 < c000_mem1*MAS_MEM[2]
	S += (t400*MAS[3])-1 < c000_mem1*MAS_MEM[3]
	S += c000_mem1 <= c000
	...
	S += (t401*MAS[0])-1 < c001_mem1*MAS_MEM[0]
	S += (t401*MAS[1])-1 < c001_mem1*MAS_MEM[1]
	S += (t401*MAS[2])-1 < c001_mem1*MAS_MEM[2]
	S += (t401*MAS[3])-1 < c001_mem1*MAS_MEM[3]
	S += c001_mem1 <= c001
	...
	S += (t411*MAS[0])-1 < c201_mem1*MAS_MEM[0]
	S += (t411*MAS[1])-1 < c201_mem1*MAS_MEM[1]
	S += (t411*MAS[2])-1 < c201_mem1*MAS_MEM[2]
	S += (t411*MAS[3])-1 < c201_mem1*MAS_MEM[3]
	S += c201_mem1 <= c201
	...
	S += (t500*MAS[1])-1 < c100_mem0*MAS_MEM[1]
	S += (t500*MAS[2])-1 < c100_mem0*MAS_MEM[2]
	S += (t500*MAS[3])-1 < c100_mem0*MAS_MEM[3]
	S += c100_mem0 <= c100

	c100_mem1 = S.Task('c100_mem1', length=1, delay_cost=1)
	c100_mem1 += alt(MAS_MEM)
	S += (t140*MAS[0])-1 < c100_mem1*MAS_MEM[0]
	S += (t140*MAS[1])-1 < c100_mem1*MAS_MEM[1]
	S += (t140*MAS[2])-1 < c100_mem1*MAS_MEM[2]
	S += (t140*MAS[3])-1 < c100_mem1*MAS_MEM[3]
	S += c100_mem1 <= c100
	...
	S += (t501*MAS[1])-1 < c101_mem0*MAS_MEM[1]
	S += (t501*MAS[2])-1 < c101_mem0*MAS_MEM[2]
	S += (t501*MAS[3])-1 < c101_mem0*MAS_MEM[3]
	S += c101_mem0 <= c101

	c101_mem1 = S.Task('c101_mem1', length=1, delay_cost=1)
	c101_mem1 += alt(MAS_MEM)
	S += (t141*MAS[0])-1 < c101_mem1*MAS_MEM[0]
	S += (t141*MAS[1])-1 < c101_mem1*MAS_MEM[1]
	S += (t141*MAS[2])-1 < c101_mem1*MAS_MEM[2]
	S += (t141*MAS[3])-1 < c101_mem1*MAS_MEM[3]
	S += c101_mem1 <= c101
	...
	S += (t511*MAS[1])-1 < c011_mem0*MAS_MEM[1]
	S += (t511*MAS[2])-1 < c011_mem0*MAS_MEM[2]
	S += (t511*MAS[3])-1 < c011_mem0*MAS_MEM[3]
	S += c011_mem0 <= c011

	c011_mem1 = S.Task('c011_mem1', length=1, delay_cost=1)
	c011_mem1 += alt(MAS_MEM)
	S += (t151*MAS[0])-1 < c011_mem1*MAS_MEM[0]
	S += (t151*MAS[1])-1 < c011_mem1*MAS_MEM[1]
	S += (t151*MAS[2])-1 < c011_mem1*MAS_MEM[2]
	S += (t151*MAS[3])-1 < c011_mem1*MAS_MEM[3]
	S += c011_mem1 <= c011
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/SPARSE/schedule5.png"
	if(S.solution() != []):
