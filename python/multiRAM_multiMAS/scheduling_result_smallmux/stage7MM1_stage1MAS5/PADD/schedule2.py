...
def solve():
	...
	S += (t6_t3*MAS[4])-1 < t6_t4_mem1*MAS_MEM[9]
	S += t6_t4_mem1 <= t6_t4
	...
	S += (t7_t3*MAS[4])-1 < t7_t4_mem1*MAS_MEM[9]
	S += t7_t4_mem1 <= t7_t4
	...
	S += (t9_t3*MAS[4])-1 < t9_t4_mem1*MAS_MEM[9]
	S += t9_t4_mem1 <= t9_t4
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage7MM1_stage1MAS5/PADD/schedule2.png"
	if(S.solution() != []):
