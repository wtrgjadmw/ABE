...
def solve():
	...
	S += (c_pbc_t4_t2*MAS[4])-1 < c_pbc_t4_t4_mem0*MAS_MEM[8]
	...
	S += (c_pcb_t0_t5*MAS[4])-1 < c_pcb_t01_mem1*MAS_MEM[9]
	...
	S += (c_pcb_t4_t2*MAS[4])-1 < c_pcb_t4_t4_mem0*MAS_MEM[8]
	...
	S += (c_pcb_t11*MAS[4])-1 < c_pcb_s00_mem1*MAS_MEM[9]
	...
	S += (c_pcb_t11*MAS[4])-1 < c_pcb_s01_mem0*MAS_MEM[8]
	...
	S += (c_pcb_t00*MAS[4])-1 < c_pcb_t50_mem0*MAS_MEM[8]
	...
	S += (c_paa_t0_t5*MAS[4])-1 < c_paa_t01_mem1*MAS_MEM[9]
	...
	S += (c_paa_t4_t2*MAS[4])-1 < c_paa_t4_t4_mem0*MAS_MEM[8]
	...
	S += (c_paa_t11*MAS[4])-1 < c_paa_s00_mem1*MAS_MEM[9]
	...
	S += (c_paa_t11*MAS[4])-1 < c_paa_s01_mem0*MAS_MEM[8]
	...
	S += (c_paa_t00*MAS[4])-1 < c_paa_t50_mem0*MAS_MEM[8]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage7MM1_stage1MAS5/INV/schedule9.png"
	if(S.solution() != []):
