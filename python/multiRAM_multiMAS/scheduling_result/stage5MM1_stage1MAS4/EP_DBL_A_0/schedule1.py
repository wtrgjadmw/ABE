...
def solve():
	...
	S += (t5*MAS[1])-1 < t6_mem0*MAS_MEM[1]
	S += (t5*MAS[2])-1 < t6_mem0*MAS_MEM[2]
	S += (t5*MAS[3])-1 < t6_mem0*MAS_MEM[3]
	S += t6_mem0 <= t6
	...
	S += (t6*MAS[1])-1 < t7_mem0*MAS_MEM[1]
	S += (t6*MAS[2])-1 < t7_mem0*MAS_MEM[2]
	S += (t6*MAS[3])-1 < t7_mem0*MAS_MEM[3]
	S += t7_mem0 <= t7
	...
	S += (t10*MAS[1])-1 < t11_mem0*MAS_MEM[1]
	S += (t10*MAS[2])-1 < t11_mem0*MAS_MEM[2]
	S += (t10*MAS[3])-1 < t11_mem0*MAS_MEM[3]
	S += t11_mem0 <= t11

	t11_mem1 = S.Task('t11_mem1', length=1, delay_cost=1)
	t11_mem1 += alt(MM_MEM)
	S += (t4*MM[0])-1 < t11_mem1*MM_MEM[0]
	S += t11_mem1 <= t11
	...
	t8_mem1 += alt(MAS_MEM)
	S += (t7*MAS[0])-1 < t8_mem1*MAS_MEM[0]
	S += (t7*MAS[1])-1 < t8_mem1*MAS_MEM[1]
	S += (t7*MAS[2])-1 < t8_mem1*MAS_MEM[2]
	S += (t7*MAS[3])-1 < t8_mem1*MAS_MEM[3]
	S += t8_mem1 <= t8

	new_PZ_in = S.Task('new_PZ_in', length=1, delay_cost=1)
	new_PZ_in += alt(MM_in)
	new_PZ = S.Task('new_PZ', length=5, delay_cost=1)
	new_PZ += alt(MM)
	S += new_PZ>=new_PZ_in
	...
	S += (t7*MAS[0])-1 < new_PZ_mem1*MAS_MEM[0]
	S += (t7*MAS[1])-1 < new_PZ_mem1*MAS_MEM[1]
	S += (t7*MAS[2])-1 < new_PZ_mem1*MAS_MEM[2]
	S += (t7*MAS[3])-1 < new_PZ_mem1*MAS_MEM[3]
	...
	S += (t12*MAS[1])-1 < t13_mem0*MAS_MEM[1]
	S += (t12*MAS[2])-1 < t13_mem0*MAS_MEM[2]
	S += (t12*MAS[3])-1 < t13_mem0*MAS_MEM[3]
	S += t13_mem0 <= t13

	t13_mem1 = S.Task('t13_mem1', length=1, delay_cost=1)
	t13_mem1 += alt(MAS_MEM)
	S += (t9*MAS[0])-1 < t13_mem1*MAS_MEM[0]
	S += (t9*MAS[1])-1 < t13_mem1*MAS_MEM[1]
	S += (t9*MAS[2])-1 < t13_mem1*MAS_MEM[2]
	S += (t9*MAS[3])-1 < t13_mem1*MAS_MEM[3]
	S += t13_mem1 <= t13
	...
	S += (t12*MAS[1])-1 < t14_mem0*MAS_MEM[1]
	S += (t12*MAS[2])-1 < t14_mem0*MAS_MEM[2]
	S += (t12*MAS[3])-1 < t14_mem0*MAS_MEM[3]
	S += t14_mem0 <= t14
	...
	S += (t13*MM[0])-1 < new_PY_mem1*MM_MEM[0]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/EP_DBL_A_0/schedule1.png"
	if(S.solution() != []):
