...
def solve():
	...
	S += (t0_t5*MAS[0])-1 < t00_mem1*MAS_MEM[0]
	S += (t0_t5*MAS[1])-1 < t00_mem1*MAS_MEM[1]
	S += (t0_t5*MAS[2])-1 < t00_mem1*MAS_MEM[2]
	S += (t0_t5*MAS[3])-1 < t00_mem1*MAS_MEM[3]
	S += t00_mem1 <= t00
	...
	S += (t1_t5*MAS[0])-1 < t10_mem1*MAS_MEM[0]
	S += (t1_t5*MAS[1])-1 < t10_mem1*MAS_MEM[1]
	S += (t1_t5*MAS[2])-1 < t10_mem1*MAS_MEM[2]
	S += (t1_t5*MAS[3])-1 < t10_mem1*MAS_MEM[3]
	S += t10_mem1 <= t10
	...
	S += (t11*MAS[0])-1 < t2_t1_mem1*MAS_MEM[0]
	S += (t11*MAS[1])-1 < t2_t1_mem1*MAS_MEM[1]
	S += (t11*MAS[2])-1 < t2_t1_mem1*MAS_MEM[2]
	S += (t11*MAS[3])-1 < t2_t1_mem1*MAS_MEM[3]
	S += t2_t1_mem1 <= t2_t1
	...
	S += (t5_t5*MAS[0])-1 < t51_mem1*MAS_MEM[0]
	S += (t5_t5*MAS[1])-1 < t51_mem1*MAS_MEM[1]
	S += (t5_t5*MAS[2])-1 < t51_mem1*MAS_MEM[2]
	S += (t5_t5*MAS[3])-1 < t51_mem1*MAS_MEM[3]
	S += t51_mem1 <= t51
	...
	S += (t50*MAS[1])-1 < t60_mem0*MAS_MEM[1]
	S += (t50*MAS[2])-1 < t60_mem0*MAS_MEM[2]
	S += (t50*MAS[3])-1 < t60_mem0*MAS_MEM[3]
	S += t60_mem0 <= t60

	t60_mem1 = S.Task('t60_mem1', length=1, delay_cost=1)
	t60_mem1 += alt(MAS_MEM)
	S += (t50*MAS[0])-1 < t60_mem1*MAS_MEM[0]
	S += (t50*MAS[1])-1 < t60_mem1*MAS_MEM[1]
	S += (t50*MAS[2])-1 < t60_mem1*MAS_MEM[2]
	S += (t50*MAS[3])-1 < t60_mem1*MAS_MEM[3]
	S += t60_mem1 <= t60
	...
	S += (t7_t5*MAS[0])-1 < t70_mem1*MAS_MEM[0]
	S += (t7_t5*MAS[1])-1 < t70_mem1*MAS_MEM[1]
	S += (t7_t5*MAS[2])-1 < t70_mem1*MAS_MEM[2]
	S += (t7_t5*MAS[3])-1 < t70_mem1*MAS_MEM[3]
	S += t70_mem1 <= t70
	...
	S += (t71*MAS[1])-1 < t81_mem0*MAS_MEM[1]
	S += (t71*MAS[2])-1 < t81_mem0*MAS_MEM[2]
	S += (t71*MAS[3])-1 < t81_mem0*MAS_MEM[3]
	S += t81_mem0 <= t81
	...
	S += (t10_t5*MAS[0])-1 < t101_mem1*MAS_MEM[0]
	S += (t10_t5*MAS[1])-1 < t101_mem1*MAS_MEM[1]
	S += (t10_t5*MAS[2])-1 < t101_mem1*MAS_MEM[2]
	S += (t10_t5*MAS[3])-1 < t101_mem1*MAS_MEM[3]
	S += t101_mem1 <= t101
	...
	S += (t100*MAS[1])-1 < t110_mem0*MAS_MEM[1]
	S += (t100*MAS[2])-1 < t110_mem0*MAS_MEM[2]
	S += (t100*MAS[3])-1 < t110_mem0*MAS_MEM[3]
	S += t110_mem0 <= t110
	...
	S += (t10*MAS[0])-1 < t2_t0_mem1*MAS_MEM[0]
	S += (t10*MAS[1])-1 < t2_t0_mem1*MAS_MEM[1]
	S += (t10*MAS[2])-1 < t2_t0_mem1*MAS_MEM[2]
	S += (t10*MAS[3])-1 < t2_t0_mem1*MAS_MEM[3]
	S += t2_t0_mem1 <= t2_t0
	...
	S += (t10*MAS[1])-1 < t2_t3_mem0*MAS_MEM[1]
	S += (t10*MAS[2])-1 < t2_t3_mem0*MAS_MEM[2]
	S += (t10*MAS[3])-1 < t2_t3_mem0*MAS_MEM[3]
	S += t2_t3_mem0 <= t2_t3

	t2_t3_mem1 = S.Task('t2_t3_mem1', length=1, delay_cost=1)
	t2_t3_mem1 += alt(MAS_MEM)
	S += (t11*MAS[0])-1 < t2_t3_mem1*MAS_MEM[0]
	S += (t11*MAS[1])-1 < t2_t3_mem1*MAS_MEM[1]
	S += (t11*MAS[2])-1 < t2_t3_mem1*MAS_MEM[2]
	S += (t11*MAS[3])-1 < t2_t3_mem1*MAS_MEM[3]
	S += t2_t3_mem1 <= t2_t3
	...
	S += (t51*MAS[1])-1 < t61_mem0*MAS_MEM[1]
	S += (t51*MAS[2])-1 < t61_mem0*MAS_MEM[2]
	S += (t51*MAS[3])-1 < t61_mem0*MAS_MEM[3]
	S += t61_mem0 <= t61

	t61_mem1 = S.Task('t61_mem1', length=1, delay_cost=1)
	t61_mem1 += alt(MAS_MEM)
	S += (t51*MAS[0])-1 < t61_mem1*MAS_MEM[0]
	S += (t51*MAS[1])-1 < t61_mem1*MAS_MEM[1]
	S += (t51*MAS[2])-1 < t61_mem1*MAS_MEM[2]
	S += (t51*MAS[3])-1 < t61_mem1*MAS_MEM[3]
	S += t61_mem1 <= t61
	...
	S += (t70*MAS[1])-1 < t80_mem0*MAS_MEM[1]
	S += (t70*MAS[2])-1 < t80_mem0*MAS_MEM[2]
	S += (t70*MAS[3])-1 < t80_mem0*MAS_MEM[3]
	S += t80_mem0 <= t80
	...
	S += (t81*MAS[1])-1 < t91_mem0*MAS_MEM[1]
	S += (t81*MAS[2])-1 < t91_mem0*MAS_MEM[2]
	S += (t81*MAS[3])-1 < t91_mem0*MAS_MEM[3]
	S += t91_mem0 <= t91

	t91_mem1 = S.Task('t91_mem1', length=1, delay_cost=1)
	t91_mem1 += alt(MAS_MEM)
	S += (t71*MAS[0])-1 < t91_mem1*MAS_MEM[0]
	S += (t71*MAS[1])-1 < t91_mem1*MAS_MEM[1]
	S += (t71*MAS[2])-1 < t91_mem1*MAS_MEM[2]
	S += (t71*MAS[3])-1 < t91_mem1*MAS_MEM[3]
	S += t91_mem1 <= t91
	...
	S += (t101*MAS[1])-1 < t111_mem0*MAS_MEM[1]
	S += (t101*MAS[2])-1 < t111_mem0*MAS_MEM[2]
	S += (t101*MAS[3])-1 < t111_mem0*MAS_MEM[3]
	S += t111_mem0 <= t111
	...
	S += (t00*MAS[1])-1 < t12_t0_mem0*MAS_MEM[1]
	S += (t00*MAS[2])-1 < t12_t0_mem0*MAS_MEM[2]
	S += (t00*MAS[3])-1 < t12_t0_mem0*MAS_MEM[3]
	S += t12_t0_mem0 <= t12_t0

	t12_t0_mem1 = S.Task('t12_t0_mem1', length=1, delay_cost=1)
	t12_t0_mem1 += alt(MAS_MEM)
	S += (t110*MAS[0])-1 < t12_t0_mem1*MAS_MEM[0]
	S += (t110*MAS[1])-1 < t12_t0_mem1*MAS_MEM[1]
	S += (t110*MAS[2])-1 < t12_t0_mem1*MAS_MEM[2]
	S += (t110*MAS[3])-1 < t12_t0_mem1*MAS_MEM[3]
	...
	S += (t00*MAS[1])-1 < t12_t2_mem0*MAS_MEM[1]
	S += (t00*MAS[2])-1 < t12_t2_mem0*MAS_MEM[2]
	S += (t00*MAS[3])-1 < t12_t2_mem0*MAS_MEM[3]
	S += t12_t2_mem0 <= t12_t2

	t12_t2_mem1 = S.Task('t12_t2_mem1', length=1, delay_cost=1)
	t12_t2_mem1 += alt(MAS_MEM)
	S += (t01*MAS[0])-1 < t12_t2_mem1*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t12_t2_mem1*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t12_t2_mem1*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t12_t2_mem1*MAS_MEM[3]
	...
	S += (t00*MAS[1])-1 < t18_t0_mem0*MAS_MEM[1]
	S += (t00*MAS[2])-1 < t18_t0_mem0*MAS_MEM[2]
	S += (t00*MAS[3])-1 < t18_t0_mem0*MAS_MEM[3]
	S += t18_t0_mem0 <= t18_t0

	t18_t0_mem1 = S.Task('t18_t0_mem1', length=1, delay_cost=1)
	t18_t0_mem1 += alt(MAS_MEM)
	S += (t01*MAS[0])-1 < t18_t0_mem1*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t18_t0_mem1*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t18_t0_mem1*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t18_t0_mem1*MAS_MEM[3]
	...
	S += (t00*MAS[1])-1 < t18_t1_mem0*MAS_MEM[1]
	S += (t00*MAS[2])-1 < t18_t1_mem0*MAS_MEM[2]
	S += (t00*MAS[3])-1 < t18_t1_mem0*MAS_MEM[3]
	S += t18_t1_mem0 <= t18_t1

	t18_t1_mem1 = S.Task('t18_t1_mem1', length=1, delay_cost=1)
	t18_t1_mem1 += alt(MAS_MEM)
	S += (t01*MAS[0])-1 < t18_t1_mem1*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t18_t1_mem1*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t18_t1_mem1*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t18_t1_mem1*MAS_MEM[3]
	...
	S += (t00*MAS[1])-1 < t18_t3_mem0*MAS_MEM[1]
	S += (t00*MAS[2])-1 < t18_t3_mem0*MAS_MEM[2]
	S += (t00*MAS[3])-1 < t18_t3_mem0*MAS_MEM[3]
	S += t18_t3_mem0 <= t18_t3

	t18_t3_mem1 = S.Task('t18_t3_mem1', length=1, delay_cost=1)
	t18_t3_mem1 += alt(MAS_MEM)
	S += (t01*MAS[0])-1 < t18_t3_mem1*MAS_MEM[0]
	S += (t01*MAS[1])-1 < t18_t3_mem1*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t18_t3_mem1*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t18_t3_mem1*MAS_MEM[3]
	...
	S += (t110*MAS[1])-1 < c010_mem0*MAS_MEM[1]
	S += (t110*MAS[2])-1 < c010_mem0*MAS_MEM[2]
	S += (t110*MAS[3])-1 < c010_mem0*MAS_MEM[3]
	S += c010_mem0 <= c010
	...
	S += (t2_t3*MAS[0])-1 < t2_t4_mem1*MAS_MEM[0]
	S += (t2_t3*MAS[1])-1 < t2_t4_mem1*MAS_MEM[1]
	S += (t2_t3*MAS[2])-1 < t2_t4_mem1*MAS_MEM[2]
	S += (t2_t3*MAS[3])-1 < t2_t4_mem1*MAS_MEM[3]
	S += t2_t4_mem1 <= t2_t4
	...
	t20_mem1 += alt(MM_MEM)
	S += (t2_t1*MM[0])-1 < t20_mem1*MM_MEM[0]
	S += t20_mem1 <= t20
	...
	S += (t2_t1*MM[0])-1 < t2_t5_mem1*MM_MEM[0]
	S += t2_t5_mem1 <= t2_t5
	...
	S += (t80*MAS[1])-1 < t90_mem0*MAS_MEM[1]
	S += (t80*MAS[2])-1 < t90_mem0*MAS_MEM[2]
	S += (t80*MAS[3])-1 < t90_mem0*MAS_MEM[3]
	S += t90_mem0 <= t90

	t90_mem1 = S.Task('t90_mem1', length=1, delay_cost=1)
	t90_mem1 += alt(MAS_MEM)
	S += (t70*MAS[0])-1 < t90_mem1*MAS_MEM[0]
	S += (t70*MAS[1])-1 < t90_mem1*MAS_MEM[1]
	S += (t70*MAS[2])-1 < t90_mem1*MAS_MEM[2]
	S += (t70*MAS[3])-1 < t90_mem1*MAS_MEM[3]
	S += t90_mem1 <= t90
	...
	S += (t01*MAS[1])-1 < t12_t1_mem0*MAS_MEM[1]
	S += (t01*MAS[2])-1 < t12_t1_mem0*MAS_MEM[2]
	S += (t01*MAS[3])-1 < t12_t1_mem0*MAS_MEM[3]
	S += t12_t1_mem0 <= t12_t1

	t12_t1_mem1 = S.Task('t12_t1_mem1', length=1, delay_cost=1)
	t12_t1_mem1 += alt(MAS_MEM)
	S += (t111*MAS[0])-1 < t12_t1_mem1*MAS_MEM[0]
	S += (t111*MAS[1])-1 < t12_t1_mem1*MAS_MEM[1]
	S += (t111*MAS[2])-1 < t12_t1_mem1*MAS_MEM[2]
	S += (t111*MAS[3])-1 < t12_t1_mem1*MAS_MEM[3]
	...
	S += (t110*MAS[1])-1 < t12_t3_mem0*MAS_MEM[1]
	S += (t110*MAS[2])-1 < t12_t3_mem0*MAS_MEM[2]
	S += (t110*MAS[3])-1 < t12_t3_mem0*MAS_MEM[3]
	S += t12_t3_mem0 <= t12_t3

	t12_t3_mem1 = S.Task('t12_t3_mem1', length=1, delay_cost=1)
	t12_t3_mem1 += alt(MAS_MEM)
	S += (t111*MAS[0])-1 < t12_t3_mem1*MAS_MEM[0]
	S += (t111*MAS[1])-1 < t12_t3_mem1*MAS_MEM[1]
	S += (t111*MAS[2])-1 < t12_t3_mem1*MAS_MEM[2]
	S += (t111*MAS[3])-1 < t12_t3_mem1*MAS_MEM[3]
	...
	S += (t60*MAS[1])-1 < new_TX_t3_mem0*MAS_MEM[1]
	S += (t60*MAS[2])-1 < new_TX_t3_mem0*MAS_MEM[2]
	S += (t60*MAS[3])-1 < new_TX_t3_mem0*MAS_MEM[3]
	S += new_TX_t3_mem0 <= new_TX_t3

	new_TX_t3_mem1 = S.Task('new_TX_t3_mem1', length=1, delay_cost=1)
	new_TX_t3_mem1 += alt(MAS_MEM)
	S += (t61*MAS[0])-1 < new_TX_t3_mem1*MAS_MEM[0]
	S += (t61*MAS[1])-1 < new_TX_t3_mem1*MAS_MEM[1]
	S += (t61*MAS[2])-1 < new_TX_t3_mem1*MAS_MEM[2]
	S += (t61*MAS[3])-1 < new_TX_t3_mem1*MAS_MEM[3]
	...
	S += (t18_t0*MAS[1])-1 < t18_t2_mem0*MAS_MEM[1]
	S += (t18_t0*MAS[2])-1 < t18_t2_mem0*MAS_MEM[2]
	S += (t18_t0*MAS[3])-1 < t18_t2_mem0*MAS_MEM[3]
	S += t18_t2_mem0 <= t18_t2

	t18_t2_mem1 = S.Task('t18_t2_mem1', length=1, delay_cost=1)
	t18_t2_mem1 += alt(MAS_MEM)
	S += (t18_t1*MAS[0])-1 < t18_t2_mem1*MAS_MEM[0]
	S += (t18_t1*MAS[1])-1 < t18_t2_mem1*MAS_MEM[1]
	S += (t18_t1*MAS[2])-1 < t18_t2_mem1*MAS_MEM[2]
	S += (t18_t1*MAS[3])-1 < t18_t2_mem1*MAS_MEM[3]
	...
	S += (t18_t3*MM[0])-1 < t18_t5_mem1*MM_MEM[0]
	...
	S += (t18_t3*MM[0])-1 < t181_mem1*MM_MEM[0]
	S += t181_mem1 <= t181
	...
	S += (t111*MAS[1])-1 < c011_mem0*MAS_MEM[1]
	S += (t111*MAS[2])-1 < c011_mem0*MAS_MEM[2]
	S += (t111*MAS[3])-1 < c011_mem0*MAS_MEM[3]
	S += c011_mem0 <= c011
	...
	S += (t91*MAS[1])-1 < c201_mem0*MAS_MEM[1]
	S += (t91*MAS[2])-1 < c201_mem0*MAS_MEM[2]
	S += (t91*MAS[3])-1 < c201_mem0*MAS_MEM[3]
	S += c201_mem0 <= c201
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/PDBL/schedule1.png"
	if(S.solution() != []):
