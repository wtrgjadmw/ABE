...
def solve():
	...
	S += (c_aa_t50*MAS[0])-1 < c_aa00_mem1*MAS_MEM[0]
	S += (c_aa_t50*MAS[1])-1 < c_aa00_mem1*MAS_MEM[1]
	S += (c_aa_t50*MAS[2])-1 < c_aa00_mem1*MAS_MEM[2]
	S += (c_aa_t50*MAS[3])-1 < c_aa00_mem1*MAS_MEM[3]
	...
	S += (c_aa_t21*MAS[1])-1 < c_aa01_mem0*MAS_MEM[1]
	S += (c_aa_t21*MAS[2])-1 < c_aa01_mem0*MAS_MEM[2]
	S += (c_aa_t21*MAS[3])-1 < c_aa01_mem0*MAS_MEM[3]
	S += c_aa01_mem0 <= c_aa01

	c_aa01_mem1 = S.Task('c_aa01_mem1', length=1, delay_cost=1)
	c_aa01_mem1 += alt(MAS_MEM)
	S += (c_aa_t51*MAS[0])-1 < c_aa01_mem1*MAS_MEM[0]
	S += (c_aa_t51*MAS[1])-1 < c_aa01_mem1*MAS_MEM[1]
	S += (c_aa_t51*MAS[2])-1 < c_aa01_mem1*MAS_MEM[2]
	S += (c_aa_t51*MAS[3])-1 < c_aa01_mem1*MAS_MEM[3]
	...
	S += (c_bb_t50*MAS[0])-1 < c_bb00_mem1*MAS_MEM[0]
	S += (c_bb_t50*MAS[1])-1 < c_bb00_mem1*MAS_MEM[1]
	S += (c_bb_t50*MAS[2])-1 < c_bb00_mem1*MAS_MEM[2]
	S += (c_bb_t50*MAS[3])-1 < c_bb00_mem1*MAS_MEM[3]
	...
	S += (c_bb_t21*MAS[1])-1 < c_bb01_mem0*MAS_MEM[1]
	S += (c_bb_t21*MAS[2])-1 < c_bb01_mem0*MAS_MEM[2]
	S += (c_bb_t21*MAS[3])-1 < c_bb01_mem0*MAS_MEM[3]
	S += c_bb01_mem0 <= c_bb01

	c_bb01_mem1 = S.Task('c_bb01_mem1', length=1, delay_cost=1)
	c_bb01_mem1 += alt(MAS_MEM)
	S += (c_bb_t51*MAS[0])-1 < c_bb01_mem1*MAS_MEM[0]
	S += (c_bb_t51*MAS[1])-1 < c_bb01_mem1*MAS_MEM[1]
	S += (c_bb_t51*MAS[2])-1 < c_bb01_mem1*MAS_MEM[2]
	S += (c_bb_t51*MAS[3])-1 < c_bb01_mem1*MAS_MEM[3]
	...
	S += (c_cc_t50*MAS[0])-1 < c_cc00_mem1*MAS_MEM[0]
	S += (c_cc_t50*MAS[1])-1 < c_cc00_mem1*MAS_MEM[1]
	S += (c_cc_t50*MAS[2])-1 < c_cc00_mem1*MAS_MEM[2]
	S += (c_cc_t50*MAS[3])-1 < c_cc00_mem1*MAS_MEM[3]
	...
	S += (c_cc_t21*MAS[1])-1 < c_cc01_mem0*MAS_MEM[1]
	S += (c_cc_t21*MAS[2])-1 < c_cc01_mem0*MAS_MEM[2]
	S += (c_cc_t21*MAS[3])-1 < c_cc01_mem0*MAS_MEM[3]
	S += c_cc01_mem0 <= c_cc01

	c_cc01_mem1 = S.Task('c_cc01_mem1', length=1, delay_cost=1)
	c_cc01_mem1 += alt(MAS_MEM)
	S += (c_cc_t51*MAS[0])-1 < c_cc01_mem1*MAS_MEM[0]
	S += (c_cc_t51*MAS[1])-1 < c_cc01_mem1*MAS_MEM[1]
	S += (c_cc_t51*MAS[2])-1 < c_cc01_mem1*MAS_MEM[2]
	S += (c_cc_t51*MAS[3])-1 < c_cc01_mem1*MAS_MEM[3]
	...
	S += (c_bc00*MAS[0])-1 < c_pa10_mem1*MAS_MEM[0]
	S += (c_bc00*MAS[1])-1 < c_pa10_mem1*MAS_MEM[1]
	S += (c_bc00*MAS[2])-1 < c_pa10_mem1*MAS_MEM[2]
	S += (c_bc00*MAS[3])-1 < c_pa10_mem1*MAS_MEM[3]
	...
	S += (c_bc01*MAS[0])-1 < c_pa11_mem1*MAS_MEM[0]
	S += (c_bc01*MAS[1])-1 < c_pa11_mem1*MAS_MEM[1]
	S += (c_bc01*MAS[2])-1 < c_pa11_mem1*MAS_MEM[2]
	S += (c_bc01*MAS[3])-1 < c_pa11_mem1*MAS_MEM[3]
	...
	S += (c_ccxi_y1_0*MAS[1])-1 < c_pb00_mem0*MAS_MEM[1]
	S += (c_ccxi_y1_0*MAS[2])-1 < c_pb00_mem0*MAS_MEM[2]
	S += (c_ccxi_y1_0*MAS[3])-1 < c_pb00_mem0*MAS_MEM[3]
	S += c_pb00_mem0 <= c_pb00

	c_pb00_mem1 = S.Task('c_pb00_mem1', length=1, delay_cost=1)
	c_pb00_mem1 += alt(MAS_MEM)
	S += (c_ab00*MAS[0])-1 < c_pb00_mem1*MAS_MEM[0]
	S += (c_ab00*MAS[1])-1 < c_pb00_mem1*MAS_MEM[1]
	S += (c_ab00*MAS[2])-1 < c_pb00_mem1*MAS_MEM[2]
	S += (c_ab00*MAS[3])-1 < c_pb00_mem1*MAS_MEM[3]
	...
	S += (c_ccxi_y1_1*MAS[1])-1 < c_pb01_mem0*MAS_MEM[1]
	S += (c_ccxi_y1_1*MAS[2])-1 < c_pb01_mem0*MAS_MEM[2]
	S += (c_ccxi_y1_1*MAS[3])-1 < c_pb01_mem0*MAS_MEM[3]
	S += c_pb01_mem0 <= c_pb01

	c_pb01_mem1 = S.Task('c_pb01_mem1', length=1, delay_cost=1)
	c_pb01_mem1 += alt(MAS_MEM)
	S += (c_ab01*MAS[0])-1 < c_pb01_mem1*MAS_MEM[0]
	S += (c_ab01*MAS[1])-1 < c_pb01_mem1*MAS_MEM[1]
	S += (c_ab01*MAS[2])-1 < c_pb01_mem1*MAS_MEM[2]
	S += (c_ab01*MAS[3])-1 < c_pb01_mem1*MAS_MEM[3]
	...
	S += (c_ac11*MAS[0])-1 < c_pc11_mem1*MAS_MEM[0]
	S += (c_ac11*MAS[1])-1 < c_pc11_mem1*MAS_MEM[1]
	S += (c_ac11*MAS[2])-1 < c_pc11_mem1*MAS_MEM[2]
	S += (c_ac11*MAS[3])-1 < c_pc11_mem1*MAS_MEM[3]
	...
	S += (c_pc10*MAS[1])-1 < c_pcb_t1_t0_mem0*MAS_MEM[1]
	S += (c_pc10*MAS[2])-1 < c_pcb_t1_t0_mem0*MAS_MEM[2]
	S += (c_pc10*MAS[3])-1 < c_pcb_t1_t0_mem0*MAS_MEM[3]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/INV/schedule7.png"
	if(S.solution() != []):
