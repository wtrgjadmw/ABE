...
def solve():
	...
	S += (c_pxi_y1_0*MAS[1])-1 < c_q00_mem0*MAS_MEM[2]
	S += (c_pxi_y1_0*MAS[2])-1 < c_q00_mem0*MAS_MEM[4]
	S += (c_pxi_y1_0*MAS[3])-1 < c_q00_mem0*MAS_MEM[6]
	S += c_q00_mem0 <= c_q00

	c_q00_mem1 = S.Task('c_q00_mem1', length=1, delay_cost=1)
	c_q00_mem1 += alt(MAS_MEM)
	S += (c_paa00*MAS[0])-1 < c_q00_mem1*MAS_MEM[1]
	S += (c_paa00*MAS[1])-1 < c_q00_mem1*MAS_MEM[3]
	S += (c_paa00*MAS[2])-1 < c_q00_mem1*MAS_MEM[5]
	S += (c_paa00*MAS[3])-1 < c_q00_mem1*MAS_MEM[7]
	S += c_q00_mem1 <= c_q00
	...
	S += (c_pxi_y1_1*MAS[1])-1 < c_q01_mem0*MAS_MEM[2]
	S += (c_pxi_y1_1*MAS[2])-1 < c_q01_mem0*MAS_MEM[4]
	S += (c_pxi_y1_1*MAS[3])-1 < c_q01_mem0*MAS_MEM[6]
	S += c_q01_mem0 <= c_q01

	c_q01_mem1 = S.Task('c_q01_mem1', length=1, delay_cost=1)
	c_q01_mem1 += alt(MAS_MEM)
	S += (c_paa01*MAS[0])-1 < c_q01_mem1*MAS_MEM[1]
	S += (c_paa01*MAS[1])-1 < c_q01_mem1*MAS_MEM[3]
	S += (c_paa01*MAS[2])-1 < c_q01_mem1*MAS_MEM[5]
	S += (c_paa01*MAS[3])-1 < c_q01_mem1*MAS_MEM[7]
	S += c_q01_mem1 <= c_q01
	...
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t0_mem0*MAS_MEM[2]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t0_mem0*MAS_MEM[4]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t0_mem0*MAS_MEM[6]
	...
	S += (c_q10*MAS[0])-1 < c_qinv_bb_t0_mem1*MAS_MEM[1]
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t0_mem1*MAS_MEM[3]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t0_mem1*MAS_MEM[5]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t0_mem1*MAS_MEM[7]
	...
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t1_mem0*MAS_MEM[2]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t1_mem0*MAS_MEM[4]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t1_mem0*MAS_MEM[6]
	...
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t1_mem1*MAS_MEM[1]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t1_mem1*MAS_MEM[3]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t1_mem1*MAS_MEM[5]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t1_mem1*MAS_MEM[7]
	...
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t2_mem0*MAS_MEM[2]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t2_mem0*MAS_MEM[4]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t2_mem0*MAS_MEM[6]
	...
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t2_mem1*MAS_MEM[1]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t2_mem1*MAS_MEM[3]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t2_mem1*MAS_MEM[5]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t2_mem1*MAS_MEM[7]
	...
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t3_mem0*MAS_MEM[2]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t3_mem0*MAS_MEM[4]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t3_mem0*MAS_MEM[6]
	...
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t3_mem1*MAS_MEM[1]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t3_mem1*MAS_MEM[3]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t3_mem1*MAS_MEM[5]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t3_mem1*MAS_MEM[7]
	...
	S += (c_q10*MAS[1])-1 < c_qinv1__t2_mem0*MAS_MEM[2]
	S += (c_q10*MAS[2])-1 < c_qinv1__t2_mem0*MAS_MEM[4]
	S += (c_q10*MAS[3])-1 < c_qinv1__t2_mem0*MAS_MEM[6]
	S += c_qinv1__t2_mem0 <= c_qinv1__t2

	c_qinv1__t2_mem1 = S.Task('c_qinv1__t2_mem1', length=1, delay_cost=1)
	c_qinv1__t2_mem1 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv1__t2_mem1*MAS_MEM[1]
	S += (c_q11*MAS[1])-1 < c_qinv1__t2_mem1*MAS_MEM[3]
	S += (c_q11*MAS[2])-1 < c_qinv1__t2_mem1*MAS_MEM[5]
	S += (c_q11*MAS[3])-1 < c_qinv1__t2_mem1*MAS_MEM[7]
	...
	S += (c_q00*MAS[1])-1 < c_qinv0_t2_mem0*MAS_MEM[2]
	S += (c_q00*MAS[2])-1 < c_qinv0_t2_mem0*MAS_MEM[4]
	S += (c_q00*MAS[3])-1 < c_qinv0_t2_mem0*MAS_MEM[6]
	S += c_qinv0_t2_mem0 <= c_qinv0_t2

	c_qinv0_t2_mem1 = S.Task('c_qinv0_t2_mem1', length=1, delay_cost=1)
	c_qinv0_t2_mem1 += alt(MAS_MEM)
	S += (c_q01*MAS[0])-1 < c_qinv0_t2_mem1*MAS_MEM[1]
	S += (c_q01*MAS[1])-1 < c_qinv0_t2_mem1*MAS_MEM[3]
	S += (c_q01*MAS[2])-1 < c_qinv0_t2_mem1*MAS_MEM[5]
	S += (c_q01*MAS[3])-1 < c_qinv0_t2_mem1*MAS_MEM[7]
