...
def solve():
	...
	S += (c_pbc_s00*MAS[0])-1 < c_pbc00_mem1*MAS_MEM[0]
	S += (c_pbc_s00*MAS[1])-1 < c_pbc00_mem1*MAS_MEM[1]
	S += (c_pbc_s00*MAS[2])-1 < c_pbc00_mem1*MAS_MEM[2]
	S += (c_pbc_s00*MAS[3])-1 < c_pbc00_mem1*MAS_MEM[3]
	...
	S += (c_pbc_s01*MAS[0])-1 < c_pbc01_mem1*MAS_MEM[0]
	S += (c_pbc_s01*MAS[1])-1 < c_pbc01_mem1*MAS_MEM[1]
	S += (c_pbc_s01*MAS[2])-1 < c_pbc01_mem1*MAS_MEM[2]
	S += (c_pbc_s01*MAS[3])-1 < c_pbc01_mem1*MAS_MEM[3]
	...
	S += (c_pbc_t41*MAS[1])-1 < c_pbc11_mem0*MAS_MEM[1]
	S += (c_pbc_t41*MAS[2])-1 < c_pbc11_mem0*MAS_MEM[2]
	S += (c_pbc_t41*MAS[3])-1 < c_pbc11_mem0*MAS_MEM[3]
	S += c_pbc11_mem0 <= c_pbc11

	c_pbc11_mem1 = S.Task('c_pbc11_mem1', length=1, delay_cost=1)
	c_pbc11_mem1 += alt(MAS_MEM)
	S += (c_pbc_t51*MAS[0])-1 < c_pbc11_mem1*MAS_MEM[0]
	S += (c_pbc_t51*MAS[1])-1 < c_pbc11_mem1*MAS_MEM[1]
	S += (c_pbc_t51*MAS[2])-1 < c_pbc11_mem1*MAS_MEM[2]
	S += (c_pbc_t51*MAS[3])-1 < c_pbc11_mem1*MAS_MEM[3]
	...
	S += (c_pcb_t41*MAS[1])-1 < c_pcb11_mem0*MAS_MEM[1]
	S += (c_pcb_t41*MAS[2])-1 < c_pcb11_mem0*MAS_MEM[2]
	S += (c_pcb_t41*MAS[3])-1 < c_pcb11_mem0*MAS_MEM[3]
	S += c_pcb11_mem0 <= c_pcb11

	c_pcb11_mem1 = S.Task('c_pcb11_mem1', length=1, delay_cost=1)
	c_pcb11_mem1 += alt(MAS_MEM)
	S += (c_pcb_t51*MAS[0])-1 < c_pcb11_mem1*MAS_MEM[0]
	S += (c_pcb_t51*MAS[1])-1 < c_pcb11_mem1*MAS_MEM[1]
	S += (c_pcb_t51*MAS[2])-1 < c_pcb11_mem1*MAS_MEM[2]
	S += (c_pcb_t51*MAS[3])-1 < c_pcb11_mem1*MAS_MEM[3]
	...
	S += (c_pbc10*MAS[1])-1 < c_pbccb10_mem0*MAS_MEM[1]
	S += (c_pbc10*MAS[2])-1 < c_pbccb10_mem0*MAS_MEM[2]
	S += (c_pbc10*MAS[3])-1 < c_pbccb10_mem0*MAS_MEM[3]
	S += c_pbccb10_mem0 <= c_pbccb10

	c_pbccb10_mem1 = S.Task('c_pbccb10_mem1', length=1, delay_cost=1)
	c_pbccb10_mem1 += alt(MAS_MEM)
	S += (c_pcb10*MAS[0])-1 < c_pbccb10_mem1*MAS_MEM[0]
	S += (c_pcb10*MAS[1])-1 < c_pbccb10_mem1*MAS_MEM[1]
	S += (c_pcb10*MAS[2])-1 < c_pbccb10_mem1*MAS_MEM[2]
	S += (c_pcb10*MAS[3])-1 < c_pbccb10_mem1*MAS_MEM[3]
	...
	S += (c_paa_t41*MAS[1])-1 < c_paa11_mem0*MAS_MEM[1]
	S += (c_paa_t41*MAS[2])-1 < c_paa11_mem0*MAS_MEM[2]
	S += (c_paa_t41*MAS[3])-1 < c_paa11_mem0*MAS_MEM[3]
	S += c_paa11_mem0 <= c_paa11

	c_paa11_mem1 = S.Task('c_paa11_mem1', length=1, delay_cost=1)
	c_paa11_mem1 += alt(MAS_MEM)
	S += (c_paa_t51*MAS[0])-1 < c_paa11_mem1*MAS_MEM[0]
	S += (c_paa_t51*MAS[1])-1 < c_paa11_mem1*MAS_MEM[1]
	S += (c_paa_t51*MAS[2])-1 < c_paa11_mem1*MAS_MEM[2]
	S += (c_paa_t51*MAS[3])-1 < c_paa11_mem1*MAS_MEM[3]
	...
	S += (c_pbc00*MAS[1])-1 < c_pbccb00_mem0*MAS_MEM[1]
	S += (c_pbc00*MAS[2])-1 < c_pbccb00_mem0*MAS_MEM[2]
	S += (c_pbc00*MAS[3])-1 < c_pbccb00_mem0*MAS_MEM[3]
	S += c_pbccb00_mem0 <= c_pbccb00

	c_pbccb00_mem1 = S.Task('c_pbccb00_mem1', length=1, delay_cost=1)
	c_pbccb00_mem1 += alt(MAS_MEM)
	S += (c_pcb00*MAS[0])-1 < c_pbccb00_mem1*MAS_MEM[0]
	S += (c_pcb00*MAS[1])-1 < c_pbccb00_mem1*MAS_MEM[1]
	S += (c_pcb00*MAS[2])-1 < c_pbccb00_mem1*MAS_MEM[2]
	S += (c_pcb00*MAS[3])-1 < c_pbccb00_mem1*MAS_MEM[3]
	...
	S += (c_pbc01*MAS[1])-1 < c_pbccb01_mem0*MAS_MEM[1]
	S += (c_pbc01*MAS[2])-1 < c_pbccb01_mem0*MAS_MEM[2]
	S += (c_pbc01*MAS[3])-1 < c_pbccb01_mem0*MAS_MEM[3]
	S += c_pbccb01_mem0 <= c_pbccb01

	c_pbccb01_mem1 = S.Task('c_pbccb01_mem1', length=1, delay_cost=1)
	c_pbccb01_mem1 += alt(MAS_MEM)
	S += (c_pcb01*MAS[0])-1 < c_pbccb01_mem1*MAS_MEM[0]
	S += (c_pcb01*MAS[1])-1 < c_pbccb01_mem1*MAS_MEM[1]
	S += (c_pcb01*MAS[2])-1 < c_pbccb01_mem1*MAS_MEM[2]
	S += (c_pcb01*MAS[3])-1 < c_pbccb01_mem1*MAS_MEM[3]
	...
	S += (c_pbc11*MAS[1])-1 < c_pbccb11_mem0*MAS_MEM[1]
	S += (c_pbc11*MAS[2])-1 < c_pbccb11_mem0*MAS_MEM[2]
	S += (c_pbc11*MAS[3])-1 < c_pbccb11_mem0*MAS_MEM[3]
	S += c_pbccb11_mem0 <= c_pbccb11

	c_pbccb11_mem1 = S.Task('c_pbccb11_mem1', length=1, delay_cost=1)
	c_pbccb11_mem1 += alt(MAS_MEM)
	S += (c_pcb11*MAS[0])-1 < c_pbccb11_mem1*MAS_MEM[0]
	S += (c_pcb11*MAS[1])-1 < c_pbccb11_mem1*MAS_MEM[1]
	S += (c_pcb11*MAS[2])-1 < c_pbccb11_mem1*MAS_MEM[2]
	S += (c_pcb11*MAS[3])-1 < c_pbccb11_mem1*MAS_MEM[3]
	...
	S += (c_pbccb10*MAS[1])-1 < c_pxi_y1_0_mem0*MAS_MEM[1]
	S += (c_pbccb10*MAS[2])-1 < c_pxi_y1_0_mem0*MAS_MEM[2]
	S += (c_pbccb10*MAS[3])-1 < c_pxi_y1_0_mem0*MAS_MEM[3]
	S += c_pxi_y1_0_mem0 <= c_pxi_y1_0

	c_pxi_y1_0_mem1 = S.Task('c_pxi_y1_0_mem1', length=1, delay_cost=1)
	c_pxi_y1_0_mem1 += alt(MAS_MEM)
	S += (c_pbccb11*MAS[0])-1 < c_pxi_y1_0_mem1*MAS_MEM[0]
	S += (c_pbccb11*MAS[1])-1 < c_pxi_y1_0_mem1*MAS_MEM[1]
	S += (c_pbccb11*MAS[2])-1 < c_pxi_y1_0_mem1*MAS_MEM[2]
	S += (c_pbccb11*MAS[3])-1 < c_pxi_y1_0_mem1*MAS_MEM[3]
	...
	S += (c_pbccb11*MAS[1])-1 < c_pxi_y1_1_mem0*MAS_MEM[1]
	S += (c_pbccb11*MAS[2])-1 < c_pxi_y1_1_mem0*MAS_MEM[2]
	S += (c_pbccb11*MAS[3])-1 < c_pxi_y1_1_mem0*MAS_MEM[3]
	S += c_pxi_y1_1_mem0 <= c_pxi_y1_1

	c_pxi_y1_1_mem1 = S.Task('c_pxi_y1_1_mem1', length=1, delay_cost=1)
	c_pxi_y1_1_mem1 += alt(MAS_MEM)
	S += (c_pbccb10*MAS[0])-1 < c_pxi_y1_1_mem1*MAS_MEM[0]
	S += (c_pbccb10*MAS[1])-1 < c_pxi_y1_1_mem1*MAS_MEM[1]
	S += (c_pbccb10*MAS[2])-1 < c_pxi_y1_1_mem1*MAS_MEM[2]
	S += (c_pbccb10*MAS[3])-1 < c_pxi_y1_1_mem1*MAS_MEM[3]
	...
	S += (c_pbccb00*MAS[1])-1 < c_q10_mem0*MAS_MEM[1]
	S += (c_pbccb00*MAS[2])-1 < c_q10_mem0*MAS_MEM[2]
	S += (c_pbccb00*MAS[3])-1 < c_q10_mem0*MAS_MEM[3]
	S += c_q10_mem0 <= c_q10

	c_q10_mem1 = S.Task('c_q10_mem1', length=1, delay_cost=1)
	c_q10_mem1 += alt(MAS_MEM)
	S += (c_paa10*MAS[0])-1 < c_q10_mem1*MAS_MEM[0]
	S += (c_paa10*MAS[1])-1 < c_q10_mem1*MAS_MEM[1]
	S += (c_paa10*MAS[2])-1 < c_q10_mem1*MAS_MEM[2]
	S += (c_paa10*MAS[3])-1 < c_q10_mem1*MAS_MEM[3]
	S += c_q10_mem1 <= c_q10
	...
	S += (c_pbccb01*MAS[1])-1 < c_q11_mem0*MAS_MEM[1]
	S += (c_pbccb01*MAS[2])-1 < c_q11_mem0*MAS_MEM[2]
	S += (c_pbccb01*MAS[3])-1 < c_q11_mem0*MAS_MEM[3]
	S += c_q11_mem0 <= c_q11

	c_q11_mem1 = S.Task('c_q11_mem1', length=1, delay_cost=1)
	c_q11_mem1 += alt(MAS_MEM)
	S += (c_paa11*MAS[0])-1 < c_q11_mem1*MAS_MEM[0]
	S += (c_paa11*MAS[1])-1 < c_q11_mem1*MAS_MEM[1]
	S += (c_paa11*MAS[2])-1 < c_q11_mem1*MAS_MEM[2]
	S += (c_paa11*MAS[3])-1 < c_q11_mem1*MAS_MEM[3]
	S += c_q11_mem1 <= c_q11
	...
	c_q00_mem0 += alt(MAS_MEM)
	S += (c_pxi_y1_0*MAS[0])-1 < c_q00_mem0*MAS_MEM[0]
	S += (c_pxi_y1_0*MAS[1])-1 < c_q00_mem0*MAS_MEM[1]
	S += (c_pxi_y1_0*MAS[2])-1 < c_q00_mem0*MAS_MEM[2]
	S += (c_pxi_y1_0*MAS[3])-1 < c_q00_mem0*MAS_MEM[3]
	S += c_q00_mem0 <= c_q00

	c_q00_mem1 = S.Task('c_q00_mem1', length=1, delay_cost=1)
	c_q00_mem1 += alt(MAS_MEM)
	S += (c_paa00*MAS[0])-1 < c_q00_mem1*MAS_MEM[0]
	S += (c_paa00*MAS[1])-1 < c_q00_mem1*MAS_MEM[1]
	S += (c_paa00*MAS[2])-1 < c_q00_mem1*MAS_MEM[2]
	S += (c_paa00*MAS[3])-1 < c_q00_mem1*MAS_MEM[3]
	S += c_q00_mem1 <= c_q00
	...
	c_q01_mem0 += alt(MAS_MEM)
	S += (c_pxi_y1_1*MAS[0])-1 < c_q01_mem0*MAS_MEM[0]
	S += (c_pxi_y1_1*MAS[1])-1 < c_q01_mem0*MAS_MEM[1]
	S += (c_pxi_y1_1*MAS[2])-1 < c_q01_mem0*MAS_MEM[2]
	S += (c_pxi_y1_1*MAS[3])-1 < c_q01_mem0*MAS_MEM[3]
	S += c_q01_mem0 <= c_q01

	c_q01_mem1 = S.Task('c_q01_mem1', length=1, delay_cost=1)
	c_q01_mem1 += alt(MAS_MEM)
	S += (c_paa01*MAS[0])-1 < c_q01_mem1*MAS_MEM[0]
	S += (c_paa01*MAS[1])-1 < c_q01_mem1*MAS_MEM[1]
	S += (c_paa01*MAS[2])-1 < c_q01_mem1*MAS_MEM[2]
	S += (c_paa01*MAS[3])-1 < c_q01_mem1*MAS_MEM[3]
	S += c_q01_mem1 <= c_q01
	...
	c_qinv_bb_t0_mem0 += alt(MAS_MEM)
	S += (c_q10*MAS[0])-1 < c_qinv_bb_t0_mem0*MAS_MEM[0]
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t0_mem0*MAS_MEM[1]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t0_mem0*MAS_MEM[2]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t0_mem0*MAS_MEM[3]
	S += c_qinv_bb_t0_mem0 <= c_qinv_bb_t0

	c_qinv_bb_t0_mem1 = S.Task('c_qinv_bb_t0_mem1', length=1, delay_cost=1)
	c_qinv_bb_t0_mem1 += alt(MAS_MEM)
	S += (c_q10*MAS[0])-1 < c_qinv_bb_t0_mem1*MAS_MEM[0]
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t0_mem1*MAS_MEM[1]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t0_mem1*MAS_MEM[2]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t0_mem1*MAS_MEM[3]
	...
	c_qinv_bb_t1_mem0 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t1_mem0*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t1_mem0*MAS_MEM[1]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t1_mem0*MAS_MEM[2]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t1_mem0*MAS_MEM[3]
	S += c_qinv_bb_t1_mem0 <= c_qinv_bb_t1

	c_qinv_bb_t1_mem1 = S.Task('c_qinv_bb_t1_mem1', length=1, delay_cost=1)
	c_qinv_bb_t1_mem1 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t1_mem1*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t1_mem1*MAS_MEM[1]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t1_mem1*MAS_MEM[2]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t1_mem1*MAS_MEM[3]
	...
	c_qinv_bb_t2_mem0 += alt(MAS_MEM)
	S += (c_q10*MAS[0])-1 < c_qinv_bb_t2_mem0*MAS_MEM[0]
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t2_mem0*MAS_MEM[1]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t2_mem0*MAS_MEM[2]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t2_mem0*MAS_MEM[3]
	S += c_qinv_bb_t2_mem0 <= c_qinv_bb_t2

	c_qinv_bb_t2_mem1 = S.Task('c_qinv_bb_t2_mem1', length=1, delay_cost=1)
	c_qinv_bb_t2_mem1 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t2_mem1*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t2_mem1*MAS_MEM[1]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t2_mem1*MAS_MEM[2]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t2_mem1*MAS_MEM[3]
	...
	c_qinv_bb_t3_mem0 += alt(MAS_MEM)
	S += (c_q10*MAS[0])-1 < c_qinv_bb_t3_mem0*MAS_MEM[0]
	S += (c_q10*MAS[1])-1 < c_qinv_bb_t3_mem0*MAS_MEM[1]
	S += (c_q10*MAS[2])-1 < c_qinv_bb_t3_mem0*MAS_MEM[2]
	S += (c_q10*MAS[3])-1 < c_qinv_bb_t3_mem0*MAS_MEM[3]
	S += c_qinv_bb_t3_mem0 <= c_qinv_bb_t3

	c_qinv_bb_t3_mem1 = S.Task('c_qinv_bb_t3_mem1', length=1, delay_cost=1)
	c_qinv_bb_t3_mem1 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv_bb_t3_mem1*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv_bb_t3_mem1*MAS_MEM[1]
	S += (c_q11*MAS[2])-1 < c_qinv_bb_t3_mem1*MAS_MEM[2]
	S += (c_q11*MAS[3])-1 < c_qinv_bb_t3_mem1*MAS_MEM[3]
	...
	c_qinv1__t2_mem0 += alt(MAS_MEM)
	S += (c_q10*MAS[0])-1 < c_qinv1__t2_mem0*MAS_MEM[0]
	S += (c_q10*MAS[1])-1 < c_qinv1__t2_mem0*MAS_MEM[1]
	S += (c_q10*MAS[2])-1 < c_qinv1__t2_mem0*MAS_MEM[2]
	S += (c_q10*MAS[3])-1 < c_qinv1__t2_mem0*MAS_MEM[3]
	S += c_qinv1__t2_mem0 <= c_qinv1__t2

	c_qinv1__t2_mem1 = S.Task('c_qinv1__t2_mem1', length=1, delay_cost=1)
	c_qinv1__t2_mem1 += alt(MAS_MEM)
	S += (c_q11*MAS[0])-1 < c_qinv1__t2_mem1*MAS_MEM[0]
	S += (c_q11*MAS[1])-1 < c_qinv1__t2_mem1*MAS_MEM[1]
	S += (c_q11*MAS[2])-1 < c_qinv1__t2_mem1*MAS_MEM[2]
	S += (c_q11*MAS[3])-1 < c_qinv1__t2_mem1*MAS_MEM[3]
	...
	S += (c_q00*MAS[1])-1 < c_qinv_aa_t0_mem0*MAS_MEM[1]
	S += (c_q00*MAS[2])-1 < c_qinv_aa_t0_mem0*MAS_MEM[2]
	S += (c_q00*MAS[3])-1 < c_qinv_aa_t0_mem0*MAS_MEM[3]
	...
	S += (c_q00*MAS[0])-1 < c_qinv_aa_t0_mem1*MAS_MEM[0]
	S += (c_q00*MAS[1])-1 < c_qinv_aa_t0_mem1*MAS_MEM[1]
	S += (c_q00*MAS[2])-1 < c_qinv_aa_t0_mem1*MAS_MEM[2]
	S += (c_q00*MAS[3])-1 < c_qinv_aa_t0_mem1*MAS_MEM[3]
	...
	S += (c_q01*MAS[1])-1 < c_qinv_aa_t1_mem0*MAS_MEM[1]
	S += (c_q01*MAS[2])-1 < c_qinv_aa_t1_mem0*MAS_MEM[2]
	S += (c_q01*MAS[3])-1 < c_qinv_aa_t1_mem0*MAS_MEM[3]
	...
	S += (c_q01*MAS[0])-1 < c_qinv_aa_t1_mem1*MAS_MEM[0]
	S += (c_q01*MAS[1])-1 < c_qinv_aa_t1_mem1*MAS_MEM[1]
	S += (c_q01*MAS[2])-1 < c_qinv_aa_t1_mem1*MAS_MEM[2]
	S += (c_q01*MAS[3])-1 < c_qinv_aa_t1_mem1*MAS_MEM[3]
	...
	S += (c_q00*MAS[1])-1 < c_qinv_aa_t2_mem0*MAS_MEM[1]
	S += (c_q00*MAS[2])-1 < c_qinv_aa_t2_mem0*MAS_MEM[2]
	S += (c_q00*MAS[3])-1 < c_qinv_aa_t2_mem0*MAS_MEM[3]
	...
	S += (c_q01*MAS[0])-1 < c_qinv_aa_t2_mem1*MAS_MEM[0]
	S += (c_q01*MAS[1])-1 < c_qinv_aa_t2_mem1*MAS_MEM[1]
	S += (c_q01*MAS[2])-1 < c_qinv_aa_t2_mem1*MAS_MEM[2]
	S += (c_q01*MAS[3])-1 < c_qinv_aa_t2_mem1*MAS_MEM[3]
	...
	S += (c_q00*MAS[1])-1 < c_qinv_aa_t3_mem0*MAS_MEM[1]
	S += (c_q00*MAS[2])-1 < c_qinv_aa_t3_mem0*MAS_MEM[2]
	S += (c_q00*MAS[3])-1 < c_qinv_aa_t3_mem0*MAS_MEM[3]
	...
	S += (c_q01*MAS[0])-1 < c_qinv_aa_t3_mem1*MAS_MEM[0]
	S += (c_q01*MAS[1])-1 < c_qinv_aa_t3_mem1*MAS_MEM[1]
	S += (c_q01*MAS[2])-1 < c_qinv_aa_t3_mem1*MAS_MEM[2]
	S += (c_q01*MAS[3])-1 < c_qinv_aa_t3_mem1*MAS_MEM[3]
	...
	S += (c_qinv_bb_t2*MAS[1])-1 < c_qinv_bb_t4_mem0*MAS_MEM[1]
	S += (c_qinv_bb_t2*MAS[2])-1 < c_qinv_bb_t4_mem0*MAS_MEM[2]
	S += (c_qinv_bb_t2*MAS[3])-1 < c_qinv_bb_t4_mem0*MAS_MEM[3]
	...
	S += (c_qinv_bb_t3*MAS[0])-1 < c_qinv_bb_t4_mem1*MAS_MEM[0]
	S += (c_qinv_bb_t3*MAS[1])-1 < c_qinv_bb_t4_mem1*MAS_MEM[1]
	S += (c_qinv_bb_t3*MAS[2])-1 < c_qinv_bb_t4_mem1*MAS_MEM[2]
	S += (c_qinv_bb_t3*MAS[3])-1 < c_qinv_bb_t4_mem1*MAS_MEM[3]
	...
	S += (c_qinv_bb_t1*MM[0])-1 < c_qinv_bb0_mem1*MM_MEM[0]
	...
	S += (c_qinv_bb_t1*MM[0])-1 < c_qinv_bb_t5_mem1*MM_MEM[0]
	...
	c_qinv0_t2_mem0 += alt(MAS_MEM)
	S += (c_q00*MAS[0])-1 < c_qinv0_t2_mem0*MAS_MEM[0]
	S += (c_q00*MAS[1])-1 < c_qinv0_t2_mem0*MAS_MEM[1]
	S += (c_q00*MAS[2])-1 < c_qinv0_t2_mem0*MAS_MEM[2]
	S += (c_q00*MAS[3])-1 < c_qinv0_t2_mem0*MAS_MEM[3]
	S += c_qinv0_t2_mem0 <= c_qinv0_t2

	c_qinv0_t2_mem1 = S.Task('c_qinv0_t2_mem1', length=1, delay_cost=1)
	c_qinv0_t2_mem1 += alt(MAS_MEM)
	S += (c_q01*MAS[0])-1 < c_qinv0_t2_mem1*MAS_MEM[0]
	S += (c_q01*MAS[1])-1 < c_qinv0_t2_mem1*MAS_MEM[1]
	S += (c_q01*MAS[2])-1 < c_qinv0_t2_mem1*MAS_MEM[2]
	S += (c_q01*MAS[3])-1 < c_qinv0_t2_mem1*MAS_MEM[3]
	...
	S += (c_qinv_aa_t2*MAS[1])-1 < c_qinv_aa_t4_mem0*MAS_MEM[1]
	S += (c_qinv_aa_t2*MAS[2])-1 < c_qinv_aa_t4_mem0*MAS_MEM[2]
	S += (c_qinv_aa_t2*MAS[3])-1 < c_qinv_aa_t4_mem0*MAS_MEM[3]
	...
	S += (c_qinv_aa_t3*MAS[0])-1 < c_qinv_aa_t4_mem1*MAS_MEM[0]
	S += (c_qinv_aa_t3*MAS[1])-1 < c_qinv_aa_t4_mem1*MAS_MEM[1]
	S += (c_qinv_aa_t3*MAS[2])-1 < c_qinv_aa_t4_mem1*MAS_MEM[2]
	S += (c_qinv_aa_t3*MAS[3])-1 < c_qinv_aa_t4_mem1*MAS_MEM[3]
	...
	S += (c_qinv_aa_t1*MM[0])-1 < c_qinv_aa0_mem1*MM_MEM[0]
	...
	S += (c_qinv_aa_t1*MM[0])-1 < c_qinv_aa_t5_mem1*MM_MEM[0]
	...
	S += (c_qinv_bb_t5*MAS[0])-1 < c_qinv_bb1_mem1*MAS_MEM[0]
	S += (c_qinv_bb_t5*MAS[1])-1 < c_qinv_bb1_mem1*MAS_MEM[1]
	S += (c_qinv_bb_t5*MAS[2])-1 < c_qinv_bb1_mem1*MAS_MEM[2]
	S += (c_qinv_bb_t5*MAS[3])-1 < c_qinv_bb1_mem1*MAS_MEM[3]
	...
	S += (c_qinv_aa_t5*MAS[0])-1 < c_qinv_aa1_mem1*MAS_MEM[0]
	S += (c_qinv_aa_t5*MAS[1])-1 < c_qinv_aa1_mem1*MAS_MEM[1]
	S += (c_qinv_aa_t5*MAS[2])-1 < c_qinv_aa1_mem1*MAS_MEM[2]
	S += (c_qinv_aa_t5*MAS[3])-1 < c_qinv_aa1_mem1*MAS_MEM[3]
	...
	S += (c_qinv_bb0*MAS[1])-1 < c_qinv_bbxi0_mem0*MAS_MEM[1]
	S += (c_qinv_bb0*MAS[2])-1 < c_qinv_bbxi0_mem0*MAS_MEM[2]
	S += (c_qinv_bb0*MAS[3])-1 < c_qinv_bbxi0_mem0*MAS_MEM[3]
	...
	S += (c_qinv_bb1*MAS[0])-1 < c_qinv_bbxi0_mem1*MAS_MEM[0]
	S += (c_qinv_bb1*MAS[1])-1 < c_qinv_bbxi0_mem1*MAS_MEM[1]
	S += (c_qinv_bb1*MAS[2])-1 < c_qinv_bbxi0_mem1*MAS_MEM[2]
	S += (c_qinv_bb1*MAS[3])-1 < c_qinv_bbxi0_mem1*MAS_MEM[3]
	...
	S += (c_qinv_bb1*MAS[1])-1 < c_qinv_bbxi1_mem0*MAS_MEM[1]
	S += (c_qinv_bb1*MAS[2])-1 < c_qinv_bbxi1_mem0*MAS_MEM[2]
	S += (c_qinv_bb1*MAS[3])-1 < c_qinv_bbxi1_mem0*MAS_MEM[3]
	...
	S += (c_qinv_bb0*MAS[0])-1 < c_qinv_bbxi1_mem1*MAS_MEM[0]
	S += (c_qinv_bb0*MAS[1])-1 < c_qinv_bbxi1_mem1*MAS_MEM[1]
	S += (c_qinv_bb0*MAS[2])-1 < c_qinv_bbxi1_mem1*MAS_MEM[2]
	S += (c_qinv_bb0*MAS[3])-1 < c_qinv_bbxi1_mem1*MAS_MEM[3]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/INV/schedule10.png"
	if(S.solution() != []):
