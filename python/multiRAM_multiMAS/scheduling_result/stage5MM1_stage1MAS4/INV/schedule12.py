...
def solve():
	...
	S += (c0_t0_t5*MAS[0])-1 < c0_t01_mem1*MAS_MEM[0]
	S += (c0_t0_t5*MAS[1])-1 < c0_t01_mem1*MAS_MEM[1]
	S += (c0_t0_t5*MAS[2])-1 < c0_t01_mem1*MAS_MEM[2]
	S += (c0_t0_t5*MAS[3])-1 < c0_t01_mem1*MAS_MEM[3]
	...
	S += (c0_t1_t5*MAS[0])-1 < c0_t11_mem1*MAS_MEM[0]
	S += (c0_t1_t5*MAS[1])-1 < c0_t11_mem1*MAS_MEM[1]
	S += (c0_t1_t5*MAS[2])-1 < c0_t11_mem1*MAS_MEM[2]
	S += (c0_t1_t5*MAS[3])-1 < c0_t11_mem1*MAS_MEM[3]
	...
	S += (c0_t4_t3*MAS[0])-1 < c0_t4_t4_mem1*MAS_MEM[0]
	S += (c0_t4_t3*MAS[1])-1 < c0_t4_t4_mem1*MAS_MEM[1]
	S += (c0_t4_t3*MAS[2])-1 < c0_t4_t4_mem1*MAS_MEM[2]
	S += (c0_t4_t3*MAS[3])-1 < c0_t4_t4_mem1*MAS_MEM[3]
	...
	S += (c0_t4_t1*MM[0])-1 < c0_t40_mem1*MM_MEM[0]
	...
	S += (c0_t4_t1*MM[0])-1 < c0_t4_t5_mem1*MM_MEM[0]
	...
	S += (c0_t00*MAS[1])-1 < c0_t50_mem0*MAS_MEM[1]
	S += (c0_t00*MAS[2])-1 < c0_t50_mem0*MAS_MEM[2]
	S += (c0_t00*MAS[3])-1 < c0_t50_mem0*MAS_MEM[3]
	S += c0_t50_mem0 <= c0_t50

	c0_t50_mem1 = S.Task('c0_t50_mem1', length=1, delay_cost=1)
	c0_t50_mem1 += alt(MAS_MEM)
	S += (c0_t10*MAS[0])-1 < c0_t50_mem1*MAS_MEM[0]
	S += (c0_t10*MAS[1])-1 < c0_t50_mem1*MAS_MEM[1]
	S += (c0_t10*MAS[2])-1 < c0_t50_mem1*MAS_MEM[2]
	S += (c0_t10*MAS[3])-1 < c0_t50_mem1*MAS_MEM[3]
	...
	S += (c1_t0_t5*MAS[0])-1 < c1_t01_mem1*MAS_MEM[0]
	S += (c1_t0_t5*MAS[1])-1 < c1_t01_mem1*MAS_MEM[1]
	S += (c1_t0_t5*MAS[2])-1 < c1_t01_mem1*MAS_MEM[2]
	S += (c1_t0_t5*MAS[3])-1 < c1_t01_mem1*MAS_MEM[3]
	...
	S += (c1_t1_t5*MAS[0])-1 < c1_t11_mem1*MAS_MEM[0]
	S += (c1_t1_t5*MAS[1])-1 < c1_t11_mem1*MAS_MEM[1]
	S += (c1_t1_t5*MAS[2])-1 < c1_t11_mem1*MAS_MEM[2]
	S += (c1_t1_t5*MAS[3])-1 < c1_t11_mem1*MAS_MEM[3]
	...
	S += (c1_t4_t3*MAS[0])-1 < c1_t4_t4_mem1*MAS_MEM[0]
	S += (c1_t4_t3*MAS[1])-1 < c1_t4_t4_mem1*MAS_MEM[1]
	S += (c1_t4_t3*MAS[2])-1 < c1_t4_t4_mem1*MAS_MEM[2]
	S += (c1_t4_t3*MAS[3])-1 < c1_t4_t4_mem1*MAS_MEM[3]
	...
	S += (c1_t4_t1*MM[0])-1 < c1_t40_mem1*MM_MEM[0]
	...
	S += (c1_t4_t1*MM[0])-1 < c1_t4_t5_mem1*MM_MEM[0]
	...
	S += (c1_t00*MAS[1])-1 < c1_t50_mem0*MAS_MEM[1]
	S += (c1_t00*MAS[2])-1 < c1_t50_mem0*MAS_MEM[2]
	S += (c1_t00*MAS[3])-1 < c1_t50_mem0*MAS_MEM[3]
	S += c1_t50_mem0 <= c1_t50

	c1_t50_mem1 = S.Task('c1_t50_mem1', length=1, delay_cost=1)
	c1_t50_mem1 += alt(MAS_MEM)
	S += (c1_t10*MAS[0])-1 < c1_t50_mem1*MAS_MEM[0]
	S += (c1_t10*MAS[1])-1 < c1_t50_mem1*MAS_MEM[1]
	S += (c1_t10*MAS[2])-1 < c1_t50_mem1*MAS_MEM[2]
	S += (c1_t10*MAS[3])-1 < c1_t50_mem1*MAS_MEM[3]
	...
	S += (c2_t0_t5*MAS[0])-1 < c2_t01_mem1*MAS_MEM[0]
	S += (c2_t0_t5*MAS[1])-1 < c2_t01_mem1*MAS_MEM[1]
	S += (c2_t0_t5*MAS[2])-1 < c2_t01_mem1*MAS_MEM[2]
	S += (c2_t0_t5*MAS[3])-1 < c2_t01_mem1*MAS_MEM[3]
	...
	S += (c2_t1_t5*MAS[0])-1 < c2_t11_mem1*MAS_MEM[0]
	S += (c2_t1_t5*MAS[1])-1 < c2_t11_mem1*MAS_MEM[1]
	S += (c2_t1_t5*MAS[2])-1 < c2_t11_mem1*MAS_MEM[2]
	S += (c2_t1_t5*MAS[3])-1 < c2_t11_mem1*MAS_MEM[3]
	...
	c2_t4_t4_mem0 += MAS_MEM[1]
	S += 97 < c2_t4_t4_mem0
	S += c2_t4_t4_mem0 <= c2_t4_t4

	c2_t4_t4_mem1 = S.Task('c2_t4_t4_mem1', length=1, delay_cost=1)
	c2_t4_t4_mem1 += alt(MAS_MEM)
	S += (c2_t4_t3*MAS[0])-1 < c2_t4_t4_mem1*MAS_MEM[0]
	S += (c2_t4_t3*MAS[1])-1 < c2_t4_t4_mem1*MAS_MEM[1]
	S += (c2_t4_t3*MAS[2])-1 < c2_t4_t4_mem1*MAS_MEM[2]
	S += (c2_t4_t3*MAS[3])-1 < c2_t4_t4_mem1*MAS_MEM[3]
	...
	S += (c2_t4_t1*MM[0])-1 < c2_t40_mem1*MM_MEM[0]
	...
	S += (c2_t4_t1*MM[0])-1 < c2_t4_t5_mem1*MM_MEM[0]
	...
	S += (c2_t00*MAS[1])-1 < c2_t50_mem0*MAS_MEM[1]
	S += (c2_t00*MAS[2])-1 < c2_t50_mem0*MAS_MEM[2]
	S += (c2_t00*MAS[3])-1 < c2_t50_mem0*MAS_MEM[3]
	S += c2_t50_mem0 <= c2_t50

	c2_t50_mem1 = S.Task('c2_t50_mem1', length=1, delay_cost=1)
	c2_t50_mem1 += alt(MAS_MEM)
	S += (c2_t10*MAS[0])-1 < c2_t50_mem1*MAS_MEM[0]
	S += (c2_t10*MAS[1])-1 < c2_t50_mem1*MAS_MEM[1]
	S += (c2_t10*MAS[2])-1 < c2_t50_mem1*MAS_MEM[2]
	S += (c2_t10*MAS[3])-1 < c2_t50_mem1*MAS_MEM[3]
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/INV/schedule12.png"
	if(S.solution() != []):
