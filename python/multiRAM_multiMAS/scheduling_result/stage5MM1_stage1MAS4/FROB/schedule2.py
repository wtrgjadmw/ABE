...
def solve():
	...
	S += c000_mem0 >= 20
	c000_mem0 += MAIN_MEM_r

	c000_mem1 = S.Task('c000_mem1', length=1, delay_cost=1)
	S += c000_mem1 >= 20
	c000_mem1 += MAIN_MEM_r
	...
	S += c001_mem0 >= 21
	c001_mem0 += MAIN_MEM_r

	c001_mem1 = S.Task('c001_mem1', length=1, delay_cost=1)
	S += c001_mem1 >= 21
	c001_mem1 += MAIN_MEM_r
	...
	c10_t4_in += alt(MM_in)
	c10_t4 = S.Task('c10_t4', length=5, delay_cost=1)
	c10_t4 += alt(MM)
	S += c10_t4>=c10_t4_in
	...
	S += (c10_t5*MAS[0])-1 < c101_mem1*MAS_MEM[0]
	S += (c10_t5*MAS[1])-1 < c101_mem1*MAS_MEM[1]
	S += (c10_t5*MAS[2])-1 < c101_mem1*MAS_MEM[2]
	S += (c10_t5*MAS[3])-1 < c101_mem1*MAS_MEM[3]
	S += c101_mem1 <= c101
	...
	S += (c20_t5*MAS[0])-1 < c201_mem1*MAS_MEM[0]
	S += (c20_t5*MAS[1])-1 < c201_mem1*MAS_MEM[1]
	S += (c20_t5*MAS[2])-1 < c201_mem1*MAS_MEM[2]
	S += (c20_t5*MAS[3])-1 < c201_mem1*MAS_MEM[3]
	S += c201_mem1 <= c201
	...
	S += (c01_t5*MAS[0])-1 < c011_mem1*MAS_MEM[0]
	S += (c01_t5*MAS[1])-1 < c011_mem1*MAS_MEM[1]
	S += (c01_t5*MAS[2])-1 < c011_mem1*MAS_MEM[2]
	S += (c01_t5*MAS[3])-1 < c011_mem1*MAS_MEM[3]
	S += c011_mem1 <= c011
	...
	S += (c11_t5*MAS[0])-1 < c111_mem1*MAS_MEM[0]
	S += (c11_t5*MAS[1])-1 < c111_mem1*MAS_MEM[1]
	S += (c11_t5*MAS[2])-1 < c111_mem1*MAS_MEM[2]
	S += (c11_t5*MAS[3])-1 < c111_mem1*MAS_MEM[3]
	S += c111_mem1 <= c111
	...
	S += (c21_t5*MAS[0])-1 < c211_mem1*MAS_MEM[0]
	S += (c21_t5*MAS[1])-1 < c211_mem1*MAS_MEM[1]
	S += (c21_t5*MAS[2])-1 < c211_mem1*MAS_MEM[2]
	S += (c21_t5*MAS[3])-1 < c211_mem1*MAS_MEM[3]
	S += c211_mem1 <= c211
	...
	pic_file_name = "/home/mfukuda/ABE/python/multiRAM_multiMAS/scheduling_result/stage5MM1_stage1MAS4/FROB/schedule2.png"
	if(S.solution() != []):
