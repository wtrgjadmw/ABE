...
def solve():
	...
	T8_mem1 += alt(MUL_MEM)
	S += (T1*MUL[0])-1 < T8_mem1*MUL_MEM[0]
	S += T8_mem1 <= T8
	...
	T9_mem1 += alt(MUL_MEM)
	S += (T1*MUL[0])-1 < T9_mem1*MUL_MEM[0]
	S += T9_mem1 <= T9
	...
	S += (T3*MUL[0])-1 < T10_mem1*MUL_MEM[0]
	S += T10_mem1 <= T10
	...
	S += (T3*MUL[0])-1 < T11_mem1*MUL_MEM[0]
	S += T11_mem1 <= T11
	...
	S += (T2*MUL[0])-1 < T12_mem1*MUL_MEM[0]
	S += T12_mem1 <= T12
	...
	S += (T2*MUL[0])-1 < T13_mem1*MUL_MEM[0]
	S += T13_mem1 <= T13
	...
	S += (T7*MUL[0])-1 < T15_mem1*MUL_MEM[0]
	S += T15_mem1 <= T15
	...
	S += (T8*MUL[0])-1 < T16_mem1*MUL_MEM[0]
	S += T16_mem1 <= T16
	...
	S += (T9*MUL[0])-1 < T18_mem1*MUL_MEM[0]
	S += T18_mem1 <= T18
	...
	S += (T9*MUL[0])-1 < T19_mem1*MUL_MEM[0]
	S += T19_mem1 <= T19
	...
	S += (T10*MUL[0])-1 < T21_mem1*MUL_MEM[0]
	S += T21_mem1 <= T21
	...
	S += (T20*MUL[0])-1 < T25_mem1*MUL_MEM[0]
	S += T25_mem1 <= T25
	...
	S += (T14*MUL[0])-1 < Z2_new_mem1*MUL_MEM[0]
	...
	S += (T24*MUL[0])-1 < X2_new_mem1*MUL_MEM[0]
	...
	S += (T17*MUL[0])-1 < X1_new_mem1*MUL_MEM[0]
